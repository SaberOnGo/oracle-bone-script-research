...
Project ID: `obs-evo-cand-005056`
...
- Project ID: `obs-evo-cand-005056`
- EVOBC category candidate ID: `evobc-evo-cat-05056`
- External category reference: `evobc-cat-05056`
- Source category ID: `05056`
- Source label for human review: `炳`
- Source codepoints: `U+70B3`
...
- `obs-evo-cand-005056-route-category-staging`
...
- `obs-evo-cand-005056-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005056-route-evolution-graph`
