# Material Visual Observation / obs-comp-cand-000450 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000450`
- External reference / 外部参照: `obimd-sub-k9fz66biv5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012373_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/k9fz66biv5/k9fz66biv5/k9fz66biv5.png`
- Checksum / 校验和:
  `f9e5f70d655cba39428def97b139676c7cd9fbe2b8b71800caa9cf125c3afe28`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.21%.
- Marked-pixel bounds: (69,31)–(180,214); span 112 × 184 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.21%。
- 痕迹范围：(69,31)–(180,214)；跨度112 × 184 px；痕迹矩形高于宽。
