...
Project ID: `obs-evo-cand-005058`
...
- Project ID: `obs-evo-cand-005058`
- EVOBC category candidate ID: `evobc-evo-cat-05058`
- External category reference: `evobc-cat-05058`
- Source category ID: `05058`
- Source label for human review: `為`
- Source codepoints: `U+70BA`
...
- era `4`
  token: `WSC`
  image references: 348
- era `5`
  token: `CS`
  image references: 3
- source `1`
  token: `Web:105952;說文Web:58`
  image references: 422
...
- `obs-evo-cand-005058-route-category-staging`
...
- `obs-evo-cand-005058-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005058-route-evolution-graph`
