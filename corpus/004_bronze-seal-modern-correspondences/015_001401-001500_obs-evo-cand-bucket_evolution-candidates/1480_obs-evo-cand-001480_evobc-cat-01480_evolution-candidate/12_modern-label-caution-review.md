# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-001480
...
- EVOBC candidate category: `evobc-evo-cat-01480`.
- Source label for search only: `叱`.
- Source codepoints for search only: `U+53F1`.
