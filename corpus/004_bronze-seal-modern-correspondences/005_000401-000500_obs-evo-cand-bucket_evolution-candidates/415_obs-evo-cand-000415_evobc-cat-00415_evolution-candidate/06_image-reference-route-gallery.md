...
- `obs-evo-cand-000415-route-category-staging`
...
- `obs-evo-cand-000415-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000415-route-evolution-graph`
