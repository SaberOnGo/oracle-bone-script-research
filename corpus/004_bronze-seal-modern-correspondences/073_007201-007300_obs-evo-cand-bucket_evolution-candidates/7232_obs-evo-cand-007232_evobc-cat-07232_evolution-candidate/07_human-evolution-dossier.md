...
Project ID: `obs-evo-cand-007232`
...
- Project ID: `obs-evo-cand-007232`
- EVOBC category candidate ID: `evobc-evo-cat-07232`
- External category reference: `evobc-cat-07232`
- Source category ID: `07232`
- Source label for human review: `芊`
- Source codepoints: `U+828A`
...
- `obs-evo-cand-007232-route-category-staging`
...
- `obs-evo-cand-007232-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007232-route-evolution-graph`
