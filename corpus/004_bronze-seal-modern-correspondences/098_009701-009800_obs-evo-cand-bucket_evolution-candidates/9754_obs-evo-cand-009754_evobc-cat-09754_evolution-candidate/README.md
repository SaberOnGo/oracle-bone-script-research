# obs-evo-cand-009754 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-009754`
- EVOBC category candidate ID: `evobc-evo-cat-09754`
- External category ref: `evobc-cat-09754`
- Source label: `陸`
- Source codepoints: `U+9678`
- Image reference count: `43`
- Era token counts: `BI:11;CS:1;OBC:5;SAC:3;SS:2;WSC:21`
- Source token counts: `Book:22;Web:21`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 5 image references
