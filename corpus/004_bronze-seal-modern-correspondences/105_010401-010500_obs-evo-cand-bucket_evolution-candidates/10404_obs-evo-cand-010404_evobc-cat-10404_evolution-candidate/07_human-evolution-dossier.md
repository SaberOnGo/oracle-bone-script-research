...
Project ID: `obs-evo-cand-010404`
...
- Project ID: `obs-evo-cand-010404`
- EVOBC category candidate ID: `evobc-evo-cat-10404`
- External category reference: `evobc-cat-10404`
- Source category ID: `10404`
- Source label for human review: `鮷`
- Source codepoints: `U+9BB7`
...
- `obs-evo-cand-010404-route-category-staging`
...
- `obs-evo-cand-010404-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010404-route-evolution-graph`
