# obs-unk-004809 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004809`
- primary external id: `hust-obc-und-X-004809`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/009_obs-unk-004809_h
  ust-obc-und-X-004809_oracle-character-candidate/03_visual-assets/001_asset
  -006402_hust-obc-und-X-004809_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/365/X_？_7349_1.png`
- asset id: `asset-006402`
...
- source class: `HUST-OBC/undeciphered/X/365/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/365/X_？_7349_1.png`
- asset id: `asset-006402`
...
- English observation: `broad horizontal group with multiple openings`
- 中文观察: `带多个开口的宽大横向结构`
...
- Which source records identify obs-unk-004809 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004809？
