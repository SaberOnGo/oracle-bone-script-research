# obs-comp-cand-001878 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001878`
- 首选外部 ID: `obimd-sub-mjcddztx5s`
- OBIMD subcharacter UID: `mjcddztx5s`
- OBIMD main character UID: `2ao64scs41`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+AE6CE;U+FABEC; U+FABED
