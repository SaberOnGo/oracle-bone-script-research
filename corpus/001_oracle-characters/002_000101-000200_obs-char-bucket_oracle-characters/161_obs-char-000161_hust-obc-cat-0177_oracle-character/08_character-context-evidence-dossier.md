...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0177`
...
- Source image / 来源图: `G_0177_後2.20.10合17961賓組.png`
- Image / 图像: `001_asset-000166_hust-obc-cat-0177_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合17961
...
- target node: `evobc-evo-cat-00015`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/015_obs-evo-cand-000015_evobc-cat-00015_evoluti
...
- Source label text / 来源标签文字: `㒧`
- Source label codepoint / 来源标签 codepoint: `U+34A7`
