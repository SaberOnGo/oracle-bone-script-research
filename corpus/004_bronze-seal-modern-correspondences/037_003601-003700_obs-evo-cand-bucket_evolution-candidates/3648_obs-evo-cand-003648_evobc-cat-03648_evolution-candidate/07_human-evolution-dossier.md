...
Project ID: `obs-evo-cand-003648`
...
- Project ID: `obs-evo-cand-003648`
- EVOBC category candidate ID: `evobc-evo-cat-03648`
- External category reference: `evobc-cat-03648`
- Source category ID: `03648`
- Source label for human review: `斬`
- Source codepoints: `U+65AC`
...
- `obs-evo-cand-003648-route-category-staging`
...
- `obs-evo-cand-003648-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003648-route-evolution-graph`
