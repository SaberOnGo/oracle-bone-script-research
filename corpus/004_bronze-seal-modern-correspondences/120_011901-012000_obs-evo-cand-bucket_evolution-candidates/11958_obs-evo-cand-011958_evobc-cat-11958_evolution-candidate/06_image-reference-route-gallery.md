...
- `obs-evo-cand-011958-route-category-staging`
...
- `obs-evo-cand-011958-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011958-route-evolution-graph`
