...
- Project ID: `obs-evo-cand-002126`
- EVOBC category candidate ID: `evobc-evo-cat-02126`
- External category reference: `evobc-cat-02126`
- Source category ID: `02126`
- Source label for human review: `姘`
- Source codepoints: `U+59D8`
...
- `obs-evo-cand-002126-route-category-staging`
...
- `obs-evo-cand-002126-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002126-route-evolution-graph`
