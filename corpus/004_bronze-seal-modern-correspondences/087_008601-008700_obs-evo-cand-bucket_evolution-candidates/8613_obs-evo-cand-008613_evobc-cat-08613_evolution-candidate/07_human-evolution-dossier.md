...
Project ID: `obs-evo-cand-008613`
...
- Project ID: `obs-evo-cand-008613`
- EVOBC category candidate ID: `evobc-evo-cat-08613`
- External category reference: `evobc-cat-08613`
- Source category ID: `08613`
- Source label for human review: `贞`
- Source codepoints: `U+8D1E`
...
- `obs-evo-cand-008613-route-category-staging`
...
- `obs-evo-cand-008613-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008613-route-evolution-graph`
