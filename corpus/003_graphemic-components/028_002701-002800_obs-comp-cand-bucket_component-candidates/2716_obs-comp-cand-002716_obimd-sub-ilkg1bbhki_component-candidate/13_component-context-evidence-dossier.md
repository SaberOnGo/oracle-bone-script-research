# obs-comp-cand-002716 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002716`
- 首选外部 ID: `obimd-sub-ilkg1bbhki`
- OBIMD subcharacter UID: `ilkg1bbhki`
- OBIMD main character UID: `ilkg1bbhki`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+FF53D; U+FF53E; 另有 1 项
