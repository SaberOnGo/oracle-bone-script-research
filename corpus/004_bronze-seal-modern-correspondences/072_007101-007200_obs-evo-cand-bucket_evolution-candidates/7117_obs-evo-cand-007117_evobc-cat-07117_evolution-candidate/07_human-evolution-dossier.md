...
- External category reference: `evobc-cat-07117`
- Source category ID: `07117`
- Source label for human review: `膉`
- Source codepoints: `U+8189`
...
- `obs-evo-cand-007117-route-category-staging`
...
- `obs-evo-cand-007117-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007117-route-evolution-graph`
