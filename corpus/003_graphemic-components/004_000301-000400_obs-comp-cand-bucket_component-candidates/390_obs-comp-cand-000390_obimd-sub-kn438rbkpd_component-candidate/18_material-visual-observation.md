# Material Visual Observation / obs-comp-cand-000390 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000390`
- External reference / 外部参照: `obimd-sub-kn438rbkpd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012313_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kn438rbkpd/kn438rbkpd/kn438rbkpd.png`
- Checksum / 校验和:
  `9613144407922bb8975d628cccedbf56b837f0c517004aa7a031896e997c5df2`
...
- Marked-pixel bounds: (81,27)–(168,221); span 88 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.84%。
- 痕迹范围：(81,27)–(168,221)；跨度88 × 195 px；痕迹矩形高于宽。
