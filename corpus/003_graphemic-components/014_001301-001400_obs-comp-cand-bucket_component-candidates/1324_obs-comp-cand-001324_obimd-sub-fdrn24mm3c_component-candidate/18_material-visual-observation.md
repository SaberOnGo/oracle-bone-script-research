# Material Visual Observation / obs-comp-cand-001324 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001324`
- External reference / 外部参照: `obimd-sub-fdrn24mm3c`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015661_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/n2eg801rgy/fdrn24mm3c/fdrn24mm3c.png`
- Checksum / 校验和:
  `ad800ed22aded8d0bed2bbb1797b7100b29c810407e326739ddc907e0d754a0a`
...
- Marked-pixel bounds: (87,29)–(162,224); span 76 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.60%。
- 痕迹范围：(87,29)–(162,224)；跨度76 × 196 px；痕迹矩形高于宽。
