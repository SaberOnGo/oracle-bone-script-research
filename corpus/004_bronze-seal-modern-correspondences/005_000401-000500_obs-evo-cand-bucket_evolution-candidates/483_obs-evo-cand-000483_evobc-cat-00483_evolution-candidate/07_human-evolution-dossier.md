...
Project ID: `obs-evo-cand-000483`
...
- Project ID: `obs-evo-cand-000483`
- EVOBC category candidate ID: `evobc-evo-cat-00483`
- External category reference: `evobc-cat-00483`
- Source category ID: `00483`
- Source label for human review: `䢺`
- Source codepoints: `U+48BA`
...
- `obs-evo-cand-000483-route-category-staging`
...
- `obs-evo-cand-000483-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000483-route-evolution-graph`
