# obs-unk-005577 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/077_obs-unk-005577_h
  ust-obc-und-X-005577_oracle-character-candidate/03_visual-assets/001_asset
  -007170_hust-obc-und-X-005577_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1133/X_？_8088_1.png`
- asset id: `asset-007170`
...
- source class: `HUST-OBC/undeciphered/X/1133/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1133/X_？_8088_1.png`
...
- Which source records identify obs-unk-005577 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005577？
