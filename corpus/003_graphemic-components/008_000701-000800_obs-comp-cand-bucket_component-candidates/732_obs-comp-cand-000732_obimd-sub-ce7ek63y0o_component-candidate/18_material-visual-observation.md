# Material Visual Observation / obs-comp-cand-000732 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000732`
- External reference / 外部参照: `obimd-sub-ce7ek63y0o`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013459_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ce7ek63y0o/ce7ek63y0o/ce7ek63y0o.png`
- Checksum / 校验和:
  `22912ffd7018e2aa00d98d3c15fc8c3641b77a08f8a71051f020d4aebe357afa`
...
- Marked-pixel bounds: (89,20)–(161,229); span 73 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.15%。
- 痕迹范围：(89,20)–(161,229)；跨度73 × 210 px；痕迹矩形高于宽。
