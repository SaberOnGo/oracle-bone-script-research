# obs-char-000395 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000395`
- primary external id: `hust-obc-cat-0448`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/395_obs-char-000395_hust-obc-cat-0448_orac
  le-character/03_visual-assets/001_asset-000400_hust-obc-cat-0448_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0448/G_0448_合8251正賓組.png`
- asset id: `asset-000400`
...
- source category: `0448`
- validation class: `394`
- source image route: `HUST-OBC/deciphered/0448/G_0448_合8251正賓組.png`
- asset id: `asset-000400`
...
- English observation: `Several dark curved and diagonal strokes cross
  around a narrow central loop.`
- 中文观察: `数条深色弧形和斜向笔画围绕狭窄中央环形痕迹交叉。`
...
- dataset label text: `㖶`
- dataset label codepoints: `U+35B6`
...
- filename catalog route clues: `Heji-like filename clue: 合8251
  (G_0448_合8251正賓組.png)`
...
- Which source records identify obs-char-000395 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000395？
