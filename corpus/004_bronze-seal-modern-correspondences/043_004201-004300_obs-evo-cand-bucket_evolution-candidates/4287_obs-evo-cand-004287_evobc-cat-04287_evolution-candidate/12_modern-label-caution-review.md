# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004287
...
- EVOBC candidate category: `evobc-evo-cat-04287`.
- Source label for search only: `檍`.
- Source codepoints for search only: `U+6A8D`.
