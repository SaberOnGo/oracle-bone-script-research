# obs-char-001023 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001023`
- primary external id: `hust-obc-cat-1148`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1023_obs-char-001023_hust-obc-cat-1148_ora
  cle-character/03_visual-assets/001_asset-001028_hust-obc-cat-1148_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1148/H_1148_60FA4_0.png`
- asset id: `asset-001028`
...
- source category: `1148`
- validation class: `1022`
- source image route: `HUST-OBC/deciphered/1148/H_1148_60FA4_0.png`
- asset id: `asset-001028`
...
- English observation: `A broad rounded lower enclosure has a tall central
  upright with a hooked terminal, upper side projections, and two long lower
  branches.`
- 中文观察: `宽大的圆弧下部闭合轮廓有带钩状末端的高直立中央笔、上部侧外伸和两条长下部分枝。`
...
- dataset label text: `㡲`
- dataset label codepoints: `U+3872`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00093`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00093`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00093`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/093_obs-evo-can
  d-000093_evobc-cat-00093_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/093_obs-evo-cand-000093_evobc-cat-00093_evolu
...
- filename catalog route clues: `catalog-like filename clue: H_1148
  (H_1148_60FA4_0.png)`
...
- Which source records identify obs-char-001023 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001023？
