...
Project ID: `obs-evo-cand-001405`
...
- Project ID: `obs-evo-cand-001405`
- EVOBC category candidate ID: `evobc-evo-cat-01405`
- External category reference: `evobc-cat-01405`
- Source category ID: `01405`
- Source label for human review: `卸`
- Source codepoints: `U+5378`
...
- `obs-evo-cand-001405-route-category-staging`
...
- `obs-evo-cand-001405-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001405-route-evolution-graph`
