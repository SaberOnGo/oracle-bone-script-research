# Material Visual Observation / obs-comp-cand-000275 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000275`
- External reference / 外部参照: `obimd-sub-xkubtjk815`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011919_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xkubtjk815/xkubtjk815/xkubtjk815.png`
- Checksum / 校验和:
  `4cff7a86eb5a5b22f5822dd073633ba879dc2d7c0293ca1c6ea705475eb60392`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.74%.
- Marked-pixel bounds: (87,28)–(162,220); span 76 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.74%。
- 痕迹范围：(87,28)–(162,220)；跨度76 × 193 px；痕迹矩形高于宽。
