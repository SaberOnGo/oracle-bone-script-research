...
Project ID: `obs-evo-cand-003472`
...
- Project ID: `obs-evo-cand-003472`
- EVOBC category candidate ID: `evobc-evo-cat-03472`
- External category reference: `evobc-cat-03472`
- Source category ID: `03472`
- Source label for human review: `摕`
- Source codepoints: `U+6455`
...
- `obs-evo-cand-003472-route-category-staging`
...
- `obs-evo-cand-003472-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003472-route-evolution-graph`
