# Material Visual Observation / obs-comp-cand-000141 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000141`
- External reference / 外部参照: `obimd-sub-yfnx5cwgq6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011553_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yfnx5cwgq6/yfnx5cwgq6/yfnx5cwgq6.png`
- Checksum / 校验和:
  `ebdf27da37e4cae020b3f952ea7a4ecae3bdd9b09a7a278ecbf31012a6fcf30f`
...
- Marked-pixel bounds: (66,27)–(183,221); span 118 × 195 px; the marked
...
- 痕迹范围：(66,27)–(183,221)；跨度118 × 195 px；痕迹矩形高于宽。
