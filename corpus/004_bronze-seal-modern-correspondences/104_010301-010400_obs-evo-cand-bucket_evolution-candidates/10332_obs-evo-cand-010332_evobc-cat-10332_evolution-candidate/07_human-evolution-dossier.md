...
- External category reference: `evobc-cat-10332`
- Source category ID: `10332`
- Source label for human review: `鬗`
- Source codepoints: `U+9B17`
...
- `obs-evo-cand-010332-route-category-staging`
...
- `obs-evo-cand-010332-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010332-route-evolution-graph`
