# obs-unk-006288 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/079_undeciphered-006
  201-006300_obs-unk-bucket_oracle-character-candidates/088_obs-unk-006288_h
  ust-obc-und-X-006288_oracle-character-candidate/03_visual-assets/001_asset
  -007880_hust-obc-und-X-006288_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1844/X_？_4815_1.png`
- asset id: `asset-007880`
...
- source class: `HUST-OBC/undeciphered/X/1844/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1844/X_？_4815_1.png`
- asset id: `asset-007880`
...
- Which source records identify obs-unk-006288 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006288？
