...
- External category reference: `evobc-cat-09197`
- Source category ID: `09197`
- Source label for human review: `鄜`
...
- `obs-evo-cand-009197-route-category-staging`
...
- `obs-evo-cand-009197-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009197-route-evolution-graph`
