# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002427
...
- EVOBC candidate category: `evobc-evo-cat-02427`.
- Source label for search only: `寝`.
- Source codepoints for search only: `U+5BDD`.
