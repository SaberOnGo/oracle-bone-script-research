# obs-unk-002350 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/040_undeciphered-002
  301-002400_obs-unk-bucket_oracle-character-candidates/050_obs-unk-002350_h
  ust-obc-und-L-002350_oracle-character-candidate/03_visual-assets/001_asset
  -003943_hust-obc-und-L-002350_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2350/L_？_3104.jpg`
- asset id: `asset-003943`
...
- source class: `HUST-OBC/undeciphered/L/2350/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2350/L_？_3104.jpg`
- asset id: `asset-003943`
...
- Which source records identify obs-unk-002350 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002350？
