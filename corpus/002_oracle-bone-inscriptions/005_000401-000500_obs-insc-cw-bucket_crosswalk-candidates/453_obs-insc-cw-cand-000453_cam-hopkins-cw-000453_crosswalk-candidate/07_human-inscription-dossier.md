...
Project ID: `obs-insc-cw-cand-000453`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000453`
...
- Yingguo / 英国所藏: `y2326` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `328` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `374` in source row; primary catalog entry pending
- Heji / 合集: `41529` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000453`
