# Material Visual Observation / obs-comp-cand-000340 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000340`
- External reference / 外部参照: `obimd-sub-jvuf4ut3c5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012264_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jvuf4ut3c5/jvuf4ut3c5/jvuf4ut3c5.png`
- Checksum / 校验和:
  `a71f729e7a196e4acb826003d048f0551e207f56e8f7134af488bbd0208cb4e2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.18%.
- Marked-pixel bounds: (83,34)–(166,214); span 84 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.18%。
- 痕迹范围：(83,34)–(166,214)；跨度84 × 181 px；痕迹矩形高于宽。
