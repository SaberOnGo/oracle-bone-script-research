# obs-char-000778 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000778`
- primary external id: `hust-obc-cat-0882`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/778_obs-char-000778_hust-obc-cat-0882_orac
  le-character/03_visual-assets/001_asset-000783_hust-obc-cat-0882_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0882/G_0882_京津3728合26779出組.png`
- asset id: `asset-000783`
...
- source category: `0882`
- validation class: `777`
- source image route: `HUST-OBC/deciphered/0882/G_0882_京津3728合26779出組.png`
- asset id: `asset-000783`
...
- English observation: `Three small diamond-like loops form a vertical chain
  along a wavering central stroke; the lowest junction continues into two
  long crossing lower branches.`
- 中文观察: `三个小菱形环沿波折中央笔纵向串联，最低接点延续为两条长交叉下枝。`
...
- dataset label text: `㝨`
- dataset label codepoints: `U+3768`
...
- graph edge count: `3`
- codepoint routes: `U+3768`
- cross-source status: `matched_evobc_by_codepoint`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00072`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00072`
- EvoBC image reference count / EvoBC 图像引用数: `4`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00072`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/072_obs-evo-can
  d-000072_evobc-cat-00072_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/072_obs-evo-cand-000072_evobc-cat-00072_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合26779
  (G_0882_京津3728合26779出組.png)`
...
- Which source records identify obs-char-000778 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000778？
