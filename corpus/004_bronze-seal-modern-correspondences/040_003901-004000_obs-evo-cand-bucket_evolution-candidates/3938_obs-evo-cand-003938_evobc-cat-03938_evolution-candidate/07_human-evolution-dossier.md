...
- External category reference: `evobc-cat-03938`
- Source category ID: `03938`
- Source label for human review: `架`
...
- `obs-evo-cand-003938-route-category-staging`
...
- `obs-evo-cand-003938-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003938-route-evolution-graph`
