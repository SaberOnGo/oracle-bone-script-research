...
Project ID: `obs-evo-cand-008338`
...
- Project ID: `obs-evo-cand-008338`
- EVOBC category candidate ID: `evobc-evo-cat-08338`
- External category reference: `evobc-cat-08338`
- Source category ID: `08338`
- Source label for human review: `謷`
- Source codepoints: `U+8B37`
...
- `obs-evo-cand-008338-route-category-staging`
...
- `obs-evo-cand-008338-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008338-route-evolution-graph`
