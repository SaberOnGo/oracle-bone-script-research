...
Project ID: `obs-evo-cand-010986`
...
- Project ID: `obs-evo-cand-010986`
- EVOBC category candidate ID: `evobc-evo-cat-10986`
- External category reference: `evobc-cat-10986`
- Source category ID: `10986`
- Source label for human review: `𡋕`
- Source codepoints: `U+212D5`
...
- `obs-evo-cand-010986-route-category-staging`
...
- `obs-evo-cand-010986-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010986-route-evolution-graph`
