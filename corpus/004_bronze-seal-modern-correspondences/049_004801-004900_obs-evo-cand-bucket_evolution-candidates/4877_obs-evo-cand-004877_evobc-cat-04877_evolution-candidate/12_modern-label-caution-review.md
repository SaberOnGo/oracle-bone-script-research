# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004877
...
- EVOBC candidate category: `evobc-evo-cat-04877`.
- Source label for search only: `漫`.
- Source codepoints for search only: `U+6F2B`.
