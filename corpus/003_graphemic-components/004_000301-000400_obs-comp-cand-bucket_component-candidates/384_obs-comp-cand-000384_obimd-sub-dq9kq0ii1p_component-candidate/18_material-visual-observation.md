# Material Visual Observation / obs-comp-cand-000384 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000384`
- External reference / 外部参照: `obimd-sub-dq9kq0ii1p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012307_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/awg8lyvedy/dq9kq0ii1p/dq9kq0ii1p.png`
- Checksum / 校验和:
  `55689c3022593ba0b6abe38ca115044a4cbdaeec48e8d182c77f54a3e33226f0`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.67%.
- Marked-pixel bounds: (86,26)–(163,223); span 78 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.67%。
- 痕迹范围：(86,26)–(163,223)；跨度78 × 198 px；痕迹矩形高于宽。
