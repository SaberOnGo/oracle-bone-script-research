# Material Visual Observation / obs-comp-cand-000577 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000577`
- External reference / 外部参照: `obimd-sub-hq4g84oqws`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013105_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hlxb5g91kc/hq4g84oqws/hq4g84oqws.png`
- Checksum / 校验和:
  `cfeea675355c66dfd901f2bbc4146ffad66dae990fd010d2808013f5e72d8109`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.53%.
- Marked-pixel bounds: (62,41)–(187,209); span 126 × 169 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.53%。
- 痕迹范围：(62,41)–(187,209)；跨度126 × 169 px；痕迹矩形高于宽。
