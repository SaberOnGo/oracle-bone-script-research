# obs-unk-008705 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008705`
- primary external id: `hust-obc-und-YH-008705`
...
- local review image route: `corpus/001_oracle-characters/104_undeciphered-008
  701-008800_obs-unk-bucket_oracle-character-candidates/005_obs-unk-008705_h
  ust-obc-und-YH-008705_oracle-character-candidate/03_visual-assets/001_asse
  t-010296_hust-obc-und-YH-008705_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60D41/H_？_60D41_0.png`
- asset id: `asset-010296`
...
- source class: `HUST-OBC/undeciphered/Y+H/60D41/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60D41/H_？_60D41_0.png`
- asset id: `asset-010296`
...
- Which source records identify obs-unk-008705 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008705？
