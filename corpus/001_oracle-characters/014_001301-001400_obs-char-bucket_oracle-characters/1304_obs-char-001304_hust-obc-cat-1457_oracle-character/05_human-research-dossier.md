# obs-char-001304 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001304`
- primary external id: `hust-obc-cat-1457`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1304_obs-char-001304_hust-obc-cat-1457_ora
  cle-character/03_visual-assets/001_asset-001309_hust-obc-cat-1457_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1457/G_1457_合29693無名組.png`
- asset id: `asset-001309`
...
- source category: `1457`
- validation class: `1303`
- source image route: `HUST-OBC/deciphered/1457/G_1457_合29693無名組.png`
- asset id: `asset-001309`
...
- English observation: `A complex form has a broad upper bar, hanging
  central strokes, and a lower rectangular cluster with side branches.`
- 中文观察: `复杂形体有宽大上横笔、中央下垂笔画和带侧部分枝的下部矩形笔画群。`
...
- dataset label text: `㦧`
- dataset label codepoints: `U+39A7`
...
- filename catalog route clues: `Heji-like filename clue: 合29693
  (G_1457_合29693無名組.png)`
...
- Which source records identify obs-char-001304 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001304？
