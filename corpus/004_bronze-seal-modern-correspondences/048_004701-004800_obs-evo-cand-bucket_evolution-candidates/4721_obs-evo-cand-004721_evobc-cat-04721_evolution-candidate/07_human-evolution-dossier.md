...
Project ID: `obs-evo-cand-004721`
...
- Project ID: `obs-evo-cand-004721`
- EVOBC category candidate ID: `evobc-evo-cat-04721`
- External category reference: `evobc-cat-04721`
- Source category ID: `04721`
- Source label for human review: `淜`
- Source codepoints: `U+6DDC`
...
- `obs-evo-cand-004721-route-category-staging`
...
- `obs-evo-cand-004721-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004721-route-evolution-graph`
