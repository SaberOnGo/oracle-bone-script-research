# obs-unk-004938 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/038_obs-unk-004938_h
  ust-obc-und-X-004938_oracle-character-candidate/03_visual-assets/001_asset
  -006531_hust-obc-und-X-004938_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/494/X_？_7477_1.png`
- asset id: `asset-006531`
...
- Thick left strokes overlap a right outlined opening and lower loop.
- The single source view is present locally.
- 直接记录：`14_material-visual-observation.md`
- 左侧粗笔画与右侧外轮廓开口及下方圆弧开口重叠。
- 单一来源视图已在本地保存。
...
- source class: `HUST-OBC/undeciphered/X/494/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/494/X_？_7477_1.png`
- asset id: `asset-006531`
...
- Which source records identify obs-unk-004938 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004938？
