# Material Visual Observation / obs-comp-cand-000535 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000535`
- External reference / 外部参照: `obimd-sub-1cffazouax`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012769_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m32ngscsu1/1cffazouax/1cffazouax.png`
- Checksum / 校验和:
  `c2a21e69ef7d75af0f0f2724f9f373298c10bde7565c482dced2745d8b463c80`
...
- Marked-pixel bounds: (72,47)–(177,202); span 106 × 156 px; the marked
...
- 痕迹范围：(72,47)–(177,202)；跨度106 × 156 px；痕迹矩形高于宽。
