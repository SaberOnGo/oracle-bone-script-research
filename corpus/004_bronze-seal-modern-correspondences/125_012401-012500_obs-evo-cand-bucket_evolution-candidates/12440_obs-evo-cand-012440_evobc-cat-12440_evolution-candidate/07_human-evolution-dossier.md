...
- External category reference: `evobc-cat-12440`
- Source category ID: `12440`
- Source label for human review: `𨜆`
- Source codepoints: `U+28706`
...
- `obs-evo-cand-012440-route-category-staging`
...
- `obs-evo-cand-012440-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012440-route-evolution-graph`
