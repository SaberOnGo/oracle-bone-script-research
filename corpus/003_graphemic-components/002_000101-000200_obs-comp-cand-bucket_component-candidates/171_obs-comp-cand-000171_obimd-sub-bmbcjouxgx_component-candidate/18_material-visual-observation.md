# Material Visual Observation / obs-comp-cand-000171 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000171`
- External reference / 外部参照: `obimd-sub-bmbcjouxgx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011583_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hed7mevt31/bmbcjouxgx/bmbcjouxgx.png`
- Checksum / 校验和:
  `115a48f92f4c75e21e061bdfe7365bce9d64c14cd14408df7f013d6d219afaca`
...
- Marked-pixel bounds: (84,29)–(165,213); span 82 × 185 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.69%。
- 痕迹范围：(84,29)–(165,213)；跨度82 × 185 px；痕迹矩形高于宽。
