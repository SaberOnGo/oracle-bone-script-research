...
- `obs-evo-cand-000446-route-category-staging`
...
- `obs-evo-cand-000446-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000446-route-evolution-graph`
