# obs-unk-004831 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004831`
- primary external id: `hust-obc-und-X-004831`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/031_obs-unk-004831_h
  ust-obc-und-X-004831_oracle-character-candidate/03_visual-assets/001_asset
  -006424_hust-obc-und-X-004831_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/387/X_？_7370_1.png`
- asset id: `asset-006424`
...
- source class: `HUST-OBC/undeciphered/X/387/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/387/X_？_7370_1.png`
- asset id: `asset-006424`
...
- English observation: `triangular upper outline and lower curved opening`
- 中文观察: `上部三角形围合和下部曲线开口`
...
- Which source records identify obs-unk-004831 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004831？
