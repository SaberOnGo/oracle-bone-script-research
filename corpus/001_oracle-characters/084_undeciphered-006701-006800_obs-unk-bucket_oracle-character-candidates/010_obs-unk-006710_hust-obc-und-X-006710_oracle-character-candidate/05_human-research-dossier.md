# obs-unk-006710 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006710`
- primary external id: `hust-obc-und-X-006710`
...
- local review image route: `corpus/001_oracle-characters/084_undeciphered-006
  701-006800_obs-unk-bucket_oracle-character-candidates/010_obs-unk-006710_h
  ust-obc-und-X-006710_oracle-character-candidate/03_visual-assets/001_asset
  -008301_hust-obc-und-X-006710_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2266/X_？_906_1.png`
- asset id: `asset-008301`
...
- source class: `HUST-OBC/undeciphered/X/2266/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2266/X_？_906_1.png`
- asset id: `asset-008301`
...
- Which source records identify obs-unk-006710 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006710？
