# obs-unk-006237 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006237`
- primary external id: `hust-obc-und-X-006237`
...
- local review image route: `corpus/001_oracle-characters/079_undeciphered-006
  201-006300_obs-unk-bucket_oracle-character-candidates/037_obs-unk-006237_h
  ust-obc-und-X-006237_oracle-character-candidate/03_visual-assets/001_asset
  -007829_hust-obc-und-X-006237_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1793/X_？_4558_1.png`
- asset id: `asset-007829`
...
- source class: `HUST-OBC/undeciphered/X/1793/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1793/X_？_4558_1.png`
- asset id: `asset-007829`
...
- Which source records identify obs-unk-006237 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006237？
