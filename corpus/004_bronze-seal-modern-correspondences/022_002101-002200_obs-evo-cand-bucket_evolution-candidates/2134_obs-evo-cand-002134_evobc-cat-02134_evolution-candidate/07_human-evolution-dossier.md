...
- External category reference: `evobc-cat-02134`
- Source category ID: `02134`
- Source label: `姤`
...
- `obs-evo-cand-002134-route-category-staging`
...
- `obs-evo-cand-002134-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002134-route-evolution-graph`
