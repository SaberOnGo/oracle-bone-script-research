...
- External category reference: `evobc-cat-00090`
- Source category ID: `00090`
- Source label for human review: `㠱`
- Source codepoints: `U+3831`
- Image reference count in source metadata: `99`
...
- `obs-evo-cand-000090-route-category-staging`
...
- `obs-evo-cand-000090-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000090-route-evolution-graph`
