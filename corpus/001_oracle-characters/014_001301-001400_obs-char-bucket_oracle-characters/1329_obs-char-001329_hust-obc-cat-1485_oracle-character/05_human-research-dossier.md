# obs-char-001329 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1329_obs-char-001329_hust-obc-cat-1485_ora
  cle-character/03_visual-assets/001_asset-001334_hust-obc-cat-1485_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1485/G_1485_前5.21.3(甲).png`
- asset id: `asset-001334`
...
- source category: `1485`
- validation class: `1328`
- source image route: `HUST-OBC/deciphered/1485/G_1485_前5.21.3(甲).png`
- asset id: `asset-001334`
...
- English observation: `A broad upper angular bar sits above a pointed lower
  loop and several short left-side marks.`
- 中文观察: `宽大的上部折角横笔位于尖状下部环形之上，左侧另有数个短标记。`
...
- dataset label text: `㧃`
- dataset label codepoints: `U+39C3`
...
- Which source records identify obs-char-001329 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001329？
