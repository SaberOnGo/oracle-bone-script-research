...
Project ID: `obs-evo-cand-000781`
...
- Project ID: `obs-evo-cand-000781`
- EVOBC category candidate ID: `evobc-evo-cat-00781`
- External category reference: `evobc-cat-00781`
- Source category ID: `00781`
- Source label for human review: `伪`
- Source codepoints: `U+4F2A`
...
- `obs-evo-cand-000781-route-category-staging`
...
- `obs-evo-cand-000781-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000781-route-evolution-graph`
