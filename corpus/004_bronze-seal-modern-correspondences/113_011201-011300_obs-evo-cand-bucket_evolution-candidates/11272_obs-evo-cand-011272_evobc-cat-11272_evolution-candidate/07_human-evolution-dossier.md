...
- External category reference: `evobc-cat-11272`
- Source category ID: `11272`
- Source label for human review: `𢣗`
...
- `obs-evo-cand-011272-route-category-staging`
...
- `obs-evo-cand-011272-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011272-route-evolution-graph`
