# obs-unk-004439 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004439`
- primary external id: `hust-obc-und-L-004439`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/039_obs-unk-004439_h
  ust-obc-und-L-004439_oracle-character-candidate/03_visual-assets/001_asset
  -006032_hust-obc-und-L-004439_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4439/L_？_9969.jpg`
- asset id: `asset-006032`
...
- source class: `HUST-OBC/undeciphered/L/4439/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4439/L_？_9969.jpg`
- asset id: `asset-006032`
...
- English observation: `A central stem crosses slanting traces above a dark`
  `lower cluster.`
- 中文观察: `中央竖干穿过斜痕，位于下部深色聚集处之上。`
...
- Which source records identify obs-unk-004439 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004439？
