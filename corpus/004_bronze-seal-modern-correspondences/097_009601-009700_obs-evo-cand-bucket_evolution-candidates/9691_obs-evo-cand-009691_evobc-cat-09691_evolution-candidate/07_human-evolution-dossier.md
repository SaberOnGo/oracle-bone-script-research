...
- External category reference: `evobc-cat-09691`
- Source category ID: `09691`
- Source label for human review: `队`
- Source codepoints: `U+961F`
...
- `obs-evo-cand-009691-route-category-staging`
...
- `obs-evo-cand-009691-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009691-route-evolution-graph`
