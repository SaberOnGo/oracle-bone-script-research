# Material Visual Observation / obs-comp-cand-000725 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000725`
- External reference / 外部参照: `obimd-sub-lv504kyqxb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013452_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lv504kyqxb/lv504kyqxb/lv504kyqxb.png`
- Checksum / 校验和:
  `7da03e02d908876d220e3146b8826f4f7a00e446fce237f4223fccac2c74bb04`
...
- Marked-pixel bounds: (85,24)–(172,228); span 88 × 205 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.12%。
- 痕迹范围：(85,24)–(172,228)；跨度88 × 205 px；痕迹矩形高于宽。
