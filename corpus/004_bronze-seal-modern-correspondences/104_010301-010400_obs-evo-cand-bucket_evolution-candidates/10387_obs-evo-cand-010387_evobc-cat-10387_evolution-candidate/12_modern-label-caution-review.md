# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010387
...
- EVOBC candidate category: `evobc-evo-cat-10387`.
- Source label for search only: `鮌`.
- Source codepoints for search only: `U+9B8C`.
