# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006445
...
- EVOBC candidate category: `evobc-evo-cat-06445`.
- Source label for search only: `約`.
- Source codepoints for search only: `U+7D04`.
