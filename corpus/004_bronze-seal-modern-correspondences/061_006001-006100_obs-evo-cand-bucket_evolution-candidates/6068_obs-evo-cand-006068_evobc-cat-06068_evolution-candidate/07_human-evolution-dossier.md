...
- Project ID: `obs-evo-cand-006068`
- EVOBC category candidate ID: `evobc-evo-cat-06068`
- External category reference: `evobc-cat-06068`
- Source category ID: `06068`
- Source label for human review: `秝`
- Source codepoints: `U+79DD`
...
- `obs-evo-cand-006068-route-category-staging`
...
- `obs-evo-cand-006068-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006068-route-evolution-graph`
