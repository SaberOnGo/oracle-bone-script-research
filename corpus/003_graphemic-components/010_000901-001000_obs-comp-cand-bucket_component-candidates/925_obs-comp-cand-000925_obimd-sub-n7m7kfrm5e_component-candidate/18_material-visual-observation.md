# Material Visual Observation / obs-comp-cand-000925 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000925`
- External reference / 外部参照: `obimd-sub-n7m7kfrm5e`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014008_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bw6bl0elx5/n7m7kfrm5e/n7m7kfrm5e.png`
- Checksum / 校验和:
  `a8a4f44bde38269560c4c01c8066398cb65bc1ad90222c76973a09eb78d30908`
...
- Marked-pixel bounds: (75,19)–(174,232); span 100 × 214 px; the marked
...
- 痕迹范围：(75,19)–(174,232)；跨度100 × 214 px；痕迹矩形高于宽。
