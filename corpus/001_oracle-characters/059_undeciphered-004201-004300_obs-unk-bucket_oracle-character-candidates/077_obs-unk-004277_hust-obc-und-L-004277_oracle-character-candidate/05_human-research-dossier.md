# obs-unk-004277 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/077_obs-unk-004277_h
  ust-obc-und-L-004277_oracle-character-candidate/03_visual-assets/001_asset
  -005870_hust-obc-und-L-004277_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4277/L_？_9448.jpg`
- asset id: `asset-005870`
...
- source class: `HUST-OBC/undeciphered/L/4277/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4277/L_？_9448.jpg`
- asset id: `asset-005870`
...
- English observation: `Upper cluster, central branches, lower trace visible.`
- 中文观察: `上部痕迹簇、中央分支和下部痕迹可见。`
...
- Which source records identify obs-unk-004277 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004277？
