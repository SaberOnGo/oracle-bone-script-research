# Material Visual Observation / obs-comp-cand-002412 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002412`
- External reference / 外部参照: `obimd-sub-n8a03276h0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020483_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/wxl14n9fo3/n8a03276h0/n8a03276h0.png`
- Checksum / 校验和:
  `baa24a952b8b529b15d517362e7115ded29d73c86780f62504b3b4709e6bcd73`
...
- Marked-pixel bounds: (78,28)–(171,216); span 94 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.65%。
- 痕迹范围：(78,28)–(171,216)；跨度94 × 189 px；痕迹矩形高于宽。
