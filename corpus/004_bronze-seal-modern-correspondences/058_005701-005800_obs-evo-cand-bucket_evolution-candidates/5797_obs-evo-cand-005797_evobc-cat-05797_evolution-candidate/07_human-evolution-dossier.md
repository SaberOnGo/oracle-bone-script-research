...
- External category reference: `evobc-cat-05797`
- Source category ID: `05797`
- Source label for human review: `眛`
- Source codepoints: `U+771B`
...
- `obs-evo-cand-005797-route-category-staging`
...
- `obs-evo-cand-005797-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005797-route-evolution-graph`
