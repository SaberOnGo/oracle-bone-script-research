# obs-char-000430 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000430`
- primary external id: `hust-obc-cat-0488`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/430_obs-char-000430_hust-obc-cat-0488_orac
  le-character/03_visual-assets/001_asset-000435_hust-obc-cat-0488_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0488/G_0488_乙1379合14787賓組.png`
- asset id: `asset-000435`
...
- source category: `0488`
- validation class: `429`
- source image route: `HUST-OBC/deciphered/0488/G_0488_乙1379合14787賓組.png`
- asset id: `asset-000435`
...
- English observation: `A single narrow vertical cluster contains several
  short transverse strokes, small internal crossings, and one thin
  descending tail.`
- 中文观察: `单个狭长竖向笔画群包含数条短横、若干内部交叉和一条纤细下垂尾笔。`
...
- dataset label text: `㗞`
- dataset label codepoints: `U+35DE`
...
- filename catalog route clues: `Heji-like filename clue: 合14787
  (G_0488_乙1379合14787賓組.png)`
...
- Which source records identify obs-char-000430 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000430？
