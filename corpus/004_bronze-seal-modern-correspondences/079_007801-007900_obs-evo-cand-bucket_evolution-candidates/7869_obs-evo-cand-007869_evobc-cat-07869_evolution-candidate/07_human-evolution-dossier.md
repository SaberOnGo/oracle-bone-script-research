...
- External category reference: `evobc-cat-07869`
- Source category ID: `07869`
- Source label for human review: `蠅`
...
- `obs-evo-cand-007869-route-category-staging`
...
- `obs-evo-cand-007869-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007869-route-evolution-graph`
