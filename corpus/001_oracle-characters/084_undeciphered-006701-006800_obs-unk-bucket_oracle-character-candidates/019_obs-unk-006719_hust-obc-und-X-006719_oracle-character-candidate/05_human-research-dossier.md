# obs-unk-006719 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006719`
- primary external id: `hust-obc-und-X-006719`
...
- local review image route: `corpus/001_oracle-characters/084_undeciphered-006
  701-006800_obs-unk-bucket_oracle-character-candidates/019_obs-unk-006719_h
  ust-obc-und-X-006719_oracle-character-candidate/03_visual-assets/001_asset
  -008310_hust-obc-und-X-006719_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2275/X_？_941_1.png`
- asset id: `asset-008310`
...
- source class: `HUST-OBC/undeciphered/X/2275/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2275/X_？_941_1.png`
- asset id: `asset-008310`
...
- Which source records identify obs-unk-006719 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006719？
