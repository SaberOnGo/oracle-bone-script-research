...
- `obs-evo-cand-005772-route-category-staging`
...
- `obs-evo-cand-005772-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005772-route-evolution-graph`
