# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008321
...
- EVOBC candidate category: `evobc-evo-cat-08321`.
- Source label for search only: `謝`.
- Source codepoints for search only: `U+8B1D`.
