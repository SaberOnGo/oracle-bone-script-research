# obs-char-000836 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/836_obs-char-000836_hust-obc-cat-0945_orac
  le-character/03_visual-assets/001_asset-000841_hust-obc-cat-0945_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0945/H_0945_606C0_0.png`
- asset id: `asset-000841`
...
- source category: `0945`
- validation class: `835`
- source image route: `HUST-OBC/deciphered/0945/H_0945_606C0_0.png`
- asset id: `asset-000841`
...
- English observation: `A large curved outer stroke at left is separated
  from multiple short vertical marks at right; the gaps are clearly
  visible.`
- 中文观察: `左侧大幅弯曲外笔与右侧多条短竖笔分离排列；各笔之间的间隔清晰可见。`
...
- dataset label text: `㞧`
- dataset label codepoints: `U+37A7`
...
- filename catalog route clues: `catalog-like filename clue: H_0945
  (H_0945_606C0_0.png)`
...
- Which source records identify obs-char-000836 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000836？
