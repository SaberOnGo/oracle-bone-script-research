# obs-char-000651 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000651`
- primary external id: `hust-obc-cat-0739`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/651_obs-char-000651_hust-obc-cat-0739_orac
  le-character/03_visual-assets/001_asset-000656_hust-obc-cat-0739_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0739/H_0739_60C67_0.png`
- asset id: `asset-000656`
...
- source category: `0739`
- validation class: `650`
- source image route: `HUST-OBC/deciphered/0739/H_0739_60C67_0.png`
- asset id: `asset-000656`
...
- English observation: `A broad pointed upper outline contains crossing
  diagonals and a rounded opening, then narrows into a lower angular grid
  with a long slanting right tail.`
- 中文观察: `宽大尖顶上轮廓内含交叉斜笔和圆形空隙，下接折角格状笔群及长右斜尾。`
...
- dataset label text: `㛙`
- dataset label codepoints: `U+36D9`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/055_obs-evo-can
  d-000055_evobc-cat-00055_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/055_obs-evo-cand-000055_evobc-cat-00055_evolu
...
- filename catalog route clues: `catalog-like filename clue: H_0739
  (H_0739_60C67_0.png)`
...
- Which source records identify obs-char-000651 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000651？
