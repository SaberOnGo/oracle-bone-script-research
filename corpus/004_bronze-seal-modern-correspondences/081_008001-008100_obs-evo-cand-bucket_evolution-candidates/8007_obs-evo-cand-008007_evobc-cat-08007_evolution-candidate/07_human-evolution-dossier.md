...
- Project ID: `obs-evo-cand-008007`
- EVOBC category candidate ID: `evobc-evo-cat-08007`
- External category reference: `evobc-cat-08007`
- Source category ID: `08007`
- Source label for human review: `褑`
- Source codepoints: `U+8911`
...
- `obs-evo-cand-008007-route-category-staging`
...
- `obs-evo-cand-008007-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008007-route-evolution-graph`
