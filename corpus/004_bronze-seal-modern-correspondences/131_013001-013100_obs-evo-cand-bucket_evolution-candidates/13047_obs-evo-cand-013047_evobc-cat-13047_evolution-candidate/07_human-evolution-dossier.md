...
- External category reference: `evobc-cat-13047`
- Source category ID: `13047`
- Source label for human review: `𫩀`
...
- `obs-evo-cand-013047-route-category-staging`
...
- `obs-evo-cand-013047-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013047-route-evolution-graph`
