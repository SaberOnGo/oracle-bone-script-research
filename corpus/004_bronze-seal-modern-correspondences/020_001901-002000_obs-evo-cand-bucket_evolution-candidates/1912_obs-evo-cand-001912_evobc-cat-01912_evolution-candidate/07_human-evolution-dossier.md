...
Project ID: `obs-evo-cand-001912`
...
- Project ID: `obs-evo-cand-001912`
- EVOBC category candidate ID: `evobc-evo-cat-01912`
- External category reference: `evobc-cat-01912`
- Source category ID: `01912`
- Source label for human review: `堹`
- Source codepoints: `U+5839`
...
- `obs-evo-cand-001912-route-category-staging`
...
- `obs-evo-cand-001912-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001912-route-evolution-graph`
