# obs-char-000773 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000773`
- primary external id: `hust-obc-cat-0877`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/773_obs-char-000773_hust-obc-cat-0877_orac
  le-character/03_visual-assets/001_asset-000778_hust-obc-cat-0877_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0877/G_0877_甲骨文.png`
- asset id: `asset-000778`
...
- source category: `0877`
- validation class: `772`
- source image route: `HUST-OBC/deciphered/0877/G_0877_甲骨文.png`
- asset id: `asset-000778`
...
- English observation: `Two small radiating upper marks stand above a
  central rounded rectangular loop; a tiny inner mark and a detached curved
  divided form appear below.`
- 中文观察: `两个小型放射上痕位于中央圆角矩形环上方；环内有微小痕，下方另有分离的弯曲分隔形。`
...
- dataset label text: `㝣`
- dataset label codepoints: `U+3763`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00071`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00071`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00071`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/071_obs-evo-can
  d-000071_evobc-cat-00071_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/071_obs-evo-cand-000071_evobc-cat-00071_evolu
...
- Which source records identify obs-char-000773 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000773？
