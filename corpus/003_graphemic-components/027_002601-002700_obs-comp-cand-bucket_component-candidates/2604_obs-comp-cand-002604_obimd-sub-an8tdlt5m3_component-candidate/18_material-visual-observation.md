# Material Visual Observation / obs-comp-cand-002604 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002604`
- External reference / 外部参照: `obimd-sub-an8tdlt5m3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021143_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/an8tdlt5m3/an8tdlt5m3/an8tdlt5m3.png`
- Checksum / 校验和:
  `97b2cc97d261338e7ad25c53428256b60e3e7c08294763f1aa666e237bbb94d5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.04%.
- Marked-pixel bounds: (63,18)–(181,230); span 119 × 213 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.04%。
- 痕迹范围：(63,18)–(181,230)；跨度119 × 213 px；痕迹矩形高于宽。
