...
Project ID: `obs-evo-cand-004474`
...
- Project ID: `obs-evo-cand-004474`
- EVOBC category candidate ID: `evobc-evo-cat-04474`
- External category reference: `evobc-cat-04474`
- Source category ID: `04474`
- Source label for human review: `氛`
- Source codepoints: `U+6C1B`
...
- `obs-evo-cand-004474-route-category-staging`
...
- `obs-evo-cand-004474-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004474-route-evolution-graph`
