# obs-unk-004108 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/008_obs-unk-004108_h
  ust-obc-und-L-004108_oracle-character-candidate/03_visual-assets/001_asset
  -005701_hust-obc-und-L-004108_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4108/L_？_8844.jpg`
- asset id: `asset-005701`
...
- source class: `HUST-OBC/undeciphered/L/4108/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4108/L_？_8844.jpg`
- asset id: `asset-005701`
...
- English observation: A pointed upper cluster descends to a narrow stem;
  curved lower strokes open left and a longer right tail descends.
- 中文观察：顶部尖状笔画簇下接窄主干；下部向左弯，右侧有较长下伸尾笔。
...
- Which source records identify obs-unk-004108 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004108？
