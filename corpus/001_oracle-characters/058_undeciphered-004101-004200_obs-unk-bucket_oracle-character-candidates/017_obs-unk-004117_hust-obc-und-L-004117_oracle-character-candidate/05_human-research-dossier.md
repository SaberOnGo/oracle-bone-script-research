# obs-unk-004117 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004117`
- primary external id: `hust-obc-und-L-004117`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/017_obs-unk-004117_h
  ust-obc-und-L-004117_oracle-character-candidate/03_visual-assets/001_asset
  -005710_hust-obc-und-L-004117_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4117/L_？_8869.jpg`
- asset id: `asset-005710`
...
- source class: `HUST-OBC/undeciphered/L/4117/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4117/L_？_8869.jpg`
- asset id: `asset-005710`
...
- English observation: The opened image shows a narrow left stem, a dense
  curved cluster, and a long lower-right trace.
- 中文观察：已打开图像可见窄左主干、密集弧形痕迹簇和右下长痕迹。
...
- Which source records identify obs-unk-004117 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004117？
