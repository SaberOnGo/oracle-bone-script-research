# Material Visual Observation / obs-comp-cand-002592 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002592`
- External reference / 外部参照: `obimd-sub-yns30oi0mq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021131_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/uu47abw0dl/yns30oi0mq/yns30oi0mq.png`
- Checksum / 校验和:
  `c502fc0fb375502b736e16a2e5475cea1956bbb3966622b92fc5a9eb95a2379a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.41%.
- Marked-pixel bounds: (70,30)–(179,222); span 110 × 193 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.41%。
- 痕迹范围：(70,30)–(179,222)；跨度110 × 193 px；痕迹矩形高于宽。
