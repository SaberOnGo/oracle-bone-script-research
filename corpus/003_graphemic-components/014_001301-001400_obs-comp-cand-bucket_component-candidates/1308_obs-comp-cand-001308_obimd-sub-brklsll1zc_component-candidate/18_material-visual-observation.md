# Material Visual Observation / obs-comp-cand-001308 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001308`
- External reference / 外部参照: `obimd-sub-brklsll1zc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015645_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/brklsll1zc/brklsll1zc/brklsll1zc.png`
- Checksum / 校验和:
  `8eceb8b9a505470fde8af61a14285a6e2970246595c02097a65e860f2dbc78a2`
...
- Marked-pixel bounds: (76,38)–(172,216); span 97 × 179 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.15%。
- 痕迹范围：(76,38)–(172,216)；跨度97 × 179 px；痕迹矩形高于宽。
