...
- External category reference: `evobc-cat-10809`
- Source category ID: `10809`
- Source label for human review: `𠌢`
...
- `obs-evo-cand-010809-route-category-staging`
...
- `obs-evo-cand-010809-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010809-route-evolution-graph`
