...
- External category reference: `evobc-cat-06654`
- Source category ID: `06654`
- Source label for human review: `縹`
- Source codepoints: `U+7E39`
...
- `obs-evo-cand-006654-route-category-staging`
...
- `obs-evo-cand-006654-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006654-route-evolution-graph`
