...
- Evidence collection task ID / 证据收集任务 ID: `graph-source-evidence-task-024`
...
- Expected output path from task queue / 任务队列预期输出路径: `doc/public/user_research/003_evidence-collection-tasks/obimd/graph-source-evidence-task-024_staging-row_collection-note.md`
...
- Collection scope / 收集范围:
  - `collect_candidate_or_staging_rows_for_primary_record`
- Task status / 任务状态:
  - `not_started`
