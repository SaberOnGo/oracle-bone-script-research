...
- External category reference: `evobc-cat-11521`
- Source category ID: `11521`
- Source label: `𣵧`
...
- `obs-evo-cand-011521-route-category-staging`
...
- `obs-evo-cand-011521-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011521-route-evolution-graph`
