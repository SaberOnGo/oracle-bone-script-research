# obs-char-001181 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001181`
- primary external id: `hust-obc-cat-1321`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1181_obs-char-001181_hust-obc-cat-1321_ora
  cle-character/03_visual-assets/001_asset-001186_hust-obc-cat-1321_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1321/G_1321_乙5405合22099子組.png`
- asset id: `asset-001186`
...
- source category: `1321`
- validation class: `1180`
- source image route: `HUST-OBC/deciphered/1321/G_1321_乙5405合22099子組.png`
- asset id: `asset-001186`
...
- English observation: `A tall slender form has a branched upper stroke, a
  long left contour, and several descending right curves.`
- 中文观察: `高而狭长的形体有上部分枝笔、长左侧轮廓和数条右侧下行弯笔。`
...
- dataset label text: `㤟`
- dataset label codepoints: `U+391F`
...
- filename catalog route clues: `Heji-like filename clue: 合22099
  (G_1321_乙5405合22099子組.png)`
...
- Which source records identify obs-char-001181 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001181？
