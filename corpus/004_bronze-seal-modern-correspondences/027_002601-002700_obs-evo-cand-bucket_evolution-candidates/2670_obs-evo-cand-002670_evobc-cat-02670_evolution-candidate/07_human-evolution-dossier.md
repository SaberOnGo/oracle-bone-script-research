...
- Project ID: `obs-evo-cand-002670`
- EVOBC category candidate ID: `evobc-evo-cat-02670`
- External category reference: `evobc-cat-02670`
- Source category ID: `02670`
- Source label for human review: `幋`
- Source codepoints: `U+5E4B`
...
- `obs-evo-cand-002670-route-category-staging`
...
- `obs-evo-cand-002670-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002670-route-evolution-graph`
