# obs-char-001049 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1049_obs-char-001049_hust-obc-cat-1176_ora
  cle-character/03_visual-assets/001_asset-001054_hust-obc-cat-1176_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1176/X_1176_66_1.png`
- asset id: `asset-001054`
...
- source category: `1176`
- validation class: `1048`
- source image route: `HUST-OBC/deciphered/1176/X_1176_66_1.png`
- asset id: `asset-001054`
...
- English observation: `A broad cropped image contains separated horizontal
  bars, thick lower vertical marks, and an irregular right descending
  contour with small interior marks.`
- 中文观察: `较宽的图像中有分离水平横笔、粗重下部竖笔，以及带小型内部笔迹的不规则右侧下行轮廓。`
...
- dataset label text: `㢎`
- dataset label codepoints: `U+388E`
...
- Which source records identify obs-char-001049 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001049？
