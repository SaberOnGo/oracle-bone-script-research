...
Project ID: `obs-evo-cand-001770`
...
- Project ID: `obs-evo-cand-001770`
- EVOBC category candidate ID: `evobc-evo-cat-01770`
- External category reference: `evobc-cat-01770`
- Source category ID: `01770`
- Source label for human review: `国`
- Source codepoints: `U+56FD`
...
- `obs-evo-cand-001770-route-category-staging`
...
- `obs-evo-cand-001770-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001770-route-evolution-graph`
