...
- `obs-evo-cand-004469-route-category-staging`
...
- `obs-evo-cand-004469-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004469-route-evolution-graph`
