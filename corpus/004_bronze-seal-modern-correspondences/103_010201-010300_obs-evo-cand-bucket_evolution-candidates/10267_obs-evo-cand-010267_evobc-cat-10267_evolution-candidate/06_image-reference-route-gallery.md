...
- `obs-evo-cand-010267-route-category-staging`
...
- `obs-evo-cand-010267-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010267-route-evolution-graph`
