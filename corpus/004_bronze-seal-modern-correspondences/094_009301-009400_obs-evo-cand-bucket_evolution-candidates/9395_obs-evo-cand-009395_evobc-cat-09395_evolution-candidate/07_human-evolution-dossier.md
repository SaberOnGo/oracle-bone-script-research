...
- External category reference: `evobc-cat-09395`
- Source category ID: `09395`
- Source label for human review: `銳`
...
- `obs-evo-cand-009395-route-category-staging`
...
- `obs-evo-cand-009395-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009395-route-evolution-graph`
