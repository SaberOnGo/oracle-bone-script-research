...
- External category reference: `evobc-cat-03544`
- Source category ID: `03544`
- Source label for human review: `攕`
...
- `obs-evo-cand-003544-route-category-staging`
...
- `obs-evo-cand-003544-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003544-route-evolution-graph`
