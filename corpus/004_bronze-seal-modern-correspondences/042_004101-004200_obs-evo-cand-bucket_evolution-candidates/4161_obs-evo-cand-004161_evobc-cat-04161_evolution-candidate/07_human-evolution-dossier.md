...
Project ID: `obs-evo-cand-004161`
...
- Project ID: `obs-evo-cand-004161`
- EVOBC category candidate ID: `evobc-evo-cat-04161`
- External category reference: `evobc-cat-04161`
- Source category ID: `04161`
- Source label for human review: `楨`
- Source codepoints: `U+6968`
...
- `obs-evo-cand-004161-route-category-staging`
...
- `obs-evo-cand-004161-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004161-route-evolution-graph`
