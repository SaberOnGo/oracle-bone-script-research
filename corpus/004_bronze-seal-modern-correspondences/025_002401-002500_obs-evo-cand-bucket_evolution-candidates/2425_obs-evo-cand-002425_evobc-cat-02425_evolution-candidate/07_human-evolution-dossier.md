...
- External category reference: `evobc-cat-02425`
- Source category ID: `02425`
- Source label for human review: `寚`
...
- `obs-evo-cand-002425-route-category-staging`
...
- `obs-evo-cand-002425-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002425-route-evolution-graph`
