# obs-unk-004602 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/002_obs-unk-004602_h
  ust-obc-und-X-004602_oracle-character-candidate/03_visual-assets/001_asset
  -006195_hust-obc-und-X-004602_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/158/X_？_7216_1.png`
- asset id: `asset-006195`
...
- source class: `HUST-OBC/undeciphered/X/158/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/158/X_？_7216_1.png`
- asset id: `asset-006195`
...
- English observation: `Curved contour, open interior, lower branch, and`
  `right gap recorded.`
- 中文观察: `已记录弧形轮廓、开放内部、下部短分支和右侧空隙。`
...
- Which source records identify obs-unk-004602 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004602？
