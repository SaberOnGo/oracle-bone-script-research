...
- External category reference: `evobc-cat-01044`
- Source category ID: `01044`
- Source label for human review: `儐`
...
- `obs-evo-cand-001044-route-category-staging`
...
- `obs-evo-cand-001044-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001044-route-evolution-graph`
