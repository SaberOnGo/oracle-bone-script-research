# obs-char-000234 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000234`
- primary external id: `hust-obc-cat-0261`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/234_obs-char-000234_hust-obc-cat-0261_orac
  le-character/03_visual-assets/001_asset-000239_hust-obc-cat-0261_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0261/G_0261_乙163合21016𠂤組.png`
- asset id: `asset-000239`
...
- source category: `0261`
- validation class: `233`
- source image route: `HUST-OBC/deciphered/0261/G_0261_乙163合21016𠂤組.png`
- asset id: `asset-000239`
...
- English observation: `Two tall tapered strokes rise side by side, with a
  small angled connection near the top; the lower ends remain separate.`
...
- dataset label text: `㓻`
- dataset label codepoints: `U+34FB`
...
- filename catalog route clues: `Heji-like filename clue: 合21016
  (G_0261_乙163合21016𠂤組.png)`
...
- Which source records identify obs-char-000234 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000234？
