...
Project ID: `obs-evo-cand-005685`
...
- Project ID: `obs-evo-cand-005685`
- EVOBC category candidate ID: `evobc-evo-cat-05685`
- External category reference: `evobc-cat-05685`
- Source category ID: `05685`
- Source label for human review: `瘽`
- Source codepoints: `U+763D`
...
- `obs-evo-cand-005685-route-category-staging`
...
- `obs-evo-cand-005685-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005685-route-evolution-graph`
