...
- External category reference: `evobc-cat-09860`
- Source category ID: `09860`
- Source label for human review: `霓`
- Source codepoints: `U+9713`
...
- `obs-evo-cand-009860-route-category-staging`
...
- `obs-evo-cand-009860-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009860-route-evolution-graph`
