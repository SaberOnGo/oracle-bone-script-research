# obs-evo-cand-006528 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06528`
- Source label for human review: `絹`
- Source codepoints: `U+7D79`
- Image reference count: `28`
- Era token counts: `SS:1;WSC:27`
- Source token counts: `Book:7;Web:21`
