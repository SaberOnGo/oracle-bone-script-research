...
- External category reference: `evobc-cat-11732`
- Source category ID: `11732`
- Source label for human review: `𤻖`
- Source codepoints: `U+24ED6`
...
- `obs-evo-cand-011732-route-category-staging`
...
- `obs-evo-cand-011732-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011732-route-evolution-graph`
