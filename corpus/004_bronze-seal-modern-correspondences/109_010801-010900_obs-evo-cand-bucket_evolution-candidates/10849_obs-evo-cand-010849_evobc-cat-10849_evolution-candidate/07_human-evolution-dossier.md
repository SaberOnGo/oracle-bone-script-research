...
Project ID: `obs-evo-cand-010849`
...
- Project ID: `obs-evo-cand-010849`
- EVOBC category candidate ID: `evobc-evo-cat-10849`
- External category reference: `evobc-cat-10849`
- Source category ID: `10849`
- Source label for human review: `𠝟`
- Source codepoints: `U+2075F`
...
- `obs-evo-cand-010849-route-category-staging`
...
- `obs-evo-cand-010849-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010849-route-evolution-graph`
