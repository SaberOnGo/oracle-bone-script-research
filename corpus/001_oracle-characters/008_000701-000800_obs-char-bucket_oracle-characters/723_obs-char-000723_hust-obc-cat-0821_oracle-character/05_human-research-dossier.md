# obs-char-000723 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000723`
- primary external id: `hust-obc-cat-0821`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/723_obs-char-000723_hust-obc-cat-0821_orac
  le-character/03_visual-assets/001_asset-000728_hust-obc-cat-0821_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0821/G_0821_乙145合20338𠂤組.png`
- asset id: `asset-000728`
...
- source category: `0821`
- validation class: `722`
- source image route: `HUST-OBC/deciphered/0821/G_0821_乙145合20338𠂤組.png`
- asset id: `asset-000728`
...
- English observation: `The faint fragmented image shows a tall right
  outline with two small enclosed spaces and several detached thin strokes
  descending at left; fine joins remain unclear.`
- 中文观察: `淡弱破碎图像显示右侧高长轮廓内有两个小空隙，左侧数条分离细笔向下延伸；细部连接仍难辨。`
...
- dataset label text: `㜫`
- dataset label codepoints: `U+372B`
...
- filename catalog route clues: `Heji-like filename clue: 合20338
  (G_0821_乙145合20338𠂤組.png)`
...
- Which source records identify obs-char-000723 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000723？
