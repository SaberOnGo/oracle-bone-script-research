...
- External category reference: `evobc-cat-04636`
- Source category ID: `04636`
- Source label for human review: `洮`
...
- `obs-evo-cand-004636-route-category-staging`
...
- `obs-evo-cand-004636-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004636-route-evolution-graph`
