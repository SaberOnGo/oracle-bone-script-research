...
Project ID: `obs-evo-cand-006782`
...
- Project ID: `obs-evo-cand-006782`
- EVOBC category candidate ID: `evobc-evo-cat-06782`
- External category reference: `evobc-cat-06782`
- Source category ID: `06782`
- Source label for human review: `缶`
- Source codepoints: `U+7F36`
- Image reference count in source metadata: `148`
...
- `obs-evo-cand-006782-route-category-staging`
...
- `obs-evo-cand-006782-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006782-route-evolution-graph`
