# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001104
...
| Glyph or codepoint route / 字形或码位路线 | 18 OBIMD route rows; examples U+53F6;U+582A;U+F65DD; U+F65DE; 另有 16 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 18 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
