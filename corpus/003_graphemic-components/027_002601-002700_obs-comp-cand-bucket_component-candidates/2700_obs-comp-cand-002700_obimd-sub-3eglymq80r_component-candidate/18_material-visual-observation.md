# Material Visual Observation / obs-comp-cand-002700 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002700`
- External reference / 外部参照: `obimd-sub-3eglymq80r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021276_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3eglymq80r/3eglymq80r/3eglymq80r.png`
- Checksum / 校验和:
  `3ef6ed6d3763f04db6d8a8121a81addc4b6d6bbcafc73d100da92d0c12d5217f`
...
- Marked-pixel bounds: (96,15)–(144,231); span 49 × 217 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.11%。
- 痕迹范围：(96,15)–(144,231)；跨度49 × 217 px；痕迹矩形高于宽。
