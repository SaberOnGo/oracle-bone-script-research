...
- External category reference: `evobc-cat-00252`
- Source category ID: `00252`
- Source label for human review: `㽺`
- Source codepoints: `U+3F7A`
...
- `obs-evo-cand-000252-route-category-staging`
...
- `obs-evo-cand-000252-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000252-route-evolution-graph`
