...
- External category reference: `evobc-cat-12219`
- Source category ID: `12219`
- Source label for human review: `𧥢`
- Source codepoints: `U+27962`
...
- `obs-evo-cand-012219-route-category-staging`
...
- `obs-evo-cand-012219-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012219-route-evolution-graph`
