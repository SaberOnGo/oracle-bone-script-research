# Material Visual Observation / obs-comp-cand-000102 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000102`
- External reference / 外部参照: `obimd-sub-67xwlxwxwm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011514_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/67xwlxwxwm/67xwlxwxwm/67xwlxwxwm.png`
- Checksum / 校验和:
  `c707aa431196a586c29ed5fb7501e78b6ae9ed9da0e432a0919e0b3a332fc5e1`
...
- Marked-pixel bounds: (92,22)–(157,228); span 66 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.49%。
- 痕迹范围：(92,22)–(157,228)；跨度66 × 207 px；痕迹矩形高于宽。
