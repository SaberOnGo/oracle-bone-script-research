# obs-evo-cand-004533 / EVOBC evolution-category candidate
...
- EVOBC category candidate ID: `evobc-evo-cat-04533`
- External category ref: `evobc-cat-04533`
- Source label for human review: `沈`
- Source codepoints: `U+6C88`
- Image reference count: `75`
- Era token counts: `BI:7;CS:1;OBC:51;SS:2;WSC:14`
- Source token counts: `Book:37;Web:38`
