...
- External category reference: `evobc-cat-01625`
- Source category ID: `01625`
- Source label for human review: `問`
...
- `obs-evo-cand-001625-route-category-staging`
...
- `obs-evo-cand-001625-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001625-route-evolution-graph`
