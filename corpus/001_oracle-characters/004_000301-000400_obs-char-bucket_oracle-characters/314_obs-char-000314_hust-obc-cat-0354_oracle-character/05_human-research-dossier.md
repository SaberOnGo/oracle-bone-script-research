# obs-char-000314 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/314_obs-char-000314_hust-obc-cat-0354_orac
  le-character/03_visual-assets/001_asset-000319_hust-obc-cat-0354_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0354/G_0354_甲骨文0.png`
- asset id: `asset-000319`
...
- source category: `0354`
- validation class: `313`
- source image route: `HUST-OBC/deciphered/0354/G_0354_甲骨文0.png`
- asset id: `asset-000319`
...
- English observation: `The image has a tall central stem with branching
  upper strokes, small side enclosures, and a pointed lower extension.`
- 中文观察: `图像有高直中干和上部分叉笔画，两侧有小型闭合轮廓，下方有尖状延伸。`
...
- dataset label text: `㕘`
- dataset label codepoints: `U+3558`
...
- Which source records identify obs-char-000314 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000314？
