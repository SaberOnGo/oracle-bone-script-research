...
- External category reference: `evobc-cat-02536`
- Source category ID: `02536`
- Source label for human review: `岑`
- Source codepoints: `U+5C91`
...
- `obs-evo-cand-002536-route-category-staging`
...
- `obs-evo-cand-002536-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002536-route-evolution-graph`
