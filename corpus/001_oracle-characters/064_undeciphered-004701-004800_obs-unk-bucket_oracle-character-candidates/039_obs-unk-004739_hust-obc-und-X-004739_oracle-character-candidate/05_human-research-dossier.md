# obs-unk-004739 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004739`
- primary external id: `hust-obc-und-X-004739`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/039_obs-unk-004739_h
  ust-obc-und-X-004739_oracle-character-candidate/03_visual-assets/001_asset
  -006332_hust-obc-und-X-004739_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/295/X_？_7273_1.png`
- asset id: `asset-006332`
...
- source class: `HUST-OBC/undeciphered/X/295/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/295/X_？_7273_1.png`
- asset id: `asset-006332`
...
- English observation: `dense enclosure with lower side strokes`
- 中文观察: `带下部两侧笔画的密集围合结构`
...
- Which source records identify obs-unk-004739 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004739？
