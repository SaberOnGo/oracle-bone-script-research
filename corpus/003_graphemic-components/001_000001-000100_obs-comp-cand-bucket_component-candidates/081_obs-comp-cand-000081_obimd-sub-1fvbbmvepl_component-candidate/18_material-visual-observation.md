# Material Visual Observation / obs-comp-cand-000081 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000081`
- External reference / 外部参照: `obimd-sub-1fvbbmvepl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011493_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1fvbbmvepl/1fvbbmvepl/1fvbbmvepl.png`
- Checksum / 校验和:
  `73a1aa0cd9fb78b06fc75a1a6be4e531a024e62d9a7d59832f308c62e9acad27`
...
- Marked-pixel bounds: (65,39)–(184,210); span 120 × 172 px; the marked
...
- 痕迹范围：(65,39)–(184,210)；跨度120 × 172 px；痕迹矩形高于宽。
