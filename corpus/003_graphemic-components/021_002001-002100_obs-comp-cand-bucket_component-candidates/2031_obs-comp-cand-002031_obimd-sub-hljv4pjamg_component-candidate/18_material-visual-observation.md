# Material Visual Observation / obs-comp-cand-002031 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002031`
- External reference / 外部参照: `obimd-sub-hljv4pjamg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019358_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/90zmojjf7j/hljv4pjamg/hljv4pjamg.png`
- Checksum / 校验和:
  `55581785fa9e7fc1f9d3d24fe3390ab7c58c70cc4b4557dcf848f8a273422207`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.04%.
- Marked-pixel bounds: (87,19)–(166,231); span 80 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.04%。
- 痕迹范围：(87,19)–(166,231)；跨度80 × 213 px；痕迹矩形高于宽。
