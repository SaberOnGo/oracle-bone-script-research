...
Project ID: `obs-evo-cand-005331`
...
- Project ID: `obs-evo-cand-005331`
- EVOBC category candidate ID: `evobc-evo-cat-05331`
- External category reference: `evobc-cat-05331`
- Source category ID: `05331`
- Source label for human review: `獵`
- Source codepoints: `U+7375`
...
- `obs-evo-cand-005331-route-category-staging`
...
- `obs-evo-cand-005331-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005331-route-evolution-graph`
