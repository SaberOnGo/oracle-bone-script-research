...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1417`
...
- Source image / 来源图: `H_1417_617F3_0.png`
- Image / 图像: `001_asset-001272_hust-obc-cat-1417_glyph.png`
...
- target node: `evobc-evo-cat-00133`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/133_obs-evo-cand-000133_evobc-cat-00133_evoluti
...
- Source label text / 来源标签文字: `㥿`
- Source label codepoint / 来源标签 codepoint: `U+397F`
