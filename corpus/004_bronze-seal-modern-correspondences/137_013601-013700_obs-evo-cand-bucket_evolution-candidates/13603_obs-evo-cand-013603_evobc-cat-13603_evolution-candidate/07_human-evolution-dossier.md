...
- External category reference: `evobc-cat-13603`
- Source category ID: `13603`
- Source label for human review: `𮅆`
- Source codepoints: `U+2E146`
...
- `obs-evo-cand-013603-route-category-staging`
...
- `obs-evo-cand-013603-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013603-route-evolution-graph`
