# obs-unk-004281 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004281`
- primary external id: `hust-obc-und-L-004281`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/081_obs-unk-004281_h
  ust-obc-und-L-004281_oracle-character-candidate/03_visual-assets/001_asset
  -005874_hust-obc-und-L-004281_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4281/L_？_9457.jpg`
- asset id: `asset-005874`
...
- source class: `HUST-OBC/undeciphered/L/4281/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4281/L_？_9457.jpg`
- asset id: `asset-005874`
...
- English observation: `Upper trace, side descents, pointed shape visible.`
- 中文观察: `上部横痕、两侧下行痕迹和尖状下部轮廓可见。`
...
- Which source records identify obs-unk-004281 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004281？
