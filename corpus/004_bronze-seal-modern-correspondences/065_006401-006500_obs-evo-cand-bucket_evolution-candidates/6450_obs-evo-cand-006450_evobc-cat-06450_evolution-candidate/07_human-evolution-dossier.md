...
- Project ID: `obs-evo-cand-006450`
- EVOBC category candidate ID: `evobc-evo-cat-06450`
- External category reference: `evobc-cat-06450`
- Source category ID: `06450`
- Source label for human review: `紊`
- Source codepoints: `U+7D0A`
...
- `obs-evo-cand-006450-route-category-staging`
...
- `obs-evo-cand-006450-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006450-route-evolution-graph`
