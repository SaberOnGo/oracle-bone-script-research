...
- External category reference: `evobc-cat-06441`
- Source category ID: `06441`
- Source label for human review: `紀`
- Source codepoints: `U+7D00`
...
- `obs-evo-cand-006441-route-category-staging`
...
- `obs-evo-cand-006441-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006441-route-evolution-graph`
