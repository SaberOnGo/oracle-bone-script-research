# Material Visual Observation / obs-comp-cand-000187 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000187`
- External reference / 外部参照: `obimd-sub-35prl36m40`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011680_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h2mhpxskhk/35prl36m40/35prl36m40.png`
- Checksum / 校验和:
  `98bca202da3c83219db4f9b65a50074df3b7fd4b2d4decc022c2afc0a5f429ca`
...
- Marked-pixel bounds: (83,13)–(166,237); span 84 × 225 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.35%。
- 痕迹范围：(83,13)–(166,237)；跨度84 × 225 px；痕迹矩形高于宽。
