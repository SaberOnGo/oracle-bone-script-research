# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005396
...
- EVOBC candidate category: `evobc-evo-cat-05396`.
- Source label for search only: `珽`.
- Source codepoints for search only: `U+73FD`.
