...
Project ID: `obs-evo-cand-001156`
...
- Project ID: `obs-evo-cand-001156`
- EVOBC category candidate ID: `evobc-evo-cat-01156`
- External category reference: `evobc-cat-01156`
- Source category ID: `01156`
- Source label for human review: `凜`
- Source codepoints: `U+51DC`
...
- `obs-evo-cand-001156-route-category-staging`
...
- `obs-evo-cand-001156-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001156-route-evolution-graph`
