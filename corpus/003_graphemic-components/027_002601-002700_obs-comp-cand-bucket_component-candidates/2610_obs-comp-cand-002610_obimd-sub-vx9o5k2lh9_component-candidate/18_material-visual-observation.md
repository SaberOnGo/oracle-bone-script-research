# Material Visual Observation / obs-comp-cand-002610 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002610`
- External reference / 外部参照: `obimd-sub-vx9o5k2lh9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021149_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vx9o5k2lh9/vx9o5k2lh9/vx9o5k2lh9.png`
- Checksum / 校验和:
  `3881bebec4d2df13f773b4e2510fd3950738592eff87c7bfaf1bb7c5f4048cc2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.61%.
- Marked-pixel bounds: (65,17)–(188,235); span 124 × 219 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.61%。
- 痕迹范围：(65,17)–(188,235)；跨度124 × 219 px；痕迹矩形高于宽。
