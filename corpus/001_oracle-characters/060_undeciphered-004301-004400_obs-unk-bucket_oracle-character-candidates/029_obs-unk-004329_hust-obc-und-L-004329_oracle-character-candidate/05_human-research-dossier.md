# obs-unk-004329 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004329`
- primary external id: `hust-obc-und-L-004329`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/029_obs-unk-004329_h
  ust-obc-und-L-004329_oracle-character-candidate/03_visual-assets/001_asset
  -005922_hust-obc-und-L-004329_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4329/L_？_9561.jpg`
- asset id: `asset-005922`
...
- source class: `HUST-OBC/undeciphered/L/4329/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4329/L_？_9561.jpg`
- asset id: `asset-005922`
...
- English observation: `Two long upper curves and a lower connection
  recorded.`
- 中文观察: `已记录两条上部长弯痕和下部连接痕。`
...
- Which source records identify obs-unk-004329 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004329？
