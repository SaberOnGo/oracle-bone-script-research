...
- External category reference: `evobc-cat-09180`
- Source category ID: `09180`
- Source label: `鄈`
...
- `obs-evo-cand-009180-route-category-staging`
...
- `obs-evo-cand-009180-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009180-route-evolution-graph`
