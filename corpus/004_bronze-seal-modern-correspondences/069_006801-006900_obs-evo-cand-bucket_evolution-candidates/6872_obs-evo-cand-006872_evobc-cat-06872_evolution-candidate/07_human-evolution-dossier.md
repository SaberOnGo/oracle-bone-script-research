...
- External category reference: `evobc-cat-06872`
- Source category ID: `06872`
- Source label: `翄`
...
- `obs-evo-cand-006872-route-category-staging`
...
- `obs-evo-cand-006872-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-006872-route-evolution-graph`
