# obs-unk-004514 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/014_obs-unk-004514_h
  ust-obc-und-X-004514_oracle-character-candidate/03_visual-assets/001_asset
  -006107_hust-obc-und-X-004514_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/70/X_？_8254_1.png`
- asset id: `asset-006107`
...
- source class: `HUST-OBC/undeciphered/X/70/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/70/X_？_8254_1.png`
- asset id: `asset-006107`
...
- English observation: `The central trace, upper projections, crossbar, and
  lower taper are directly recorded.`
- 中文观察: `已直接记录中央痕、上部外伸、横向痕和下端收窄。`
...
- Which source records identify obs-unk-004514 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004514？
