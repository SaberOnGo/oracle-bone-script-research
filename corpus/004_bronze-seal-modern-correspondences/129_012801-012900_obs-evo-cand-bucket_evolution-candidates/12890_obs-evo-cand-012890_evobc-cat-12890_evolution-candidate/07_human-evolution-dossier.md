...
- External category reference: `evobc-cat-12890`
- Source category ID: `12890`
- Source label for human review: `𪻑`
- Source codepoints: `U+2AED1`
...
- `obs-evo-cand-012890-route-category-staging`
...
- `obs-evo-cand-012890-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012890-route-evolution-graph`
