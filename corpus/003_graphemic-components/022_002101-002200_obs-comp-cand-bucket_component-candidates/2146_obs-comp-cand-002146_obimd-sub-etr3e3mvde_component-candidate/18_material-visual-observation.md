# Material Visual Observation / obs-comp-cand-002146 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002146`
- External reference / 外部参照: `obimd-sub-etr3e3mvde`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019734_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6x8v1c8903/etr3e3mvde/etr3e3mvde.png`
- Checksum / 校验和:
  `9207d0d01ed511ec798067d6e102178c75b07837dc564cd6405a5dd39d3ed7a5`
...
- Marked-pixel bounds: (100,38)–(147,210); span 48 × 173 px; the marked
...
- 痕迹范围：(100,38)–(147,210)；跨度48 × 173 px；痕迹矩形高于宽。
