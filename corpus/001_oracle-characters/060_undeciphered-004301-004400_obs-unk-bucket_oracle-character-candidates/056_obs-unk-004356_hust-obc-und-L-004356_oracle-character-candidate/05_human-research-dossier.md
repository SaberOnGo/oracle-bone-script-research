# obs-unk-004356 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/056_obs-unk-004356_h
  ust-obc-und-L-004356_oracle-character-candidate/03_visual-assets/001_asset
  -005949_hust-obc-und-L-004356_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4356/L_？_9654.jpg`
- asset id: `asset-005949`
...
- source class: `HUST-OBC/undeciphered/L/4356/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4356/L_？_9654.jpg`
- asset id: `asset-005949`
...
- English observation: `Left zigzag, central trace, and lower hook recorded.`
- 中文观察: `已记录左侧折线、中央痕迹和下部钩状痕。`
...
- Which source records identify obs-unk-004356 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004356？
