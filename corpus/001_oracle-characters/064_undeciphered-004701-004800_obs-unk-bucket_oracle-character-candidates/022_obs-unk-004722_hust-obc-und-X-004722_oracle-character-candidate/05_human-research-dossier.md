# obs-unk-004722 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004722`
- primary external id: `hust-obc-und-X-004722`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/022_obs-unk-004722_h
  ust-obc-und-X-004722_oracle-character-candidate/03_visual-assets/001_asset
  -006315_hust-obc-und-X-004722_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/278/X_？_7254_1.png`
- asset id: `asset-006315`
...
- source class: `HUST-OBC/undeciphered/X/278/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/278/X_？_7254_1.png`
- asset id: `asset-006315`
- source image count: `17`
...
- English observation: `three upper projections with long lower opening`
- 中文观察: `带下部长开口的上部三处分支`
...
- Which source records identify obs-unk-004722 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004722？
