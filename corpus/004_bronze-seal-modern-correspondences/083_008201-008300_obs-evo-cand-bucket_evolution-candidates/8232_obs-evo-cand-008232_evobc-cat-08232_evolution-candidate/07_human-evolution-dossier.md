...
- External category reference: `evobc-cat-08232`
- Source category ID: `08232`
- Source label for human review: `誚`
...
- `obs-evo-cand-008232-route-category-staging`
...
- `obs-evo-cand-008232-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008232-route-evolution-graph`
