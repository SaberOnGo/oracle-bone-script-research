...
- External category reference: `evobc-cat-06608`
- Source category ID: `06608`
- Source label for human review: `緭`
...
- `obs-evo-cand-006608-route-category-staging`
...
- `obs-evo-cand-006608-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006608-route-evolution-graph`
