# obs-unk-004735 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004735`
- primary external id: `hust-obc-und-X-004735`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/035_obs-unk-004735_h
  ust-obc-und-X-004735_oracle-character-candidate/03_visual-assets/001_asset
  -006328_hust-obc-und-X-004735_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/291/X_？_7270_1.png`
- asset id: `asset-006328`
...
- source class: `HUST-OBC/undeciphered/X/291/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/291/X_？_7270_1.png`
- asset id: `asset-006328`
...
- English observation: `curved left form and separate right group`
- 中文观察: `弯曲左侧结构和分离的右侧笔画组`
...
- Which source records identify obs-unk-004735 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004735？
