# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006655
...
- EVOBC candidate category: `evobc-evo-cat-06655`.
- Source label for search only: `縻`.
- Source codepoints for search only: `U+7E3B`.
