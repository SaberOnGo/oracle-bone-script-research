# Material Visual Observation / obs-comp-cand-000652 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000652`
- External reference / 外部参照: `obimd-sub-0r736pj3nc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013215_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ih7qa28rb3/0r736pj3nc/0r736pj3nc.png`
- Checksum / 校验和:
  `58be85530eb18eb8eea677eb70e560a208fd123d97303065a3e62627ca9df249`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.09%.
- Marked-pixel bounds: (45,25)–(215,227); span 171 × 203 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.09%。
- 痕迹范围：(45,25)–(215,227)；跨度171 × 203 px；痕迹矩形近方形。
