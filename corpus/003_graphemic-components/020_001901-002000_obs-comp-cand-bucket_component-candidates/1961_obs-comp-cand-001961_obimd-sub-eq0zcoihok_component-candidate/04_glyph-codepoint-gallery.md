# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001961
...
| --- | --- | --- | --- |
| `obimd-glyph-link-029721` | 󻋑 | `U+FB2D1` | `reviewed_metadata_only` |
| `obimd-glyph-link-029722` | 󻋒 | `U+FB2D2` | `reviewed_metadata_only` |
