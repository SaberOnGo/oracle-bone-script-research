...
- Project ID: `obs-evo-cand-013456`
- EVOBC category candidate ID: `evobc-evo-cat-13456`
- External category reference: `evobc-cat-13456`
- Source category ID: `13456`
- Source label for human review: `𬹩`
- Source codepoints: `U+2CE69`
...
- `obs-evo-cand-013456-route-category-staging`
...
- `obs-evo-cand-013456-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013456-route-evolution-graph`
