...
Project ID: `obs-evo-cand-005204`
...
- Project ID: `obs-evo-cand-005204`
- EVOBC category candidate ID: `evobc-evo-cat-05204`
- External category reference: `evobc-cat-05204`
- Source category ID: `05204`
- Source label for human review: `牜`
- Source codepoints: `U+725C`
...
- `obs-evo-cand-005204-route-category-staging`
...
- `obs-evo-cand-005204-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005204-route-evolution-graph`
