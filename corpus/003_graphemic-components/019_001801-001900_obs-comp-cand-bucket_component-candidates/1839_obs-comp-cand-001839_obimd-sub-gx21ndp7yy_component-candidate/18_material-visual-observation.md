# Material Visual Observation / obs-comp-cand-001839 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001839`
- External reference / 外部参照: `obimd-sub-gx21ndp7yy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018200_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gx21ndp7yy/gx21ndp7yy/gx21ndp7yy.png`
- Checksum / 校验和:
  `ddfcdf55b59708e8ab23032b0b656ed5657ad99feda9f3b0870866ffe9a35dc2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.05%.
- Marked-pixel bounds: (68,14)–(189,233); span 122 × 220 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.05%。
- 痕迹范围：(68,14)–(189,233)；跨度122 × 220 px；痕迹矩形高于宽。
