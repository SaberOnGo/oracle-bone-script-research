# obs-unk-004427 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004427`
- primary external id: `hust-obc-und-L-004427`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/027_obs-unk-004427_h
  ust-obc-und-L-004427_oracle-character-candidate/03_visual-assets/001_asset
  -006020_hust-obc-und-L-004427_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4427/L_？_9926.jpg`
- asset id: `asset-006020`
...
- source class: `HUST-OBC/undeciphered/L/4427/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4427/L_？_9926.jpg`
- asset id: `asset-006020`
...
- English observation: `Crossed upper traces lead to a stem and`
  `rectangular base.`
- 中文观察: `上部交叉痕迹通向竖干和下部框状轮廓。`
...
- Which source records identify obs-unk-004427 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004427？
