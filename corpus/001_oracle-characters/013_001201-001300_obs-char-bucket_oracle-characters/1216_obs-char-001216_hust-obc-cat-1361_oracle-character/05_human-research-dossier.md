# obs-char-001216 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1216_obs-char-001216_hust-obc-cat-1361_ora
  cle-character/03_visual-assets/001_asset-001221_hust-obc-cat-1361_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1361/X_1361_245_1.png`
- asset id: `asset-001221`
...
- source category: `1361`
- validation class: `1215`
- source image route: `HUST-OBC/deciphered/1361/X_1361_245_1.png`
- asset id: `asset-001221`
...
- English observation: `A large pale branching form has a tall right outer
  curve, two left forked branches, and a long lower diagonal stroke.`
- 中文观察: `大型较淡分枝形体有高直右侧外弯、两条左侧分叉和长下部斜笔。`
...
- dataset label text: `㥇`
- dataset label codepoints: `U+3947`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00125`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00125`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00125`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/125_obs-evo-can
  d-000125_evobc-cat-00125_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/125_obs-evo-cand-000125_evobc-cat-00125_evolu
...
- Which source records identify obs-char-001216 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001216？
