# Material Visual Observation / obs-comp-cand-001660 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001660`
- External reference / 外部参照: `obimd-sub-b1ljeixboc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017336_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/81k3ssygt1/b1ljeixboc/b1ljeixboc.png`
- Checksum / 校验和:
  `0b365994578a9b151717b06ca99998d265bbd95b3b4351f1461d690597ea4a55`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.57%.
- Marked-pixel bounds: (66,55)–(183,179); span 118 × 125 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.57%。
- 痕迹范围：(66,55)–(183,179)；跨度118 × 125 px；痕迹矩形近方形。
