# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000822
...
| --- | --- | --- | --- |
| `obimd-glyph-link-011842` | 󹲙 | `U+F9C99` | `reviewed_metadata_only` |
| `obimd-glyph-link-011843` | 󹙆 | `U+F9646` | `reviewed_metadata_only` |
