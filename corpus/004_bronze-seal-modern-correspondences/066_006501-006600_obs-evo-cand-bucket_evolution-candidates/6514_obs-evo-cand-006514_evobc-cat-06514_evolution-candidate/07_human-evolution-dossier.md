...
- External category reference: `evobc-cat-06514`
- Source category ID: `06514`
- Source label: `絣`
...
- `obs-evo-cand-006514-route-category-staging`
...
- `obs-evo-cand-006514-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006514-route-evolution-graph`
