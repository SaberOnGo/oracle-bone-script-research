...
- Project ID: `obs-evo-cand-001835`
- EVOBC category candidate ID: `evobc-evo-cat-01835`
- External category reference: `evobc-cat-01835`
- Source category ID: `01835`
- Source label for human review: `坶`
- Source codepoints: `U+5776`
...
- `obs-evo-cand-001835-route-category-staging`
...
- `obs-evo-cand-001835-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001835-route-evolution-graph`
