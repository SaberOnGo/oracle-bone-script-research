# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013686
...
- EVOBC candidate category: `evobc-evo-cat-13686`.
- Source label for search only: `𮪍`.
- Source codepoints for search only: `U+2EA8D`.
