# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006363
...
- EVOBC candidate category: `evobc-evo-cat-06363`.
- Source label for search only: `簿`.
- Source codepoints for search only: `U+7C3F`.
