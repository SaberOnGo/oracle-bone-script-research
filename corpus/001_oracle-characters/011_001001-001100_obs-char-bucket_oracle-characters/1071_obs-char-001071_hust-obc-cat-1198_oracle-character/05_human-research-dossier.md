# obs-char-001071 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1071_obs-char-001071_hust-obc-cat-1198_ora
  cle-character/03_visual-assets/001_asset-001076_hust-obc-cat-1198_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1198/X_1198_3072_1.png`
- asset id: `asset-001076`
...
- source category: `1198`
- validation class: `1070`
- source image route: `HUST-OBC/deciphered/1198/X_1198_3072_1.png`
- asset id: `asset-001076`
...
- English observation: `A large left stem branches into several splayed
  lower strokes, beside a separate right curved form with a long descending
  edge.`
- 中文观察: `大型左侧笔干向下分为数条张开的下部笔，右侧有分离的弯曲形体和长下行边缘。`
...
- dataset label text: `㢤`
- dataset label codepoints: `U+38A4`
...
- Which source records identify obs-char-001071 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001071？
