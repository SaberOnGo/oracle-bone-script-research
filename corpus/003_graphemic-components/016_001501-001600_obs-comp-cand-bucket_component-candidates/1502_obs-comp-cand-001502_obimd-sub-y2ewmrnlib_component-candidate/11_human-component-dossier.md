# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001502
...
- candidate_component_id: `obs-comp-cand-001502`
- primary_external_ref_id: `obimd-sub-y2ewmrnlib`
- source_subcharacter_uid: `y2ewmrnlib`
...
- glyph_codepoint_uplus_sample: `U+F8AA5, U+F8AA6, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-016430` | `001_asset-016430_img.png` | `b75d1a6a85f2a92b077bb43308ec13e3897d1f8c3619ca2da4596cdf3b0ed8dc` |
