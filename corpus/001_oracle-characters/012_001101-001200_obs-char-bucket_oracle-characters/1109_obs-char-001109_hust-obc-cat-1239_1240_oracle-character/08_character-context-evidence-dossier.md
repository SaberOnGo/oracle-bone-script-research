...
- 项目 ID: `obs-char-001109`
- 首选外部 ID: `hust-obc-cat-1239_1240`
- 来源 ID: `src-hust-obc`
...
- 来源图像路线数: `1`
- 本地复核图像数: `1`
- 首个来源图像名: `G_1239_上(2).從(甲).16(楚).png`
- 首个本地图像名: `001_asset-001114_hust-obc-cat-1239_1240_glyph.png`
