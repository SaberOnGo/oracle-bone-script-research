...
- `obs-evo-cand-004647-route-category-staging`
...
- `obs-evo-cand-004647-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004647-route-evolution-graph`
