# obs-char-000849 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000849`
- primary external id: `hust-obc-cat-0958`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/849_obs-char-000849_hust-obc-cat-0958_orac
  le-character/03_visual-assets/001_asset-000854_hust-obc-cat-0958_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0958/G_0958_存下974合36960黃組.png`
- asset id: `asset-000854`
...
- source category: `0958`
- validation class: `848`
- source image route: `HUST-OBC/deciphered/0958/G_0958_存下974合36960黃組.png`
- asset id: `asset-000854`
...
- English observation: `Two bold curved forms flank angular upper strokes;
  several short detached marks appear below and between them.`
- 中文观察: `两条粗重弯曲形体分列折角上笔两旁；下方及两形之间出现数个分离短笔痕迹。`
...
- dataset label text: `㞴`
- dataset label codepoints: `U+37B4`
...
- filename catalog route clues: `Heji-like filename clue: 合36960
  (G_0958_存下974合36960黃組.png)`
...
- Which source records identify obs-char-000849 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000849？
