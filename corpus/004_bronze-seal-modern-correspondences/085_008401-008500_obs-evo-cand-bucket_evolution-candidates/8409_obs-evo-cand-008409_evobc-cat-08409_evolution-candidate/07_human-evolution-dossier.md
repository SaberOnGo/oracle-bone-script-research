...
- External category reference: `evobc-cat-08409`
- Source category ID: `08409`
- Source label for human review: `论`
...
- `obs-evo-cand-008409-route-category-staging`
...
- `obs-evo-cand-008409-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008409-route-evolution-graph`
