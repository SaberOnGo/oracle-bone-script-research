# obs-unk-006731 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006731`
- primary external id: `hust-obc-und-X-006731`
...
- local review image route: `corpus/001_oracle-characters/084_undeciphered-006
  701-006800_obs-unk-bucket_oracle-character-candidates/031_obs-unk-006731_h
  ust-obc-und-X-006731_oracle-character-candidate/03_visual-assets/001_asset
  -008322_hust-obc-und-X-006731_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2287/X_？_995_1.png`
- asset id: `asset-008322`
...
- source class: `HUST-OBC/undeciphered/X/2287/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2287/X_？_995_1.png`
- asset id: `asset-008322`
...
- Which source records identify obs-unk-006731 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006731？
