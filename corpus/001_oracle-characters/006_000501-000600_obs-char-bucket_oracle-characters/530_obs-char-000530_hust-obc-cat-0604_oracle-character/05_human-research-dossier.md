# obs-char-000530 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000530`
- primary external id: `hust-obc-cat-0604`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/530_obs-char-000530_hust-obc-cat-0604_orac
  le-character/03_visual-assets/001_asset-000535_hust-obc-cat-0604_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0604/G_0604_甲骨文0.png`
- asset id: `asset-000535`
...
- source category: `0604`
- validation class: `529`
- source image route: `HUST-OBC/deciphered/0604/G_0604_甲骨文0.png`
- asset id: `asset-000535`
...
- dataset label text: `㙒`
- dataset label codepoints: `U+3652`
...
- Which source records identify obs-char-000530 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000530？
