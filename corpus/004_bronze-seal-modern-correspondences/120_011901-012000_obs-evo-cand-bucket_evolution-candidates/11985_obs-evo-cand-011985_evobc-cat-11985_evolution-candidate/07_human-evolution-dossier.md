...
Project ID: `obs-evo-cand-011985`
...
- Project ID: `obs-evo-cand-011985`
- EVOBC category candidate ID: `evobc-evo-cat-11985`
- External category reference: `evobc-cat-11985`
- Source category ID: `11985`
- Source label for human review: `𦈬`
- Source codepoints: `U+2622C`
...
- `obs-evo-cand-011985-route-category-staging`
...
- `obs-evo-cand-011985-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011985-route-evolution-graph`
