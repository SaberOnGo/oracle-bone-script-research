# obs-char-000743 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/743_obs-char-000743_hust-obc-cat-0845_orac
  le-character/03_visual-assets/001_asset-000748_hust-obc-cat-0845_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0845/G_0845_後2.39.16(甲).png`
- asset id: `asset-000748`
...
- source category: `0845`
- validation class: `742`
- source image route: `HUST-OBC/deciphered/0845/G_0845_後2.39.16(甲).png`
- asset id: `asset-000748`
...
- dataset label text: `㝃`
- dataset label codepoints: `U+3743`
...
- EvoBC image reference count / EvoBC 图像引用数: `19`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/065_obs-evo-can
  d-000065_evobc-cat-00065_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/065_obs-evo-cand-000065_evobc-cat-00065_evolu
...
- Which source records identify obs-char-000743 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000743？
