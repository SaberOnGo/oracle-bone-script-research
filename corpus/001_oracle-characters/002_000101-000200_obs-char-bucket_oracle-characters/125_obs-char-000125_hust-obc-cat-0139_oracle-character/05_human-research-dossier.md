# obs-char-000125 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000125`
- primary external id: `hust-obc-cat-0139`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/125_obs-char-000125_hust-obc-cat-0139_orac
  le-character/03_visual-assets/001_asset-000130_hust-obc-cat-0139_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0139/H_0139_60AC5_0.png`
- asset id: `asset-000130`
...
- source category: `0139`
- validation class: `124`
- source image route: `HUST-OBC/deciphered/0139/H_0139_60AC5_0.png`
- asset id: `asset-000130`
...
- English observation: `Two separated angular arch-like forms are visible,
  one broad above and a smaller one below, both open along their lower
  edges.`
- 中文观察: `图像可见上下分离的两处折角拱形痕迹，上方较宽，下方较小，底部都呈开放状态。`
...
- dataset label text: `㒁`
- dataset label codepoints: `U+3481`
...
- filename catalog route clues: `catalog-like filename clue: H_0139
  (H_0139_60AC5_0.png)`
...
- Which source records identify obs-char-000125 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000125？
