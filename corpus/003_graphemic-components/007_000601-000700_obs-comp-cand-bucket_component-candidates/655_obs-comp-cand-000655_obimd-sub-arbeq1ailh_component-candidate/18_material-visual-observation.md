# Material Visual Observation / obs-comp-cand-000655 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000655`
- External reference / 外部参照: `obimd-sub-arbeq1ailh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013218_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qh2w0s40kw/arbeq1ailh/arbeq1ailh.png`
- Checksum / 校验和:
  `10b3109c5d8b6fd20d0c71e5b4d3d4205397d0a9d358e2fcb092203e7b5c7266`
...
- Marked-pixel bounds: (80,19)–(173,228); span 94 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.54%。
- 痕迹范围：(80,19)–(173,228)；跨度94 × 210 px；痕迹矩形高于宽。
