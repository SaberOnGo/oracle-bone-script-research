...
Project ID: `obs-evo-cand-000759`
...
- Project ID: `obs-evo-cand-000759`
- EVOBC category candidate ID: `evobc-evo-cat-00759`
- External category reference: `evobc-cat-00759`
- Source category ID: `00759`
- Source label for human review: `伀`
- Source codepoints: `U+4F00`
...
- `obs-evo-cand-000759-route-category-staging`
...
- `obs-evo-cand-000759-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000759-route-evolution-graph`
