# Material Visual Observation / obs-comp-cand-001391 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001391`
- External reference / 外部参照: `obimd-sub-gotsdcy0ks`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015810_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ff8rp0nh6u/gotsdcy0ks/gotsdcy0ks.png`
- Checksum / 校验和:
  `4b37a9e9a77b253f8346b43582844216471b3c77e0717fc8b6b4bd9a23fd6c07`
...
- Marked-pixel bounds: (76,21)–(171,229); span 96 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.39%。
- 痕迹范围：(76,21)–(171,229)；跨度96 × 209 px；痕迹矩形高于宽。
