...
- External category reference: `evobc-cat-08888`
- Source category ID: `08888`
- Source label for human review: `轩`
- Source codepoints: `U+8F69`
...
- `obs-evo-cand-008888-route-category-staging`
...
- `obs-evo-cand-008888-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008888-route-evolution-graph`
