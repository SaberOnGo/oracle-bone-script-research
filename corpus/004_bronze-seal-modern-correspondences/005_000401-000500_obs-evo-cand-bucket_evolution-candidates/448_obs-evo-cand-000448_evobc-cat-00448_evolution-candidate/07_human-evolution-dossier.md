...
- External category reference: `evobc-cat-00448`
- Source category ID: `00448`
- Source label for human review: `䝳`
- Source codepoints: `U+4773`
...
- `obs-evo-cand-000448-route-category-staging`
...
- `obs-evo-cand-000448-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000448-route-evolution-graph`
