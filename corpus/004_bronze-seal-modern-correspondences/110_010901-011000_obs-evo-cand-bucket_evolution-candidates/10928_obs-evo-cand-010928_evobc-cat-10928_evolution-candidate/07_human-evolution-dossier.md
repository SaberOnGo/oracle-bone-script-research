...
Project ID: `obs-evo-cand-010928`
...
- Project ID: `obs-evo-cand-010928`
- EVOBC category candidate ID: `evobc-evo-cat-10928`
- External category reference: `evobc-cat-10928`
- Source category ID: `10928`
- Source label for human review: `𠮏`
- Source codepoints: `U+20B8F`
...
- `obs-evo-cand-010928-route-category-staging`
...
- `obs-evo-cand-010928-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010928-route-evolution-graph`
