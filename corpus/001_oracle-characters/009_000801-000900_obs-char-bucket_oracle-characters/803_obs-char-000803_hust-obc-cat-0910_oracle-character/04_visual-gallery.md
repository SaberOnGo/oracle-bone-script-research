# obs-char-000803 Visual Gallery / obs-char-000803 图像资料页
...
- Project ID / 项目 ID: `obs-char-000803`
- Primary external reference / 首选外部参考: `hust-obc-cat-0910`
...
## obs-char-000803-visual-source-001 / 图像条目

![obs-char-000803 glyph candidate](03_visual-assets/001_asset-000808_hust-obc-cat-0910_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000808_hust-obc-cat-0910_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000808_hust-obc-cat-0910_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0910/G_0910_合10406反(甲).png`
