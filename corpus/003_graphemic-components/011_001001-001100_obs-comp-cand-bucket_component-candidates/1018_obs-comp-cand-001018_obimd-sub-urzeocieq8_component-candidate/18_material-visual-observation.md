# Material Visual Observation / obs-comp-cand-001018 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001018`
- External reference / 外部参照: `obimd-sub-urzeocieq8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014500_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/urzeocieq8/urzeocieq8/urzeocieq8.png`
- Checksum / 校验和:
  `88c0c5e12168c9ca8c0f1cf4cf6a6d2b8954637c257b5714feffddd676aac0c8`
...
- Marked-pixel bounds: (53,59)–(185,197); span 133 × 139 px; the marked
...
- 痕迹范围：(53,59)–(185,197)；跨度133 × 139 px；痕迹矩形近方形。
