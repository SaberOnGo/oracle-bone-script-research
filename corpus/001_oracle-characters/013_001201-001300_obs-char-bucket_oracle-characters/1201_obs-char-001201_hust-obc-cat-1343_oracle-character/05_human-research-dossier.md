# obs-char-001201 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1201_obs-char-001201_hust-obc-cat-1343_ora
  cle-character/03_visual-assets/001_asset-001206_hust-obc-cat-1343_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1343/G_1343_後1.18.9(甲).png`
- asset id: `asset-001206`
...
- source category: `1343`
- validation class: `1200`
- source image route: `HUST-OBC/deciphered/1343/G_1343_後1.18.9(甲).png`
- asset id: `asset-001206`
...
- English observation: `A dense upright cluster has repeated pointed
  branches, a central narrow enclosure, and short lower side strokes.`
...
- dataset label text: `㤵`
- dataset label codepoints: `U+3935`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/119_obs-evo-can
  d-000119_evobc-cat-00119_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/119_obs-evo-cand-000119_evobc-cat-00119_evolu
...
- Which source records identify obs-char-001201 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001201？
