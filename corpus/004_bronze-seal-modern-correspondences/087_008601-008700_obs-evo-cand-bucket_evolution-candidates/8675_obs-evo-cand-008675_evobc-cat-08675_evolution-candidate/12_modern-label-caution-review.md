# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008675
...
- EVOBC candidate category: `evobc-evo-cat-08675`.
- Source label for search only: `越`.
- Source codepoints for search only: `U+8D8A`.
