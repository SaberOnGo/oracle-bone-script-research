# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008490
...
- EVOBC candidate category: `evobc-evo-cat-08490`.
- Source label for search only: `豝`.
- Source codepoints for search only: `U+8C5D`.
