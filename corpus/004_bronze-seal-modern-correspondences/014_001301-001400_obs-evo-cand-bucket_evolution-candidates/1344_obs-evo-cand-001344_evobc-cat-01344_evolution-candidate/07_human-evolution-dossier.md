...
Project ID: `obs-evo-cand-001344`
...
- Project ID: `obs-evo-cand-001344`
- EVOBC category candidate ID: `evobc-evo-cat-01344`
- External category reference: `evobc-cat-01344`
- Source category ID: `01344`
- Source label for human review: `匣`
- Source codepoints: `U+5323`
...
- `obs-evo-cand-001344-route-category-staging`
...
- `obs-evo-cand-001344-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001344-route-evolution-graph`
