# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006098
...
- EVOBC candidate category: `evobc-evo-cat-06098`.
- Source label for search only: `稗`.
- Source codepoints for search only: `U+7A17`.
