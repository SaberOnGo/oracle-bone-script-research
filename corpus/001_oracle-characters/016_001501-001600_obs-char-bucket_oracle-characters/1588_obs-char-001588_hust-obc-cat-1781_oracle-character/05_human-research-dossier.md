# obs-char-001588 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001588`
- primary external id: `hust-obc-cat-1781`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1588_obs-char-001588_hust-obc-cat-1781_ora
  cle-character/03_visual-assets/001_asset-001593_hust-obc-cat-1781_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1781/L_1781_2045.jpg`
- asset id: `asset-001593`
...
- source category: `1781`
- validation class: `1587`
- source image route: `HUST-OBC/deciphered/1781/L_1781_2045.jpg`
- asset id: `asset-001593`
...
- English observation: `A low-resolution gray image preserves several narrow
  upright strokes with pointed upper ends.`
- 中文观察: `低清灰度图像保留数条上端尖状的狭长直立笔画。`
...
- dataset label text: `㫫`
- dataset label codepoints: `U+3AEB`
...
- Which source records identify obs-char-001588 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001588？
