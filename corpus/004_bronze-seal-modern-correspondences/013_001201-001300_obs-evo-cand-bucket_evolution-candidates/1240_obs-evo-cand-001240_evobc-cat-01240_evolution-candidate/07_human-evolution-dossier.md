...
Project ID: `obs-evo-cand-001240`
...
- Project ID: `obs-evo-cand-001240`
- EVOBC category candidate ID: `evobc-evo-cat-01240`
- External category reference: `evobc-cat-01240`
- Source category ID: `01240`
- Source label for human review: `剮`
- Source codepoints: `U+526E`
...
- `obs-evo-cand-001240-route-category-staging`
...
- `obs-evo-cand-001240-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001240-route-evolution-graph`
