...
- External category reference: `evobc-cat-05771`
- Source category ID: `05771`
- Source label for human review: `目`
- Source codepoints: `U+76EE`
- Image reference count in source metadata: `124`
...
- `obs-evo-cand-005771-route-category-staging`
...
- `obs-evo-cand-005771-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005771-route-evolution-graph`
