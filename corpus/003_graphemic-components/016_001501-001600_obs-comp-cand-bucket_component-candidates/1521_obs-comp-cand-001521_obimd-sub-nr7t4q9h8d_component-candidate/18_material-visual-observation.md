# Material Visual Observation / obs-comp-cand-001521 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001521`
- External reference / 外部参照: `obimd-sub-nr7t4q9h8d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016484_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nr7t4q9h8d/nr7t4q9h8d/nr7t4q9h8d.png`
- Checksum / 校验和:
  `54ac52b2417b100b2c2afd63f11a1ebf93585be9a7a0f37bf4cbb3a3773c6c53`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.12%.
- Marked-pixel bounds: (72,21)–(182,219); span 111 × 199 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.12%。
- 痕迹范围：(72,21)–(182,219)；跨度111 × 199 px；痕迹矩形高于宽。
