# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002511
...
- EVOBC candidate category: `evobc-evo-cat-02511`.
- Source label for search only: `屝`.
- Source codepoints for search only: `U+5C5D`.
