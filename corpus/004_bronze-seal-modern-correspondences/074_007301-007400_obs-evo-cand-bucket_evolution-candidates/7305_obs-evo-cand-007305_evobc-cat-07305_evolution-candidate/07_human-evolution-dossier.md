...
Project ID: `obs-evo-cand-007305`
...
- Project ID: `obs-evo-cand-007305`
- EVOBC category candidate ID: `evobc-evo-cat-07305`
- External category reference: `evobc-cat-07305`
- Source category ID: `07305`
- Source label for human review: `茆`
- Source codepoints: `U+8306`
...
- `obs-evo-cand-007305-route-category-staging`
...
- `obs-evo-cand-007305-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007305-route-evolution-graph`
