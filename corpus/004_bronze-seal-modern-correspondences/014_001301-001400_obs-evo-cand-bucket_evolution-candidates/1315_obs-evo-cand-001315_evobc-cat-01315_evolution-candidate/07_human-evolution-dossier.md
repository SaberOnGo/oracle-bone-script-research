...
- Project ID: `obs-evo-cand-001315`
- EVOBC category candidate ID: `evobc-evo-cat-01315`
- External category reference: `evobc-cat-01315`
- Source category ID: `01315`
- Source label for human review: `勶`
- Source codepoints: `U+52F6`
...
- `obs-evo-cand-001315-route-category-staging`
...
- `obs-evo-cand-001315-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001315-route-evolution-graph`
