# Material Visual Observation / obs-comp-cand-000833 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000833`
- External reference / 外部参照: `obimd-sub-uw0p21e2zc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013704_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/13cqabljgi/uw0p21e2zc/uw0p21e2zc.png`
- Checksum / 校验和:
  `1e3f9777496e27f773ce032632c0de7010f09177a888ff0c569f228c459e5a0b`
...
- Marked-pixel bounds: (80,34)–(169,218); span 90 × 185 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.08%。
- 痕迹范围：(80,34)–(169,218)；跨度90 × 185 px；痕迹矩形高于宽。
