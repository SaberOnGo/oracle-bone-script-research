...
Project ID: `obs-evo-cand-003810`
...
- Project ID: `obs-evo-cand-003810`
- EVOBC category candidate ID: `evobc-evo-cat-03810`
- External category reference: `evobc-cat-03810`
- Source category ID: `03810`
- Source label for human review: `曰`
- Source codepoints: `U+66F0`
- Image reference count in source metadata: `420`
...
- `obs-evo-cand-003810-route-category-staging`
...
- `obs-evo-cand-003810-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003810-route-evolution-graph`
