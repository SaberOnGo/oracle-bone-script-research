# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002215
...
- EVOBC candidate category: `evobc-evo-cat-02215`.
- Source label for search only: `婸`.
- Source codepoints for search only: `U+5A78`.
