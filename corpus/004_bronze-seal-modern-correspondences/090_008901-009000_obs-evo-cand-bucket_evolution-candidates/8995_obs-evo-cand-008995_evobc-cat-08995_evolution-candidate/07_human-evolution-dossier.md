...
- External category reference: `evobc-cat-08995`
- Source category ID: `08995`
- Source label for human review: `逗`
...
- `obs-evo-cand-008995-route-category-staging`
...
- `obs-evo-cand-008995-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008995-route-evolution-graph`
