# obs-char-001584 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001584`
- primary external id: `hust-obc-cat-1776`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1584_obs-char-001584_hust-obc-cat-1776_ora
  cle-character/03_visual-assets/001_asset-001589_hust-obc-cat-1776_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1776/L_1776_14846.jpg`
- asset id: `asset-001589`
...
- source category: `1776`
- validation class: `1583`
- source image route: `HUST-OBC/deciphered/1776/L_1776_14846.jpg`
- asset id: `asset-001589`
...
- English observation: `A low-resolution gray image preserves a compact
  central cluster with an indistinct outer contour.`
- 中文观察: `低清灰度图像保留紧凑中央笔画群，外部轮廓难以辨清。`
...
- dataset label text: `㫦`
- dataset label codepoints: `U+3AE6`
...
- Which source records identify obs-char-001584 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001584？
