# obs-unk-006657 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/083_undeciphered-006
  601-006700_obs-unk-bucket_oracle-character-candidates/057_obs-unk-006657_h
  ust-obc-und-X-006657_oracle-character-candidate/03_visual-assets/001_asset
  -008248_hust-obc-und-X-006657_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2213/X_？_6697_1.png`
- asset id: `asset-008248`
...
- source class: `HUST-OBC/undeciphered/X/2213/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2213/X_？_6697_1.png`
- asset id: `asset-008248`
- source image count: `40`
...
- Which source records identify obs-unk-006657 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006657？
