...
- External category reference: `evobc-cat-01056`
- Source category ID: `01056`
- Source label for human review: `優`
- Source codepoints: `U+512A`
...
- `obs-evo-cand-001056-route-category-staging`
...
- `obs-evo-cand-001056-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001056-route-evolution-graph`
