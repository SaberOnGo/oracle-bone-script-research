# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004326
...
- EVOBC candidate category: `evobc-evo-cat-04326`.
- Source label for search only: `櫼`.
- Source codepoints for search only: `U+6AFC`.
