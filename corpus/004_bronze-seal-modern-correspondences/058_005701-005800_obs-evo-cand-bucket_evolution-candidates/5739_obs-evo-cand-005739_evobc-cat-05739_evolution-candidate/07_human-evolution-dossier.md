...
Project ID: `obs-evo-cand-005739`
...
- Project ID: `obs-evo-cand-005739`
- EVOBC category candidate ID: `evobc-evo-cat-05739`
- External category reference: `evobc-cat-05739`
- Source category ID: `05739`
- Source label for human review: `盄`
- Source codepoints: `U+76C4`
...
- `obs-evo-cand-005739-route-category-staging`
...
- `obs-evo-cand-005739-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005739-route-evolution-graph`
