# obs-unk-004658 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004658`
- primary external id: `hust-obc-und-X-004658`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/058_obs-unk-004658_h
  ust-obc-und-X-004658_oracle-character-candidate/03_visual-assets/001_asset
  -006251_hust-obc-und-X-004658_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/214/X_？_8385_1.png`
- asset id: `asset-006251`
...
- source class: `HUST-OBC/undeciphered/X/214/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/214/X_？_8385_1.png`
- asset id: `asset-006251`
...
- English observation: `forked upper stroke and crossed central bar`
- 中文观察: `上部叉形笔画与中央横向交叉笔画`
...
- Which source records identify obs-unk-004658 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004658？
