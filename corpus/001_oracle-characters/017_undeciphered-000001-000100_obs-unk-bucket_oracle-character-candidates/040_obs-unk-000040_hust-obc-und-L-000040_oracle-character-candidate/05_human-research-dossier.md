# obs-unk-000040 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-000040`
- primary external id: `hust-obc-und-L-000040`
...
- local review image route: `corpus/001_oracle-characters/017_undeciphered-000
  001-000100_obs-unk-bucket_oracle-character-candidates/040_obs-unk-000040_h
  ust-obc-und-L-000040_oracle-character-candidate/03_visual-assets/001_asset
  -001633_hust-obc-und-L-000040_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/40/L_？_10125.jpg`
- asset id: `asset-001633`
...
- source class: `HUST-OBC/undeciphered/L/40/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/40/L_？_10125.jpg`
- asset id: `asset-001633`
...
- Which source records identify obs-unk-000040 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-000040？
