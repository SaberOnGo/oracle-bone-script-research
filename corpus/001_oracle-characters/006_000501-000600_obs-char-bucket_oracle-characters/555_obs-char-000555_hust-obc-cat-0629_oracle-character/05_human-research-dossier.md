# obs-char-000555 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000555`
- primary external id: `hust-obc-cat-0629`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/555_obs-char-000555_hust-obc-cat-0629_orac
  le-character/03_visual-assets/001_asset-000560_hust-obc-cat-0629_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0629/G_0629_乙5321合22045午組.png`
- asset id: `asset-000560`
...
- source category: `0629`
- validation class: `554`
- source image route: `HUST-OBC/deciphered/0629/G_0629_乙5321合22045午組.png`
- asset id: `asset-000560`
...
- English observation: `A long left descending stroke joins a small angular
  top enclosure, while a separate small bent loop at right lies below a
  short sloping top mark.`
- 中文观察: `左侧长下行笔连接小型折角顶框，右侧分离小弯环位于一条短斜顶痕下方。`
...
- dataset label text: `㙫`
- dataset label codepoints: `U+366B`
...
- filename catalog route clues: `Heji-like filename clue: 合22045
  (G_0629_乙5321合22045午組.png)`
...
- Which source records identify obs-char-000555 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000555？
