# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012893
...
- EVOBC candidate category: `evobc-evo-cat-12893`.
- Source label for search only: `𪼝`.
- Source codepoints for search only: `U+2AF1D`.
