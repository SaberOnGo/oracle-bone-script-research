...
Project ID: `obs-evo-cand-011972`
...
- Project ID: `obs-evo-cand-011972`
- EVOBC category candidate ID: `evobc-evo-cat-11972`
- External category reference: `evobc-cat-11972`
- Source category ID: `11972`
- Source label for human review: `𦄦`
- Source codepoints: `U+26126`
...
- `obs-evo-cand-011972-route-category-staging`
...
- `obs-evo-cand-011972-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011972-route-evolution-graph`
