# obs-unk-004686 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004686`
- primary external id: `hust-obc-und-X-004686`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/086_obs-unk-004686_h
  ust-obc-und-X-004686_oracle-character-candidate/03_visual-assets/001_asset
  -006279_hust-obc-und-X-004686_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/242/X_？_8410_1.png`
- asset id: `asset-006279`
...
- source class: `HUST-OBC/undeciphered/X/242/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/242/X_？_8410_1.png`
- asset id: `asset-006279`
...
- English observation: `adjoining blocks with upper prongs and openings`
- 中文观察: `带上部尖突和开口的相邻块状区域`
...
- Which source records identify obs-unk-004686 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004686？
