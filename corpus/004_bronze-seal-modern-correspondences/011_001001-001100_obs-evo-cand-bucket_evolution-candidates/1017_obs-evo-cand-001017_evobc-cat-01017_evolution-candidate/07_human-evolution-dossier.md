...
- External category reference: `evobc-cat-01017`
- Source category ID: `01017`
- Source label for human review: `僚`
...
- `obs-evo-cand-001017-route-category-staging`
...
- `obs-evo-cand-001017-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001017-route-evolution-graph`
