...
- External category reference: `evobc-cat-05443`
- Source category ID: `05443`
- Source label for human review: `瑞`
...
- `obs-evo-cand-005443-route-category-staging`
...
- `obs-evo-cand-005443-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005443-route-evolution-graph`
