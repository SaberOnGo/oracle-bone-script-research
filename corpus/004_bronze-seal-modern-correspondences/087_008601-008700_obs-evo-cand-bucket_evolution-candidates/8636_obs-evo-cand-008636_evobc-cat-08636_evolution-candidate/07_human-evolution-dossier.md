...
- External category reference: `evobc-cat-08636`
- Source category ID: `08636`
- Source label for human review: `贼`
- Source codepoints: `U+8D3C`
...
- `obs-evo-cand-008636-route-category-staging`
...
- `obs-evo-cand-008636-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008636-route-evolution-graph`
