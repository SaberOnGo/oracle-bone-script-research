# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006317
...
- EVOBC candidate category: `evobc-evo-cat-06317`.
- Source label for search only: `篍`.
- Source codepoints for search only: `U+7BCD`.
