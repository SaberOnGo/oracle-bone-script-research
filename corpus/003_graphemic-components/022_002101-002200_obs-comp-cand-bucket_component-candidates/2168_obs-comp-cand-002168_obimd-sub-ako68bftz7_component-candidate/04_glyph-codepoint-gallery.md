# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002168
...
| --- | --- | --- | --- |
| `obimd-glyph-link-033765` | 󼞭 | `U+FC7AD` | `reviewed_metadata_only` |
| `obimd-glyph-link-033766` | 󼞮 | `U+FC7AE` | `reviewed_metadata_only` |
