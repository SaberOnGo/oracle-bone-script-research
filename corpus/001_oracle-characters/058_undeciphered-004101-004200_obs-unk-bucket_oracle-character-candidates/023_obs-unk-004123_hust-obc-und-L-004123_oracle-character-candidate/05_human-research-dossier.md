# obs-unk-004123 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/023_obs-unk-004123_h
  ust-obc-und-L-004123_oracle-character-candidate/03_visual-assets/001_asset
  -005716_hust-obc-und-L-004123_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4123/L_？_8882.jpg`
- asset id: `asset-005716`
...
- source class: `HUST-OBC/undeciphered/L/4123/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4123/L_？_8882.jpg`
- asset id: `asset-005716`
...
- English observation: The opened image shows a broad upper stroke group, a
  central connection, and a narrow stem ending below.
- 中文观察：已打开图像可见宽上部笔画组、中央连接和向下收束的窄主干。
...
- Which source records identify obs-unk-004123 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004123？
