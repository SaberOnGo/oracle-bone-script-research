# obs-comp-cand-000902 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000902`
- 首选外部 ID: `obimd-sub-lacjgjmulx`
- OBIMD subcharacter UID: `lacjgjmulx`
- OBIMD main character UID: `lacjgjmulx`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+F50E5; U+F50E6; 另有 2 项
