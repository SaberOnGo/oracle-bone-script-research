...
Project ID: `obs-evo-cand-000388`
...
- Project ID: `obs-evo-cand-000388`
- EVOBC category candidate ID: `evobc-evo-cat-00388`
- External category reference: `evobc-cat-00388`
- Source category ID: `00388`
- Source label for human review: `䔬`
- Source codepoints: `U+452C`
...
- `obs-evo-cand-000388-route-category-staging`
...
- `obs-evo-cand-000388-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000388-route-evolution-graph`
