...
- External category reference: `evobc-cat-10956`
- Source category ID: `10956`
- Source label for human review: `𠽙`
...
- `obs-evo-cand-010956-route-category-staging`
...
- `obs-evo-cand-010956-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010956-route-evolution-graph`
