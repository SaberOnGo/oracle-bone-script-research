# obs-char-001358 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001358`
- primary external id: `hust-obc-cat-1515`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1358_obs-char-001358_hust-obc-cat-1515_ora
  cle-character/03_visual-assets/001_asset-001363_hust-obc-cat-1515_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1515/H_1515_608C9_0.png`
- asset id: `asset-001363`
...
- source category: `1515`
- validation class: `1357`
- source image route: `HUST-OBC/deciphered/1515/H_1515_608C9_0.png`
- asset id: `asset-001363`
...
- dataset label text: `㧡`
- dataset label codepoints: `U+39E1`
...
- filename catalog route clues: `catalog-like filename clue: H_1515
  (H_1515_608C9_0.png)`
...
- Which source records identify obs-char-001358 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001358？
