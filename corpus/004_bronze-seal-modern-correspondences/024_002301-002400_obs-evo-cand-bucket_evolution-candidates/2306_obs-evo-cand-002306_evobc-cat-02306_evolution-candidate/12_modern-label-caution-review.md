# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002306
...
- EVOBC candidate category: `evobc-evo-cat-02306`.
- Source label for search only: `嬪`.
- Source codepoints for search only: `U+5B2A`.
