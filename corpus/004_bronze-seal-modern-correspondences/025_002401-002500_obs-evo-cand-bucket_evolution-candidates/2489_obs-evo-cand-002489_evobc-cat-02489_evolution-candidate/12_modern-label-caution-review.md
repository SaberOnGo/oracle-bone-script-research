# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002489
...
- EVOBC candidate category: `evobc-evo-cat-02489`.
- Source label for search only: `尺`.
- Source codepoints for search only: `U+5C3A`.
