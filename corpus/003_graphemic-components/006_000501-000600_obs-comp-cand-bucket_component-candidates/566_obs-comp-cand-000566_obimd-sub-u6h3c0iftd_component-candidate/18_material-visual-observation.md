# Material Visual Observation / obs-comp-cand-000566 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000566`
- External reference / 外部参照: `obimd-sub-u6h3c0iftd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012818_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u6h3c0iftd/u6h3c0iftd/u6h3c0iftd.png`
- Checksum / 校验和:
  `b00e71c8ff25a7883ead5e09d2b1cffff370a974182199ddc0839bd42c66e736`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.82%.
- Marked-pixel bounds: (79,36)–(170,213); span 92 × 178 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.82%。
- 痕迹范围：(79,36)–(170,213)；跨度92 × 178 px；痕迹矩形高于宽。
