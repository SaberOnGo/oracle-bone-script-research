...
Project ID: `obs-evo-cand-008633`
...
- Project ID: `obs-evo-cand-008633`
- EVOBC category candidate ID: `evobc-evo-cat-08633`
- External category reference: `evobc-cat-08633`
- Source category ID: `08633`
- Source label for human review: `贸`
- Source codepoints: `U+8D38`
...
- `obs-evo-cand-008633-route-category-staging`
...
- `obs-evo-cand-008633-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008633-route-evolution-graph`
