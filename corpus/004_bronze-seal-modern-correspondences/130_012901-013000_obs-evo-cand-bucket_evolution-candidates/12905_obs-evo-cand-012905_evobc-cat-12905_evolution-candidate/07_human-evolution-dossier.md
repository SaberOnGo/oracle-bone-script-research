...
- Project ID: `obs-evo-cand-012905`
- EVOBC category candidate ID: `evobc-evo-cat-12905`
- External category reference: `evobc-cat-12905`
- Source category ID: `12905`
- Source label for human review: `𫀊`
- Source codepoints: `U+2B00A`
...
- `obs-evo-cand-012905-route-category-staging`
...
- `obs-evo-cand-012905-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012905-route-evolution-graph`
