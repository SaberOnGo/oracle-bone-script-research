# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010268
...
- EVOBC candidate category: `evobc-evo-cat-10268`.
- Source label for search only: `驫`.
- Source codepoints for search only: `U+9A6B`.
