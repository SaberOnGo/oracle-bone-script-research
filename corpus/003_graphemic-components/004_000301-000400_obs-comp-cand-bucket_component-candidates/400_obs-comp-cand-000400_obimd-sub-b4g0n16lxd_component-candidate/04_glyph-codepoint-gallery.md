# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000400
...
| --- | --- | --- | --- |
| `obimd-glyph-link-005939` | 򴿌󲕞 | `U+B4FCC;U+F255E` | `reviewed_metadata_only` |
| `obimd-glyph-link-005940` | 󲕟 | `U+F255F` | `reviewed_metadata_only` |
| `obimd-glyph-link-005941` | 󲕠 | `U+F2560` | `reviewed_metadata_only` |
