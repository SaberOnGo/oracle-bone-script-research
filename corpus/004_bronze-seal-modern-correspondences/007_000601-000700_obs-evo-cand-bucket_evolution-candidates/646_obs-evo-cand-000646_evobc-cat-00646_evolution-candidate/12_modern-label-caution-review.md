# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000646
...
- EVOBC candidate category: `evobc-evo-cat-00646`.
- Source label for search only: `为`.
- Source codepoints for search only: `U+4E3A`.
