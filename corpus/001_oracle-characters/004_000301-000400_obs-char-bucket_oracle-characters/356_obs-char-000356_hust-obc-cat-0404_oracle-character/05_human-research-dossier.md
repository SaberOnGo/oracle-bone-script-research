# obs-char-000356 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/356_obs-char-000356_hust-obc-cat-0404_orac
  le-character/03_visual-assets/001_asset-000361_hust-obc-cat-0404_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0404/L_0404_1127.jpg`
- asset id: `asset-000361`
...
- source category: `0404`
- validation class: `355`
- source image route: `HUST-OBC/deciphered/0404/L_0404_1127.jpg`
- asset id: `asset-000361`
...
- English observation: `The low-contrast gray image shows a slim branching
  stroke and a separate long right-side mark; contrast needs recheck.`
- 中文观察: `低对比度灰色图像有纤细分叉笔画，右侧另有长痕迹；对比度仍需复核。`
...
- dataset label text: `㖊`
- dataset label codepoints: `U+358A`
...
- Which source records identify obs-char-000356 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000356？
