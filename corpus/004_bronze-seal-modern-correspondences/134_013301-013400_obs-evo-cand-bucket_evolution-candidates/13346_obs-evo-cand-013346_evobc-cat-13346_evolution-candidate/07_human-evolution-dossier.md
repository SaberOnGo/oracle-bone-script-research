...
- External category reference: `evobc-cat-13346`
- Source category ID: `13346`
- Source label for human review: `𬤊`
...
- `obs-evo-cand-013346-route-category-staging`
...
- `obs-evo-cand-013346-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013346-route-evolution-graph`
