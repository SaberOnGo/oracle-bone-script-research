# Material Visual Observation / obs-comp-cand-001659 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001659`
- External reference / 外部参照: `obimd-sub-81k3ssygt1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017335_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/81k3ssygt1/81k3ssygt1/81k3ssygt1.png`
- Checksum / 校验和:
  `abf28e51b4ec55ab2a1fabaae8070d08d172acb53bbe5307eb994a87e791f03b`
...
- Marked-pixel bounds: (67,57)–(181,188); span 115 × 132 px; the marked
...
- 痕迹范围：(67,57)–(181,188)；跨度115 × 132 px；痕迹矩形近方形。
