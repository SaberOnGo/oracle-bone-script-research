# Material Visual Observation / obs-comp-cand-001477 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001477`
- External reference / 外部参照: `obimd-sub-dlpctjqwqf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016054_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dlpctjqwqf/dlpctjqwqf/dlpctjqwqf.png`
- Checksum / 校验和:
  `f3f97c2c6e0bf1e7b8f97f37c84fd380a6d2204939e854582a963ac036db04a5`
...
- Marked-pixel bounds: (66,47)–(183,196); span 118 × 150 px; the marked
...
- 痕迹范围：(66,47)–(183,196)；跨度118 × 150 px；痕迹矩形高于宽。
