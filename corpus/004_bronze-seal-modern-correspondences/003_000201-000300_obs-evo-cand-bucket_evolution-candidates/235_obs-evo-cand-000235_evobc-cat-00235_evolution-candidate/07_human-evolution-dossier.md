...
- External category reference: `evobc-cat-00235`
- Source category ID: `00235`
- Source label for human review: `㺒`
...
- `obs-evo-cand-000235-route-category-staging`
...
- `obs-evo-cand-000235-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000235-route-evolution-graph`
