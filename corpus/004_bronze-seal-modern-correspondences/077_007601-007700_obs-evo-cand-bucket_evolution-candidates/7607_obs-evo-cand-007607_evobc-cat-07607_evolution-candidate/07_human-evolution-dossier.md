...
- External category reference: `evobc-cat-07607`
- Source category ID: `07607`
- Source label for human review: `薌`
...
- `obs-evo-cand-007607-route-category-staging`
...
- `obs-evo-cand-007607-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007607-route-evolution-graph`
