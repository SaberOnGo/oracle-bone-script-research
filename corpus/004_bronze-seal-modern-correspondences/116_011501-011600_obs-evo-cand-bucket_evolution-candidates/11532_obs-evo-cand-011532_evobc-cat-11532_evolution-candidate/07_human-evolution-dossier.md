...
- External category reference: `evobc-cat-11532`
- Source category ID: `11532`
- Source label for human review: `𣻐`
- Source codepoints: `U+23ED0`
...
- `obs-evo-cand-011532-route-category-staging`
...
- `obs-evo-cand-011532-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011532-route-evolution-graph`
