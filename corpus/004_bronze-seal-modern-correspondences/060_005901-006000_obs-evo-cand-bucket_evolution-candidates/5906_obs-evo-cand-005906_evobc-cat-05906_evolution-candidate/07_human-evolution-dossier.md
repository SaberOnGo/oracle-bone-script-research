...
- External category reference: `evobc-cat-05906`
- Source category ID: `05906`
- Source label: `硜`
...
- `obs-evo-cand-005906-route-category-staging`
...
- `obs-evo-cand-005906-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005906-route-evolution-graph`
