# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003802
...
- EVOBC candidate category: `evobc-evo-cat-03802`.
- Source label for search only: `曟`.
- Source codepoints for search only: `U+66DF`.
