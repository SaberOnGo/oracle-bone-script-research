...
Project ID: `obs-evo-cand-007748`
...
- Project ID: `obs-evo-cand-007748`
- EVOBC category candidate ID: `evobc-evo-cat-07748`
- External category reference: `evobc-cat-07748`
- Source category ID: `07748`
- Source label for human review: `蛘`
- Source codepoints: `U+86D8`
...
- `obs-evo-cand-007748-route-category-staging`
...
- `obs-evo-cand-007748-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007748-route-evolution-graph`
