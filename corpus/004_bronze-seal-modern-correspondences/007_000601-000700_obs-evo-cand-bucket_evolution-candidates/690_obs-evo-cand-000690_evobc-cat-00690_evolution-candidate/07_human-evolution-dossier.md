...
- External category reference: `evobc-cat-00690`
- Source category ID: `00690`
- Source label for human review: `五`
- Source codepoints: `U+4E94`
- Image reference count in source metadata: `274`
...
- `obs-evo-cand-000690-route-category-staging`
...
- `obs-evo-cand-000690-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000690-route-evolution-graph`
