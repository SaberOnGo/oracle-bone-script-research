# obs-unk-006487 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/087_obs-unk-006487_h
  ust-obc-und-X-006487_oracle-character-candidate/03_visual-assets/001_asset
  -008078_hust-obc-und-X-006487_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2043/X_？_5693_1.png`
- asset id: `asset-008078`
...
- source class: `HUST-OBC/undeciphered/X/2043/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2043/X_？_5693_1.png`
- asset id: `asset-008078`
...
- Which source records identify obs-unk-006487 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006487？
