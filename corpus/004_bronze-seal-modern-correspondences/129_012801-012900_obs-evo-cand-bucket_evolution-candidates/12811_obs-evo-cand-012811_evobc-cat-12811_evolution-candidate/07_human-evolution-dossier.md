...
Project ID: `obs-evo-cand-012811`
...
- Project ID: `obs-evo-cand-012811`
- EVOBC category candidate ID: `evobc-evo-cat-12811`
- External category reference: `evobc-cat-12811`
- Source category ID: `12811`
- Source label for human review: `𪡑`
- Source codepoints: `U+2A851`
...
- `obs-evo-cand-012811-route-category-staging`
...
- `obs-evo-cand-012811-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012811-route-evolution-graph`
