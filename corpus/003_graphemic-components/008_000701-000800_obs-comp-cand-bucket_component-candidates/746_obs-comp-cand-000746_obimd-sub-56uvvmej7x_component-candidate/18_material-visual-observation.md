# Material Visual Observation / obs-comp-cand-000746 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000746`
- External reference / 外部参照: `obimd-sub-56uvvmej7x`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013511_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/56uvvmej7x/56uvvmej7x/56uvvmej7x.png`
- Checksum / 校验和:
  `fe60987465226d680c155009e22a7d12a23079460487b4cbcd54cfe6adaabc4e`
...
- Marked-pixel bounds: (92,35)–(157,229); span 66 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.11%。
- 痕迹范围：(92,35)–(157,229)；跨度66 × 195 px；痕迹矩形高于宽。
