...
- External category reference: `evobc-cat-04258`
- Source category ID: `04258`
- Source label for human review: `橃`
- Source codepoints: `U+6A43`
...
- `obs-evo-cand-004258-route-category-staging`
...
- `obs-evo-cand-004258-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004258-route-evolution-graph`
