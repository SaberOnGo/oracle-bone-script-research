...
Project ID: `obs-evo-cand-003267`
...
- Project ID: `obs-evo-cand-003267`
- EVOBC category candidate ID: `evobc-evo-cat-03267`
- External category reference: `evobc-cat-03267`
- Source category ID: `03267`
- Source label for human review: `扺`
- Source codepoints: `U+627A`
...
- `obs-evo-cand-003267-route-category-staging`
...
- `obs-evo-cand-003267-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003267-route-evolution-graph`
