...
- External category reference: `evobc-cat-05188`
- Source category ID: `05188`
- Source label for human review: `爽`
- Source codepoints: `U+723D`
...
- `obs-evo-cand-005188-route-category-staging`
...
- `obs-evo-cand-005188-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005188-route-evolution-graph`
