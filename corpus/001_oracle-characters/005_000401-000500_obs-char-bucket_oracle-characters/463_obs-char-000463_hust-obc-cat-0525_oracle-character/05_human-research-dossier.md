# obs-char-000463 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/463_obs-char-000463_hust-obc-cat-0525_orac
  le-character/03_visual-assets/001_asset-000468_hust-obc-cat-0525_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0525/G_0525_乙2256合14206賓組.png`
- asset id: `asset-000468`
...
- source category: `0525`
- validation class: `462`
- source image route: `HUST-OBC/deciphered/0525/G_0525_乙2256合14206賓組.png`
- asset id: `asset-000468`
...
- English observation: `A pointed arch formed by two long side strokes
  encloses a central crossing with one vertical and one transverse stroke.`
...
- dataset label text: `㘃`
- dataset label codepoints: `U+3603`
...
- filename catalog route clues: `Heji-like filename clue: 合14206
  (G_0525_乙2256合14206賓組.png)`
...
- Which source records identify obs-char-000463 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000463？
