...
- External category reference: `evobc-cat-12394`
- Source category ID: `12394`
- Source label for human review: `𨙋`
...
- `obs-evo-cand-012394-route-category-staging`
...
- `obs-evo-cand-012394-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012394-route-evolution-graph`
