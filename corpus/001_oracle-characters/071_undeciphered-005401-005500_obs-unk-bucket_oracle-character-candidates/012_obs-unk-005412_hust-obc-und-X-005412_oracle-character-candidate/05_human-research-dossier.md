# obs-unk-005412 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005412`
- primary external id: `hust-obc-und-X-005412`
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/012_obs-unk-005412_h
  ust-obc-und-X-005412_oracle-character-candidate/03_visual-assets/001_asset
  -007005_hust-obc-und-X-005412_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/968/X_？_7933_1.png`
- asset id: `asset-007005`
...
- source class: `HUST-OBC/undeciphered/X/968/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/968/X_？_7933_1.png`
- asset id: `asset-007005`
...
- Which source records identify obs-unk-005412 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005412？
