...
- External category reference: `evobc-cat-09443`
- Source category ID: `09443`
- Source label for human review: `錭`
- Source codepoints: `U+932D`
...
- `obs-evo-cand-009443-route-category-staging`
...
- `obs-evo-cand-009443-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009443-route-evolution-graph`
