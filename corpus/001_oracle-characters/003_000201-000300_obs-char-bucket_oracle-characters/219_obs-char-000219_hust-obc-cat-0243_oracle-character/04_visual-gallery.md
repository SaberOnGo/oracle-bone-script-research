# obs-char-000219 Visual Gallery / obs-char-000219 图像资料页
...
- Project ID / 项目 ID: `obs-char-000219`
- Primary external reference / 首选外部参考: `hust-obc-cat-0243`
...
## obs-char-000219-visual-source-001 / 图像条目

![obs-char-000219 glyph candidate](03_visual-assets/001_asset-000224_hust-obc-cat-0243_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000224_hust-obc-cat-0243_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000224_hust-obc-cat-0243_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0243/G_0243_前4.38.7(甲).png`
