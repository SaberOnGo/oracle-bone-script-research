# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008300
...
- EVOBC candidate category: `evobc-evo-cat-08300`.
- Source label for search only: `諽`.
- Source codepoints for search only: `U+8AFD`.
