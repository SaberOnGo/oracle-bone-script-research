...
- Project ID: `obs-evo-cand-009632`
- EVOBC category candidate ID: `evobc-evo-cat-09632`
- External category reference: `evobc-cat-09632`
- Source category ID: `09632`
- Source label for human review: `閥`
- Source codepoints: `U+95A5`
...
- `obs-evo-cand-009632-route-category-staging`
...
- `obs-evo-cand-009632-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009632-route-evolution-graph`
