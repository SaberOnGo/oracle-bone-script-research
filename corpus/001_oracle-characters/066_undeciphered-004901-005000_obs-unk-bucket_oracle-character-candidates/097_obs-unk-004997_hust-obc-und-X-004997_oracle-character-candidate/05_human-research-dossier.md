# obs-unk-004997 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004997`
- primary external id: `hust-obc-und-X-004997`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/097_obs-unk-004997_h
  ust-obc-und-X-004997_oracle-character-candidate/03_visual-assets/001_asset
  -006590_hust-obc-und-X-004997_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/553/X_？_7532_1.png`
- asset id: `asset-006590`
...
- One of two expected views was opened; upper branches and a central gap
  are visible.
- 直接记录：`14_material-visual-observation.md`
- 两个预期视图中当前打开一个，可见上部分枝和中央开口。
...
- source class: `HUST-OBC/undeciphered/X/553/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/553/X_？_7532_1.png`
- asset id: `asset-006590`
...
- Which source records identify obs-unk-004997 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004997？
