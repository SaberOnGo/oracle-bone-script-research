# Material Visual Observation / obs-comp-cand-001779 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001779`
- External reference / 外部参照: `obimd-sub-xwyc1vzwgg`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018000_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zxrxdzrytu/xwyc1vzwgg/xwyc1vzwgg.png`
- Checksum / 校验和:
  `6b0fa404bb61424cb0ec9261534228a49bfc826089cb81522d7c0b849a786394`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.89%.
- Marked-pixel bounds: (55,50)–(194,193); span 140 × 144 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.89%。
- 痕迹范围：(55,50)–(194,193)；跨度140 × 144 px；痕迹矩形近方形。
