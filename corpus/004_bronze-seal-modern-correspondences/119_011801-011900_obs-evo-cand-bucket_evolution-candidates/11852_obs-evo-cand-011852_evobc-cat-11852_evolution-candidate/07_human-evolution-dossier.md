...
- External category reference: `evobc-cat-11852`
- Source category ID: `11852`
- Source label for human review: `𥧞`
- Source codepoints: `U+259DE`
...
- `obs-evo-cand-011852-route-category-staging`
...
- `obs-evo-cand-011852-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011852-route-evolution-graph`
