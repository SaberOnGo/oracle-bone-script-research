...
Project ID: `obs-evo-cand-013350`
...
- Project ID: `obs-evo-cand-013350`
- EVOBC category candidate ID: `evobc-evo-cat-13350`
- External category reference: `evobc-cat-13350`
- Source category ID: `13350`
- Source label for human review: `𬥐`
- Source codepoints: `U+2C950`
...
- `obs-evo-cand-013350-route-category-staging`
...
- `obs-evo-cand-013350-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013350-route-evolution-graph`
