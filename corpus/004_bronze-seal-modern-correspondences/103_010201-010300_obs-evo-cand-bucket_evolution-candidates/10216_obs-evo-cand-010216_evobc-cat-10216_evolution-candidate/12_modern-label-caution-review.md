# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010216
...
- EVOBC candidate category: `evobc-evo-cat-10216`.
- Source label for search only: `騎`.
- Source codepoints for search only: `U+9A0E`.
