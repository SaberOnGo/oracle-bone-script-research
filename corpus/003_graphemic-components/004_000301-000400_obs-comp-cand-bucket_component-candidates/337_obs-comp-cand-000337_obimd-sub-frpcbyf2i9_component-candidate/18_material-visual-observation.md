# Material Visual Observation / obs-comp-cand-000337 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000337`
- External reference / 外部参照: `obimd-sub-frpcbyf2i9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012261_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h920pdxci1/frpcbyf2i9/frpcbyf2i9.png`
- Checksum / 校验和:
  `265f937d231db7db88a03275583c104283540e6f5c9cd094137b60e067e9286d`
...
- Marked-pixel bounds: (72,31)–(177,218); span 106 × 188 px; the marked
...
- 痕迹范围：(72,31)–(177,218)；跨度106 × 188 px；痕迹矩形高于宽。
