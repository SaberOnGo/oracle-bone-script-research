# Material Visual Observation / obs-comp-cand-002415 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002415`
- External reference / 外部参照: `obimd-sub-s2ud9qxguj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020486_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kjv0lvcezv/s2ud9qxguj/s2ud9qxguj.png`
- Checksum / 校验和:
  `36eda56fa96d9eeac9878192802f0a7aaf3b908dfc84b94e0983ec9f3a94f061`
...
- Marked-pixel bounds: (71,56)–(178,188); span 108 × 133 px; the marked
...
- 痕迹范围：(71,56)–(178,188)；跨度108 × 133 px；痕迹矩形高于宽。
