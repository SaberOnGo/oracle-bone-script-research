...
- `obs-evo-cand-006196-route-category-staging`
...
- `obs-evo-cand-006196-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-006196-route-evolution-graph`
