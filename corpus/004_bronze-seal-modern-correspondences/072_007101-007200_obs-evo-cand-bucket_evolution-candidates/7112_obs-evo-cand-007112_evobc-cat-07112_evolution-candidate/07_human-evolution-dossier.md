...
- External category reference: `evobc-cat-07112`
- Source category ID: `07112`
- Source label for human review: `腹`
- Source codepoints: `U+8179`
...
- `obs-evo-cand-007112-route-category-staging`
...
- `obs-evo-cand-007112-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007112-route-evolution-graph`
