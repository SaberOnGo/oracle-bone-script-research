# obs-char-001226 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001226`
- primary external id: `hust-obc-cat-1371`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1226_obs-char-001226_hust-obc-cat-1371_ora
  cle-character/03_visual-assets/001_asset-001231_hust-obc-cat-1371_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1371/G_1371_存下517(甲).png`
- asset id: `asset-001231`
...
- source category: `1371`
- validation class: `1225`
- source image route: `HUST-OBC/deciphered/1371/G_1371_存下517(甲).png`
- asset id: `asset-001231`
...
- English observation: `A dense upright form has an angular upper loop, a
  long right descending stroke, and several lower curves.`
- 中文观察: `密集直立形体有折角上部环、长右侧下行笔和数条下部弯笔。`
...
- dataset label text: `㥑`
- dataset label codepoints: `U+3951`
...
- Which source records identify obs-char-001226 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001226？
