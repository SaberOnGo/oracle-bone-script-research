# Material Visual Observation / obs-comp-cand-002495 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002495`
- External reference / 外部参照: `obimd-sub-tx3m8otqgw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020717_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tx3m8otqgw/tx3m8otqgw/0s1cx3wfxv.png`
- Checksum / 校验和:
  `d9dc7ab75f4c7827318cb1ec00d435d195477c0f5539224d3d95bc87d8c694b4`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.90%.
- Marked-pixel bounds: (63,58)–(186,185); span 124 × 128 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.90%。
- 痕迹范围：(63,58)–(186,185)；跨度124 × 128 px；痕迹矩形近方形。
