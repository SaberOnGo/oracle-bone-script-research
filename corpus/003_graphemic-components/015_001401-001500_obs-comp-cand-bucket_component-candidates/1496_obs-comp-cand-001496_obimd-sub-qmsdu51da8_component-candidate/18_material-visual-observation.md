# Material Visual Observation / obs-comp-cand-001496 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001496`
- External reference / 外部参照: `obimd-sub-qmsdu51da8`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016107_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qmsdu51da8/qmsdu51da8/1atl21tcfb.png`
- Checksum / 校验和:
  `e60c6adc473044d2d51e37bb7ce6045aea1866a753da020e5079cec31ad15399`
...
- Marked-pixel bounds: (93,42)–(156,208); span 64 × 167 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.31%。
- 痕迹范围：(93,42)–(156,208)；跨度64 × 167 px；痕迹矩形高于宽。
