...
- External category reference: `evobc-cat-03216`
- Source category ID: `03216`
- Source label for human review: `戟`
- Source codepoints: `U+621F`
...
- `obs-evo-cand-003216-route-category-staging`
...
- `obs-evo-cand-003216-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003216-route-evolution-graph`
