# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000824
...
- candidate_component_id: `obs-comp-cand-000824`
- primary_external_ref_id: `obimd-sub-t1sxdsvi3f`
- source_subcharacter_uid: `t1sxdsvi3f`
- source_main_character_uid: `nnm6jhv5jz`
- main_character_external_ref_id: `obimd-main-nnm6jhv5jz`
...
- glyph_codepoint_uplus_sample: `U+F4A5D, U+F4A5E, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-013695` | `001_asset-013695_img.png` | `690ce3a9022ab1f4298b5a7b95fdd79d3660ad01b7f8a3787d847f9e5a5114c8` |
