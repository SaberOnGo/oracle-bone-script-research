# obs-char-000127 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000127`
- primary external id: `hust-obc-cat-0141`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/127_obs-char-000127_hust-obc-cat-0141_orac
  le-character/03_visual-assets/001_asset-000132_hust-obc-cat-0141_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0141/G_0141_乙1157合14153賓組.png`
- asset id: `asset-000132`
...
- source category: `0141`
- validation class: `126`
- source image route: `HUST-OBC/deciphered/0141/G_0141_乙1157合14153賓組.png`
- asset id: `asset-000132`
...
- English observation: `Two separated forms are visible: a small open
  triangular form above and a narrow angular hooked form below.`
- 中文观察: `图像可见上下分离的两种形体：上方为小型开放三角形，下方为窄长折角钩状形。`
...
- dataset label text: `㒃`
- dataset label codepoints: `U+3483`
...
- filename catalog route clues: `Heji-like filename clue: 合14153
  (G_0141_乙1157合14153賓組.png)`
...
- Which source records identify obs-char-000127 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000127？
