...
- `obs-evo-cand-012543-route-category-staging`
...
- `obs-evo-cand-012543-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012543-route-evolution-graph`
