...
Project ID: `obs-evo-cand-010505`
...
- Project ID: `obs-evo-cand-010505`
- EVOBC category candidate ID: `evobc-evo-cat-10505`
- External category reference: `evobc-cat-10505`
- Source category ID: `10505`
- Source label for human review: `鴿`
- Source codepoints: `U+9D3F`
...
- `obs-evo-cand-010505-route-category-staging`
...
- `obs-evo-cand-010505-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010505-route-evolution-graph`
