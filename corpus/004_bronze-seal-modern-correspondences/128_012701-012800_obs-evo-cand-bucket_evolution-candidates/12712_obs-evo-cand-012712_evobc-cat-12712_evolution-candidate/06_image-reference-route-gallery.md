...
- `obs-evo-cand-012712-route-category-staging`
...
- `obs-evo-cand-012712-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012712-route-evolution-graph`
