...
- Project ID: `obs-evo-cand-003190`
- EVOBC category candidate ID: `evobc-evo-cat-03190`
- External category reference: `evobc-cat-03190`
- Source category ID: `03190`
- Source label for human review: `懶`
- Source codepoints: `U+61F6`
...
- `obs-evo-cand-003190-route-category-staging`
...
- `obs-evo-cand-003190-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003190-route-evolution-graph`
