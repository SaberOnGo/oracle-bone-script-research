# obs-char-000445 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/445_obs-char-000445_hust-obc-cat-0505_orac
  le-character/03_visual-assets/001_asset-000450_hust-obc-cat-0505_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0505/G_0505_乙8896合22246子組.png`
- asset id: `asset-000450`
...
- source category: `0505`
- validation class: `444`
- source image route: `HUST-OBC/deciphered/0505/G_0505_乙8896合22246子組.png`
- asset id: `asset-000450`
...
- English observation: `Two compact forms stand apart: the left has a long
  top bar and descending central stroke, while the right has a small upper
  enclosure and a bent lower extension.`
- 中文观察: `两个紧凑形体彼此分离：左侧有长顶横和中央下行笔画，右侧有小型上部围框及弯折下部延伸。`
...
- dataset label text: `㗯`
- dataset label codepoints: `U+35EF`
...
- filename catalog route clues: `Heji-like filename clue: 合22246
...
- Which source records identify obs-char-000445 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000445？
