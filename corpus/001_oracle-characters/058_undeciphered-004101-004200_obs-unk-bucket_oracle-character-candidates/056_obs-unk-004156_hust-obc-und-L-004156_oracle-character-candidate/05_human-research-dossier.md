# obs-unk-004156 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004156`
- primary external id: `hust-obc-und-L-004156`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/056_obs-unk-004156_h
  ust-obc-und-L-004156_oracle-character-candidate/03_visual-assets/001_asset
  -005749_hust-obc-und-L-004156_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4156/L_？_9004.jpg`
- asset id: `asset-005749`
...
- source class: `HUST-OBC/undeciphered/L/4156/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4156/L_？_9004.jpg`
- asset id: `asset-005749`
...
- English observation: A tall left angular trace stands beside a rounded
  right outline with an inner mark.
- 中文观察：左侧较高折角痕迹旁有带内部痕迹的右侧圆弧轮廓。
...
- Which source records identify obs-unk-004156 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004156？
