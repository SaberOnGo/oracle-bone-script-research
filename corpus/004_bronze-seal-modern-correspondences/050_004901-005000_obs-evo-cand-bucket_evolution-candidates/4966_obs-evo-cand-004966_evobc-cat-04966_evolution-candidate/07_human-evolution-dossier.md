...
Project ID: `obs-evo-cand-004966`
...
- Project ID: `obs-evo-cand-004966`
- EVOBC category candidate ID: `evobc-evo-cat-04966`
- External category reference: `evobc-cat-04966`
- Source category ID: `04966`
- Source label for human review: `濡`
- Source codepoints: `U+6FE1`
...
- `obs-evo-cand-004966-route-category-staging`
...
- `obs-evo-cand-004966-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004966-route-evolution-graph`
