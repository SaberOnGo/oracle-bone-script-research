...
- External category reference: `evobc-cat-08676`
- Source category ID: `08676`
- Source label for human review: `趋`
- Source codepoints: `U+8D8B`
...
- `obs-evo-cand-008676-route-category-staging`
...
- `obs-evo-cand-008676-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008676-route-evolution-graph`
