...
- External category reference: `evobc-cat-07563`
- Source category ID: `07563`
- Source label: `蔩`
...
- `obs-evo-cand-007563-route-category-staging`
...
- `obs-evo-cand-007563-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007563-route-evolution-graph`
