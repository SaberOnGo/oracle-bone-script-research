# obs-unk-004251 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/051_obs-unk-004251_h
  ust-obc-und-L-004251_oracle-character-candidate/03_visual-assets/001_asset
  -005844_hust-obc-und-L-004251_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4251/L_？_9361.jpg`
- asset id: `asset-005844`
...
- source class: `HUST-OBC/undeciphered/L/4251/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4251/L_？_9361.jpg`
- asset id: `asset-005844`
...
- English observation: `Jagged left trace, angular middle, right curve visible.`
- 中文观察: `左侧锯齿状痕迹、中部棱角轮廓和右侧弯曲痕迹可见。`
...
- Which source records identify obs-unk-004251 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004251？
