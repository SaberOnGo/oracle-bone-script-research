...
- Project ID: `obs-evo-cand-005001`
- EVOBC category candidate ID: `evobc-evo-cat-05001`
- External category reference: `evobc-cat-05001`
- Source category ID: `05001`
- Source label for human review: `瀳`
- Source codepoints: `U+7033`
...
- `obs-evo-cand-005001-route-category-staging`
...
- `obs-evo-cand-005001-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005001-route-evolution-graph`
