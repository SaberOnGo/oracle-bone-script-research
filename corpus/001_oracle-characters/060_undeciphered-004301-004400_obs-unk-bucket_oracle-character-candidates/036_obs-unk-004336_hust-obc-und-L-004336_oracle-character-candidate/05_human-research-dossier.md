# obs-unk-004336 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/036_obs-unk-004336_h
  ust-obc-und-L-004336_oracle-character-candidate/03_visual-assets/001_asset
  -005929_hust-obc-und-L-004336_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4336/L_？_9578.jpg`
- asset id: `asset-005929`
...
- source class: `HUST-OBC/undeciphered/L/4336/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4336/L_？_9578.jpg`
- asset id: `asset-005929`
...
- English observation: `Upper curve, pointed central trace, and right curve
  recorded.`
- 中文观察: `已记录上部弧痕、中央尖细痕和右侧弯痕。`
...
- Which source records identify obs-unk-004336 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004336？
