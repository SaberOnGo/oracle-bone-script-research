...
- External category reference: `evobc-cat-09027`
- Source category ID: `09027`
- Source label for human review: `運`
- Source codepoints: `U+904B`
...
- `obs-evo-cand-009027-route-category-staging`
...
- `obs-evo-cand-009027-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009027-route-evolution-graph`
