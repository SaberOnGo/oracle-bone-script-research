# obs-char-001300 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1300_obs-char-001300_hust-obc-cat-1453_ora
  cle-character/03_visual-assets/001_asset-001305_hust-obc-cat-1453_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1453/X_1453_957_1.png`
- asset id: `asset-001305`
...
- source category: `1453`
- validation class: `1299`
- source image route: `HUST-OBC/deciphered/1453/X_1453_957_1.png`
- asset id: `asset-001305`
...
- English observation: `A long irregular descending form has an upper fork,
  a sweeping lower curve, and a detached bottom mark.`
...
- dataset label text: `㦣`
- dataset label codepoints: `U+39A3`
...
- Which source records identify obs-char-001300 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001300？
