# Material Visual Observation / obs-comp-cand-000378 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000378`
- External reference / 外部参照: `obimd-sub-fmv0hxp7i5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012301_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fmv0hxp7i5/fmv0hxp7i5/fmv0hxp7i5.png`
- Checksum / 校验和:
  `71dddad3a75a96c6b65929e9f29eba8683e9b480997a3ad9a0403b401cd9c22e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.83%.
- Marked-pixel bounds: (65,21)–(184,227); span 120 × 207 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.83%。
- 痕迹范围：(65,21)–(184,227)；跨度120 × 207 px；痕迹矩形高于宽。
