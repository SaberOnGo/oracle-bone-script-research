# Material Visual Observation / obs-comp-cand-002395 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002395`
- External reference / 外部参照: `obimd-sub-ascjpxq201`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020466_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ebp3zxjwi7/ascjpxq201/ascjpxq201.png`
- Checksum / 校验和:
  `96a5a26fee8dbeafa28909139803c7445420b19891b73fd34c86005a2a2cdf40`
...
- Marked-pixel bounds: (96,35)–(155,217); span 60 × 183 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.86%。
- 痕迹范围：(96,35)–(155,217)；跨度60 × 183 px；痕迹矩形高于宽。
