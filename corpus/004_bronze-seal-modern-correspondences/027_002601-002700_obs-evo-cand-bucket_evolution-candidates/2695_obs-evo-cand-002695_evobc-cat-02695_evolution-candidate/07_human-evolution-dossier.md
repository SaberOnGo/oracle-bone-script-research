...
Project ID: `obs-evo-cand-002695`
...
- Project ID: `obs-evo-cand-002695`
- EVOBC category candidate ID: `evobc-evo-cat-02695`
- External category reference: `evobc-cat-02695`
- Source category ID: `02695`
- Source label for human review: `年`
- Source codepoints: `U+5E74`
- Image reference count in source metadata: `476`
...
- `obs-evo-cand-002695-route-category-staging`
...
- `obs-evo-cand-002695-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002695-route-evolution-graph`
