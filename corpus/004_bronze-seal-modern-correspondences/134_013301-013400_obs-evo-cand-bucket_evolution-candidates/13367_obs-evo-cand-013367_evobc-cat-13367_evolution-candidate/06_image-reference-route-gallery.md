...
- `obs-evo-cand-013367-route-category-staging`
...
- `obs-evo-cand-013367-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013367-route-evolution-graph`
