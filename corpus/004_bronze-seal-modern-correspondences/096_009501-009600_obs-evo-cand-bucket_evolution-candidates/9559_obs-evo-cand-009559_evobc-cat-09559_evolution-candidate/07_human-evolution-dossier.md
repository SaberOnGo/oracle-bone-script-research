...
- External category reference: `evobc-cat-09559`
- Source category ID: `09559`
- Source label for human review: `鑸`
...
- `obs-evo-cand-009559-route-category-staging`
...
- `obs-evo-cand-009559-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009559-route-evolution-graph`
