# Material Visual Observation / obs-comp-cand-002053 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002053`
- External reference / 外部参照: `obimd-sub-iuouekyjwj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019440_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/iuouekyjwj/iuouekyjwj/iuouekyjwj.png`
- Checksum / 校验和:
  `f4326c658a15ac2ddd1437aeef8453543a160c5b15b66f23ee7f3bf18f91e4c5`
...
- Marked-pixel bounds: (73,21)–(189,225); span 117 × 205 px; the marked
...
- 痕迹范围：(73,21)–(189,225)；跨度117 × 205 px；痕迹矩形高于宽。
