...
Project ID: `obs-evo-cand-009829`
...
- Project ID: `obs-evo-cand-009829`
- EVOBC category candidate ID: `evobc-evo-cat-09829`
- External category reference: `evobc-cat-09829`
- Source category ID: `09829`
- Source label for human review: `雡`
- Source codepoints: `U+96E1`
...
- `obs-evo-cand-009829-route-category-staging`
...
- `obs-evo-cand-009829-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009829-route-evolution-graph`
