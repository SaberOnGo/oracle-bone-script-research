...
- Project ID: `obs-evo-cand-011600`
- EVOBC category candidate ID: `evobc-evo-cat-11600`
- External category reference: `evobc-cat-11600`
- Source category ID: `11600`
- Source label for human review: `𤚢`
- Source codepoints: `U+246A2`
...
- `obs-evo-cand-011600-route-category-staging`
...
- `obs-evo-cand-011600-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011600-route-evolution-graph`
