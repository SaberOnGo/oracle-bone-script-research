...
- Project ID / 项目 ID: `obs-char-000771`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0875`
...
- Source image / 来源图: `G_0875_甲骨文.png`
- Image / 图像: `001_asset-000776_hust-obc-cat-0875_glyph.png`
...
- target node: `obimd-main-cand-002291`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00070`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `24`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/070_obs-evo-cand-000070_evobc-cat-00070_evoluti
...
- Source label text / 来源标签文字: `㝡`
- Source label codepoint / 来源标签 codepoint: `U+3761`
