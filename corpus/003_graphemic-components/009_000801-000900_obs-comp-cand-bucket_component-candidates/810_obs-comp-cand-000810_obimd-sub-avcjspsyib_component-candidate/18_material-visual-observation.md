# Material Visual Observation / obs-comp-cand-000810 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000810`
- External reference / 外部参照: `obimd-sub-avcjspsyib`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013606_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/avcjspsyib/avcjspsyib/avcjspsyib.png`
- Checksum / 校验和:
  `120b5548a17b903d4a0aefc509bc982a1b371e4e5d74d466513972e7858a6f53`
...
- Marked-pixel bounds: (66,30)–(188,221); span 123 × 192 px; the marked
...
- 痕迹范围：(66,30)–(188,221)；跨度123 × 192 px；痕迹矩形高于宽。
