...
- External category reference: `evobc-cat-05063`
- Source category ID: `05063`
- Source label for human review: `烏`
- Source codepoints: `U+70CF`
- Image reference count in source metadata: `540`
...
- era `4`
  token: `WSC`
  image references: 487
- era `5`
  token: `CS`
  image references: 1
- source `1`
  token: `Web:105952;說文Web:58`
  image references: 461
- source `3`
  token: `Book:21681`
  image references: 10
- source `4`
...
- `obs-evo-cand-005063-route-category-staging`
...
- `obs-evo-cand-005063-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005063-route-evolution-graph`
