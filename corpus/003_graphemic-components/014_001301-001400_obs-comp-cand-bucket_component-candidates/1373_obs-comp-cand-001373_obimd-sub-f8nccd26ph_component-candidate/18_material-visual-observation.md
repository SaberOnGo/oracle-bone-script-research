# Material Visual Observation / obs-comp-cand-001373 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001373`
- External reference / 外部参照: `obimd-sub-f8nccd26ph`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015792_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/73ru6libmk/f8nccd26ph/f8nccd26ph.png`
- Checksum / 校验和:
  `e2ec6a8e02966a581eda613d951faade6acafffeab7c37bb7ef90fd3aa02d883`
...
- Marked-pixel bounds: (79,44)–(170,201); span 92 × 158 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.67%。
- 痕迹范围：(79,44)–(170,201)；跨度92 × 158 px；痕迹矩形高于宽。
