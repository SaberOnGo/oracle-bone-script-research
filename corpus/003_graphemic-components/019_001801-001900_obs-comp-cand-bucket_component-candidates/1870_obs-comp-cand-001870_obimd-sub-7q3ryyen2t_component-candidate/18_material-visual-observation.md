# Material Visual Observation / obs-comp-cand-001870 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001870`
- External reference / 外部参照: `obimd-sub-7q3ryyen2t`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018249_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7q3ryyen2t/7q3ryyen2t/7q3ryyen2t.png`
- Checksum / 校验和:
  `d1578e4fcf9ad58b29c07cce64020cbfdf5c8b6db27b40b027ea9c922499d807`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 14.34%.
- Marked-pixel bounds: (42,20)–(222,225); span 181 × 206 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占14.34%。
- 痕迹范围：(42,20)–(222,225)；跨度181 × 206 px；痕迹矩形近方形。
