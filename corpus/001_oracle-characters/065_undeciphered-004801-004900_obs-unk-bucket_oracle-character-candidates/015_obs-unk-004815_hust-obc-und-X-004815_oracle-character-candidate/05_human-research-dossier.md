# obs-unk-004815 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/015_obs-unk-004815_h
  ust-obc-und-X-004815_oracle-character-candidate/03_visual-assets/001_asset
  -006408_hust-obc-und-X-004815_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/371/X_？_7118_1.png`
- asset id: `asset-006408`
...
- source class: `HUST-OBC/undeciphered/X/371/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/371/X_？_7118_1.png`
- asset id: `asset-006408`
...
- English observation: `upper fork, long right curve, and lower-left block`
- 中文观察: `上部的分叉结构、右侧长曲线和左下分离块`
...
- Which source records identify obs-unk-004815 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004815？
