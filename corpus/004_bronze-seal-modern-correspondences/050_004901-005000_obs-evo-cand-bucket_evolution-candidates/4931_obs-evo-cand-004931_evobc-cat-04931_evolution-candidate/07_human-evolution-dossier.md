...
- External category reference: `evobc-cat-04931`
- Source category ID: `04931`
- Source label for human review: `澐`
...
- `obs-evo-cand-004931-route-category-staging`
...
- `obs-evo-cand-004931-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004931-route-evolution-graph`
