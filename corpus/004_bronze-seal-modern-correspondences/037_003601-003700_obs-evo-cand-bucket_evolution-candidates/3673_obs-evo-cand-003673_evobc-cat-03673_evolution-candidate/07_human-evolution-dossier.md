...
Project ID: `obs-evo-cand-003673`
...
- Project ID: `obs-evo-cand-003673`
- EVOBC category candidate ID: `evobc-evo-cat-03673`
- External category reference: `evobc-cat-03673`
- Source category ID: `03673`
- Source label for human review: `旖`
- Source codepoints: `U+65D6`
...
- `obs-evo-cand-003673-route-category-staging`
...
- `obs-evo-cand-003673-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003673-route-evolution-graph`
