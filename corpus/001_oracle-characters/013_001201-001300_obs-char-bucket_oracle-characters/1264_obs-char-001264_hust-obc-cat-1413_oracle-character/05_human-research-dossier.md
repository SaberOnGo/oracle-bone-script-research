# obs-char-001264 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1264_obs-char-001264_hust-obc-cat-1413_ora
  cle-character/03_visual-assets/001_asset-001269_hust-obc-cat-1413_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1413/H_1413_60D7D_0.png`
- asset id: `asset-001269`
...
- source category: `1413`
- validation class: `1263`
- source image route: `HUST-OBC/deciphered/1413/H_1413_60D7D_0.png`
- asset id: `asset-001269`
...
- English observation: `Two separated angular forms combine upper and lower
  cross-strokes with central verticals and squared turns.`
- 中文观察: `两个分离的折角形体结合上下横笔、中央竖笔和方折转笔。`
...
- dataset label text: `㥻`
- dataset label codepoints: `U+397B`
...
- filename catalog route clues: `catalog-like filename clue: H_1413
  (H_1413_60D7D_0.png)`
...
- Which source records identify obs-char-001264 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001264？
