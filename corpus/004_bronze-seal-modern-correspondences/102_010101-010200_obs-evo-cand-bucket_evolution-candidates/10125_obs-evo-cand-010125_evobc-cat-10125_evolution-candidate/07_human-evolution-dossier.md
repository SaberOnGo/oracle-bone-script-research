...
Project ID: `obs-evo-cand-010125`
...
- Project ID: `obs-evo-cand-010125`
- EVOBC category candidate ID: `evobc-evo-cat-10125`
- External category reference: `evobc-cat-10125`
- Source category ID: `10125`
- Source label for human review: `餼`
- Source codepoints: `U+993C`
...
- `obs-evo-cand-010125-route-category-staging`
...
- `obs-evo-cand-010125-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010125-route-evolution-graph`
