...
- External category reference: `evobc-cat-07841`
- Source category ID: `07841`
- Source label for human review: `螼`
- Source codepoints: `U+87BC`
...
- `obs-evo-cand-007841-route-category-staging`
...
- `obs-evo-cand-007841-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007841-route-evolution-graph`
