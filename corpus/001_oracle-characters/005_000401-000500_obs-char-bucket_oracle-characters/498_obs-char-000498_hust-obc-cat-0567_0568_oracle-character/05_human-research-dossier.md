# obs-char-000498 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000498`
- primary external id: `hust-obc-cat-0567_0568`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/498_obs-char-000498_hust-obc-cat-0567_0568
  _oracle-character/03_visual-assets/001_asset-000503_hust-obc-cat-0567_0568
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0567_0568/0567/G_0567_乙1290合974
  賓組.png`
- asset id: `asset-000503`
...
- source category: `0567_0568`
- validation class: `497`
- source image route: `HUST-OBC/deciphered/0567_0568/0567/G_0567_乙1290合974賓組.p
  ng`
- asset id: `asset-000503`
...
- English observation: `A long horizontal stroke has a forked left-pointing
  end and crosses a central vertical line and a large curved loop opening
  toward the left.`
- 中文观察: `长横左端呈叉状指向左侧，并穿过中央竖线和一个向左开口的大型弯曲环形。`
...
- dataset label text: `㘭㘮`
- dataset label codepoints: `U+362D;U+362E`
...
- graph edge count: `2`
- codepoint routes: `U+362D;U+362E`
...
- filename catalog route clues: `Heji-like filename clue: 合974
  (G_0567_乙1290合974賓組.png)`
...
- Which source records identify obs-char-000498 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000498？
