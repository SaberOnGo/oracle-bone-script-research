...
- External category reference: `evobc-cat-06932`
- Source category ID: `06932`
- Source label for human review: `耻`
- Source codepoints: `U+803B`
...
- `obs-evo-cand-006932-route-category-staging`
...
- `obs-evo-cand-006932-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006932-route-evolution-graph`
