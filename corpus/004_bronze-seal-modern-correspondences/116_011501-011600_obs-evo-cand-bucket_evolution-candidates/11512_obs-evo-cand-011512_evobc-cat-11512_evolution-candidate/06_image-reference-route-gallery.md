...
- `obs-evo-cand-011512-route-category-staging`
...
- `obs-evo-cand-011512-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011512-route-evolution-graph`
