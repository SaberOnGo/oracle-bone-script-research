# obs-unk-004512 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/012_obs-unk-004512_h
  ust-obc-und-X-004512_oracle-character-candidate/03_visual-assets/001_asset
  -006105_hust-obc-und-X-004512_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/68/X_？_8253_1.png`
- asset id: `asset-006105`
...
- source class: `HUST-OBC/undeciphered/X/68/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/68/X_？_8253_1.png`
- asset id: `asset-006105`
...
- English observation: `The pointed outer peak, parallel inner trace, lower
  opening, and central projection are directly recorded.`
- 中文观察: `已直接记录尖顶外痕、平行内痕、下部空白和中央外伸痕。`
...
- Which source records identify obs-unk-004512 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004512？
