# Material Visual Observation / obs-comp-cand-000302 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000302`
- External reference / 外部参照: `obimd-sub-aki498y6jc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012068_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/aki498y6jc/aki498y6jc/aki498y6jc.png`
- Checksum / 校验和:
  `1891ed3e57c117eabeebb61e62aa865f05d21423076e723e8547cc542882ee17`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.84%.
- Marked-pixel bounds: (80,17)–(169,230); span 90 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.84%。
- 痕迹范围：(80,17)–(169,230)；跨度90 × 214 px；痕迹矩形高于宽。
