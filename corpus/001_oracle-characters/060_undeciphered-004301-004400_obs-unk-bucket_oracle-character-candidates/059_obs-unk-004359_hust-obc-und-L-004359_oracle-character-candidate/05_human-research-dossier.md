# obs-unk-004359 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004359`
- primary external id: `hust-obc-und-L-004359`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/059_obs-unk-004359_h
  ust-obc-und-L-004359_oracle-character-candidate/03_visual-assets/001_asset
  -005952_hust-obc-und-L-004359_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4359/L_？_9665.jpg`
- asset id: `asset-005952`
...
- source class: `HUST-OBC/undeciphered/L/4359/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4359/L_？_9665.jpg`
- asset id: `asset-005952`
...
- English observation: `Left angular trace, central mark, and right descent`
  `recorded.`
- 中文观察: `已记录左侧斜角痕、中央痕和右侧下行痕。`
...
- Which source records identify obs-unk-004359 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004359？
