# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001658
...
| --- | --- | --- | --- |
| `obimd-glyph-link-025667` | 󹧣 | `U+F99E3` | `reviewed_metadata_only` |
| `obimd-glyph-link-025668` | 󹧤 | `U+F99E4` | `reviewed_metadata_only` |
| `obimd-glyph-link-025669` | 󹧥 | `U+F99E5` | `reviewed_metadata_only` |
| `obimd-glyph-link-025670` | 󹧦 | `U+F99E6` | `reviewed_metadata_only` |
| `obimd-glyph-link-025671` | 󹧧 | `U+F99E7` | `reviewed_metadata_only` |
