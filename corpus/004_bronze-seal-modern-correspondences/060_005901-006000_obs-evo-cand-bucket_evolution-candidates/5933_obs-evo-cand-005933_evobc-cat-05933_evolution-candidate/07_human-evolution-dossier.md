...
Project ID: `obs-evo-cand-005933`
...
- Project ID: `obs-evo-cand-005933`
- EVOBC category candidate ID: `evobc-evo-cat-05933`
- External category reference: `evobc-cat-05933`
- Source category ID: `05933`
- Source label for human review: `碱`
- Source codepoints: `U+78B1`
...
- `obs-evo-cand-005933-route-category-staging`
...
- `obs-evo-cand-005933-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005933-route-evolution-graph`
