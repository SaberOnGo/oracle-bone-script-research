...
- External category reference: `evobc-cat-04216`
- Source category ID: `04216`
- Source label for human review: `槥`
- Source codepoints: `U+69E5`
...
- `obs-evo-cand-004216-route-category-staging`
...
- `obs-evo-cand-004216-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004216-route-evolution-graph`
