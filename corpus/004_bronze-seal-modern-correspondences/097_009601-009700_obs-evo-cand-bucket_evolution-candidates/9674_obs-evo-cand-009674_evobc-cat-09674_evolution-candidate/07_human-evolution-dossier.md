...
- Project ID: `obs-evo-cand-009674`
- EVOBC category candidate ID: `evobc-evo-cat-09674`
- External category reference: `evobc-cat-09674`
- Source category ID: `09674`
- Source label for human review: `问`
- Source codepoints: `U+95EE`
...
- `obs-evo-cand-009674-route-category-staging`
...
- `obs-evo-cand-009674-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009674-route-evolution-graph`
