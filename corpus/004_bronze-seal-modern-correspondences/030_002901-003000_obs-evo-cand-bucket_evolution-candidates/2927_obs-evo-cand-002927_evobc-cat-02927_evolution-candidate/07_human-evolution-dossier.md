...
Project ID: `obs-evo-cand-002927`
...
- Project ID: `obs-evo-cand-002927`
- EVOBC category candidate ID: `evobc-evo-cat-02927`
- External category reference: `evobc-cat-02927`
- Source category ID: `02927`
- Source label for human review: `怀`
- Source codepoints: `U+6000`
...
- `obs-evo-cand-002927-route-category-staging`
...
- `obs-evo-cand-002927-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002927-route-evolution-graph`
