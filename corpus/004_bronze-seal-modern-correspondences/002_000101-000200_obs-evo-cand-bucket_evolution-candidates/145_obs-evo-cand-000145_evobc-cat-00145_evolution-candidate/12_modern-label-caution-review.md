# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000145
...
- EVOBC candidate category: `evobc-evo-cat-00145`.
- Source label for search only: `㩺`.
- Source codepoints for search only: `U+3A7A`.
