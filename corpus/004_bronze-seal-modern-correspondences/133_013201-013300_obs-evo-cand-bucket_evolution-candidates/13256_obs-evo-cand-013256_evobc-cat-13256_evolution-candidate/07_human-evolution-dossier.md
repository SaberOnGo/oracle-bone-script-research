...
Project ID: `obs-evo-cand-013256`
...
- Project ID: `obs-evo-cand-013256`
- EVOBC category candidate ID: `evobc-evo-cat-13256`
- External category reference: `evobc-cat-13256`
- Source category ID: `13256`
- Source label for human review: `𬐦`
- Source codepoints: `U+2C426`
...
- `obs-evo-cand-013256-route-category-staging`
...
- `obs-evo-cand-013256-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013256-route-evolution-graph`
