...
- Project ID: `obs-evo-cand-001636`
- EVOBC category candidate ID: `evobc-evo-cat-01636`
- External category reference: `evobc-cat-01636`
- Source category ID: `01636`
- Source label for human review: `啻`
- Source codepoints: `U+557B`
...
- `obs-evo-cand-001636-route-category-staging`
...
- `obs-evo-cand-001636-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001636-route-evolution-graph`
