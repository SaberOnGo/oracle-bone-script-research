# obs-char-001321 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001321`
- primary external id: `hust-obc-cat-1477`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1321_obs-char-001321_hust-obc-cat-1477_ora
  cle-character/03_visual-assets/001_asset-001326_hust-obc-cat-1477_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1477/G_1477_乙3401合6032賓組.png`
- asset id: `asset-001326`
...
- source category: `1477`
- validation class: `1320`
- source image route: `HUST-OBC/deciphered/1477/G_1477_乙3401合6032賓組.png`
- asset id: `asset-001326`
...
- English observation: `A small upright form has a rounded triangular upper
  enclosure and a pointed lower loop.`
- 中文观察: `小型直立形体有圆拱三角状上部框形和尖状下部环形。`
...
- dataset label text: `㦻`
- dataset label codepoints: `U+39BB`
...
- filename catalog route clues: `Heji-like filename clue: 合6032
  (G_1477_乙3401合6032賓組.png)`
...
- Which source records identify obs-char-001321 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001321？
