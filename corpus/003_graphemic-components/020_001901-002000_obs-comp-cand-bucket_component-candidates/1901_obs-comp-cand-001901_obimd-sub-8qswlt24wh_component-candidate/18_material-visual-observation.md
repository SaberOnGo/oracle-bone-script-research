# Material Visual Observation / obs-comp-cand-001901 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001901`
- External reference / 外部参照: `obimd-sub-8qswlt24wh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018311_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/c771nmkmb8/8qswlt24wh/8qswlt24wh.png`
- Checksum / 校验和:
  `d6da13b6776d031cde294365075f9c12d9fe6a66a57228189fb8fb34193a7cd7`
...
- Marked-pixel bounds: (51,31)–(195,208); span 145 × 178 px; the marked
...
- 痕迹范围：(51,31)–(195,208)；跨度145 × 178 px；痕迹矩形高于宽。
