...
- External category reference: `evobc-cat-05004`
- Source category ID: `05004`
- Source label for human review: `瀷`
- Source codepoints: `U+7037`
...
- `obs-evo-cand-005004-route-category-staging`
...
- `obs-evo-cand-005004-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005004-route-evolution-graph`
