# obs-char-001273 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001273`
- primary external id: `hust-obc-cat-1424`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1273_obs-char-001273_hust-obc-cat-1424_ora
  cle-character/03_visual-assets/001_asset-001278_hust-obc-cat-1424_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1424/G_1424_乙6929反合938反賓組.png`
- asset id: `asset-001278`
...
- source category: `1424`
- validation class: `1272`
- source image route: `HUST-OBC/deciphered/1424/G_1424_乙6929反合938反賓組.png`
- asset id: `asset-001278`
...
- English observation: `A sloping angular form has a short upper crossing,
  several left branches, and a long descending right curve.`
- 中文观察: `倾斜折角形体有短上部交叉笔、数条左侧分枝和长下行右侧弧线。`
...
- dataset label text: `㦆`
- dataset label codepoints: `U+3986`
...
- filename catalog route clues: `Heji-like filename clue: 合938
  (G_1424_乙6929反合938反賓組.png)`
...
- Which source records identify obs-char-001273 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001273？
