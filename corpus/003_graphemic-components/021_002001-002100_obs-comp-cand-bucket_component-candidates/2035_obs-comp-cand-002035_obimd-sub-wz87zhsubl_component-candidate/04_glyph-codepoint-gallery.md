# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002035
...
| --- | --- | --- | --- |
| `obimd-glyph-link-031338` | 󻮆 | `U+FBB86` | `reviewed_metadata_only` |
| `obimd-glyph-link-031339` | 󻮇 | `U+FBB87` | `reviewed_metadata_only` |
