...
Project ID: `obs-evo-cand-003274`
...
- Project ID: `obs-evo-cand-003274`
- EVOBC category candidate ID: `evobc-evo-cat-03274`
- External category reference: `evobc-cat-03274`
- Source category ID: `03274`
- Source label for human review: `把`
- Source codepoints: `U+628A`
...
- `obs-evo-cand-003274-route-category-staging`
...
- `obs-evo-cand-003274-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003274-route-evolution-graph`
