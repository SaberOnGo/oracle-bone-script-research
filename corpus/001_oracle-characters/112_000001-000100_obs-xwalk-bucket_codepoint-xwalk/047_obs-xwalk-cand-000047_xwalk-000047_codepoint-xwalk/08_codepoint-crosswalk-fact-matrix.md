...
|---|---|---|
| Source Codepoint Route | `U+342D` | not identity |
| HUST candidate route | `hust-obc-cat-0055` | not reading |
| OBIMD route | `obimd-main-cand-002255` | not component |
| EVOBC route | `evobc-evo-cat-00005` | not evolution |
