...
- External category reference: `evobc-cat-06843`
- Source category ID: `06843`
- Source label for human review: `羔`
...
- `obs-evo-cand-006843-route-category-staging`
...
- `obs-evo-cand-006843-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006843-route-evolution-graph`
