...
- External category reference: `evobc-cat-00272`
- Source category ID: `00272`
- Source label for human review: `䀘`
- Source codepoints: `U+4018`
...
- `obs-evo-cand-000272-route-category-staging`
...
- `obs-evo-cand-000272-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000272-route-evolution-graph`
