...
- External category reference: `evobc-cat-05223`
- Source category ID: `05223`
- Source label for human review: `牽`
...
- `obs-evo-cand-005223-route-category-staging`
...
- `obs-evo-cand-005223-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005223-route-evolution-graph`
