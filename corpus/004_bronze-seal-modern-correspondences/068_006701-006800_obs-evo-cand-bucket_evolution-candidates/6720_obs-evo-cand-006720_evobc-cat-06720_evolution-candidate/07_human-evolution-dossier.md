...
Project ID: `obs-evo-cand-006720`
...
- Project ID: `obs-evo-cand-006720`
- EVOBC category candidate ID: `evobc-evo-cat-06720`
- External category reference: `evobc-cat-06720`
- Source category ID: `06720`
- Source label for human review: `纚`
- Source codepoints: `U+7E9A`
...
- `obs-evo-cand-006720-route-category-staging`
...
- `obs-evo-cand-006720-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006720-route-evolution-graph`
