...
- Project ID: `obs-evo-cand-011632`
- EVOBC category candidate ID: `evobc-evo-cat-11632`
- External category reference: `evobc-cat-11632`
- Source category ID: `11632`
- Source label for human review: `𤣔`
- Source codepoints: `U+248D4`
...
- `obs-evo-cand-011632-route-category-staging`
...
- `obs-evo-cand-011632-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011632-route-evolution-graph`
