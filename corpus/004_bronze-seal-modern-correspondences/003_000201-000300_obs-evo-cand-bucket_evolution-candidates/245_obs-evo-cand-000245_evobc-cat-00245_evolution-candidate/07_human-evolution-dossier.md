...
- Project ID: `obs-evo-cand-000245`
- EVOBC category candidate ID: `evobc-evo-cat-00245`
- External category reference: `evobc-cat-00245`
- Source category ID: `00245`
- Source label for human review: `㼰`
- Source codepoints: `U+3F30`
...
- `obs-evo-cand-000245-route-category-staging`
...
- `obs-evo-cand-000245-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000245-route-evolution-graph`
