# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007167
...
- EVOBC candidate category: `evobc-evo-cat-07167`.
- Source label for search only: `臬`.
- Source codepoints for search only: `U+81EC`.
