...
Project ID: `obs-insc-cw-cand-000294`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000294`
...
- Yingguo / 英国所藏: `y1925` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `423` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `84` in source row; primary catalog entry pending
- Heji / 合集: `40927` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000294`
