...
- External category reference: `evobc-cat-06129`
- Source category ID: `06129`
- Source label for human review: `穎`
...
- `obs-evo-cand-006129-route-category-staging`
...
- `obs-evo-cand-006129-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006129-route-evolution-graph`
