...
- External category reference: `evobc-cat-00336`
- Source category ID: `00336`
- Source label for human review: `䌛`
...
- `obs-evo-cand-000336-route-category-staging`
...
- `obs-evo-cand-000336-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000336-route-evolution-graph`
