...
- External category reference: `evobc-cat-02946`
- Source category ID: `02946`
- Source label for human review: `急`
- Source codepoints: `U+6025`
...
- `obs-evo-cand-002946-route-category-staging`
...
- `obs-evo-cand-002946-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002946-route-evolution-graph`
