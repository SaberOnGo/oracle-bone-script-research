# Material Visual Observation / obs-comp-cand-000054 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000054`
- External reference / 外部参照: `obimd-sub-h8jm2odi3q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011464_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pkibwuo4bv/h8jm2odi3q/5h85dol85n.png`
- Checksum / 校验和:
  `203f92c6bbfd818e219cdf2d32b73ecdb4fbbf262a64667ff138fe1573484b2f`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 3.61%.
- Marked-pixel bounds: (78,55)–(171,193); span 94 × 139 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.61%。
- 痕迹范围：(78,55)–(171,193)；跨度94 × 139 px；痕迹矩形高于宽。
