...
Project ID: `obs-evo-cand-003056`
...
- Project ID: `obs-evo-cand-003056`
- EVOBC category candidate ID: `evobc-evo-cat-03056`
- External category reference: `evobc-cat-03056`
- Source category ID: `03056`
- Source label for human review: `惢`
- Source codepoints: `U+60E2`
...
- `obs-evo-cand-003056-route-category-staging`
...
- `obs-evo-cand-003056-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003056-route-evolution-graph`
