# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007422
...
- EVOBC candidate category: `evobc-evo-cat-07422`.
- Source label for search only: `菲`.
- Source codepoints for search only: `U+83F2`.
