# obs-char-000679 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/679_obs-char-000679_hust-obc-cat-0770_orac
  le-character/03_visual-assets/001_asset-000684_hust-obc-cat-0770_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0770/X_0770_3239_1.png`
- asset id: `asset-000684`
...
- source category: `0770`
- validation class: `678`
- source image route: `HUST-OBC/deciphered/0770/X_0770_3239_1.png`
- asset id: `asset-000684`
...
- English observation: `The large low-resolution image has a broad arched
  outer top and tall right side around dense blocky internal strokes and
  narrow openings, with a heavy lower-left cluster and tail.`
...
- dataset label text: `㛸`
- dataset label codepoints: `U+36F8`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00058`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00058`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00058`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/058_obs-evo-can
  d-000058_evobc-cat-00058_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/058_obs-evo-cand-000058_evobc-cat-00058_evolu
...
- Which source records identify obs-char-000679 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000679？
