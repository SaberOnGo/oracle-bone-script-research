...
- External category reference: `evobc-cat-07234`
- Source category ID: `07234`
- Source label for human review: `芍`
...
- `obs-evo-cand-007234-route-category-staging`
...
- `obs-evo-cand-007234-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007234-route-evolution-graph`
