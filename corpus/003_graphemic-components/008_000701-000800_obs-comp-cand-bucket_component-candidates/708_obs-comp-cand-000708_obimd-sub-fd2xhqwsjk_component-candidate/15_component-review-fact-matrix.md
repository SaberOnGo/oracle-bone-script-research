# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000708
...
| Glyph or codepoint route / 字形或码位路线 | 37 OBIMD route rows; examples U+4ECE;U+F40AC; U+F40AD; 另有 35 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 37 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
