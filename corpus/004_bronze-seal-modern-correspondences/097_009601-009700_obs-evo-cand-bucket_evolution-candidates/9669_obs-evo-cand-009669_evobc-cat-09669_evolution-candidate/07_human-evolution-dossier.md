...
Project ID: `obs-evo-cand-009669`
...
- Project ID: `obs-evo-cand-009669`
- EVOBC category candidate ID: `evobc-evo-cat-09669`
- External category reference: `evobc-cat-09669`
- Source category ID: `09669`
- Source label for human review: `闤`
- Source codepoints: `U+95E4`
...
- `obs-evo-cand-009669-route-category-staging`
...
- `obs-evo-cand-009669-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009669-route-evolution-graph`
