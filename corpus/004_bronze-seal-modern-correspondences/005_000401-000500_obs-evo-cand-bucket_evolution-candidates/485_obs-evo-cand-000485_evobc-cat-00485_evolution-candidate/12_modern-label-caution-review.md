# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000485
...
- EVOBC candidate category: `evobc-evo-cat-00485`.
- Source label for search only: `䢽`.
- Source codepoints for search only: `U+48BD`.
