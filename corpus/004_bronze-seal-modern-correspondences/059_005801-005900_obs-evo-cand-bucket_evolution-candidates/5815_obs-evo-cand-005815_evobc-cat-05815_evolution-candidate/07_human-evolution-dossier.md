...
Project ID: `obs-evo-cand-005815`
...
- Project ID: `obs-evo-cand-005815`
- EVOBC category candidate ID: `evobc-evo-cat-05815`
- External category reference: `evobc-cat-05815`
- Source category ID: `05815`
- Source label for human review: `眼`
- Source codepoints: `U+773C`
...
- `obs-evo-cand-005815-route-category-staging`
...
- `obs-evo-cand-005815-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005815-route-evolution-graph`
