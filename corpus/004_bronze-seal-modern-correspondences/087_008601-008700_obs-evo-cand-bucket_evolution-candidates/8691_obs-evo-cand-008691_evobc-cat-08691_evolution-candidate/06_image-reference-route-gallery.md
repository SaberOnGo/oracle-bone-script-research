...
- `obs-evo-cand-008691-route-category-staging`
...
- `obs-evo-cand-008691-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008691-route-evolution-graph`
