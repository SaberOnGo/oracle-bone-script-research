...
- External category reference: `evobc-cat-03642`
- Source category ID: `03642`
- Source label: `斦`
...
- `obs-evo-cand-003642-route-category-staging`
...
- `obs-evo-cand-003642-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003642-route-evolution-graph`
