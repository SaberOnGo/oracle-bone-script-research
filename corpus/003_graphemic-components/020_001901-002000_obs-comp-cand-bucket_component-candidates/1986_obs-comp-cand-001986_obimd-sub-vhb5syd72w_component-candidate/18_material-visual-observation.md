# Material Visual Observation / obs-comp-cand-001986 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001986`
- External reference / 外部参照: `obimd-sub-vhb5syd72w`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018978_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qe26dg343r/vhb5syd72w/vhb5syd72w.png`
- Checksum / 校验和:
  `d5153b4aa35ca2f2d0e2cf73796736ed930fb6de6e2f9ee3b2ffafb47fe28f5a`
...
- Marked-pixel bounds: (79,34)–(170,209); span 92 × 176 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.31%。
- 痕迹范围：(79,34)–(170,209)；跨度92 × 176 px；痕迹矩形高于宽。
