...
- Project ID: `obs-evo-cand-000470`
- EVOBC category candidate ID: `evobc-evo-cat-00470`
- External category reference: `evobc-cat-00470`
- Source category ID: `00470`
- Source label for human review: `䢉`
- Source codepoints: `U+4889`
...
- `obs-evo-cand-000470-route-category-staging`
...
- `obs-evo-cand-000470-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000470-route-evolution-graph`
