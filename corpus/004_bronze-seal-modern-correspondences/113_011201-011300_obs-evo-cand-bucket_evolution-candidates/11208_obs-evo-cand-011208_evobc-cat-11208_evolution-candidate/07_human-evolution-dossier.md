...
Project ID: `obs-evo-cand-011208`
...
- Project ID: `obs-evo-cand-011208`
- EVOBC category candidate ID: `evobc-evo-cat-11208`
- External category reference: `evobc-cat-11208`
- Source category ID: `11208`
- Source label for human review: `𢔍`
- Source codepoints: `U+2250D`
...
- `obs-evo-cand-011208-route-category-staging`
...
- `obs-evo-cand-011208-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011208-route-evolution-graph`
