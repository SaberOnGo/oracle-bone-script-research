# Material Visual Observation / obs-comp-cand-001217 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001217`
- External reference / 外部参照: `obimd-sub-myoqtwlezn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015448_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/myoqtwlezn/myoqtwlezn/myoqtwlezn.png`
- Checksum / 校验和:
  `53bc0a614010529b6b4c16471e89d871e945da3101d7c226e92d6c3e77555d1b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.12%.
- Marked-pixel bounds: (68,38)–(181,212); span 114 × 175 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.12%。
- 痕迹范围：(68,38)–(181,212)；跨度114 × 175 px；痕迹矩形高于宽。
