# obs-unk-004080 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004080`
- primary external id: `hust-obc-und-L-004080`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/080_obs-unk-004080_h
  ust-obc-und-L-004080_oracle-character-candidate/03_visual-assets/001_asset
  -005673_hust-obc-und-L-004080_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4080/L_？_8760.jpg`
- asset id: `asset-005673`
...
- source class: `HUST-OBC/undeciphered/L/4080/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4080/L_？_8760.jpg`
- asset id: `asset-005673`
...
- English observation: Several slanting traces occupy the upper and left area,
  with a rounded or loop-like outline at the lower right and a dark interior.
  It is visually similar at this scale to 004074, but no checksum or
  deduplication comparison has been performed.
...
- Which source records identify obs-unk-004080 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004080？
