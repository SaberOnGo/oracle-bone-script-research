# Material Visual Observation / obs-unk-002653
...
- English observation: Several short strokes branch from the upper center.
  A vertical line descends to a horizontal base, which encloses a pale
  lower area.
- 中文观察：上部中央分出数条短笔痕。一条纵向笔痕向下接至横向底部，
  底部围住较浅的下方区域。
