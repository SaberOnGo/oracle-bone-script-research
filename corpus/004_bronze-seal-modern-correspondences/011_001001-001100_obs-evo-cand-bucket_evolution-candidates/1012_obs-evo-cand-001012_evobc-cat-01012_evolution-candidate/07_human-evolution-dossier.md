...
Project ID: `obs-evo-cand-001012`
...
- Project ID: `obs-evo-cand-001012`
- EVOBC category candidate ID: `evobc-evo-cat-01012`
- External category reference: `evobc-cat-01012`
- Source category ID: `01012`
- Source label for human review: `僑`
- Source codepoints: `U+50D1`
...
- `obs-evo-cand-001012-route-category-staging`
...
- `obs-evo-cand-001012-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001012-route-evolution-graph`
