...
- External category reference: `evobc-cat-07337`
- Source category ID: `07337`
- Source label for human review: `荂`
...
- `obs-evo-cand-007337-route-category-staging`
...
- `obs-evo-cand-007337-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007337-route-evolution-graph`
