# obs-char-001426 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001426`
- primary external id: `hust-obc-cat-1598`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1426_obs-char-001426_hust-obc-cat-1598_ora
  cle-character/03_visual-assets/001_asset-001431_hust-obc-cat-1598_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1598/G_1598_乙3401合6032賓組.png`
- asset id: `asset-001431`
...
- source category: `1598`
- validation class: `1425`
- source image route: `HUST-OBC/deciphered/1598/G_1598_乙3401合6032賓組.png`
- asset id: `asset-001431`
...
- English observation: `A leaf-like cluster has a rounded inner mark and
  several short upper strokes.`
- 中文观察: `叶状笔画群有圆拱内部笔画和数条短上部笔画。`
...
- dataset label text: `㨴`
- dataset label codepoints: `U+3A34`
...
- Which source records identify obs-char-001426 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001426？
