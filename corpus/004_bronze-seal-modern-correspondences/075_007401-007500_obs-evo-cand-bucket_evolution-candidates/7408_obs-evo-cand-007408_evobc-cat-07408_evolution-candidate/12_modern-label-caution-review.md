# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007408
...
- EVOBC candidate category: `evobc-evo-cat-07408`.
- Source label for search only: `菏`.
- Source codepoints for search only: `U+83CF`.
