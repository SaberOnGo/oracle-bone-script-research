...
- Project ID: `obs-evo-cand-006685`
- EVOBC category candidate ID: `evobc-evo-cat-06685`
- External category reference: `evobc-cat-06685`
- Source category ID: `06685`
- Source label for human review: `繢`
- Source codepoints: `U+7E62`
...
- `obs-evo-cand-006685-route-category-staging`
...
- `obs-evo-cand-006685-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006685-route-evolution-graph`
