...
- External category reference: `evobc-cat-09313`
- Source category ID: `09313`
- Source label for human review: `釫`
- Source codepoints: `U+91EB`
...
- `obs-evo-cand-009313-route-category-staging`
...
- `obs-evo-cand-009313-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009313-route-evolution-graph`
