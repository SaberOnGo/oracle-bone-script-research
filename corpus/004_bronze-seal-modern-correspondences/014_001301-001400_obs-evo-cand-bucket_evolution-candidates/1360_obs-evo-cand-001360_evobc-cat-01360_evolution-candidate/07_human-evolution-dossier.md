...
Project ID: `obs-evo-cand-001360`
...
- Project ID: `obs-evo-cand-001360`
- EVOBC category candidate ID: `evobc-evo-cat-01360`
- External category reference: `evobc-cat-01360`
- Source category ID: `01360`
- Source label for human review: `匿`
- Source codepoints: `U+533F`
- Image reference count in source metadata: `63`
...
- `obs-evo-cand-001360-route-category-staging`
...
- `obs-evo-cand-001360-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001360-route-evolution-graph`
