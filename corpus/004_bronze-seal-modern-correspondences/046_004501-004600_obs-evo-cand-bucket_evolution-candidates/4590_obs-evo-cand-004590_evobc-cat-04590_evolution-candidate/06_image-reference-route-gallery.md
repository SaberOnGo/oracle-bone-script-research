...
- `obs-evo-cand-004590-route-category-staging`
...
- `obs-evo-cand-004590-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004590-route-evolution-graph`
