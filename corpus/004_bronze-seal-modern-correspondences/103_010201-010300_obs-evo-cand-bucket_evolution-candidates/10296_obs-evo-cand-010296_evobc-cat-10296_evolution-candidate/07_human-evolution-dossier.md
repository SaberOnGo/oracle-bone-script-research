...
Project ID: `obs-evo-cand-010296`
...
- Project ID: `obs-evo-cand-010296`
- EVOBC category candidate ID: `evobc-evo-cat-10296`
- External category reference: `evobc-cat-10296`
- Source category ID: `10296`
- Source label for human review: `骾`
- Source codepoints: `U+9ABE`
...
- `obs-evo-cand-010296-route-category-staging`
...
- `obs-evo-cand-010296-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010296-route-evolution-graph`
