...
- External category reference: `evobc-cat-10082`
- Source category ID: `10082`
- Source label for human review: `飢`
...
- `obs-evo-cand-010082-route-category-staging`
...
- `obs-evo-cand-010082-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010082-route-evolution-graph`
