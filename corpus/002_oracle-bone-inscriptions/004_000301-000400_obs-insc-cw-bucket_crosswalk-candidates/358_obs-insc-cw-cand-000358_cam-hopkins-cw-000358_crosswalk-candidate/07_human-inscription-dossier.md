...
- Source page section: `Period II Group 12` /
  `第 II 期第 12 组`
- Source section key: `period-ii-group-12`
...
- Yingguo / 英国所藏: `y2051` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `450` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `51` in source row; primary catalog entry pending
