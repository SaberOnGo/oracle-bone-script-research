...
Project ID: `obs-evo-cand-009100`
...
- Project ID: `obs-evo-cand-009100`
- EVOBC category candidate ID: `evobc-evo-cat-09100`
- External category reference: `evobc-cat-09100`
- Source category ID: `09100`
- Source label for human review: `那`
- Source codepoints: `U+90A3`
...
- `obs-evo-cand-009100-route-category-staging`
...
- `obs-evo-cand-009100-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009100-route-evolution-graph`
