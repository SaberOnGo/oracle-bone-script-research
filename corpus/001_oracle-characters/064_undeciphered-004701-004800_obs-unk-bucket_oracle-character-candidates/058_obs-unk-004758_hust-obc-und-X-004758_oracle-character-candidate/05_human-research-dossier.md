# obs-unk-004758 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004758`
- primary external id: `hust-obc-und-X-004758`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/058_obs-unk-004758_h
  ust-obc-und-X-004758_oracle-character-candidate/03_visual-assets/001_asset
  -006351_hust-obc-und-X-004758_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/314/X_？_7299_1.png`
- asset id: `asset-006351`
...
- source class: `HUST-OBC/undeciphered/X/314/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/314/X_？_7299_1.png`
- asset id: `asset-006351`
...
- English observation: `detached upper strokes and separate lower hook`
- 中文观察: `分离的上部笔画和下部弯钩结构`
...
- Which source records identify obs-unk-004758 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004758？
