# obs-unk-008767 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008767`
- primary external id: `hust-obc-und-YH-008767`
...
- local review image route: `corpus/001_oracle-characters/104_undeciphered-008
  701-008800_obs-unk-bucket_oracle-character-candidates/067_obs-unk-008767_h
  ust-obc-und-YH-008767_oracle-character-candidate/03_visual-assets/001_asse
  t-010358_hust-obc-und-YH-008767_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60DD1/H_？_60DD1_0.png`
- asset id: `asset-010358`
...
- source class: `HUST-OBC/undeciphered/Y+H/60DD1/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60DD1/H_？_60DD1_0.png`
- asset id: `asset-010358`
...
- Which source records identify obs-unk-008767 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008767？
