# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012750
...
- EVOBC candidate category: `evobc-evo-cat-12750`.
- Source label for search only: `𪏌`.
- Source codepoints for search only: `U+2A3CC`.
