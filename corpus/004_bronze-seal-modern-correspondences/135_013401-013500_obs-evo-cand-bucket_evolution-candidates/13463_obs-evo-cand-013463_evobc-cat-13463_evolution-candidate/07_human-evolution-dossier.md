...
Project ID: `obs-evo-cand-013463`
...
- Project ID: `obs-evo-cand-013463`
- EVOBC category candidate ID: `evobc-evo-cat-13463`
- External category reference: `evobc-cat-13463`
- Source category ID: `13463`
- Source label for human review: `𬽒`
- Source codepoints: `U+2CF52`
...
- `obs-evo-cand-013463-route-category-staging`
...
- `obs-evo-cand-013463-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013463-route-evolution-graph`
