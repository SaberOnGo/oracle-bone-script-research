# Material Visual Observation / obs-comp-cand-000140 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000140`
- External reference / 外部参照: `obimd-sub-gtadlgs1p2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011552_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/shksxlt8ok/gtadlgs1p2/gtadlgs1p2.png`
- Checksum / 校验和:
  `5430a07669c3e707fbfa630819fe0b4627399b5e930350649d64c7b8f4f24551`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.26%.
- Marked-pixel bounds: (62,57)–(187,189); span 126 × 133 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.26%。
- 痕迹范围：(62,57)–(187,189)；跨度126 × 133 px；痕迹矩形近方形。
