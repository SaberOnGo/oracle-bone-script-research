# Material Visual Observation / obs-comp-cand-000508 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000508`
- External reference / 外部参照: `obimd-sub-t2memeu0c4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012744_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/t2memeu0c4/t2memeu0c4/t2memeu0c4.png`
- Checksum / 校验和:
  `cc8f598cf8eba3b279d00292eb19559187700ca958176211859bb6c47e2d0573`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.49%.
- Marked-pixel bounds: (58,25)–(191,218); span 134 × 194 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.49%。
- 痕迹范围：(58,25)–(191,218)；跨度134 × 194 px；痕迹矩形高于宽。
