# Material Visual Observation / obs-comp-cand-000972 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000972`
- External reference / 外部参照: `obimd-sub-yblerkk95h`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014229_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/j5cl5jcqdz/yblerkk95h/yblerkk95h.png`
- Checksum / 校验和:
  `34a12fee51ac1ca5fbeb815261499d8487f41cf97e1dbeab7ac137e47112776b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.81%.
- Marked-pixel bounds: (94,34)–(155,216); span 62 × 183 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.81%。
- 痕迹范围：(94,34)–(155,216)；跨度62 × 183 px；痕迹矩形高于宽。
