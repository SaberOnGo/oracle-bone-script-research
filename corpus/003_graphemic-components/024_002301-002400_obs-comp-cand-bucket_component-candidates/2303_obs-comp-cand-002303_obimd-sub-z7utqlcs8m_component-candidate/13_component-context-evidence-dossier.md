# obs-comp-cand-002303 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002303`
- 首选外部 ID: `obimd-sub-z7utqlcs8m`
- OBIMD subcharacter UID: `z7utqlcs8m`
- OBIMD main character UID: `z7utqlcs8m`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+A753C;U+FD469; U+FD46A; 另有 1 项
