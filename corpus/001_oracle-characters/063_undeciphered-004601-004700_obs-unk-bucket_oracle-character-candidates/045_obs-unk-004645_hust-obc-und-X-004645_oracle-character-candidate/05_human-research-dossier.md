# obs-unk-004645 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004645`
- primary external id: `hust-obc-und-X-004645`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/045_obs-unk-004645_h
  ust-obc-und-X-004645_oracle-character-candidate/03_visual-assets/001_asset
  -006238_hust-obc-und-X-004645_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/201/X_？_8374_1.png`
- asset id: `asset-006238`
...
- source class: `HUST-OBC/undeciphered/X/201/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/201/X_？_8374_1.png`
- asset id: `asset-006238`
...
- English observation: `compact vertical form with three pale openings`
- 中文观察: `带三个浅色开口的紧凑竖向形体`
...
- Which source records identify obs-unk-004645 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004645？
