# obs-unk-003962 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/062_obs-unk-003962_h
  ust-obc-und-L-003962_oracle-character-candidate/03_visual-assets/001_asset
  -005555_hust-obc-und-L-003962_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3962/L_？_8361.jpg`
- asset id: `asset-005555`
...
- source class: `HUST-OBC/undeciphered/L/3962/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3962/L_？_8361.jpg`
- asset id: `asset-005555`
...
- English observation: A separate left curve sits beside a compact cluster of
  crossing angular strokes and a short lower fork.
- 中文观察：分开的左侧弧痕邻近紧凑痕迹组，组内有交叉折线和下方短分叉。
...
- Which source records identify obs-unk-003962 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003962？
