...
Project ID: `obs-evo-cand-009592`
...
- Project ID: `obs-evo-cand-009592`
- EVOBC category candidate ID: `evobc-evo-cat-09592`
- External category reference: `evobc-cat-09592`
- Source category ID: `09592`
- Source label for human review: `锉`
- Source codepoints: `U+9509`
...
- `obs-evo-cand-009592-route-category-staging`
...
- `obs-evo-cand-009592-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009592-route-evolution-graph`
