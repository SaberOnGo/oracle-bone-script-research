...
- External category reference: `evobc-cat-04093`
- Source category ID: `04093`
- Source label for human review: `棓`
...
- `obs-evo-cand-004093-route-category-staging`
...
- `obs-evo-cand-004093-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004093-route-evolution-graph`
