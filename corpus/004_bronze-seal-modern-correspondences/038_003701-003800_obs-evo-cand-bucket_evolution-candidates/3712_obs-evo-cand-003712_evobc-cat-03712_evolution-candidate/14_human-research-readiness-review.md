# Human Research Readiness Review / 正式研究准备复核: obs-evo-cand-003712
...
- Source label for lookup only: `易`.
- Source codepoints for lookup only: `U+6613`.
- Era/source code rows to open: `14`.
