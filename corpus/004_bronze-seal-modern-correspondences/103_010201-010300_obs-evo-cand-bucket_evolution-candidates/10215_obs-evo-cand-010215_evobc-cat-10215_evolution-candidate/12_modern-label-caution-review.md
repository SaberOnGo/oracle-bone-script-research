# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010215
...
- EVOBC candidate category: `evobc-evo-cat-10215`.
- Source label for search only: `騍`.
- Source codepoints for search only: `U+9A0D`.
