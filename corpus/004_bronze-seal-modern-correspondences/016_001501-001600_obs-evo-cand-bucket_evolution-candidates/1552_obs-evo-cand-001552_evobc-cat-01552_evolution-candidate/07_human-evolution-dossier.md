...
- Project ID: `obs-evo-cand-001552`
- EVOBC category candidate ID: `evobc-evo-cat-01552`
- External category reference: `evobc-cat-01552`
- Source category ID: `01552`
- Source label for human review: `咄`
- Source codepoints: `U+5484`
...
- `obs-evo-cand-001552-route-category-staging`
...
- `obs-evo-cand-001552-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001552-route-evolution-graph`
