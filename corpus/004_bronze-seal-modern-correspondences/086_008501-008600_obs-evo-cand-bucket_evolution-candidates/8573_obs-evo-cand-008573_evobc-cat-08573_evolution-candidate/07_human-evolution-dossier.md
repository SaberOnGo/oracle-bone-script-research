...
- External category reference: `evobc-cat-08573`
- Source category ID: `08573`
- Source label for human review: `賒`
...
- `obs-evo-cand-008573-route-category-staging`
...
- `obs-evo-cand-008573-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008573-route-evolution-graph`
