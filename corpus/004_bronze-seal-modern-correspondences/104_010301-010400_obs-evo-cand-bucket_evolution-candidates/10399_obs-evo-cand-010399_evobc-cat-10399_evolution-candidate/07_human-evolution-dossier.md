...
- Project ID: `obs-evo-cand-010399`
- EVOBC category candidate ID: `evobc-evo-cat-10399`
- External category reference: `evobc-cat-10399`
- Source category ID: `10399`
- Source label for human review: `鮨`
- Source codepoints: `U+9BA8`
...
- `obs-evo-cand-010399-route-category-staging`
...
- `obs-evo-cand-010399-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010399-route-evolution-graph`
