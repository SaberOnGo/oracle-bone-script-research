...
Project ID: `obs-evo-cand-002814`
...
- Project ID: `obs-evo-cand-002814`
- EVOBC category candidate ID: `evobc-evo-cat-02814`
- External category reference: `evobc-cat-02814`
- Source category ID: `02814`
- Source label for human review: `張`
- Source codepoints: `U+5F35`
- Image reference count in source metadata: `36`
...
- `obs-evo-cand-002814-route-category-staging`
...
- `obs-evo-cand-002814-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002814-route-evolution-graph`
