...
Project ID: `obs-evo-cand-008351`
...
- Project ID: `obs-evo-cand-008351`
- EVOBC category candidate ID: `evobc-evo-cat-08351`
- External category reference: `evobc-cat-08351`
- Source category ID: `08351`
- Source label for human review: `譋`
- Source codepoints: `U+8B4B`
...
- `obs-evo-cand-008351-route-category-staging`
...
- `obs-evo-cand-008351-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008351-route-evolution-graph`
