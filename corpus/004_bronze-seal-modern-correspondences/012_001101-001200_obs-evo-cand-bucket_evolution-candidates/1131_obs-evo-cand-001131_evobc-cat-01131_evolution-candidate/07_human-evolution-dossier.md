...
- External category reference: `evobc-cat-01131`
- Source category ID: `01131`
- Source label for human review: `冣`
- Source codepoints: `U+51A3`
...
- `obs-evo-cand-001131-route-category-staging`
...
- `obs-evo-cand-001131-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001131-route-evolution-graph`
