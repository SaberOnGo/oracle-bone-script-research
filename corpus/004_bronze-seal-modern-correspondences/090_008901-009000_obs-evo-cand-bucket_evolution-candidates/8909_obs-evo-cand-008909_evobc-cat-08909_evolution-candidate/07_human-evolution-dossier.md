...
- External category reference: `evobc-cat-08909`
- Source category ID: `08909`
- Source label for human review: `辞`
...
- `obs-evo-cand-008909-route-category-staging`
...
- `obs-evo-cand-008909-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008909-route-evolution-graph`
