...
- Project ID: `obs-evo-cand-004631`
- EVOBC category candidate ID: `evobc-evo-cat-04631`
- External category reference: `evobc-cat-04631`
- Source category ID: `04631`
- Source label for human review: `洧`
- Source codepoints: `U+6D27`
...
- `obs-evo-cand-004631-route-category-staging`
...
- `obs-evo-cand-004631-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004631-route-evolution-graph`
