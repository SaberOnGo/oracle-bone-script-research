...
- `obs-evo-cand-009062-route-category-staging`
...
- `obs-evo-cand-009062-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009062-route-evolution-graph`
