...
- External category reference: `evobc-cat-07665`
- Source category ID: `07665`
- Source label for human review: `蘊`
...
- `obs-evo-cand-007665-route-category-staging`
...
- `obs-evo-cand-007665-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007665-route-evolution-graph`
