...
- External category reference: `evobc-cat-02262`
- Source category ID: `02262`
- Source label for human review: `嫍`
- Source codepoints: `U+5ACD`
...
- `obs-evo-cand-002262-route-category-staging`
...
- `obs-evo-cand-002262-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002262-route-evolution-graph`
