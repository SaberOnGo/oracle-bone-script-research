...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0770`
...
- Source image / 来源图: `X_0770_3239_1.png`
- Image / 图像: `001_asset-000684_hust-obc-cat-0770_glyph.png`
...
- target node: `evobc-evo-cat-00058`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/058_obs-evo-cand-000058_evobc-cat-00058_evoluti
...
- Source label text / 来源标签文字: `㛸`
- Source label codepoint / 来源标签 codepoint: `U+36F8`
