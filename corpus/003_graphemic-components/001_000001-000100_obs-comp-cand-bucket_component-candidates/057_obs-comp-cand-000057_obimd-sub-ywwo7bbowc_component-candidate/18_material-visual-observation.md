# Material Visual Observation / obs-comp-cand-000057 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000057`
- External reference / 外部参照: `obimd-sub-ywwo7bbowc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011470_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vk0iw3x90b/ywwo7bbowc/ywwo7bbowc.png`
- Checksum / 校验和:
  `5a635f011ed0a62baa3dcda80020037748e589fdd5d82055a4938c2a9deec95a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.19%.
- Marked-pixel bounds: (54,65)–(194,189); span 141 × 125 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.19%。
- 痕迹范围：(54,65)–(194,189)；跨度141 × 125 px；痕迹矩形近方形。
