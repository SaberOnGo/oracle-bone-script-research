# obs-char-000131 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/131_obs-char-000131_hust-obc-cat-0145_0146
  _oracle-character/03_visual-assets/001_asset-000136_hust-obc-cat-0145_0146
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0145_0146/0145/G_0145_前6.12.4合1
  7939賓組.png`
- asset id: `asset-000136`
...
- source category: `0145_0146`
- validation class: `130`
- source image route: `HUST-OBC/deciphered/0145_0146/0145/G_0145_前6.12.4合17939
  賓組.png`
- asset id: `asset-000136`
...
- English observation: `The narrow image has a small angular upper junction,
  a long descending stroke on the right, and a broken curved stroke along
  the left edge.`
- 中文观察: `狭长图像上方有小型折角交接处，右侧有长下行笔，左缘有断续弯曲笔。`
...
- dataset label text: `㒇㒈`
- dataset label codepoints: `U+3487;U+3488`
...
- filename catalog route clues: `Heji-like filename clue: 合17939
...
- Which source records identify obs-char-000131 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000131？
