...
|---|---|---|
| Source Codepoint Route | `U+376A` | not identity |
| HUST candidate route | `hust-obc-cat-0884` | not reading |
| OBIMD route | `obimd-main-cand-003071` | not component |
| EVOBC route | `evobc-evo-cat-00074` | not evolution |
