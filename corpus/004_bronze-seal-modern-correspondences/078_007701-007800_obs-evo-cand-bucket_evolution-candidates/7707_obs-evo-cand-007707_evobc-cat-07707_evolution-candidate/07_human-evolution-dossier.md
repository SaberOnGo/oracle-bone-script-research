...
- External category reference: `evobc-cat-07707`
- Source category ID: `07707`
- Source label for human review: `虡`
- Source codepoints: `U+8661`
...
- `obs-evo-cand-007707-route-category-staging`
...
- `obs-evo-cand-007707-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007707-route-evolution-graph`
