# Material Visual Observation / obs-comp-cand-000980 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000980`
- External reference / 外部参照: `obimd-sub-bg8bhr1896`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014262_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bg8bhr1896/bg8bhr1896/bg8bhr1896.png`
- Checksum / 校验和:
  `bb3d7cb05221f1be084370687e720f266fac9dd864518114aba430d631558353`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.35%.
- Marked-pixel bounds: (60,38)–(186,217); span 127 × 180 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.35%。
- 痕迹范围：(60,38)–(186,217)；跨度127 × 180 px；痕迹矩形高于宽。
