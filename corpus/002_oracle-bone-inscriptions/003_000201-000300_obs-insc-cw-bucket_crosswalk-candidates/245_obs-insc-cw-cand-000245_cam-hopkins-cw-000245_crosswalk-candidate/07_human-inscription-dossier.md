...
- Yingguo / 英国所藏: `y1591` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `172` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `619` in source row; primary catalog entry pending
