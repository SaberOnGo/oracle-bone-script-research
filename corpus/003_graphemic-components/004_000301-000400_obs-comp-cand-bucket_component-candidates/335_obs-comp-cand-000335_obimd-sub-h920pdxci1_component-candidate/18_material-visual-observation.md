# Material Visual Observation / obs-comp-cand-000335 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000335`
- External reference / 外部参照: `obimd-sub-h920pdxci1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012259_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/h920pdxci1/h920pdxci1/h920pdxci1.png`
- Checksum / 校验和:
  `ad5c86b3ee84e64fbc8a93cf3d0c2004c48822d79872f894443de18975147213`
...
- Marked-pixel bounds: (76,25)–(164,237); span 89 × 213 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.44%。
- 痕迹范围：(76,25)–(164,237)；跨度89 × 213 px；痕迹矩形高于宽。
