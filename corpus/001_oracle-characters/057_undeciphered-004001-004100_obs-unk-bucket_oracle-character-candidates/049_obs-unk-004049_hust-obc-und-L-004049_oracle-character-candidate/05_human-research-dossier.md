# obs-unk-004049 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/049_obs-unk-004049_h
  ust-obc-und-L-004049_oracle-character-candidate/03_visual-assets/001_asset
  -005642_hust-obc-und-L-004049_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4049/L_？_8659.jpg`
- asset id: `asset-005642`
...
- source class: `HUST-OBC/undeciphered/L/4049/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4049/L_？_8659.jpg`
- asset id: `asset-005642`
...
- English observation: A narrow branching trace rises on the left. A thicker
  block-like trace occupies the right and contains several short horizontal
  marks. The lower connection between the two areas is partly obscured.
...
- Which source records identify obs-unk-004049 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004049？
