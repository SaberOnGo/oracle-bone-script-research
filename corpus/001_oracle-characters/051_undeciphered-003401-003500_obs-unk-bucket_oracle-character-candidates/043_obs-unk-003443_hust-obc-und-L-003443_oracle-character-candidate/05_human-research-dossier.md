# obs-unk-003443 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003443`
- primary external id: `hust-obc-und-L-003443`
...
- local review image route: `corpus/001_oracle-characters/051_undeciphered-003
  401-003500_obs-unk-bucket_oracle-character-candidates/043_obs-unk-003443_h
  ust-obc-und-L-003443_oracle-character-candidate/03_visual-assets/001_asset
  -005036_hust-obc-und-L-003443_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3443/L_？_6631.jpg`
- asset id: `asset-005036`
...
- source class: `HUST-OBC/undeciphered/L/3443/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3443/L_？_6631.jpg`
- asset id: `asset-005036`
...
- Which source records identify obs-unk-003443 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003443？
