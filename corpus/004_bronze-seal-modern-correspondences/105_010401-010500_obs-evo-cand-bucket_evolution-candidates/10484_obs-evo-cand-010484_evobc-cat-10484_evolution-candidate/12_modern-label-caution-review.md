# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010484
...
- EVOBC candidate category: `evobc-evo-cat-10484`.
- Source label for search only: `鴋`.
- Source codepoints for search only: `U+9D0B`.
