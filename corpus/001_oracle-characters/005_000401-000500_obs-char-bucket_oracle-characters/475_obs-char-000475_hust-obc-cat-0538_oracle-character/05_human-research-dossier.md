# obs-char-000475 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000475`
- primary external id: `hust-obc-cat-0538`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/475_obs-char-000475_hust-obc-cat-0538_orac
  le-character/03_visual-assets/001_asset-000480_hust-obc-cat-0538_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0538/G_0538_乙4699合13555賓組.png`
- asset id: `asset-000480`
...
- source category: `0538`
- validation class: `474`
- source image route: `HUST-OBC/deciphered/0538/G_0538_乙4699合13555賓組.png`
- asset id: `asset-000480`
...
- English observation: `The low-contrast image shows a pointed outer
  outline, an upper internal crossing, a sinuous central vertical stroke,
  and a detached horizontal base below.`
- 中文观察: `低对比度图像显示尖顶外轮廓、上部内部交叉、曲折中央竖笔和下方分离横底线。`
...
- dataset label text: `㘐`
- dataset label codepoints: `U+3610`
...
- filename catalog route clues: `Heji-like filename clue: 合13555
  (G_0538_乙4699合13555賓組.png)`
...
- Which source records identify obs-char-000475 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000475？
