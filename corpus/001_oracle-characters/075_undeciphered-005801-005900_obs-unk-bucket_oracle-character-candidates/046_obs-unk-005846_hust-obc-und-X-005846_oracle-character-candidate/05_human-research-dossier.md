# obs-unk-005846 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/046_obs-unk-005846_h
  ust-obc-und-X-005846_oracle-character-candidate/03_visual-assets/001_asset
  -007438_hust-obc-und-X-005846_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1402/X_？_2049_1.png`
- asset id: `asset-007438`
...
- source class: `HUST-OBC/undeciphered/X/1402/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1402/X_？_2049_1.png`
- asset id: `asset-007438`
...
- Which source records identify obs-unk-005846 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005846？
