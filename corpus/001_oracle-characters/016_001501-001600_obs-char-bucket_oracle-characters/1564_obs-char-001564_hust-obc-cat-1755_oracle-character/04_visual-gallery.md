# obs-char-001564 Visual Gallery / obs-char-001564 图像资料页
...
- Primary external reference / 首选外部参考: `hust-obc-cat-1755`
...
## obs-char-001564-visual-source-001 / 图像条目

![obs-char-001564 glyph candidate](03_visual-assets/001_asset-001569_hust-obc-cat-1755_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-001569_hust-obc-cat-1755_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-001569_hust-obc-cat-1755_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/1755/G_1755_續3.458(甲).png`
