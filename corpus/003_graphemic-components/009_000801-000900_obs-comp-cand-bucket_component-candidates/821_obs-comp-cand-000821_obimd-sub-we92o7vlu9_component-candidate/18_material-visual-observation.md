# Material Visual Observation / obs-comp-cand-000821 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000821`
- External reference / 外部参照: `obimd-sub-we92o7vlu9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013692_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/we92o7vlu9/we92o7vlu9/we92o7vlu9.png`
- Checksum / 校验和:
  `ab8aa590224b3272c37946064b48a6c16dd8a6b62498fbf5600f0ebecf6099ee`
...
- Marked-pixel bounds: (65,22)–(181,227); span 117 × 206 px; the marked
...
- 痕迹范围：(65,22)–(181,227)；跨度117 × 206 px；痕迹矩形高于宽。
