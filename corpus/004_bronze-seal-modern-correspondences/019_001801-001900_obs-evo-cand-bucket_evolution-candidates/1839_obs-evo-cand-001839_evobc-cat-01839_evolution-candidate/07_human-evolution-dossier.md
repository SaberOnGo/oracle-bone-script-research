...
- External category reference: `evobc-cat-01839`
- Source category ID: `01839`
- Source label for human review: `坻`
...
- `obs-evo-cand-001839-route-category-staging`
...
- `obs-evo-cand-001839-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001839-route-evolution-graph`
