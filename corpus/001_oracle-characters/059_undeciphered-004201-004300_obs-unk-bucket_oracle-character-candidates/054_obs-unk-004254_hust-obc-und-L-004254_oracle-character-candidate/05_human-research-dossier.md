# obs-unk-004254 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004254`
- primary external id: `hust-obc-und-L-004254`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/054_obs-unk-004254_h
  ust-obc-und-L-004254_oracle-character-candidate/03_visual-assets/001_asset
  -005847_hust-obc-und-L-004254_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4254/L_？_9372.jpg`
- asset id: `asset-005847`
...
- source class: `HUST-OBC/undeciphered/L/4254/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4254/L_？_9372.jpg`
- asset id: `asset-005847`
...
- English observation: `Tall left, open cluster, right hook visible.`
- 中文观察: `左侧高痕迹、中部开口痕迹簇和右侧钩状末端可见。`
...
- Which source records identify obs-unk-004254 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004254？
