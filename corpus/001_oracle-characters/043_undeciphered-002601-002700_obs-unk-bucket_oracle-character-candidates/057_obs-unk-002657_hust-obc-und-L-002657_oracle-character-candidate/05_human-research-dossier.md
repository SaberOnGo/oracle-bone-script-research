# obs-unk-002657 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002657`
- primary external id: `hust-obc-und-L-002657`
...
- local review image route: `corpus/001_oracle-characters/043_undeciphered-002
  601-002700_obs-unk-bucket_oracle-character-candidates/057_obs-unk-002657_h
  ust-obc-und-L-002657_oracle-character-candidate/03_visual-assets/001_asset
  -004250_hust-obc-und-L-002657_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2657/L_？_4143.jpg`
- asset id: `asset-004250`
...
- source class: `HUST-OBC/undeciphered/L/2657/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2657/L_？_4143.jpg`
- asset id: `asset-004250`
...
- Which source records identify obs-unk-002657 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002657？
