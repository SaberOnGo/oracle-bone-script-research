# obs-unk-004139 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004139`
- primary external id: `hust-obc-und-L-004139`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/039_obs-unk-004139_h
  ust-obc-und-L-004139_oracle-character-candidate/03_visual-assets/001_asset
  -005732_hust-obc-und-L-004139_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4139/L_？_8947.jpg`
- asset id: `asset-005732`
...
- source class: `HUST-OBC/undeciphered/L/4139/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4139/L_？_8947.jpg`
- asset id: `asset-005732`
...
- English observation: A small isolated mark sits upper left of a narrow
  descending trace with short side marks.
- 中文观察：小孤立痕迹位于带短侧痕的窄下行痕迹左上方。
...
- Which source records identify obs-unk-004139 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004139？
