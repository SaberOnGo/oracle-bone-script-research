...
- External category reference: `evobc-cat-11968`
- Source category ID: `11968`
- Source label for human review: `𦄓`
...
- `obs-evo-cand-011968-route-category-staging`
...
- `obs-evo-cand-011968-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011968-route-evolution-graph`
