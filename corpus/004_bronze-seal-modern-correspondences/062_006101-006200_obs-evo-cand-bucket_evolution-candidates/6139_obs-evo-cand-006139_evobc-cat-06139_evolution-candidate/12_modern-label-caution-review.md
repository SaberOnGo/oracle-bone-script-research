# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006139
...
- EVOBC candidate category: `evobc-evo-cat-06139`.
- Source label for search only: `穫`.
- Source codepoints for search only: `U+7A6B`.
