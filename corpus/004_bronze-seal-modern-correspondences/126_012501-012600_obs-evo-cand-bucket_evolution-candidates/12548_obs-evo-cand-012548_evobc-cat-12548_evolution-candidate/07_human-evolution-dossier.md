...
- Project ID: `obs-evo-cand-012548`
- EVOBC category candidate ID: `evobc-evo-cat-12548`
- External category reference: `evobc-cat-12548`
- Source category ID: `12548`
- Source label for human review: `𩁹`
- Source codepoints: `U+29079`
- Image reference count in source metadata: `41`
...
- `obs-evo-cand-012548-route-category-staging`
...
- `obs-evo-cand-012548-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012548-route-evolution-graph`
