...
- External category reference: `evobc-cat-07347`
- Source category ID: `07347`
- Source label for human review: `荍`
...
- `obs-evo-cand-007347-route-category-staging`
...
- `obs-evo-cand-007347-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007347-route-evolution-graph`
