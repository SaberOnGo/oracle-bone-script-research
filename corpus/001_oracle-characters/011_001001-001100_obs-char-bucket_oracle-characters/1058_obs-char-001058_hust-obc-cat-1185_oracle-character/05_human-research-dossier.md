# obs-char-001058 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001058`
- primary external id: `hust-obc-cat-1185`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1058_obs-char-001058_hust-obc-cat-1185_ora
  cle-character/03_visual-assets/001_asset-001063_hust-obc-cat-1185_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1185/H_1185_60A1D_0.png`
- asset id: `asset-001063`
...
- source category: `1185`
- validation class: `1057`
- source image route: `HUST-OBC/deciphered/1185/H_1185_60A1D_0.png`
- asset id: `asset-001063`
...
- dataset label text: `㢗`
- dataset label codepoints: `U+3897`
...
- filename catalog route clues: `catalog-like filename clue: H_1185
  (H_1185_60A1D_0.png)`
...
- Which source records identify obs-char-001058 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001058？
