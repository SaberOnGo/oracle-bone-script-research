...
- External category reference: `evobc-cat-13698`
- Source category ID: `13698`
- Source label for human review: `𮮵`
- Source codepoints: `U+2EBB5`
...
- `obs-evo-cand-013698-route-category-staging`
...
- `obs-evo-cand-013698-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013698-route-evolution-graph`
