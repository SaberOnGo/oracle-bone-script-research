...
- External category reference: `evobc-cat-11724`
- Source category ID: `11724`
- Source label for human review: `𤺊`
- Source codepoints: `U+24E8A`
...
- `obs-evo-cand-011724-route-category-staging`
...
- `obs-evo-cand-011724-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011724-route-evolution-graph`
