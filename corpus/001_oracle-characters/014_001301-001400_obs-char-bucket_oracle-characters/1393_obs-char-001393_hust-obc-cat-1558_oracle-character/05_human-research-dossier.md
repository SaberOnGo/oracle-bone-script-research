# obs-char-001393 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001393`
- primary external id: `hust-obc-cat-1558`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1393_obs-char-001393_hust-obc-cat-1558_ora
  cle-character/03_visual-assets/001_asset-001398_hust-obc-cat-1558_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1558/G_1558_乙1088合125賓組.png`
- asset id: `asset-001398`
...
- source category: `1558`
- validation class: `1392`
- source image route: `HUST-OBC/deciphered/1558/G_1558_乙1088合125賓組.png`
- asset id: `asset-001398`
...
- English observation: `An angular upper crossing leads to curved legs
  beside a small lower enclosure.`
- 中文观察: `角状上部交叉笔连接弧形下行笔，旁有小型下部框形。`
...
- dataset label text: `㨌`
- dataset label codepoints: `U+3A0C`
...
- filename catalog route clues: `Heji-like filename clue: 合125
  (G_1558_乙1088合125賓組.png)`
...
- Which source records identify obs-char-001393 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001393？
