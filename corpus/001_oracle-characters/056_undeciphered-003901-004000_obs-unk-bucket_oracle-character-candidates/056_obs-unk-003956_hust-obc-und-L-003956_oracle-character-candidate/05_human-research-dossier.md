# obs-unk-003956 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003956`
- primary external id: `hust-obc-und-L-003956`
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/056_obs-unk-003956_h
  ust-obc-und-L-003956_oracle-character-candidate/03_visual-assets/001_asset
  -005549_hust-obc-und-L-003956_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3956/L_？_8342.jpg`
- asset id: `asset-005549`
...
- source class: `HUST-OBC/undeciphered/L/3956/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3956/L_？_8342.jpg`
- asset id: `asset-005549`
...
- English observation: Several sharp upper angles sit above a descending trace;
  a broad lower bar crosses the form with a shorter angled mark below.
- 中文观察：数个尖锐上部折角位于下行痕迹之上，下部横痕穿过形体，下面另有
  较短斜痕。
...
- Which source records identify obs-unk-003956 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003956？
