...
- External category reference: `evobc-cat-02565`
- Source category ID: `02565`
- Source label for human review: `崖`
- Source codepoints: `U+5D16`
...
- `obs-evo-cand-002565-route-category-staging`
...
- `obs-evo-cand-002565-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002565-route-evolution-graph`
