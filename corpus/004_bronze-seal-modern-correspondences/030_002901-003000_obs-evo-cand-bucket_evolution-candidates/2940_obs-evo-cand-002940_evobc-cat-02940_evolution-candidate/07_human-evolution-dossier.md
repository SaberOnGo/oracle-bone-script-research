...
- External category reference: `evobc-cat-02940`
- Source category ID: `02940`
- Source label for human review: `怜`
- Source codepoints: `U+601C`
...
- `obs-evo-cand-002940-route-category-staging`
...
- `obs-evo-cand-002940-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002940-route-evolution-graph`
