...
- External category reference: `evobc-cat-00492`
- Source category ID: `00492`
- Source label: `䣊`
...
- `obs-evo-cand-000492-route-category-staging`
...
- `obs-evo-cand-000492-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000492-route-evolution-graph`
