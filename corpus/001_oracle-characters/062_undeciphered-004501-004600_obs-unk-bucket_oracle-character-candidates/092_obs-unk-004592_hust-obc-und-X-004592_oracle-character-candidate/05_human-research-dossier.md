# obs-unk-004592 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004592`
- primary external id: `hust-obc-und-X-004592`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/092_obs-unk-004592_h
  ust-obc-und-X-004592_oracle-character-candidate/03_visual-assets/001_asset
  -006185_hust-obc-und-X-004592_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/148/X_？_8325_1.png`
- asset id: `asset-006185`
...
- source class: `HUST-OBC/undeciphered/X/148/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/148/X_？_8325_1.png`
- asset id: `asset-006185`
...
- English observation: `High-contrast crop and unstable glyph boundary`
  `recorded.`
- 中文观察: `已记录高对比裁切和不稳定的字形边界。`
...
- Which source records identify obs-unk-004592 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004592？
