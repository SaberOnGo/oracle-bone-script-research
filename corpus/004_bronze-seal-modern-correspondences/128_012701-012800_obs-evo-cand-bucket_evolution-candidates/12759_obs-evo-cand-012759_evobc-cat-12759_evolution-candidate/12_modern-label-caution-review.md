# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012759
...
- EVOBC candidate category: `evobc-evo-cat-12759`.
- Source label for search only: `𪒏`.
- Source codepoints for search only: `U+2A48F`.
