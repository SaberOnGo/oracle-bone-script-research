...
- External category reference: `evobc-cat-07610`
- Source category ID: `07610`
- Source label for human review: `薕`
- Source codepoints: `U+8595`
...
- `obs-evo-cand-007610-route-category-staging`
...
- `obs-evo-cand-007610-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007610-route-evolution-graph`
