...
|---|---|---|
| Source Codepoint Route | `U+3831` | not identity |
| HUST candidate route | `hust-obc-cat-1083` | not reading |
| OBIMD route | `obimd-main-cand-002775` | not component |
| EVOBC route | `evobc-evo-cat-00090` | not evolution |
