...
- Project ID: `obs-evo-cand-005802`
- EVOBC category candidate ID: `evobc-evo-cat-05802`
- External category reference: `evobc-cat-05802`
- Source category ID: `05802`
- Source label for human review: `眢`
- Source codepoints: `U+7722`
...
- `obs-evo-cand-005802-route-category-staging`
...
- `obs-evo-cand-005802-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005802-route-evolution-graph`
