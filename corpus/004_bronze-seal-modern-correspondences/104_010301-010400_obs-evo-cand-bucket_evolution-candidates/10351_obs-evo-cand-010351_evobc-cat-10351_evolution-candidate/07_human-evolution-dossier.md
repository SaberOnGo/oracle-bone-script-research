...
Project ID: `obs-evo-cand-010351`
...
- Project ID: `obs-evo-cand-010351`
- EVOBC category candidate ID: `evobc-evo-cat-10351`
- External category reference: `evobc-cat-10351`
- Source category ID: `10351`
- Source label for human review: `鬷`
- Source codepoints: `U+9B37`
...
- `obs-evo-cand-010351-route-category-staging`
...
- `obs-evo-cand-010351-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010351-route-evolution-graph`
