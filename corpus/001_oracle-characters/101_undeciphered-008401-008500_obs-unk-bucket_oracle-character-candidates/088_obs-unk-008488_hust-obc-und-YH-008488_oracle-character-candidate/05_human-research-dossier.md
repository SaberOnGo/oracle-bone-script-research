# obs-unk-008488 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008488`
- primary external id: `hust-obc-und-YH-008488`
...
- local review image route: `corpus/001_oracle-characters/101_undeciphered-008
  401-008500_obs-unk-bucket_oracle-character-candidates/088_obs-unk-008488_h
  ust-obc-und-YH-008488_oracle-character-candidate/03_visual-assets/001_asse
  t-010079_hust-obc-und-YH-008488_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60B78/Y_？_60B78.jpg`
- asset id: `asset-010079`
...
- source class: `HUST-OBC/undeciphered/Y+H/60B78/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60B78/Y_？_60B78.jpg`
- asset id: `asset-010079`
...
- Which source records identify obs-unk-008488 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008488？
