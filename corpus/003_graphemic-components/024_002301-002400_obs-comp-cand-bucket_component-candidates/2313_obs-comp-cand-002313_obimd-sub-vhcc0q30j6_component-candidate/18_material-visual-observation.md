# Material Visual Observation / obs-comp-cand-002313 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002313`
- External reference / 外部参照: `obimd-sub-vhcc0q30j6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020332_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gy2dprpjxa/vhcc0q30j6/vhcc0q30j6.png`
- Checksum / 校验和:
  `c6bd285410da1b3e102aa0631068a7f26034fb37d89bf184c939b93eaf381782`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.27%.
- Marked-pixel bounds: (92,20)–(157,229); span 66 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.27%。
- 痕迹范围：(92,20)–(157,229)；跨度66 × 210 px；痕迹矩形高于宽。
