# Material Visual Observation / obs-comp-cand-001140 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001140`
- External reference / 外部参照: `obimd-sub-jn8qw1nhns`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015094_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jn8qw1nhns/jn8qw1nhns/jn8qw1nhns.png`
- Checksum / 校验和:
  `66250ec2aae75a82eb253e6829c33ebf1e97985fc6b30bc6d3f8f8f04dd1e826`
...
- Marked-pixel bounds: (82,57)–(166,196); span 85 × 140 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.18%。
- 痕迹范围：(82,57)–(166,196)；跨度85 × 140 px；痕迹矩形高于宽。
