# obs-char-001005 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1005_obs-char-001005_hust-obc-cat-1129_ora
  cle-character/03_visual-assets/001_asset-001010_hust-obc-cat-1129_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1129/G_1129_乙4810.png`
- asset id: `asset-001010`
...
- source category: `1129`
- validation class: `1004`
- source image route: `HUST-OBC/deciphered/1129/G_1129_乙4810.png`
- asset id: `asset-001010`
...
- English observation: `A rounded U-shaped enclosure contains several
  separated short interior marks and opens into two long lower branches.`
- 中文观察: `圆弧 U 形闭合轮廓内有数条分离短笔，并向下分为两条长分枝。`
...
- dataset label text: `㡟`
- dataset label codepoints: `U+385F`
...
- Which source records identify obs-char-001005 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001005？
