# Material Visual Observation / obs-comp-cand-001102 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001102`
- External reference / 外部参照: `obimd-sub-cj0x5c4cfa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015026_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xlscyddubk/cj0x5c4cfa/cj0x5c4cfa.png`
- Checksum / 校验和:
  `205577a434679a77ab47028bde6012687947fb18a444b2b281ce55be2de7a7f7`
...
- Marked-pixel bounds: (83,38)–(166,211); span 84 × 174 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.27%。
- 痕迹范围：(83,38)–(166,211)；跨度84 × 174 px；痕迹矩形高于宽。
