...
- External category reference: `evobc-cat-11833`
- Source category ID: `11833`
- Source label: `𥝩`
...
- `obs-evo-cand-011833-route-category-staging`
...
- `obs-evo-cand-011833-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-011833-route-evolution-graph`
