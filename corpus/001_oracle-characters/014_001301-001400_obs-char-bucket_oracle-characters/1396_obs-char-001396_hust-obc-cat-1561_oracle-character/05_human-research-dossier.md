# obs-char-001396 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001396`
- primary external id: `hust-obc-cat-1561`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1396_obs-char-001396_hust-obc-cat-1561_ora
  cle-character/03_visual-assets/001_asset-001401_hust-obc-cat-1561_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1561/G_1561_乙7285合14542.png`
- asset id: `asset-001401`
...
- source category: `1561`
- validation class: `1395`
- source image route: `HUST-OBC/deciphered/1561/G_1561_乙7285合14542.png`
- asset id: `asset-001401`
...
- English observation: `Two short upper bars stand above several separated
  straight lower strokes.`
- 中文观察: `两个短上部横笔位于数条分离直下笔之上。`
...
- dataset label text: `㨏`
- dataset label codepoints: `U+3A0F`
...
- filename catalog route clues: `Heji-like filename clue: 合14542
  (G_1561_乙7285合14542.png)`
...
- Which source records identify obs-char-001396 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001396？
