# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002546
...
| --- | --- | --- | --- |
| `obimd-glyph-link-038953` | 󾚼 | `U+FE6BC` | `reviewed_metadata_only` |
| `obimd-glyph-link-038954` | 󾚽 | `U+FE6BD` | `reviewed_metadata_only` |
