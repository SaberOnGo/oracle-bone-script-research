...
Project ID: `obs-evo-cand-005823`
...
- Project ID: `obs-evo-cand-005823`
- EVOBC category candidate ID: `evobc-evo-cat-05823`
- External category reference: `evobc-cat-05823`
- Source category ID: `05823`
- Source label for human review: `睎`
- Source codepoints: `U+774E`
...
- `obs-evo-cand-005823-route-category-staging`
...
- `obs-evo-cand-005823-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005823-route-evolution-graph`
