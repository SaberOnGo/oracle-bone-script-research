# obs-unk-005004 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/004_obs-unk-005004_h
  ust-obc-und-X-005004_oracle-character-candidate/03_visual-assets/001_asset
  -006597_hust-obc-und-X-005004_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/560/X_？_7135_1.png`
- asset id: `asset-006597`
...
- source class: `HUST-OBC/undeciphered/X/560/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/560/X_？_7135_1.png`
- asset id: `asset-006597`
...
- Which source records identify obs-unk-005004 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005004？
