...
- `obs-evo-cand-011236-route-category-staging`
...
- `obs-evo-cand-011236-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-011236-route-evolution-graph`
