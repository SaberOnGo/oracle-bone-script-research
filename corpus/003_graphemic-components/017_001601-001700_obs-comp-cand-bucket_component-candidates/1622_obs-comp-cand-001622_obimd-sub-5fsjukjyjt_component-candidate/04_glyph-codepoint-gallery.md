# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001622
...
| --- | --- | --- | --- |
| `obimd-glyph-link-025173` | 亳󹛹 | `U+4EB3;U+F96F9` | `reviewed_metadata_only` |
| `obimd-glyph-link-025174` | 󹛺 | `U+F96FA` | `reviewed_metadata_only` |
| `obimd-glyph-link-025175` | 󹛻 | `U+F96FB` | `reviewed_metadata_only` |
| `obimd-glyph-link-025176` | 󹛼 | `U+F96FC` | `reviewed_metadata_only` |
