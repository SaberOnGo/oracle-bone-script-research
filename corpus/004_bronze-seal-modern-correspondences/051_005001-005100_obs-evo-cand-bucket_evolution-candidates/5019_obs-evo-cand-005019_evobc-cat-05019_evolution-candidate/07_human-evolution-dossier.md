...
Project ID: `obs-evo-cand-005019`
...
- Project ID: `obs-evo-cand-005019`
- EVOBC category candidate ID: `evobc-evo-cat-05019`
- External category reference: `evobc-cat-05019`
- Source category ID: `05019`
- Source label for human review: `灘`
- Source codepoints: `U+7058`
...
- `obs-evo-cand-005019-route-category-staging`
...
- `obs-evo-cand-005019-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005019-route-evolution-graph`
