...
- Yingguo / 英国所藏: `y1167` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `176` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `598` in source row; primary catalog entry pending
