# Material Visual Observation / obs-comp-cand-002206 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002206`
- External reference / 外部参照: `obimd-sub-tq26tb9tj9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019990_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tq26tb9tj9/tq26tb9tj9/tq26tb9tj9.png`
- Checksum / 校验和:
  `7e0c42e8f3911db06d90545af547ebdea61347a41a516b346988c987a760ee27`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.95%.
- Marked-pixel bounds: (55,44)–(199,211); span 145 × 168 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.95%。
- 痕迹范围：(55,44)–(199,211)；跨度145 × 168 px；痕迹矩形近方形。
