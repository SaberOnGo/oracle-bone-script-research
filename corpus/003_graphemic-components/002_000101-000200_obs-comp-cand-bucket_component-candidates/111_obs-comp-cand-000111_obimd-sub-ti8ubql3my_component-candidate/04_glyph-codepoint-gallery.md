# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000111
...
| --- | --- | --- | --- |
| `obimd-glyph-link-001668` | 󰩩 | `U+F0A69` | `reviewed_metadata_only` |
| `obimd-glyph-link-001669` | 󰩪 | `U+F0A6A` | `reviewed_metadata_only` |
