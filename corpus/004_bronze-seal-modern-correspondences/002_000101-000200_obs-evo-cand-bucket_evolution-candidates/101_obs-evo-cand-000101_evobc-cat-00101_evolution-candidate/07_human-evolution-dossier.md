...
- Project ID: `obs-evo-cand-000101`
- EVOBC category candidate ID: `evobc-evo-cat-00101`
- External category reference: `evobc-cat-00101`
- Source category ID: `00101`
- Source label for human review: `㢵`
- Source codepoints: `U+38B5`
...
- `obs-evo-cand-000101-route-category-staging`
...
- `obs-evo-cand-000101-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000101-route-evolution-graph`
