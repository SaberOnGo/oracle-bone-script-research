...
Project ID: `obs-evo-cand-009335`
...
- Project ID: `obs-evo-cand-009335`
- EVOBC category candidate ID: `evobc-evo-cat-09335`
- External category reference: `evobc-cat-09335`
- Source category ID: `09335`
- Source label for human review: `鈒`
- Source codepoints: `U+9212`
...
- `obs-evo-cand-009335-route-category-staging`
...
- `obs-evo-cand-009335-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009335-route-evolution-graph`
