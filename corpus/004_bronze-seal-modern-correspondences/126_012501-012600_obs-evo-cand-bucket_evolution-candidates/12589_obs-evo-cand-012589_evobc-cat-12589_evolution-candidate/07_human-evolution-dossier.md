...
- External category reference: `evobc-cat-12589`
- Source category ID: `12589`
- Source label for human review: `𩎘`
...
- `obs-evo-cand-012589-route-category-staging`
...
- `obs-evo-cand-012589-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012589-route-evolution-graph`
