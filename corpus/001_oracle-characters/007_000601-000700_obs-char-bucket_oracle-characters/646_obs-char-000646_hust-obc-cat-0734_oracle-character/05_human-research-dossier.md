# obs-char-000646 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/646_obs-char-000646_hust-obc-cat-0734_orac
  le-character/03_visual-assets/001_asset-000651_hust-obc-cat-0734_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0734/X_0734_5464_1.png`
- asset id: `asset-000651`
...
- source category: `0734`
- validation class: `645`
- source image route: `HUST-OBC/deciphered/0734/X_0734_5464_1.png`
- asset id: `asset-000651`
...
- English observation: `A thick left upright curves across the top and sends
  a diagonal inward branch toward a rounded open loop at right, with a short
...
- dataset label text: `㛔`
- dataset label codepoints: `U+36D4`
...
- Which source records identify obs-char-000646 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000646？
