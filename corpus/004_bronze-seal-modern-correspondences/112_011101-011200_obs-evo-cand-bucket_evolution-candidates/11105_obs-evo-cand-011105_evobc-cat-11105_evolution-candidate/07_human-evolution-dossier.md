...
- Project ID: `obs-evo-cand-011105`
- EVOBC category candidate ID: `evobc-evo-cat-11105`
- External category reference: `evobc-cat-11105`
- Source category ID: `11105`
- Source label for human review: `𡴆`
- Source codepoints: `U+21D06`
...
- `obs-evo-cand-011105-route-category-staging`
...
- `obs-evo-cand-011105-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011105-route-evolution-graph`
