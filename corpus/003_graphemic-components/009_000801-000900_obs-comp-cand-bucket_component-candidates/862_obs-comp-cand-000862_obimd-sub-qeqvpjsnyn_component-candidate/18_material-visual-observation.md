# Material Visual Observation / obs-comp-cand-000862 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000862`
- External reference / 外部参照: `obimd-sub-qeqvpjsnyn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013859_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qeqvpjsnyn/qeqvpjsnyn/qeqvpjsnyn.png`
- Checksum / 校验和:
  `6cad2167435c9252b4e409bcb17e4a8c58146a81c40126ea60c36b269449c065`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.79%.
- Marked-pixel bounds: (94,28)–(166,224); span 73 × 197 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.79%。
- 痕迹范围：(94,28)–(166,224)；跨度73 × 197 px；痕迹矩形高于宽。
