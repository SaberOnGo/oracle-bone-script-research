# Material Visual Observation / obs-comp-cand-000156 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000156`
- External reference / 外部参照: `obimd-sub-gfyngwaipo`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011568_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gfyngwaipo/gfyngwaipo/gfyngwaipo.png`
- Checksum / 校验和:
  `76faf6602ef79c807c1865a0218e957d759b72a2fa9d11189e442f9e75fc2e03`
...
- Marked-pixel bounds: (74,31)–(175,220); span 102 × 190 px; the marked
...
- 痕迹范围：(74,31)–(175,220)；跨度102 × 190 px；痕迹矩形高于宽。
