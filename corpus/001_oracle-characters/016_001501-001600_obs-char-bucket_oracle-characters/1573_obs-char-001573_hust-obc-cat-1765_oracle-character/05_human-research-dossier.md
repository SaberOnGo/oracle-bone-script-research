# obs-char-001573 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1573_obs-char-001573_hust-obc-cat-1765_ora
  cle-character/03_visual-assets/001_asset-001578_hust-obc-cat-1765_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1765/G_1765_佚292(甲).png`
- asset id: `asset-001578`
...
- source category: `1765`
- validation class: `1572`
- source image route: `HUST-OBC/deciphered/1765/G_1765_佚292(甲).png`
- asset id: `asset-001578`
...
- English observation: `Two adjacent forms show a dense branching left
  contour and a separate narrow right stroke.`
- 中文观察: `两个相邻形体左侧有密集分枝轮廓，右侧有分离的狭长笔画。`
...
- dataset label text: `㫛`
- dataset label codepoints: `U+3ADB`
...
- Which source records identify obs-char-001573 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001573？
