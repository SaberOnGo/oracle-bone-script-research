# obs-char-000441 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000441`
- primary external id: `hust-obc-cat-0501`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/441_obs-char-000441_hust-obc-cat-0501_orac
  le-character/03_visual-assets/001_asset-000446_hust-obc-cat-0501_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0501/H_0501_60271_0.png`
- asset id: `asset-000446`
...
- source category: `0501`
- validation class: `440`
- source image route: `HUST-OBC/deciphered/0501/H_0501_60271_0.png`
- asset id: `asset-000446`
...
- English observation: `Two bold forms are separated by white space: the
  left combines an upper triangular area with a lower frame, while the right
  has crossed upper and angular lower strokes.`
- 中文观察: `两个粗重形体以空白分隔：左侧结合上部三角区域和下部框架，右侧上部交叉、下部折角。`
...
- dataset label text: `㗫`
- dataset label codepoints: `U+35EB`
...
- filename catalog route clues: `catalog-like filename clue: H_0501
  (H_0501_60271_0.png)`
...
- Which source records identify obs-char-000441 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000441？
