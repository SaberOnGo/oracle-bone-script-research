...
- External category reference: `evobc-cat-05561`
- Source category ID: `05561`
- Source label for human review: `畍`
- Source codepoints: `U+754D`
...
- `obs-evo-cand-005561-route-category-staging`
...
- `obs-evo-cand-005561-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005561-route-evolution-graph`
