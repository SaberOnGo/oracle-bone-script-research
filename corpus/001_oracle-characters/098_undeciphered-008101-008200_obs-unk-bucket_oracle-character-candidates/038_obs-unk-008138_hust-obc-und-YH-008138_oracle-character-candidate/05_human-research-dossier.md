# obs-unk-008138 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008138`
- primary external id: `hust-obc-und-YH-008138`
...
- local review image route: `corpus/001_oracle-characters/098_undeciphered-008
  101-008200_obs-unk-bucket_oracle-character-candidates/038_obs-unk-008138_h
  ust-obc-und-YH-008138_oracle-character-candidate/03_visual-assets/001_asse
  t-009729_hust-obc-und-YH-008138_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/607BE/H_？_607BE_0.png`
- asset id: `asset-009729`
...
- source class: `HUST-OBC/undeciphered/Y+H/607BE/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/607BE/H_？_607BE_0.png`
- asset id: `asset-009729`
...
- Which source records identify obs-unk-008138 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008138？
