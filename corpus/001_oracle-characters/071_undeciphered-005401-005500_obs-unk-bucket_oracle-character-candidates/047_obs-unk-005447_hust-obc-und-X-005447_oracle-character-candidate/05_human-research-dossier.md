# obs-unk-005447 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005447`
- primary external id: `hust-obc-und-X-005447`
...
- local review image route: `corpus/001_oracle-characters/071_undeciphered-005
  401-005500_obs-unk-bucket_oracle-character-candidates/047_obs-unk-005447_h
  ust-obc-und-X-005447_oracle-character-candidate/03_visual-assets/001_asset
  -007040_hust-obc-und-X-005447_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1003/X_？_7098_1.png`
- asset id: `asset-007040`
...
- source class: `HUST-OBC/undeciphered/X/1003/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1003/X_？_7098_1.png`
- asset id: `asset-007040`
...
- Which source records identify obs-unk-005447 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005447？
