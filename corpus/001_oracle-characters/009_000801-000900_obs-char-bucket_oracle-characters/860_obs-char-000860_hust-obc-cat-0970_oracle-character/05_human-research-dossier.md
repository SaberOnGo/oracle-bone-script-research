# obs-char-000860 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/860_obs-char-000860_hust-obc-cat-0970_orac
  le-character/03_visual-assets/001_asset-000865_hust-obc-cat-0970_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0970/G_0970_合11156賓組.png`
- asset id: `asset-000865`
...
- source category: `0970`
- validation class: `859`
- source image route: `HUST-OBC/deciphered/0970/G_0970_合11156賓組.png`
- asset id: `asset-000865`
...
- English observation: `An elongated central loop contains crossing strokes;
  long diagonal outer strokes extend above and below, and fine joins are
  unclear.`
...
- dataset label text: `㟀`
- dataset label codepoints: `U+37C0`
...
- filename catalog route clues: `Heji-like filename clue: 合11156
  (G_0970_合11156賓組.png)`
...
- Which source records identify obs-char-000860 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000860？
