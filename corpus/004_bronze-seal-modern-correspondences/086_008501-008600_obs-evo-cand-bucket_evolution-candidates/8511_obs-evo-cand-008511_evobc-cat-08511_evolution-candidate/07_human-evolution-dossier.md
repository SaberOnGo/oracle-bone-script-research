...
- External category reference: `evobc-cat-08511`
- Source category ID: `08511`
- Source label for human review: `豺`
...
- `obs-evo-cand-008511-route-category-staging`
...
- `obs-evo-cand-008511-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008511-route-evolution-graph`
