...
- External category reference: `evobc-cat-02138`
- Source category ID: `02138`
- Source label for human review: `姫`
...
- `obs-evo-cand-002138-route-category-staging`
...
- `obs-evo-cand-002138-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002138-route-evolution-graph`
