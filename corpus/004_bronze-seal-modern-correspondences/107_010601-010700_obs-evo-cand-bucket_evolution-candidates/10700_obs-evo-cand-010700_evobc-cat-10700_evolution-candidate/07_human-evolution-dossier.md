...
Project ID: `obs-evo-cand-010700`
...
- Project ID: `obs-evo-cand-010700`
- EVOBC category candidate ID: `evobc-evo-cat-10700`
- External category reference: `evobc-cat-10700`
- Source category ID: `10700`
- Source label for human review: `鼲`
- Source codepoints: `U+9F32`
...
- `obs-evo-cand-010700-route-category-staging`
...
- `obs-evo-cand-010700-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010700-route-evolution-graph`
