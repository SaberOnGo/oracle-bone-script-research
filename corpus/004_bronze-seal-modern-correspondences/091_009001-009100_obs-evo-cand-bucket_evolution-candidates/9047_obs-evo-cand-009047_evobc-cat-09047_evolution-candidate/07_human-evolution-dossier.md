...
Project ID: `obs-evo-cand-009047`
...
- Project ID: `obs-evo-cand-009047`
- EVOBC category candidate ID: `evobc-evo-cat-09047`
- External category reference: `evobc-cat-09047`
- Source category ID: `09047`
- Source label for human review: `遣`
- Source codepoints: `U+9063`
- Image reference count in source metadata: `141`
...
- `obs-evo-cand-009047-route-category-staging`
...
- `obs-evo-cand-009047-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009047-route-evolution-graph`
