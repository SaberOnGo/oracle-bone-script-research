# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006784
...
- EVOBC candidate category: `evobc-evo-cat-06784`.
- Source label for search only: `缺`.
- Source codepoints for search only: `U+7F3A`.
