...
- Project ID: `obs-evo-cand-012642`
- EVOBC category candidate ID: `evobc-evo-cat-12642`
- External category reference: `evobc-cat-12642`
- Source category ID: `12642`
- Source label for human review: `𩟷`
- Source codepoints: `U+297F7`
...
- `obs-evo-cand-012642-route-category-staging`
...
- `obs-evo-cand-012642-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012642-route-evolution-graph`
