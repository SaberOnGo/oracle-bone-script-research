# obs-comp-cand-001127 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001127`
- 首选外部 ID: `obimd-sub-mvl9bio8ou`
- OBIMD subcharacter UID: `mvl9bio8ou`
- OBIMD main character UID: `mvl9bio8ou`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+B72F2;U+F6784; U+F6785; 另有 1 项
