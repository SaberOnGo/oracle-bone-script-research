# obs-char-000410 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/410_obs-char-000410_hust-obc-cat-0466_orac
  le-character/03_visual-assets/001_asset-000415_hust-obc-cat-0466_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0466/G_0466_京都1092A合6108賓組.png`
- asset id: `asset-000415`
...
- source category: `0466`
- validation class: `409`
- source image route: `HUST-OBC/deciphered/0466/G_0466_京都1092A合6108賓組.png`
- asset id: `asset-000415`
...
- English observation: `A thin vertical trace crosses a small upper
  rectangular loop and continues through several sharp lower bends; contrast
  needs recheck.`
...
- dataset label text: `㗈`
- dataset label codepoints: `U+35C8`
...
- filename catalog route clues: `Heji-like filename clue: 合6108
...
- Which source records identify obs-char-000410 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000410？
