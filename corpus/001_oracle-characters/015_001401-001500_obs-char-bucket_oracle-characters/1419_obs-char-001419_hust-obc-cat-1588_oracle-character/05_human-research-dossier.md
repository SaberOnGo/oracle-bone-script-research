# obs-char-001419 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1419_obs-char-001419_hust-obc-cat-1588_ora
  cle-character/03_visual-assets/001_asset-001424_hust-obc-cat-1588_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1588/H_1588_60696_0.png`
- asset id: `asset-001424`
...
- source category: `1588`
- validation class: `1418`
- source image route: `HUST-OBC/deciphered/1588/H_1588_60696_0.png`
- asset id: `asset-001424`
...
- English observation: `Two vertical forms combine a curved left stem with
  three right side marks.`
...
- dataset label text: `㨪`
- dataset label codepoints: `U+3A2A`
...
- filename catalog route clues: `catalog-like filename clue: H_1588
  (H_1588_60696_0.png)`
...
- Which source records identify obs-char-001419 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001419？
