# obs-unk-005032 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/067_undeciphered-005
  001-005100_obs-unk-bucket_oracle-character-candidates/032_obs-unk-005032_h
  ust-obc-und-X-005032_oracle-character-candidate/03_visual-assets/001_asset
  -006625_hust-obc-und-X-005032_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/588/X_？_7563_1.png`
- asset id: `asset-006625`
...
- source class: `HUST-OBC/undeciphered/X/588/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/588/X_？_7563_1.png`
- asset id: `asset-006625`
...
- Which source records identify obs-unk-005032 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005032？
