...
- External category reference: `evobc-cat-09968`
- Source category ID: `09968`
- Source label for human review: `頁`
- Source codepoints: `U+9801`
...
- `obs-evo-cand-009968-route-category-staging`
...
- `obs-evo-cand-009968-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009968-route-evolution-graph`
