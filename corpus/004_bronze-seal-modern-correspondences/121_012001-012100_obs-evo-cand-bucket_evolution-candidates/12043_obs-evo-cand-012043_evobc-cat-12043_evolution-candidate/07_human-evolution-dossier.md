...
- External category reference: `evobc-cat-12043`
- Source category ID: `12043`
- Source label for human review: `𦚎`
- Source codepoints: `U+2668E`
...
- `obs-evo-cand-012043-route-category-staging`
...
- `obs-evo-cand-012043-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012043-route-evolution-graph`
