...
- External category reference: `evobc-cat-03997`
- Source category ID: `03997`
- Source label for human review: `栝`
- Source codepoints: `U+681D`
...
- `obs-evo-cand-003997-route-category-staging`
...
- `obs-evo-cand-003997-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003997-route-evolution-graph`
