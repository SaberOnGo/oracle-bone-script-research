...
- External category reference: `evobc-cat-00431`
- Source category ID: `00431`
- Source label for human review: `䛩`
...
- `obs-evo-cand-000431-route-category-staging`
...
- `obs-evo-cand-000431-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000431-route-evolution-graph`
