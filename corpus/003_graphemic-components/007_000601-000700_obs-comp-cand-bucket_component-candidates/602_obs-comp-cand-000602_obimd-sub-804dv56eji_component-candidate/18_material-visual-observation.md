# Material Visual Observation / obs-comp-cand-000602 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000602`
- External reference / 外部参照: `obimd-sub-804dv56eji`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013135_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/804dv56eji/804dv56eji/804dv56eji.png`
- Checksum / 校验和:
  `69f188101c4df5639d352e03fe675474c2547a410b3a7636eea04af084384613`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.55%.
- Marked-pixel bounds: (80,13)–(174,235); span 95 × 223 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.55%。
- 痕迹范围：(80,13)–(174,235)；跨度95 × 223 px；痕迹矩形高于宽。
