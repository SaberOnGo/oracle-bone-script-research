...
Project ID: `obs-evo-cand-001459`
...
- Project ID: `obs-evo-cand-001459`
- EVOBC category candidate ID: `evobc-evo-cat-01459`
- External category reference: `evobc-cat-01459`
- Source category ID: `01459`
- Source label for human review: `叕`
- Source codepoints: `U+53D5`
...
- `obs-evo-cand-001459-route-category-staging`
...
- `obs-evo-cand-001459-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001459-route-evolution-graph`
