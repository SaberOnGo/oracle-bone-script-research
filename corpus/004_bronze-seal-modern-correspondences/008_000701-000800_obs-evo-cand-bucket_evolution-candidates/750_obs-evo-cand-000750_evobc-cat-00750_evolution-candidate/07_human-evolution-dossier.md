...
- External category reference: `evobc-cat-00750`
- Source category ID: `00750`
- Source label for human review: `仰`
- Source codepoints: `U+4EF0`
...
- `obs-evo-cand-000750-route-category-staging`
...
- `obs-evo-cand-000750-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000750-route-evolution-graph`
