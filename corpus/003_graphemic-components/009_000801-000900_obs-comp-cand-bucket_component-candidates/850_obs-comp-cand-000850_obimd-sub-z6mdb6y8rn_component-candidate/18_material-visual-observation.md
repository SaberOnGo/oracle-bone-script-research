# Material Visual Observation / obs-comp-cand-000850 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000850`
- External reference / 外部参照: `obimd-sub-z6mdb6y8rn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013720_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/z6mdb6y8rn/z6mdb6y8rn/z6mdb6y8rn.png`
- Checksum / 校验和:
  `d89a6ed8015844f4dc6e33d4a7866b61cca58cd4f6140c333958653082bfb5cf`
...
- Marked-pixel bounds: (68,33)–(181,220); span 114 × 188 px; the marked
...
- 痕迹范围：(68,33)–(181,220)；跨度114 × 188 px；痕迹矩形高于宽。
