...
- Project ID: `obs-evo-cand-009670`
- EVOBC category candidate ID: `evobc-evo-cat-09670`
- External category reference: `evobc-cat-09670`
- Source category ID: `09670`
- Source label for human review: `闥`
- Source codepoints: `U+95E5`
...
- `obs-evo-cand-009670-route-category-staging`
...
- `obs-evo-cand-009670-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009670-route-evolution-graph`
