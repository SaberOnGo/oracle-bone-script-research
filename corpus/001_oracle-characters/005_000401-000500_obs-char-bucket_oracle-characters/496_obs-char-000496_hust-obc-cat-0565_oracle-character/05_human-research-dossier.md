# obs-char-000496 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000496`
- primary external id: `hust-obc-cat-0565`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/496_obs-char-000496_hust-obc-cat-0565_orac
  le-character/03_visual-assets/001_asset-000501_hust-obc-cat-0565_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0565/G_0565_前6.31.3合3919.png`
- asset id: `asset-000501`
...
- source category: `0565`
- validation class: `495`
- source image route: `HUST-OBC/deciphered/0565/G_0565_前6.31.3合3919.png`
- asset id: `asset-000501`
...
- English observation: `A pointed polygonal outer frame encloses an upper
  oval loop with crossed branches; below it are two stacked groups of
  horizontal and vertical strokes.`
- 中文观察: `尖顶多边外框包围带交叉分支的上部椭圆环，其下有两组层叠横竖笔画。`
...
- dataset label text: `㘫`
- dataset label codepoints: `U+362B`
...
- filename catalog route clues: `Heji-like filename clue: 合3919
  (G_0565_前6.31.3合3919.png)`
...
- Which source records identify obs-char-000496 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000496？
