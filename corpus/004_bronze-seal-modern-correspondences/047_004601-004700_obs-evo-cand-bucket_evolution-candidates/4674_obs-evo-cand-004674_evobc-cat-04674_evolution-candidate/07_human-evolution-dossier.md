...
- External category reference: `evobc-cat-04674`
- Source category ID: `04674`
- Source label for human review: `涂`
- Source codepoints: `U+6D82`
...
- `obs-evo-cand-004674-route-category-staging`
...
- `obs-evo-cand-004674-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004674-route-evolution-graph`
