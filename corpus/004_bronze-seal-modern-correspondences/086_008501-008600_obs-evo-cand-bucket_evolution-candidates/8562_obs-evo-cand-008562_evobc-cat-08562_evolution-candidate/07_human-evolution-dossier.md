...
- Project ID: `obs-evo-cand-008562`
- EVOBC category candidate ID: `evobc-evo-cat-08562`
- External category reference: `evobc-cat-08562`
- Source category ID: `08562`
- Source label for human review: `賁`
- Source codepoints: `U+8CC1`
...
- `obs-evo-cand-008562-route-category-staging`
...
- `obs-evo-cand-008562-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008562-route-evolution-graph`
