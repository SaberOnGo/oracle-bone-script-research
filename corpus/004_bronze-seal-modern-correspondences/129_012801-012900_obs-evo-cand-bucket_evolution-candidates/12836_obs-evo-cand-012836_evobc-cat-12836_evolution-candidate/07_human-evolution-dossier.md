...
- Project ID: `obs-evo-cand-012836`
- EVOBC category candidate ID: `evobc-evo-cat-12836`
- External category reference: `evobc-cat-12836`
- Source category ID: `12836`
- Source label for human review: `𪩄`
- Source codepoints: `U+2AA44`
...
- `obs-evo-cand-012836-route-category-staging`
...
- `obs-evo-cand-012836-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012836-route-evolution-graph`
