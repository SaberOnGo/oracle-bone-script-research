# obs-char-000276 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/276_obs-char-000276_hust-obc-cat-0311_orac
  le-character/03_visual-assets/001_asset-000281_hust-obc-cat-0311_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0311/G_0311_乙4518合9774賓組.png`
- asset id: `asset-000281`
...
- source category: `0311`
- validation class: `275`
- source image route: `HUST-OBC/deciphered/0311/G_0311_乙4518合9774賓組.png`
- asset id: `asset-000281`
...
- English observation: `The narrow image contains several short angular
  branches around a thin descending stroke; the lower tip tapers and remains
  irregular.`
...
- dataset label text: `㔭`
- dataset label codepoints: `U+352D`
...
- Which source records identify obs-char-000276 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000276？
