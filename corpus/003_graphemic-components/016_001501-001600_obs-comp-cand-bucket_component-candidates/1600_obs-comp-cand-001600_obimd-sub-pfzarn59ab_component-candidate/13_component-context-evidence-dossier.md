# obs-comp-cand-001600 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001600`
- 首选外部 ID: `obimd-sub-pfzarn59ab`
- OBIMD subcharacter UID: `pfzarn59ab`
- OBIMD main character UID: `pfzarn59ab`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+A1B6F;U+F9573; U+F9574; 另有 2 项
