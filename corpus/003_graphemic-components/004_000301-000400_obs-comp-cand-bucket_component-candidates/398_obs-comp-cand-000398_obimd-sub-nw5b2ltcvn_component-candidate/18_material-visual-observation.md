# Material Visual Observation / obs-comp-cand-000398 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000398`
- External reference / 外部参照: `obimd-sub-nw5b2ltcvn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012321_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/33ico48nyd/nw5b2ltcvn/nw5b2ltcvn.png`
- Checksum / 校验和:
  `30144310fd3c25cc7e0667762f633f658b978c5ad88def68c2f129057268c58f`
...
- Marked-pixel bounds: (78,11)–(171,235); span 94 × 225 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.23%。
- 痕迹范围：(78,11)–(171,235)；跨度94 × 225 px；痕迹矩形高于宽。
