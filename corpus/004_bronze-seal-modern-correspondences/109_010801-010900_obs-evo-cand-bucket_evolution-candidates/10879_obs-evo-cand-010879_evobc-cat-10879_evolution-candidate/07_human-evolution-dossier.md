...
- Project ID: `obs-evo-cand-010879`
- EVOBC category candidate ID: `evobc-evo-cat-10879`
- External category reference: `evobc-cat-10879`
- Source category ID: `10879`
- Source label for human review: `𠦉`
- Source codepoints: `U+20989`
...
- `obs-evo-cand-010879-route-category-staging`
...
- `obs-evo-cand-010879-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010879-route-evolution-graph`
