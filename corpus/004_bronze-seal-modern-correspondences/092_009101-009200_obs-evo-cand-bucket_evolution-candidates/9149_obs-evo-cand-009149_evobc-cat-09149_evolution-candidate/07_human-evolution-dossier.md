...
- External category reference: `evobc-cat-09149`
- Source category ID: `09149`
- Source label for human review: `郠`
...
- `obs-evo-cand-009149-route-category-staging`
...
- `obs-evo-cand-009149-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009149-route-evolution-graph`
