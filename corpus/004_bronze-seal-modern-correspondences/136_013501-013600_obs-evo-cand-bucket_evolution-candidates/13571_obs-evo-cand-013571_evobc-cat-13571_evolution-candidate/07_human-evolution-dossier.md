...
Project ID: `obs-evo-cand-013571`
...
- Project ID: `obs-evo-cand-013571`
- EVOBC category candidate ID: `evobc-evo-cat-13571`
- External category reference: `evobc-cat-13571`
- Source category ID: `13571`
- Source label for human review: `𭴣`
- Source codepoints: `U+2DD23`
...
- `obs-evo-cand-013571-route-category-staging`
...
- `obs-evo-cand-013571-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013571-route-evolution-graph`
