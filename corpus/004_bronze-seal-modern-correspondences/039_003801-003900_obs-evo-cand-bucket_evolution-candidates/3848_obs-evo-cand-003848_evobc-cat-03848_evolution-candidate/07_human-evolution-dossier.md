...
Project ID: `obs-evo-cand-003848`
...
- Project ID: `obs-evo-cand-003848`
- EVOBC category candidate ID: `evobc-evo-cat-03848`
- External category reference: `evobc-cat-03848`
- Source category ID: `03848`
- Source label for human review: `未`
- Source codepoints: `U+672A`
- Image reference count in source metadata: `229`
...
- `obs-evo-cand-003848-route-category-staging`
...
- `obs-evo-cand-003848-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003848-route-evolution-graph`
