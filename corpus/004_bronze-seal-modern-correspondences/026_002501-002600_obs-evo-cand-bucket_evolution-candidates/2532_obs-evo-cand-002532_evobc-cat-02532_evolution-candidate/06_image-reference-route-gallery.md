...
- `obs-evo-cand-002532-route-category-staging`
...
- `obs-evo-cand-002532-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002532-route-evolution-graph`
