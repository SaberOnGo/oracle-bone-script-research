# obs-evo-cand-007970 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-007970`
- EVOBC category candidate ID: `evobc-evo-cat-07970`
- External category ref: `evobc-cat-07970`
- Source label for human review: `裏`
- Source codepoints: `U+88CF`
- Image reference count: `15`
- Era token counts: `BI:5;SS:1;WSC:9`
- Source token counts: `Book:14;Web:1`
