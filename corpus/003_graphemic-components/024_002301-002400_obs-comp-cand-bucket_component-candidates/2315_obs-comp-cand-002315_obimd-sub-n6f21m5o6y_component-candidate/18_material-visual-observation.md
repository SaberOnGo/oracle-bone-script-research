# Material Visual Observation / obs-comp-cand-002315 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002315`
- External reference / 外部参照: `obimd-sub-n6f21m5o6y`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020334_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dnqkkwgd05/n6f21m5o6y/n6f21m5o6y.png`
- Checksum / 校验和:
  `f0290f91639cb24c6f0112aedafa27e590fc1eaa87ec35bab12c0f9f03eb8803`
...
- Marked-pixel bounds: (67,39)–(177,208); span 111 × 170 px; the marked
...
- 痕迹范围：(67,39)–(177,208)；跨度111 × 170 px；痕迹矩形高于宽。
