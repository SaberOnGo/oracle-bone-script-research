# Material Visual Observation / obs-comp-cand-000590 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000590`
- External reference / 外部参照: `obimd-sub-rusuh5vsrz`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013118_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/e19hd5tm0i/rusuh5vsrz/rusuh5vsrz.png`
- Checksum / 校验和:
  `3da8e853dd6cfb6bbe011977da9ffc1026b1e2d6bc14c4f3bed5103216704781`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.01%.
- Marked-pixel bounds: (37,31)–(212,222); span 176 × 192 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.01%。
- 痕迹范围：(37,31)–(212,222)；跨度176 × 192 px；痕迹矩形近方形。
