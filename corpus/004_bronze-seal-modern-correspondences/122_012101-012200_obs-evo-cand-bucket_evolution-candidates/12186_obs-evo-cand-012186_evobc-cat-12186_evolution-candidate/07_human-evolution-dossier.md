...
- External category reference: `evobc-cat-12186`
- Source category ID: `12186`
- Source label for human review: `𧗿`
...
- `obs-evo-cand-012186-route-category-staging`
...
- `obs-evo-cand-012186-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012186-route-evolution-graph`
