# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002504
...
| --- | --- | --- | --- |
| `obimd-glyph-link-038379` | 󾎧 | `U+FE3A7` | `reviewed_metadata_only` |
| `obimd-glyph-link-038380` | 󾎨 | `U+FE3A8` | `reviewed_metadata_only` |
| `obimd-glyph-link-038381` | 󾎩 | `U+FE3A9` | `reviewed_metadata_only` |
| `obimd-glyph-link-038382` | 󾎪 | `U+FE3AA` | `reviewed_metadata_only` |
| `obimd-glyph-link-038383` | 󾎫 | `U+FE3AB` | `reviewed_metadata_only` |
