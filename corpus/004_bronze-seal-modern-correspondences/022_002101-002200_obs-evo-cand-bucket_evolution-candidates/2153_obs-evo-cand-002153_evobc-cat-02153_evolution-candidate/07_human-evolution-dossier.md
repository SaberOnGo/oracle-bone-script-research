...
- External category reference: `evobc-cat-02153`
- Source category ID: `02153`
- Source label for human review: `娃`
- Source codepoints: `U+5A03`
...
- `obs-evo-cand-002153-route-category-staging`
...
- `obs-evo-cand-002153-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002153-route-evolution-graph`
