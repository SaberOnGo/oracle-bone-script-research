...
- External category reference: `evobc-cat-03674`
- Source category ID: `03674`
- Source label for human review: `旗`
...
- `obs-evo-cand-003674-route-category-staging`
...
- `obs-evo-cand-003674-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003674-route-evolution-graph`
