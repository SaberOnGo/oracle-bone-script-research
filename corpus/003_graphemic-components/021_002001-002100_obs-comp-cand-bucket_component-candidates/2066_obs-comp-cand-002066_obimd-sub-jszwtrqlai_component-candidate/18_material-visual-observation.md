# Material Visual Observation / obs-comp-cand-002066 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002066`
- External reference / 外部参照: `obimd-sub-jszwtrqlai`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019453_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jszwtrqlai/jszwtrqlai/jszwtrqlai.png`
- Checksum / 校验和:
  `e274253030c91a0fc024433969c9beee5e0c99558817885532b2a0972b234263`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.07%.
- Marked-pixel bounds: (44,19)–(214,228); span 171 × 210 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.07%。
- 痕迹范围：(44,19)–(214,228)；跨度171 × 210 px；痕迹矩形高于宽。
