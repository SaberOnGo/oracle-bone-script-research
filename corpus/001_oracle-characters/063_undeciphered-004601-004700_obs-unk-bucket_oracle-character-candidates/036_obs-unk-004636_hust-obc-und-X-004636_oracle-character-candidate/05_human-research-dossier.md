# obs-unk-004636 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004636`
- primary external id: `hust-obc-und-X-004636`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/036_obs-unk-004636_h
  ust-obc-und-X-004636_oracle-character-candidate/03_visual-assets/001_asset
  -006229_hust-obc-und-X-004636_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/192/X_？_8365_1.png`
- asset id: `asset-006229`
...
- source class: `HUST-OBC/undeciphered/X/192/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/192/X_？_8365_1.png`
- asset id: `asset-006229`
...
- English observation: `central branch, side block, detached upper fragment`
- 中文观察: `中央分支、左侧块状痕和上方分离片段已记录。`
...
- Which source records identify obs-unk-004636 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004636？
