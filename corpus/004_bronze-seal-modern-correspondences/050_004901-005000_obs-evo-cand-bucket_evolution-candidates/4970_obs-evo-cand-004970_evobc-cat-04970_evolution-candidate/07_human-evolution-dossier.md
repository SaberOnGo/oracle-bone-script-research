...
- External category reference: `evobc-cat-04970`
- Source category ID: `04970`
- Source label for human review: `濦`
- Source codepoints: `U+6FE6`
...
- `obs-evo-cand-004970-route-category-staging`
...
- `obs-evo-cand-004970-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004970-route-evolution-graph`
