...
Project ID: `obs-evo-cand-004537`
...
- Project ID: `obs-evo-cand-004537`
- EVOBC category candidate ID: `evobc-evo-cat-04537`
- External category reference: `evobc-cat-04537`
- Source category ID: `04537`
- Source label for human review: `沐`
- Source codepoints: `U+6C90`
...
- `obs-evo-cand-004537-route-category-staging`
...
- `obs-evo-cand-004537-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004537-route-evolution-graph`
