# obs-unk-003997 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/097_obs-unk-003997_h
  ust-obc-und-L-003997_oracle-character-candidate/03_visual-assets/001_asset
  -005590_hust-obc-und-L-003997_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3997/L_？_8460.jpg`
- asset id: `asset-005590`
...
- source class: `HUST-OBC/undeciphered/L/3997/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3997/L_？_8460.jpg`
- asset id: `asset-005590`
...
- English observation: A broad arched upper band carries short vertical
  notches, with curved and descending traces below.
- 中文观察：上部弧形痕迹带有短直立缺口，下方有弯曲和下行痕迹。
...
- Which source records identify obs-unk-003997 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003997？
