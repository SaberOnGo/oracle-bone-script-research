# obs-char-000686 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000686`
- primary external id: `hust-obc-cat-0777`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/686_obs-char-000686_hust-obc-cat-0777_orac
  le-character/03_visual-assets/001_asset-000691_hust-obc-cat-0777_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0777/G_0777_中大261.png`
- asset id: `asset-000691`
...
- source category: `0777`
- validation class: `685`
- source image route: `HUST-OBC/deciphered/0777/G_0777_中大261.png`
- asset id: `asset-000691`
...
- English observation: `A small detached diamond-like loop with a middle bar
  stands at left; a taller right form has a pointed top, bent central stem,
  and two spreading lower branches.`
- 中文观察: `左侧有带中横的小型分离菱形环；较高右形带尖顶、弯中央干和两条外展下枝。`
...
- dataset label text: `㛿`
- dataset label codepoints: `U+36FF`
...
- Which source records identify obs-char-000686 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000686？
