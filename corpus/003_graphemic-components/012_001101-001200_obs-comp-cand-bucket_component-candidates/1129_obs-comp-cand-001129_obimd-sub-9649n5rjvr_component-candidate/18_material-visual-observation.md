# Material Visual Observation / obs-comp-cand-001129 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001129`
- External reference / 外部参照: `obimd-sub-9649n5rjvr`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015083_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9649n5rjvr/9649n5rjvr/9649n5rjvr.png`
- Checksum / 校验和:
  `9aae56d8312138ef2398d9d649a78359f430fba750369fed0b48ed807f999720`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.44%.
- Marked-pixel bounds: (51,62)–(203,192); span 153 × 131 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.44%。
- 痕迹范围：(51,62)–(203,192)；跨度153 × 131 px；痕迹矩形近方形。
