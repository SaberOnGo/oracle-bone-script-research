# Material Visual Observation / obs-comp-cand-001871 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001871`
- External reference / 外部参照: `obimd-sub-wffqg3bra1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018250_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7q3ryyen2t/wffqg3bra1/wffqg3bra1.png`
- Checksum / 校验和:
  `4576a4dd9067d897372b72d3e54963f1a7402d467efc4c8539fb99ea58a0019e`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.41%.
- Marked-pixel bounds: (55,21)–(199,223); span 145 × 203 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.41%。
- 痕迹范围：(55,21)–(199,223)；跨度145 × 203 px；痕迹矩形高于宽。
