...
- External category reference: `evobc-cat-03426`
- Source category ID: `03426`
- Source label for human review: `揖`
- Source codepoints: `U+63D6`
...
- `obs-evo-cand-003426-route-category-staging`
...
- `obs-evo-cand-003426-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003426-route-evolution-graph`
