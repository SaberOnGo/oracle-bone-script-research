...
- External category reference: `evobc-cat-03487`
- Source category ID: `03487`
- Source label for human review: `摷`
...
- `obs-evo-cand-003487-route-category-staging`
...
- `obs-evo-cand-003487-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003487-route-evolution-graph`
