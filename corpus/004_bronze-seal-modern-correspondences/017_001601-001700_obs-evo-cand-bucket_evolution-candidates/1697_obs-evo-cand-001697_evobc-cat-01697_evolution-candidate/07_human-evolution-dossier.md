...
- External category reference: `evobc-cat-01697`
- Source category ID: `01697`
- Source label for human review: `嘒`
...
- `obs-evo-cand-001697-route-category-staging`
...
- `obs-evo-cand-001697-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001697-route-evolution-graph`
