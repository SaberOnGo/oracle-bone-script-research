# obs-char-000403 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000403`
- primary external id: `hust-obc-cat-0457`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/403_obs-char-000403_hust-obc-cat-0457_orac
  le-character/03_visual-assets/001_asset-000408_hust-obc-cat-0457_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0457/G_0457_京津1682合18063賓組.png`
- asset id: `asset-000408`
...
- source category: `0457`
- validation class: `402`
- source image route: `HUST-OBC/deciphered/0457/G_0457_京津1682合18063賓組.png`
- asset id: `asset-000408`
...
- English observation: `A thin left cluster of curved and angled strokes
  stands beside a tall right stem crossed by two short bars.`
- 中文观察: `左侧纤细弧折笔画群与右侧高长主干并列，右侧主干被两条短横笔画穿过。`
...
- dataset label text: `㖿`
- dataset label codepoints: `U+35BF`
...
- filename catalog route clues: `Heji-like filename clue: 合18063
  (G_0457_京津1682合18063賓組.png)`
...
- Which source records identify obs-char-000403 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000403？
