# obs-unk-004630 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004630`
- primary external id: `hust-obc-und-X-004630`
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/030_obs-unk-004630_h
  ust-obc-und-X-004630_oracle-character-candidate/03_visual-assets/001_asset
  -006223_hust-obc-und-X-004630_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/186/X_？_8360_1.png`
- asset id: `asset-006223`
...
- source class: `HUST-OBC/undeciphered/X/186/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/186/X_？_8360_1.png`
- asset id: `asset-006223`
...
- English observation: `nested U-shaped contours with upright ends`
- 中文观察: `内外 U 形轮廓和上伸末端已记录。`
...
- Which source records identify obs-unk-004630 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004630？
