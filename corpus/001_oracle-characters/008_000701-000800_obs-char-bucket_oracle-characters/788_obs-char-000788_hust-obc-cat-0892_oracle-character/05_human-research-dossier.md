# obs-char-000788 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000788`
- primary external id: `hust-obc-cat-0892`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/788_obs-char-000788_hust-obc-cat-0892_orac
  le-character/03_visual-assets/001_asset-000793_hust-obc-cat-0892_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0892/G_0892_乙4836合2498賓組.png`
- asset id: `asset-000793`
...
- source category: `0892`
- validation class: `787`
- source image route: `HUST-OBC/deciphered/0892/G_0892_乙4836合2498賓組.png`
- asset id: `asset-000793`
...
- English observation: `A tall bent outline has a small rounded upper
  opening, a long descending left side, and a separate angular lower section
  that turns toward the right.`
- 中文观察: `高长弯折轮廓上部有小圆空隙，左侧长笔下垂；下方另有折角段向右转折。`
...
- dataset label text: `㝲`
- dataset label codepoints: `U+3772`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00077`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00077`
- EvoBC image reference count / EvoBC 图像引用数: `1`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00077`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/077_obs-evo-can
  d-000077_evobc-cat-00077_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/077_obs-evo-cand-000077_evobc-cat-00077_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合2498
  (G_0892_乙4836合2498賓組.png)`
...
- Which source records identify obs-char-000788 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000788？
