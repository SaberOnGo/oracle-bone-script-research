...
- External category reference: `evobc-cat-10394`
- Source category ID: `10394`
- Source label for human review: `鮞`
- Source codepoints: `U+9B9E`
...
- `obs-evo-cand-010394-route-category-staging`
...
- `obs-evo-cand-010394-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010394-route-evolution-graph`
