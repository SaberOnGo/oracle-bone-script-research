...
Project ID: `obs-evo-cand-006034`
...
- Project ID: `obs-evo-cand-006034`
- EVOBC category candidate ID: `evobc-evo-cat-06034`
- External category reference: `evobc-cat-06034`
- Source category ID: `06034`
- Source label for human review: `禪`
- Source codepoints: `U+79AA`
...
- `obs-evo-cand-006034-route-category-staging`
...
- `obs-evo-cand-006034-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006034-route-evolution-graph`
