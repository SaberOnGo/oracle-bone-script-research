# Material Visual Observation / obs-comp-cand-001358 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001358`
- External reference / 外部参照: `obimd-sub-tp5ykv5jzh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015747_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tp5ykv5jzh/tp5ykv5jzh/1dj9y7ypfe.png`
- Checksum / 校验和:
  `b96fb088e7cf841ef7690f2d9d69b400778748a51d953143b1f7103a14f11f08`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.82%.
- Marked-pixel bounds: (72,45)–(177,204); span 106 × 160 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.82%。
- 痕迹范围：(72,45)–(177,204)；跨度106 × 160 px；痕迹矩形高于宽。
