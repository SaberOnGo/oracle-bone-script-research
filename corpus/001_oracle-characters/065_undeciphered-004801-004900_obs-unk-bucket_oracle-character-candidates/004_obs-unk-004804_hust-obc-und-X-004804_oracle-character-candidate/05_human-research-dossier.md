# obs-unk-004804 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/004_obs-unk-004804_h
  ust-obc-und-X-004804_oracle-character-candidate/03_visual-assets/001_asset
  -006397_hust-obc-und-X-004804_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/360/X_？_7117_1.png`
- asset id: `asset-006397`
...
- source class: `HUST-OBC/undeciphered/X/360/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/360/X_？_7117_1.png`
- asset id: `asset-006397`
...
- English observation: `dense left group and separate right diagonal`
- 中文观察: `密集左侧结构和分离的右侧斜笔`
...
- Which source records identify obs-unk-004804 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004804？
