# obs-char-001576 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001576`
- primary external id: `hust-obc-cat-1768`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1576_obs-char-001576_hust-obc-cat-1768_ora
  cle-character/03_visual-assets/001_asset-001581_hust-obc-cat-1768_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1768/G_1768_前4.26.4(甲).png`
- asset id: `asset-001581`
...
- source category: `1768`
- validation class: `1575`
- source image route: `HUST-OBC/deciphered/1768/G_1768_前4.26.4(甲).png`
- asset id: `asset-001581`
...
- English observation: `Two separated forms pair a branching left cluster
  with a small rounded upper enclosure on the right.`
- 中文观察: `两个分离形体将左侧分枝笔画群与右侧小型圆折上部框形相配。`
...
- dataset label text: `㫞`
- dataset label codepoints: `U+3ADE`
...
- Which source records identify obs-char-001576 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001576？
