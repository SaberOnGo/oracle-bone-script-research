# obs-char-000110 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000110`
- primary external id: `hust-obc-cat-0124`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/110_obs-char-000110_hust-obc-cat-0124_orac
  le-character/03_visual-assets/001_asset-000115_hust-obc-cat-0124_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0124/G_0124_乙6400合914賓組.png`
- asset id: `asset-000115`
...
- source category: `0124`
- validation class: `109`
- source image route: `HUST-OBC/deciphered/0124/G_0124_乙6400合914賓組.png`
- asset id: `asset-000115`
...
- English observation: `The rounded image has a central
  vertical-and-horizontal junction and four short curved projections
  extending around it.`
- 中文观察: `弧形图像中部有横竖交接点，周围向四方伸出四道短弯曲笔画。`
...
- dataset label text: `㑲`
- dataset label codepoints: `U+3472`
...
- filename catalog route clues: `Heji-like filename clue: 合914
  (G_0124_乙6400合914賓組.png)`
...
- Which source records identify obs-char-000110 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000110？
