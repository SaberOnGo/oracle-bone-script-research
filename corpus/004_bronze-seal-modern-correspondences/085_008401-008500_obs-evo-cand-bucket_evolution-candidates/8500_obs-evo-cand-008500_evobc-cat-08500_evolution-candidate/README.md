# obs-evo-cand-008500 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-08500`
- Source label for human review: `豫`
- Source codepoints: `U+8C6B`
- Image reference count: `52`
- Era token counts: `BI:3;CS:2;SAC:5;SS:2;WSC:40`
- Source token counts: `Book:32;Web:20`
