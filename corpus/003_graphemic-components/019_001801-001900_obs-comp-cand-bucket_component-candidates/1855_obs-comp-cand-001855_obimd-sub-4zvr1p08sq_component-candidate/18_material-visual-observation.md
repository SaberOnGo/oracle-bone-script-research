# Material Visual Observation / obs-comp-cand-001855 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001855`
- External reference / 外部参照: `obimd-sub-4zvr1p08sq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018234_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/33r901db0e/4zvr1p08sq/4zvr1p08sq.png`
- Checksum / 校验和:
  `189e424494138865301a75ea576f03916c180f0493c6e2678412e750f10cbe31`
...
- Marked-pixel bounds: (59,40)–(194,215); span 136 × 176 px; the marked
...
- 痕迹范围：(59,40)–(194,215)；跨度136 × 176 px；痕迹矩形高于宽。
