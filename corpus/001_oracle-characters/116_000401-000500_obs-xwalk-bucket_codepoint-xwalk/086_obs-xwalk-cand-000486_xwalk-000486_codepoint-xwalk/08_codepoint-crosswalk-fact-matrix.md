...
|---|---|---|
| Source Codepoint Route | `U+361D` | not identity |
| HUST candidate route | `hust-obc-cat-0551` | not reading |
| OBIMD route | `obimd-main-cand-002432` | not component |
| EVOBC route | `evobc-evo-cat-00038` | not evolution |
