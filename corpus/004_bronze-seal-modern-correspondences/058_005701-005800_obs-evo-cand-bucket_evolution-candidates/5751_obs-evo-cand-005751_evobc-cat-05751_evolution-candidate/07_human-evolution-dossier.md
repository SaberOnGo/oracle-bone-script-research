...
- External category reference: `evobc-cat-05751`
- Source category ID: `05751`
- Source label for human review: `监`
- Source codepoints: `U+76D1`
...
- `obs-evo-cand-005751-route-category-staging`
...
- `obs-evo-cand-005751-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005751-route-evolution-graph`
