...
Project ID: `obs-evo-cand-012532`
...
- Project ID: `obs-evo-cand-012532`
- EVOBC category candidate ID: `evobc-evo-cat-12532`
- External category reference: `evobc-cat-12532`
- Source category ID: `12532`
- Source label for human review: `𨾂`
- Source codepoints: `U+28F82`
...
- `obs-evo-cand-012532-route-category-staging`
...
- `obs-evo-cand-012532-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012532-route-evolution-graph`
