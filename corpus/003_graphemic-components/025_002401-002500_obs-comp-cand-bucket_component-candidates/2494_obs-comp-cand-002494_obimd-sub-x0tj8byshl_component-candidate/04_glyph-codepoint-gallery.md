# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002494
...
| --- | --- | --- | --- |
| `obimd-glyph-link-038307` | 󾌰 | `U+FE330` | `reviewed_metadata_only` |
| `obimd-glyph-link-038308` | 󾌱 | `U+FE331` | `reviewed_metadata_only` |
| `obimd-glyph-link-038309` | 󾌲 | `U+FE332` | `reviewed_metadata_only` |
