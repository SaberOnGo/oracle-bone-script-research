# obs-unk-004769 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004769`
- primary external id: `hust-obc-und-X-004769`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/069_obs-unk-004769_h
  ust-obc-und-X-004769_oracle-character-candidate/03_visual-assets/001_asset
  -006362_hust-obc-und-X-004769_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/325/X_？_7310_1.png`
- asset id: `asset-006362`
...
- source class: `HUST-OBC/undeciphered/X/325/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/325/X_？_7310_1.png`
- asset id: `asset-006362`
...
- English observation: `upper bar, central V, and lower pointed terminal`
- 中文观察: `上部横杆、中央 V 形结构和下部尖状末端`
...
- Which source records identify obs-unk-004769 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004769？
