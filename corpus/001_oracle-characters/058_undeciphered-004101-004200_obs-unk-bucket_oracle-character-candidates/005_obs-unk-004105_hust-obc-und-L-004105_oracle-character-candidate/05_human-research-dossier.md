# obs-unk-004105 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004105`
- primary external id: `hust-obc-und-L-004105`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/005_obs-unk-004105_h
  ust-obc-und-L-004105_oracle-character-candidate/03_visual-assets/001_asset
  -005698_hust-obc-und-L-004105_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4105/L_？_8825.jpg`
- asset id: `asset-005698`
...
- source class: `HUST-OBC/undeciphered/L/4105/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4105/L_？_8825.jpg`
- asset id: `asset-005698`
...
- English observation: Compact vertical cluster; taller upper strokes and a
  dense lower base are visible in the opened image.
- 中文观察：图像中可见紧凑竖向笔画簇、较高上部笔画和较密下部基部。
...
- Which source records identify obs-unk-004105 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004105？
