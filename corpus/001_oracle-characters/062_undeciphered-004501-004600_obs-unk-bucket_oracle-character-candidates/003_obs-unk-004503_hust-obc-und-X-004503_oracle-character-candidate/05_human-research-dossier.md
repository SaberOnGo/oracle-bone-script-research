# obs-unk-004503 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004503`
- primary external id: `hust-obc-und-X-004503`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/003_obs-unk-004503_h
  ust-obc-und-X-004503_oracle-character-candidate/03_visual-assets/001_asset
  -006096_hust-obc-und-X-004503_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/59/X_？_8244_1.png`
- asset id: `asset-006096`
...
- source class: `HUST-OBC/undeciphered/X/59/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/59/X_？_8244_1.png`
- asset id: `asset-006096`
...
- English observation: `The two separated groups, left crossbar and tail, right
  opening, and long curved trace are directly recorded.`
- 中文观察: `已直接记录两组分离痕迹、左侧横痕下垂痕、右侧空隙和长弧痕。`
...
- Which source records identify obs-unk-004503 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004503？
