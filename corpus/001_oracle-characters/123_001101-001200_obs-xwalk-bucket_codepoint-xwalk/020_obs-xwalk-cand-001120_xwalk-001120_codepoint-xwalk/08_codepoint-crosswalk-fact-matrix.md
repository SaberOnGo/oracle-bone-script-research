...
|---|---|---|
| Source Codepoint Route | `U+38D9` | not identity |
| HUST candidate route | `hust-obc-cat-1251` | not reading |
| OBIMD route | `obimd-main-cand-002637` | not component |
| EVOBC route | `evobc-evo-cat-00107` | not evolution |
