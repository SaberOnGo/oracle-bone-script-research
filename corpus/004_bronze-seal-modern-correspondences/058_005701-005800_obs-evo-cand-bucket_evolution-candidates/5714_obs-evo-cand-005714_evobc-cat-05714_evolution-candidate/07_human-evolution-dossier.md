...
- External category reference: `evobc-cat-05714`
- Source category ID: `05714`
- Source label for human review: `百`
- Source codepoints: `U+767E`
- Image reference count in source metadata: `281`
...
- `obs-evo-cand-005714-route-category-staging`
...
- `obs-evo-cand-005714-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005714-route-evolution-graph`
