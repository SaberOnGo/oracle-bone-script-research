# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010705
...
- EVOBC candidate category: `evobc-evo-cat-10705`.
- Source label for search only: `鼽`.
- Source codepoints for search only: `U+9F3D`.
