...
- External category reference: `evobc-cat-04766`
- Source category ID: `04766`
- Source label for human review: `港`
- Source codepoints: `U+6E2F`
...
- `obs-evo-cand-004766-route-category-staging`
...
- `obs-evo-cand-004766-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004766-route-evolution-graph`
