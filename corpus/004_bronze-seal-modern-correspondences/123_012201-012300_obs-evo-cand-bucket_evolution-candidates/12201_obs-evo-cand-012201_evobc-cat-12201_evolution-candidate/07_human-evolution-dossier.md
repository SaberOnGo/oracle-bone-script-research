...
- Project ID: `obs-evo-cand-012201`
- EVOBC category candidate ID: `evobc-evo-cat-12201`
- External category reference: `evobc-cat-12201`
- Source category ID: `12201`
- Source label for human review: `𧝹`
- Source codepoints: `U+27779`
...
- `obs-evo-cand-012201-route-category-staging`
...
- `obs-evo-cand-012201-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012201-route-evolution-graph`
