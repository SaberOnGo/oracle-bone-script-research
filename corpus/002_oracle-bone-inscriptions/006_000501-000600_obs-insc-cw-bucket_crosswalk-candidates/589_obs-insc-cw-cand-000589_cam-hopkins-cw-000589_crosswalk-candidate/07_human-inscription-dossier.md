...
- Yingguo / 英国所藏: `y2638` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `397` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `572` in source row; primary catalog entry pending
- Heji / 合集: `41951` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000589`
