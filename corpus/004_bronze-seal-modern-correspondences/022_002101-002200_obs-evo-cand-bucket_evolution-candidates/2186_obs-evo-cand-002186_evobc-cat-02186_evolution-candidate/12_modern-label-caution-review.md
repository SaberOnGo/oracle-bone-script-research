# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002186
...
- EVOBC candidate category: `evobc-evo-cat-02186`.
- Source label for search only: `娽`.
- Source codepoints for search only: `U+5A3D`.
