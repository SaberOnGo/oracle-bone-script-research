...
Project ID: `obs-evo-cand-008101`
...
- Project ID: `obs-evo-cand-008101`
- EVOBC category candidate ID: `evobc-evo-cat-08101`
- External category reference: `evobc-cat-08101`
- Source category ID: `08101`
- Source label for human review: `觡`
- Source codepoints: `U+89E1`
...
- `obs-evo-cand-008101-route-category-staging`
...
- `obs-evo-cand-008101-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008101-route-evolution-graph`
