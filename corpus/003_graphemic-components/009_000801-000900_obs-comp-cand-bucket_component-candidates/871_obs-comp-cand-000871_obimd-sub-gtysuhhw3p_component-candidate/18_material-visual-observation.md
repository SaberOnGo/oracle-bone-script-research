# Material Visual Observation / obs-comp-cand-000871 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000871`
- External reference / 外部参照: `obimd-sub-gtysuhhw3p`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013868_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gtysuhhw3p/gtysuhhw3p/gtysuhhw3p.png`
- Checksum / 校验和:
  `b00292f41e9f99b0bb25c11e2933e64c1473490f6fd22c935dd851f2668eead2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.68%.
- Marked-pixel bounds: (72,30)–(178,221); span 107 × 192 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.68%。
- 痕迹范围：(72,30)–(178,221)；跨度107 × 192 px；痕迹矩形高于宽。
