# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008340
...
- EVOBC candidate category: `evobc-evo-cat-08340`.
- Source label for search only: `謺`.
- Source codepoints for search only: `U+8B3A`.
