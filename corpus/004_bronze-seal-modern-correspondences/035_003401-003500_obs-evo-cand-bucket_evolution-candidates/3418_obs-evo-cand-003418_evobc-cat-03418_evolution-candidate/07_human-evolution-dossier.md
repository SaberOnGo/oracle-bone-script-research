...
- External category reference: `evobc-cat-03418`
- Source category ID: `03418`
- Source label for human review: `掾`
...
- `obs-evo-cand-003418-route-category-staging`
...
- `obs-evo-cand-003418-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003418-route-evolution-graph`
