# obs-char-000864 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000864`
- primary external id: `hust-obc-cat-0974`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/864_obs-char-000864_hust-obc-cat-0974_orac
  le-character/03_visual-assets/001_asset-000869_hust-obc-cat-0974_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0974/G_0974_合5362(甲).png`
- asset id: `asset-000869`
...
- source category: `0974`
- validation class: `863`
- source image route: `HUST-OBC/deciphered/0974/G_0974_合5362(甲).png`
- asset id: `asset-000869`
...
- English observation: `A narrow cluster contains a tall pointed central
  space between curved side strokes, with small detached marks at right.`
- 中文观察: `狭长笔群中，弯曲侧笔之间有高长尖形空隙，右侧另有小型分离痕迹。`
...
- dataset label text: `㟄`
- dataset label codepoints: `U+37C4`
...
- filename catalog route clues: `Heji-like filename clue: 合5362
  (G_0974_合5362(甲).png)`
...
- Which source records identify obs-char-000864 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000864？
