# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002219
...
- EVOBC candidate category: `evobc-evo-cat-02219`.
- Source label for search only: `婿`.
- Source codepoints for search only: `U+5A7F`.
