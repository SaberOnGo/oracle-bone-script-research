...
- External category reference: `evobc-cat-05343`
- Source category ID: `05343`
- Source label for human review: `玈`
...
- `obs-evo-cand-005343-route-category-staging`
...
- `obs-evo-cand-005343-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005343-route-evolution-graph`
