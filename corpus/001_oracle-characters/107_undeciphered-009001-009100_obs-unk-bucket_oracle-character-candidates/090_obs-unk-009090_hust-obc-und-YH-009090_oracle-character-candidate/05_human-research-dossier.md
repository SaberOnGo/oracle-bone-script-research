# obs-unk-009090 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/107_undeciphered-009
  001-009100_obs-unk-bucket_oracle-character-candidates/090_obs-unk-009090_h
  ust-obc-und-YH-009090_oracle-character-candidate/03_visual-assets/001_asse
  t-010681_hust-obc-und-YH-009090_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/611BD/H_？_611BD_0.png`
- asset id: `asset-010681`
...
- source class: `HUST-OBC/undeciphered/Y+H/611BD/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/611BD/H_？_611BD_0.png`
- asset id: `asset-010681`
...
- Which source records identify obs-unk-009090 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009090？
