# obs-char-000325 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000325`
- primary external id: `hust-obc-cat-0367`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/325_obs-char-000325_hust-obc-cat-0367_orac
  le-character/03_visual-assets/001_asset-000330_hust-obc-cat-0367_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0367/G_0367_京都2062合29004無名組.png
  `
- asset id: `asset-000330`
...
- source category: `0367`
- validation class: `324`
- source image route: `HUST-OBC/deciphered/0367/G_0367_京都2062合29004無名組.png`
- asset id: `asset-000330`
...
- English observation: `The image has central crossed and branching strokes,
  several small detached rounded marks, and a long descending central line.`
- 中文观察: `图像中部笔画交叉并分叉，周围有数个分离的圆弧痕迹，中部有长下行线条。`
...
- dataset label text: `㕥`
- dataset label codepoints: `U+3565`
...
- filename catalog route clues: `Heji-like filename clue: 合29004
  (G_0367_京都2062合29004無名組.png)`
...
- Which source records identify obs-char-000325 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000325？
