# obs-char-001325 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1325_obs-char-001325_hust-obc-cat-1481_ora
  cle-character/03_visual-assets/001_asset-001330_hust-obc-cat-1481_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1481/G_1481_京津4001(甲).png`
- asset id: `asset-001330`
...
- source category: `1481`
- validation class: `1324`
- source image route: `HUST-OBC/deciphered/1481/G_1481_京津4001(甲).png`
- asset id: `asset-001330`
...
- English observation: `A narrow form has a small angular upper enclosure, a
  long descending curve, and a short lower hook.`
- 中文观察: `狭长形体有小型折角上部框形、长下行弧线和短下部钩笔。`
...
- dataset label text: `㦿`
- dataset label codepoints: `U+39BF`
...
- EvoBC image reference count / EvoBC 图像引用数: `10`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/141_obs-evo-can
  d-000141_evobc-cat-00141_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/141_obs-evo-cand-000141_evobc-cat-00141_evolu
...
- Which source records identify obs-char-001325 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001325？
