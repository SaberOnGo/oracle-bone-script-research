# obs-char-000340 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000340`
- primary external id: `hust-obc-cat-0384`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/340_obs-char-000340_hust-obc-cat-0384_orac
  le-character/03_visual-assets/001_asset-000345_hust-obc-cat-0384_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0384/G_0384_七S186.png`
- asset id: `asset-000345`
...
- source category: `0384`
- validation class: `339`
- source image route: `HUST-OBC/deciphered/0384/G_0384_七S186.png`
- asset id: `asset-000345`
...
- English observation: `The large rectangular grid contains multiple
  internal horizontal and vertical divisions with irregular lower marks.`
- 中文观察: `大型方形格状轮廓内部有多道横竖分隔笔画，下部痕迹不规则。`
...
- dataset label text: `㕶`
- dataset label codepoints: `U+3576`
...
- Which source records identify obs-char-000340 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000340？
