...
- `obs-evo-cand-012990-route-category-staging`
...
- `obs-evo-cand-012990-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012990-route-evolution-graph`
