# obs-unk-004228 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004228`
- primary external id: `hust-obc-und-L-004228`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/028_obs-unk-004228_h
  ust-obc-und-L-004228_oracle-character-candidate/03_visual-assets/001_asset
  -005821_hust-obc-und-L-004228_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4228/L_？_9256.jpg`
- asset id: `asset-005821`
...
- source class: `HUST-OBC/undeciphered/L/4228/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4228/L_？_9256.jpg`
- asset id: `asset-005821`
...
- English observation: `Upper triangle, central crossing, lower strokes.`
- 中文观察: `上部三角轮廓、中央交叉笔画和下部笔画可见。`
...
- Which source records identify obs-unk-004228 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004228？
