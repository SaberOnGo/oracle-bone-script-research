...
Project ID: `obs-evo-cand-004906`
...
- Project ID: `obs-evo-cand-004906`
- EVOBC category candidate ID: `evobc-evo-cat-04906`
- External category reference: `evobc-cat-04906`
- Source category ID: `04906`
- Source label for human review: `潣`
- Source codepoints: `U+6F63`
...
- `obs-evo-cand-004906-route-category-staging`
...
- `obs-evo-cand-004906-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004906-route-evolution-graph`
