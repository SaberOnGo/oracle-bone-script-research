...
- Project ID: `obs-evo-cand-008688`
- EVOBC category candidate ID: `evobc-evo-cat-08688`
- External category reference: `evobc-cat-08688`
- Source category ID: `08688`
- Source label for human review: `趢`
- Source codepoints: `U+8DA2`
...
- `obs-evo-cand-008688-route-category-staging`
...
- `obs-evo-cand-008688-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008688-route-evolution-graph`
