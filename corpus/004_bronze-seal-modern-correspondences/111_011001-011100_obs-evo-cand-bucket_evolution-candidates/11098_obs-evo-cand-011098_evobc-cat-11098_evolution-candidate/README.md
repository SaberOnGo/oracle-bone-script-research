# obs-evo-cand-011098 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-11098`
- Source label for human review: `𡱂`
- Source codepoints: `U+21C42`
- Image reference count: `19`
- Era token counts: `OBC:5;WSC:14`
- Source token counts: `Book:17;Web:2`
