# Material Visual Observation / obs-comp-cand-001302 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001302`
- External reference / 外部参照: `obimd-sub-tl7goh8zfs`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015639_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/2sdz63p9g6/tl7goh8zfs/tl7goh8zfs.png`
- Checksum / 校验和:
  `0d4e7e0b6ebfc983f5f1cce9146c928ea7ea5337e92d6832167d625c3fabcdf1`
...
- Marked-pixel bounds: (88,28)–(161,216); span 74 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.60%。
- 痕迹范围：(88,28)–(161,216)；跨度74 × 189 px；痕迹矩形高于宽。
