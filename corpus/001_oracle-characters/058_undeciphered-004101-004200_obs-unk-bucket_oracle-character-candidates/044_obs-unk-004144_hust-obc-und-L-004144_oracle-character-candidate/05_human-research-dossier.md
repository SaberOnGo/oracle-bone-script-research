# obs-unk-004144 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/044_obs-unk-004144_h
  ust-obc-und-L-004144_oracle-character-candidate/03_visual-assets/001_asset
  -005737_hust-obc-und-L-004144_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4144/L_？_8966.jpg`
- asset id: `asset-005737`
...
- source class: `HUST-OBC/undeciphered/L/4144/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4144/L_？_8966.jpg`
- asset id: `asset-005737`
...
- English observation: A curved upper trace rises above two short lower bars
  and a tapered endpoint.
- 中文观察：上部弯曲痕迹位于两条下部短横痕和收窄末端上方。
...
- Which source records identify obs-unk-004144 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004144？
