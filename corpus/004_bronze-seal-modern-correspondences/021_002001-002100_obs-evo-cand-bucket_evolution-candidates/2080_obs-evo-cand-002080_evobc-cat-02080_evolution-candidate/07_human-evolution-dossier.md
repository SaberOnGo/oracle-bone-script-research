...
- External category reference: `evobc-cat-02080`
- Source category ID: `02080`
- Source label for human review: `妓`
- Source codepoints: `U+5993`
...
- `obs-evo-cand-002080-route-category-staging`
...
- `obs-evo-cand-002080-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002080-route-evolution-graph`
