# obs-char-000586 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/586_obs-char-000586_hust-obc-cat-0665_orac
  le-character/03_visual-assets/001_asset-000591_hust-obc-cat-0665_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0665/G_0665_甲骨文.png`
- asset id: `asset-000591`
...
- source category: `0665`
- validation class: `585`
- source image route: `HUST-OBC/deciphered/0665/G_0665_甲骨文.png`
- asset id: `asset-000591`
...
- English observation: `An upper forked curve narrows into a central
  vertical crossed by a horizontal bar; two long diagonals spread downward
  to a broad base line.`
- 中文观察: `上部叉状曲线收窄为被横栏穿过的中央竖笔，两条长斜笔向下展开至宽底线。`
...
- dataset label text: `㚏`
- dataset label codepoints: `U+368F`
...
- Which source records identify obs-char-000586 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000586？
