# obs-comp-cand-002721 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002721`
- 首选外部 ID: `obimd-sub-64um7iv24n`
- OBIMD subcharacter UID: `64um7iv24n`
- OBIMD main character UID: `64um7iv24n`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `8`
- codepoint 示例: U+FF57C; U+FF57D; 另有 6 项
