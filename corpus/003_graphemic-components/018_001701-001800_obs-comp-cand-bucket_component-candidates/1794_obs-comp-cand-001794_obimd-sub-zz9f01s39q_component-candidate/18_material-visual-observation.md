# Material Visual Observation / obs-comp-cand-001794 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001794`
- External reference / 外部参照: `obimd-sub-zz9f01s39q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018015_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zz9f01s39q/zz9f01s39q/zz9f01s39q.png`
- Checksum / 校验和:
  `06ce525ddc6ba0cd31ffebdf703132eb5fc7d68ebae048ea71458d0ffc1b5bb3`
...
- Marked-pixel bounds: (79,18)–(163,231); span 85 × 214 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.02%。
- 痕迹范围：(79,18)–(163,231)；跨度85 × 214 px；痕迹矩形高于宽。
