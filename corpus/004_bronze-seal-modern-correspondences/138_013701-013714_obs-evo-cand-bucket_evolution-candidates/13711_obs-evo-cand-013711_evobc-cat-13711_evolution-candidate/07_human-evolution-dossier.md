...
Project ID: `obs-evo-cand-013711`
...
- Project ID: `obs-evo-cand-013711`
- EVOBC category candidate ID: `evobc-evo-cat-13711`
- External category reference: `evobc-cat-13711`
- Source category ID: `13711`
- Source label for human review: `喝`
- Source codepoints: `U+FA36`
...
- `obs-evo-cand-013711-route-category-staging`
...
- `obs-evo-cand-013711-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013711-route-evolution-graph`
