...
Project ID: `obs-evo-cand-009600`
...
- Project ID: `obs-evo-cand-009600`
- EVOBC category candidate ID: `evobc-evo-cat-09600`
- External category reference: `evobc-cat-09600`
- Source category ID: `09600`
- Source label for human review: `锯`
- Source codepoints: `U+952F`
...
- `obs-evo-cand-009600-route-category-staging`
...
- `obs-evo-cand-009600-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009600-route-evolution-graph`
