# Material Visual Observation / obs-comp-cand-000568 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000568`
- External reference / 外部参照: `obimd-sub-krjznp1i0d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012820_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/krjznp1i0d/krjznp1i0d/krjznp1i0d.png`
- Checksum / 校验和:
  `c7d53782cc441efad807af8ae6e304a9b8157a97093fe6b7248b9206015f334b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.55%.
- Marked-pixel bounds: (58,35)–(191,218); span 134 × 184 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.55%。
- 痕迹范围：(58,35)–(191,218)；跨度134 × 184 px；痕迹矩形高于宽。
