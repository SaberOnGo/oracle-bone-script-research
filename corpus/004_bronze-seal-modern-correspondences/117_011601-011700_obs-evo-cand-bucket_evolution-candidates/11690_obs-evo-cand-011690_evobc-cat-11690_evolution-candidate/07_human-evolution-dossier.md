...
- Project ID: `obs-evo-cand-011690`
- EVOBC category candidate ID: `evobc-evo-cat-11690`
- External category reference: `evobc-cat-11690`
- Source category ID: `11690`
- Source label for human review: `𤶇`
- Source codepoints: `U+24D87`
...
- `obs-evo-cand-011690-route-category-staging`
...
- `obs-evo-cand-011690-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011690-route-evolution-graph`
