# obs-unk-004791 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/091_obs-unk-004791_h
  ust-obc-und-X-004791_oracle-character-candidate/03_visual-assets/001_asset
  -006384_hust-obc-und-X-004791_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/347/X_？_7330_1.png`
- asset id: `asset-006384`
...
- source class: `HUST-OBC/undeciphered/X/347/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/347/X_？_7330_1.png`
- asset id: `asset-006384`
...
- English observation: `upper triangular opening and lower rounded opening`
- 中文观察: `上部三角开口和下部圆形开口`
...
- Which source records identify obs-unk-004791 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004791？
