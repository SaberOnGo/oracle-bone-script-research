...
Project ID: `obs-evo-cand-007599`
...
- Project ID: `obs-evo-cand-007599`
- EVOBC category candidate ID: `evobc-evo-cat-07599`
- External category reference: `evobc-cat-07599`
- Source category ID: `07599`
- Source label for human review: `薁`
- Source codepoints: `U+8581`
...
- `obs-evo-cand-007599-route-category-staging`
...
- `obs-evo-cand-007599-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007599-route-evolution-graph`
