...
- External category reference: `evobc-cat-01362`
- Source category ID: `01362`
- Source label for human review: `十`
- Source codepoints: `U+5341`
- Image reference count in source metadata: `200`
...
- `obs-evo-cand-001362-route-category-staging`
...
- `obs-evo-cand-001362-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001362-route-evolution-graph`
