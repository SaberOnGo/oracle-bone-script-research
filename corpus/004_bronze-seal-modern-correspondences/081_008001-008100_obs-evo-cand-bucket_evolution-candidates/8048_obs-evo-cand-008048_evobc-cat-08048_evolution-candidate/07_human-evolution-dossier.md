...
Project ID: `obs-evo-cand-008048`
...
- Project ID: `obs-evo-cand-008048`
- EVOBC category candidate ID: `evobc-evo-cat-08048`
- External category reference: `evobc-cat-08048`
- Source category ID: `08048`
- Source label for human review: `襾`
- Source codepoints: `U+897E`
...
- `obs-evo-cand-008048-route-category-staging`
...
- `obs-evo-cand-008048-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008048-route-evolution-graph`
