# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002179
...
- EVOBC candidate category: `evobc-evo-cat-02179`.
- Source label for search only: `娭`.
- Source codepoints for search only: `U+5A2D`.
