...
- External category reference: `evobc-cat-06161`
- Source category ID: `06161`
- Source label for human review: `窐`
...
- `obs-evo-cand-006161-route-category-staging`
...
- `obs-evo-cand-006161-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006161-route-evolution-graph`
