...
- External category reference: `evobc-cat-12430`
- Source category ID: `12430`
- Source label for human review: `𨛢`
...
- `obs-evo-cand-012430-route-category-staging`
...
- `obs-evo-cand-012430-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012430-route-evolution-graph`
