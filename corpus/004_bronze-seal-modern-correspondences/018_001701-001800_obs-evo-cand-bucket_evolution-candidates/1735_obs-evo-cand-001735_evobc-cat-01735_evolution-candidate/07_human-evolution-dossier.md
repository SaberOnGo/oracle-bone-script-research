...
- External category reference: `evobc-cat-01735`
- Source category ID: `01735`
- Source label for human review: `嚐`
- Source codepoints: `U+5690`
...
- `obs-evo-cand-001735-route-category-staging`
...
- `obs-evo-cand-001735-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001735-route-evolution-graph`
