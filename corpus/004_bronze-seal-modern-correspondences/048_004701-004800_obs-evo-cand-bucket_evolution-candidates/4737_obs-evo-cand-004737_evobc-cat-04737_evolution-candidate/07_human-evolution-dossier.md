...
Project ID: `obs-evo-cand-004737`
...
- Project ID: `obs-evo-cand-004737`
- EVOBC category candidate ID: `evobc-evo-cat-04737`
- External category reference: `evobc-cat-04737`
- Source category ID: `04737`
- Source label for human review: `深`
- Source codepoints: `U+6DF1`
...
- `obs-evo-cand-004737-route-category-staging`
...
- `obs-evo-cand-004737-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004737-route-evolution-graph`
