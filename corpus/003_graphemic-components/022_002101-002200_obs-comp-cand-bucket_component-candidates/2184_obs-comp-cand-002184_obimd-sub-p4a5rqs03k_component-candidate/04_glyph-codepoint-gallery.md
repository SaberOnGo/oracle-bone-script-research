# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002184
...
| --- | --- | --- | --- |
| `obimd-glyph-link-033971` | 򹧋󼤬 | `U+B99CB;U+FC92C` | `reviewed_metadata_only` |
| `obimd-glyph-link-033972` | 󼤭 | `U+FC92D` | `reviewed_metadata_only` |
| `obimd-glyph-link-033973` | 󼤮 | `U+FC92E` | `reviewed_metadata_only` |
| `obimd-glyph-link-033974` | 󼤯 | `U+FC92F` | `reviewed_metadata_only` |
