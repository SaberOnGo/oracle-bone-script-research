# Material Visual Observation / obs-comp-cand-000477 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000477`
- External reference / 外部参照: `obimd-sub-qpe695ed6v`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012627_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qpe695ed6v/qpe695ed6v/qpe695ed6v.png`
- Checksum / 校验和:
  `34ca5b8a6a43928735306e8e5ee27bd71554f16da180a7c4fca205048921b0c0`
...
- Marked-pixel bounds: (80,26)–(169,223); span 90 × 198 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.30%。
- 痕迹范围：(80,26)–(169,223)；跨度90 × 198 px；痕迹矩形高于宽。
