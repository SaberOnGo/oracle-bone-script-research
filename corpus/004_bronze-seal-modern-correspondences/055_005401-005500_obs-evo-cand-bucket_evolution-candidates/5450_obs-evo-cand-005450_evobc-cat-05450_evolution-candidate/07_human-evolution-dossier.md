...
Project ID: `obs-evo-cand-005450`
...
- Project ID: `obs-evo-cand-005450`
- EVOBC category candidate ID: `evobc-evo-cat-05450`
- External category reference: `evobc-cat-05450`
- Source category ID: `05450`
- Source label for human review: `瑮`
- Source codepoints: `U+746E`
...
- `obs-evo-cand-005450-route-category-staging`
...
- `obs-evo-cand-005450-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005450-route-evolution-graph`
