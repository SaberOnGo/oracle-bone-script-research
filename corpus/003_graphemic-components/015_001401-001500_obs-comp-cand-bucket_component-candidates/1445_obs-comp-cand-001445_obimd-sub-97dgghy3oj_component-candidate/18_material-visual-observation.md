# Material Visual Observation / obs-comp-cand-001445 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001445`
- External reference / 外部参照: `obimd-sub-97dgghy3oj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016022_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/97dgghy3oj/97dgghy3oj/97dgghy3oj.png`
- Checksum / 校验和:
  `22a211f88bc2a2c426b4f7f7fd38aeb55f4f4c4c539c8a478b529e3ae0cd5d2b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.30%.
- Marked-pixel bounds: (78,24)–(172,226); span 95 × 203 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.30%。
- 痕迹范围：(78,24)–(172,226)；跨度95 × 203 px；痕迹矩形高于宽。
