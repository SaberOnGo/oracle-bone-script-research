# obs-char-000066 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/066_obs-char-000066_hust-obc-cat-0076_orac
  le-character/03_visual-assets/001_asset-000071_hust-obc-cat-0076_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0076/G_0076_屯0873(甲).png`
- asset id: `asset-000071`
...
- source category: `0076`
- validation class: `65`
- source image route: `HUST-OBC/deciphered/0076/G_0076_屯0873(甲).png`
- asset id: `asset-000071`
...
- English observation: `Two separated forms are visible: the left has
  stacked crossing marks and a lower fork, while the right is a curved
  bracket-like form.`
...
- dataset label text: `㑂`
- dataset label codepoints: `U+3442`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/009_obs-evo-can
  d-000009_evobc-cat-00009_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/009_obs-evo-cand-000009_evobc-cat-00009_evolu
...
- Which source records identify obs-char-000066 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000066？
