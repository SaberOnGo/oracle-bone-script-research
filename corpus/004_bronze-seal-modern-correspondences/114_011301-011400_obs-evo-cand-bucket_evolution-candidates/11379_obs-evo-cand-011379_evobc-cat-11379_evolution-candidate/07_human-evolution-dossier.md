...
- External category reference: `evobc-cat-11379`
- Source category ID: `11379`
- Source label for human review: `𣂲`
...
- `obs-evo-cand-011379-route-category-staging`
...
- `obs-evo-cand-011379-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011379-route-evolution-graph`
