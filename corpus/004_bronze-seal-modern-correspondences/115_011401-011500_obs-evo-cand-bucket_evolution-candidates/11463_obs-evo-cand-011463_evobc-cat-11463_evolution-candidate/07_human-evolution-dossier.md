...
- External category reference: `evobc-cat-11463`
- Source category ID: `11463`
...
- `obs-evo-cand-011463-route-category-staging`
...
- `obs-evo-cand-011463-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011463-route-evolution-graph`
