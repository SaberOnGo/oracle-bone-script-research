# obs-unk-004032 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/032_obs-unk-004032_h
  ust-obc-und-L-004032_oracle-character-candidate/03_visual-assets/001_asset
  -005625_hust-obc-und-L-004032_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4032/L_？_8611.jpg`
- asset id: `asset-005625`
...
- source class: `HUST-OBC/undeciphered/L/4032/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4032/L_？_8611.jpg`
- asset id: `asset-005625`
...
- English observation: A long curved or upright trace runs along the right
  ...
  are connected.
- 中文观察：右侧有长而弯曲或直立的痕迹；左侧分叉上痕迹下方有紧凑的圆弧区域，
    内部可见小型留白。图像未显示左右两侧是否相连。
...
- Which source records identify obs-unk-004032 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004032？
