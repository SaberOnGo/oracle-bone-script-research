...
- `obs-evo-cand-009985-route-category-staging`
...
- `obs-evo-cand-009985-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009985-route-evolution-graph`
