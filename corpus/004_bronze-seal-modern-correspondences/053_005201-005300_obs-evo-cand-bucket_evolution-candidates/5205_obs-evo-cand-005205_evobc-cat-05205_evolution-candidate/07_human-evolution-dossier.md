...
- External category reference: `evobc-cat-05205`
- Source category ID: `05205`
- Source label: `牝`
- Source codepoints: `U+725D`
- Image reference count in source metadata: `172`
...
- `obs-evo-cand-005205-route-category-staging`
...
- `obs-evo-cand-005205-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005205-route-evolution-graph`
