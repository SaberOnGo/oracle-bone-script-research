# obs-comp-cand-000253 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000253`
- 首选外部 ID: `obimd-sub-vrcmv7tjdu`
- OBIMD subcharacter UID: `vrcmv7tjdu`
- OBIMD main character UID: `vrcmv7tjdu`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+6749;U+F1747; U+F1748; 另有 2 项
