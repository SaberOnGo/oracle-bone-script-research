# Material Visual Observation / obs-comp-cand-001566 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001566`
- External reference / 外部参照: `obimd-sub-ex96ntmoie`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017113_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ex96ntmoie/ex96ntmoie/ex96ntmoie.png`
- Checksum / 校验和:
  `344e20682351c9792c974e84cf89bb7e02585f60738067e57789a76f94bf9bbe`
...
- Marked-pixel bounds: (88,42)–(148,208); span 61 × 167 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.92%。
- 痕迹范围：(88,42)–(148,208)；跨度61 × 167 px；痕迹矩形高于宽。
