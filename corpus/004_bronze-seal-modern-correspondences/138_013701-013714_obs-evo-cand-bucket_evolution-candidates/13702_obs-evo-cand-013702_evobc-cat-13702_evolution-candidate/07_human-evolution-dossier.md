...
Project ID: `obs-evo-cand-013702`
...
- Project ID: `obs-evo-cand-013702`
- EVOBC category candidate ID: `evobc-evo-cat-13702`
- External category reference: `evobc-cat-13702`
- Source category ID: `13702`
- Source label for human review: `亂`
- Source codepoints: `U+F91B`
...
- `obs-evo-cand-013702-route-category-staging`
...
- `obs-evo-cand-013702-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013702-route-evolution-graph`
