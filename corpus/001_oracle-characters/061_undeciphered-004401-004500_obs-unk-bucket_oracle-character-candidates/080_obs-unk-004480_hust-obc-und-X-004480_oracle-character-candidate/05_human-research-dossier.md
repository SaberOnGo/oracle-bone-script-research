# obs-unk-004480 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/080_obs-unk-004480_h
  ust-obc-und-X-004480_oracle-character-candidate/03_visual-assets/001_asset
  -006073_hust-obc-und-X-004480_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/36/X_？_7205_1.png`
- asset id: `asset-006073`
...
- source class: `HUST-OBC/undeciphered/X/36/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/36/X_？_7205_1.png`
- asset id: `asset-006073`
...
- English observation: A central stem has upper hooks and a rounded opening,
  then divides into two lower terminals.
- 中文观察: 中轴带上部钩状痕迹和圆弧开口，下部再分成两个末端。
...
- Which source records identify obs-unk-004480 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004480？
