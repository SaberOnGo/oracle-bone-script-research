# obs-unk-004441 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004441`
- primary external id: `hust-obc-und-L-004441`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/041_obs-unk-004441_h
  ust-obc-und-L-004441_oracle-character-candidate/03_visual-assets/001_asset
  -006034_hust-obc-und-L-004441_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4441/L_？_9971.jpg`
- asset id: `asset-006034`
...
- source class: `HUST-OBC/undeciphered/L/4441/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4441/L_？_9971.jpg`
- asset id: `asset-006034`
...
- English observation: `An upper rounded outline sits above a separate`
  `lower angled mark.`
- 中文观察: `上部圆弧轮廓位于分离的下部斜向痕迹之上。`
...
- Which source records identify obs-unk-004441 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004441？
