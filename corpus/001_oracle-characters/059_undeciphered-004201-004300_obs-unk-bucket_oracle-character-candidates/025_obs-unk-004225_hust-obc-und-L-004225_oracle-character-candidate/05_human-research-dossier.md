# obs-unk-004225 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004225`
- primary external id: `hust-obc-und-L-004225`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/025_obs-unk-004225_h
  ust-obc-und-L-004225_oracle-character-candidate/03_visual-assets/001_asset
  -005818_hust-obc-und-L-004225_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4225/L_？_9242.jpg`
- asset id: `asset-005818`
...
- source class: `HUST-OBC/undeciphered/L/4225/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4225/L_？_9242.jpg`
- asset id: `asset-005818`
...
- English observation: `Upper rounded trace, diagonal, lower curve visible.`
- 中文观察: `上部圆弧痕迹、斜笔画和下部弯曲笔画可见。`
...
- Which source records identify obs-unk-004225 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004225？
