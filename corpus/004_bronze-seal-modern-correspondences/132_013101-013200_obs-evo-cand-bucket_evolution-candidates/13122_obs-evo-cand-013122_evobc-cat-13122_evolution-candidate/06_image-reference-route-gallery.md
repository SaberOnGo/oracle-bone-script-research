...
- `obs-evo-cand-013122-route-category-staging`
...
- `obs-evo-cand-013122-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013122-route-evolution-graph`
