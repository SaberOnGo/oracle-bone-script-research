# src-obimd Source Object / src-obimd 来源对象
...
- Provider / 提供方: `Key Laboratory of Oracle Bone Inscriptions Information Processing Anyang Normal University; Xiamen University; Tencent Youtu Lab; University of Cambridge; Scientific Data`
...
- Metadata profile route count / metadata profile 路线数: `5`

## Risk And Boundary / 风险与边界

English:
Dataset card reports CC-BY 4.0 while the GitHub README includes narrower academic-use wording; raw files remain large and need rights review before import.
