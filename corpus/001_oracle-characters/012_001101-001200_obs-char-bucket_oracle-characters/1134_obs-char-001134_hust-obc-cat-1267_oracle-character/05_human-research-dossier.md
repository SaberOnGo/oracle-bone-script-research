# obs-char-001134 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1134_obs-char-001134_hust-obc-cat-1267_ora
  cle-character/03_visual-assets/001_asset-001139_hust-obc-cat-1267_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1267/G_1267_佚604(甲).png`
- asset id: `asset-001139`
...
- source category: `1267`
- validation class: `1133`
- source image route: `HUST-OBC/deciphered/1267/G_1267_佚604(甲).png`
- asset id: `asset-001139`
...
- English observation: `A broad horizontal stroke crosses a central upright,
  with a short right branch and a long lower descending stroke.`
- 中文观察: `宽大的水平笔穿过中央直立笔，右侧有短分枝，下方有长下行笔。`
...
- dataset label text: `㣩`
- dataset label codepoints: `U+38E9`
...
- Which source records identify obs-char-001134 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001134？
