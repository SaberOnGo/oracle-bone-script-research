...
- External category reference: `evobc-cat-10072`
- Source category ID: `10072`
- Source label for human review: `颼`
- Source codepoints: `U+98BC`
...
- `obs-evo-cand-010072-route-category-staging`
...
- `obs-evo-cand-010072-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010072-route-evolution-graph`
