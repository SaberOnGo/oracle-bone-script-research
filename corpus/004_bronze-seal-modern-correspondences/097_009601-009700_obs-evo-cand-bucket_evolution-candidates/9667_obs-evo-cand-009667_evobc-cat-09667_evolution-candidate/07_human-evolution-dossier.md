...
- External category reference: `evobc-cat-09667`
- Source category ID: `09667`
- Source label for human review: `闢`
...
- `obs-evo-cand-009667-route-category-staging`
...
- `obs-evo-cand-009667-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009667-route-evolution-graph`
