...
- Project ID: `obs-evo-cand-007267`
- EVOBC category candidate ID: `evobc-evo-cat-07267`
- External category reference: `evobc-cat-07267`
- Source category ID: `07267`
- Source label for human review: `芻`
- Source codepoints: `U+82BB`
...
- `obs-evo-cand-007267-route-category-staging`
...
- `obs-evo-cand-007267-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007267-route-evolution-graph`
