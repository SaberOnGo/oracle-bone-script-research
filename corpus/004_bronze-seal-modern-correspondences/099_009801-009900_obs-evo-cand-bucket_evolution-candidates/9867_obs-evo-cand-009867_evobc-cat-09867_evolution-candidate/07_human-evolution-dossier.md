...
- External category reference: `evobc-cat-09867`
- Source category ID: `09867`
- Source label for human review: `霣`
...
- `obs-evo-cand-009867-route-category-staging`
...
- `obs-evo-cand-009867-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009867-route-evolution-graph`
