...
- External category reference: `evobc-cat-09560`
- Source category ID: `09560`
- Source label for human review: `鑺`
...
- `obs-evo-cand-009560-route-category-staging`
...
- `obs-evo-cand-009560-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009560-route-evolution-graph`
