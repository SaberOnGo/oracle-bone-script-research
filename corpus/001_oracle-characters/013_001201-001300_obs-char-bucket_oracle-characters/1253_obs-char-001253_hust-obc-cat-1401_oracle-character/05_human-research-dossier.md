# obs-char-001253 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001253`
- primary external id: `hust-obc-cat-1401`
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1253_obs-char-001253_hust-obc-cat-1401_ora
  cle-character/03_visual-assets/001_asset-001258_hust-obc-cat-1401_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1401/G_1401_京津2221(甲).png`
- asset id: `asset-001258`
...
- source category: `1401`
- validation class: `1252`
- source image route: `HUST-OBC/deciphered/1401/G_1401_京津2221(甲).png`
- asset id: `asset-001258`
...
- English observation: `A faint narrow form has a small angular upper
  enclosure, a long descending stem, and a short side mark.`
- 中文观察: `较淡的狭长形体有小型折角上部框形、长下行笔干和一条短侧笔画。`
...
- dataset label text: `㥯`
- dataset label codepoints: `U+396F`
...
- Which source records identify obs-char-001253 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001253？
