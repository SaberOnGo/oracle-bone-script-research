...
- External category reference: `evobc-cat-08457`
- Source category ID: `08457`
- Source label for human review: `谛`
- Source codepoints: `U+8C1B`
...
- `obs-evo-cand-008457-route-category-staging`
...
- `obs-evo-cand-008457-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008457-route-evolution-graph`
