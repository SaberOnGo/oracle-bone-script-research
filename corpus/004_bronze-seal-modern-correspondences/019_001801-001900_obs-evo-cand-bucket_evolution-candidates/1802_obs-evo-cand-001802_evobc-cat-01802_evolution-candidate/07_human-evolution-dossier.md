...
- External category reference: `evobc-cat-01802`
- Source category ID: `01802`
- Source label: `圾`
...
- `obs-evo-cand-001802-route-category-staging`
...
- `obs-evo-cand-001802-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-001802-route-evolution-graph`
