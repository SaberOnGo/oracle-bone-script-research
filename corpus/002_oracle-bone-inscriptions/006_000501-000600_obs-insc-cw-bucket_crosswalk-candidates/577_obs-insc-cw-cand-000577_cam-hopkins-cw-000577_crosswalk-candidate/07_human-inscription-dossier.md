...
- Source page section: `Period V Group 18` /
  `第 V 期第 18 组`
- Source section key: `period-v-group-18`
...
- Yingguo / 英国所藏: `y2613` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `A14` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000577`
