# obs-char-000118 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000118`
- primary external id: `hust-obc-cat-0132`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/118_obs-char-000118_hust-obc-cat-0132_orac
  le-character/03_visual-assets/001_asset-000123_hust-obc-cat-0132_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0132/G_0132_乙4196反合18810反.png`
- asset id: `asset-000123`
...
- source category: `0132`
- validation class: `117`
- source image route: `HUST-OBC/deciphered/0132/G_0132_乙4196反合18810反.png`
- asset id: `asset-000123`
...
- English observation: `The image has a pointed triangular upper form, a
  horizontal cross stroke, two short uprights, and a rounded closed lower
  bowl.`
- 中文观察: `图像上部呈尖三角形，有横向交叉笔和两道短竖笔，下部为圆弧闭合框。`
...
- dataset label text: `㑺`
- dataset label codepoints: `U+347A`
...
- filename catalog route clues: `Heji-like filename clue: 合18810
  (G_0132_乙4196反合18810反.png)`
...
- Which source records identify obs-char-000118 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000118？
