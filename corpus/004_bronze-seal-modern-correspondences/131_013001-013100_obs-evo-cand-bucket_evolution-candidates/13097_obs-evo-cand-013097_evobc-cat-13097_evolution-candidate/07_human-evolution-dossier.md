...
Project ID: `obs-evo-cand-013097`
...
- Project ID: `obs-evo-cand-013097`
- EVOBC category candidate ID: `evobc-evo-cat-13097`
- External category reference: `evobc-cat-13097`
- Source category ID: `13097`
- Source label for human review: `𫳥`
- Source codepoints: `U+2BCE5`
...
- `obs-evo-cand-013097-route-category-staging`
...
- `obs-evo-cand-013097-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013097-route-evolution-graph`
