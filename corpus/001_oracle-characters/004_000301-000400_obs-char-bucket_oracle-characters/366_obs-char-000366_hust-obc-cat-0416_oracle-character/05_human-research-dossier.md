# obs-char-000366 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000366`
- primary external id: `hust-obc-cat-0416`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/366_obs-char-000366_hust-obc-cat-0416_orac
  le-character/03_visual-assets/001_asset-000371_hust-obc-cat-0416_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0416/G_0416_乙2110(甲).png`
- asset id: `asset-000371`
...
- source category: `0416`
- validation class: `365`
- source image route: `HUST-OBC/deciphered/0416/G_0416_乙2110(甲).png`
- asset id: `asset-000371`
...
- English observation: `An angular pointed upper form is joined to a long
  slanting lower stroke and a short left branch.`
- 中文观察: `尖状折角上部形体连接长斜向下行笔画，左侧另有短分支。`
...
- dataset label text: `㖖`
- dataset label codepoints: `U+3596`
...
- Which source records identify obs-char-000366 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000366？
