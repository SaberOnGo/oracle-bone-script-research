...
- External category reference: `evobc-cat-00863`
- Source category ID: `00863`
- Source label for human review: `侰`
- Source codepoints: `U+4FB0`
...
- `obs-evo-cand-000863-route-category-staging`
...
- `obs-evo-cand-000863-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000863-route-evolution-graph`
