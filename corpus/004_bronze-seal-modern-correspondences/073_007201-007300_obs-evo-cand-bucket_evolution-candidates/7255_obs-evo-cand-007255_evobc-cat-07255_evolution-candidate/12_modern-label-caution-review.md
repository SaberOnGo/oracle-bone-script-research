# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007255
...
- EVOBC candidate category: `evobc-evo-cat-07255`.
- Source label for search only: `芪`.
- Source codepoints for search only: `U+82AA`.
