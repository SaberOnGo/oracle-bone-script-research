# Material Visual Observation / obs-comp-cand-002201 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002201`
- External reference / 外部参照: `obimd-sub-cvxsbiqy4g`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019907_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cvxsbiqy4g/cvxsbiqy4g/cvxsbiqy4g.png`
- Checksum / 校验和:
  `c5233ed373d36ebedb43fe451ad08007213c27725faf8dda8d417682767a0ade`
...
- Marked-pixel bounds: (73,27)–(189,222); span 117 × 196 px; the marked
...
- 痕迹范围：(73,27)–(189,222)；跨度117 × 196 px；痕迹矩形高于宽。
