...
- External category reference: `evobc-cat-12754`
- Source category ID: `12754`
- Source label for human review: `𪑙`
- Source codepoints: `U+2A459`
...
- `obs-evo-cand-012754-route-category-staging`
...
- `obs-evo-cand-012754-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012754-route-evolution-graph`
