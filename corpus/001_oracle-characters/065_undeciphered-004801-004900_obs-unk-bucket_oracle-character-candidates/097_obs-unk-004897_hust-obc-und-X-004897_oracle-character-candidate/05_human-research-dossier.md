# obs-unk-004897 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004897`
- primary external id: `hust-obc-und-X-004897`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/097_obs-unk-004897_h
  ust-obc-und-X-004897_oracle-character-candidate/03_visual-assets/001_asset
  -006490_hust-obc-und-X-004897_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/453/X_？_7433_1.png`
- asset id: `asset-006490`
...
- source class: `HUST-OBC/undeciphered/X/453/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/453/X_？_7433_1.png`
- asset id: `asset-006490`
...
- English observation: `curved upper stem and dense lower grid`
- 中文观察: `弧形上部长笔画和密集下部格状结构`
...
- Which source records identify obs-unk-004897 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004897？
