...
Project ID: `obs-evo-cand-002987`
...
- Project ID: `obs-evo-cand-002987`
- EVOBC category candidate ID: `evobc-evo-cat-02987`
- External category reference: `evobc-cat-02987`
- Source category ID: `02987`
- Source label for human review: `恬`
- Source codepoints: `U+606C`
...
- `obs-evo-cand-002987-route-category-staging`
...
- `obs-evo-cand-002987-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002987-route-evolution-graph`
