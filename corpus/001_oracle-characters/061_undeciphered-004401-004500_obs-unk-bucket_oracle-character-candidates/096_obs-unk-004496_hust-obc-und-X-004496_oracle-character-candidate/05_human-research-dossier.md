# obs-unk-004496 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/096_obs-unk-004496_h
  ust-obc-und-X-004496_oracle-character-candidate/03_visual-assets/001_asset
  -006089_hust-obc-und-X-004496_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/52/X_？_8236_1.png`
- asset id: `asset-006089`
...
- source class: `HUST-OBC/undeciphered/X/52/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/52/X_？_8236_1.png`
- asset id: `asset-006089`
...
- English observation: `The two peaks, central V trace, long side contours,
  and detached raster marks are directly recorded.`
- 中文观察: `已直接记录两个尖峰、中央 V 形痕、两侧长轮廓和分离栅格痕。`
...
- Which source records identify obs-unk-004496 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004496？
