# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008134
...
- EVOBC candidate category: `evobc-evo-cat-08134`.
- Source label for search only: `訑`.
- Source codepoints for search only: `U+8A11`.
