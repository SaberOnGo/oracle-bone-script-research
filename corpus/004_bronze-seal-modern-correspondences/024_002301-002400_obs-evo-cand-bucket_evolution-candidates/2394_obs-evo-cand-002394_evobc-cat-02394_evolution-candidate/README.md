# obs-evo-cand-002394 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-002394`
- EVOBC category candidate ID: `evobc-evo-cat-02394`
- External category ref: `evobc-cat-02394`
- Source label: `宰`
- Source codepoints: `U+5BB0`
- Image reference count: `149`
- Era token counts: `BI:44;CS:1;OBC:60;SAC:7;SS:2;WSC:35`
- Source token counts: `Book:52;Web:97`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 60 image references
- era 1 / BI: 44 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 7 image references
- era 4 / WSC: 35 image references
- era 5 / CS: 1 image references
- source 0 / Web:1633: 2 image references
- source 1 / Web:105952;說文Web:58: 53 image references
