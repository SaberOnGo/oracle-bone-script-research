# Material Visual Observation / obs-comp-cand-002131 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002131`
- External reference / 外部参照: `obimd-sub-l93tak6vzx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019688_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l93tak6vzx/l93tak6vzx/l93tak6vzx.png`
- Checksum / 校验和:
  `48a4c4ba779f8947a200a87afe3804f00a41d0b6916f260cb030a8c0c172148d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.62%.
- Marked-pixel bounds: (67,40)–(182,204); span 116 × 165 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.62%。
- 痕迹范围：(67,40)–(182,204)；跨度116 × 165 px；痕迹矩形高于宽。
