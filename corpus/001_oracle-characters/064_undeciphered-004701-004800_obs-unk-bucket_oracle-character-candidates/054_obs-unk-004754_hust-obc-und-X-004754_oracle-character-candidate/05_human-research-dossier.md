# obs-unk-004754 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004754`
- primary external id: `hust-obc-und-X-004754`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/054_obs-unk-004754_h
  ust-obc-und-X-004754_oracle-character-candidate/03_visual-assets/001_asset
  -006347_hust-obc-und-X-004754_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/310/X_？_7295_1.png`
- asset id: `asset-006347`
...
- source class: `HUST-OBC/undeciphered/X/310/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/310/X_？_7295_1.png`
- asset id: `asset-006347`
...
- English observation: `central branching group with detached upper openings`
- 中文观察: `带分离上部开口的中央分支组`
...
- Which source records identify obs-unk-004754 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004754？
