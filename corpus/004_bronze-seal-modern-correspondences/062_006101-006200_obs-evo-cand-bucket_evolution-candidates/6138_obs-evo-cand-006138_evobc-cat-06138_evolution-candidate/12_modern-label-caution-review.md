# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006138
...
- EVOBC candidate category: `evobc-evo-cat-06138`.
- Source label for search only: `穩`.
- Source codepoints for search only: `U+7A69`.
