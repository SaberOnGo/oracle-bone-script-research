# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012957
...
- EVOBC candidate category: `evobc-evo-cat-12957`.
- Source label for search only: `𫒊`.
- Source codepoints for search only: `U+2B48A`.
