# Material Visual Observation / obs-comp-cand-000624 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000624`
- External reference / 外部参照: `obimd-sub-hwj18cvm0i`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013187_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hwj18cvm0i/hwj18cvm0i/hwj18cvm0i.png`
- Checksum / 校验和:
  `77bd7eb78d23a0f8dbb65a9f3367b2abb4123cd21a96c3e2f6eb3c7318cc5a59`
...
- Marked-pixel bounds: (84,21)–(163,226); span 80 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.33%。
- 痕迹范围：(84,21)–(163,226)；跨度80 × 206 px；痕迹矩形高于宽。
