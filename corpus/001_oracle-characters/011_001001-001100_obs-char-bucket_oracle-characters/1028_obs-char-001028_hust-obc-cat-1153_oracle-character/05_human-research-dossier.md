# obs-char-001028 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1028_obs-char-001028_hust-obc-cat-1153_ora
  cle-character/03_visual-assets/001_asset-001033_hust-obc-cat-1153_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1153/L_1153_12829.jpg`
- asset id: `asset-001033`
...
- source category: `1153`
- validation class: `1027`
- source image route: `HUST-OBC/deciphered/1153/L_1153_12829.jpg`
- asset id: `asset-001033`
...
- English observation: `The faint gray image shows a narrow stacked cluster
  with short horizontal bands and a curved lower extension; contrast is
  low.`
- 中文观察: `较淡灰色图像显示狭长叠置笔群、短横向带和弯曲下部外伸；对比度较低。`
...
- dataset label text: `㡷`
- dataset label codepoints: `U+3877`
...
- Which source records identify obs-char-001028 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001028？
