...
- External category reference: `evobc-cat-12909`
- Source category ID: `12909`
- Source label for human review: `𫁲`
- Source codepoints: `U+2B072`
...
- `obs-evo-cand-012909-route-category-staging`
...
- `obs-evo-cand-012909-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012909-route-evolution-graph`
