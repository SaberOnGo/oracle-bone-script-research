...
- External category reference: `evobc-cat-08953`
- Source category ID: `08953`
- Source label for human review: `违`
- Source codepoints: `U+8FDD`
...
- `obs-evo-cand-008953-route-category-staging`
...
- `obs-evo-cand-008953-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008953-route-evolution-graph`
