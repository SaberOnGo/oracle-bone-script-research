# obs-char-000850 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000850`
- primary external id: `hust-obc-cat-0959`
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/850_obs-char-000850_hust-obc-cat-0959_orac
  le-character/03_visual-assets/001_asset-000855_hust-obc-cat-0959_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0959/G_0959_餘15.4(甲).png`
- asset id: `asset-000855`
...
- source category: `0959`
- validation class: `849`
- source image route: `HUST-OBC/deciphered/0959/G_0959_餘15.4(甲).png`
- asset id: `asset-000855`
...
- English observation: `A very narrow cluster contains long curved strokes
  with short diagonal side marks; fine joining is difficult to resolve.`
...
- dataset label text: `㞵`
- dataset label codepoints: `U+37B5`
...
- Which source records identify obs-char-000850 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000850？
