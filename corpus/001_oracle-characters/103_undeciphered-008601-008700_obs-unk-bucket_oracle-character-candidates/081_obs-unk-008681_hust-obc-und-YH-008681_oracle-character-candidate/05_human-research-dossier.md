# obs-unk-008681 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/103_undeciphered-008
  601-008700_obs-unk-bucket_oracle-character-candidates/081_obs-unk-008681_h
  ust-obc-und-YH-008681_oracle-character-candidate/03_visual-assets/001_asse
  t-010272_hust-obc-und-YH-008681_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60D0E/Y_？_60D0E.jpg`
- asset id: `asset-010272`
...
- source class: `HUST-OBC/undeciphered/Y+H/60D0E/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60D0E/Y_？_60D0E.jpg`
- asset id: `asset-010272`
...
- Which source records identify obs-unk-008681 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008681？
