# obs-unk-005816 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005816`
- primary external id: `hust-obc-und-X-005816`
...
- local review image route: `corpus/001_oracle-characters/075_undeciphered-005
  801-005900_obs-unk-bucket_oracle-character-candidates/016_obs-unk-005816_h
  ust-obc-und-X-005816_oracle-character-candidate/03_visual-assets/001_asset
  -007408_hust-obc-und-X-005816_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1372/X_？_1838_1.png`
- asset id: `asset-007408`
...
- source class: `HUST-OBC/undeciphered/X/1372/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1372/X_？_1838_1.png`
- asset id: `asset-007408`
...
- Which source records identify obs-unk-005816 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005816？
