...
- External category reference: `evobc-cat-03261`
- Source category ID: `03261`
- Source label for human review: `扮`
...
- `obs-evo-cand-003261-route-category-staging`
...
- `obs-evo-cand-003261-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003261-route-evolution-graph`
