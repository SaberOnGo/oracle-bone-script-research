# Material Visual Observation / obs-comp-cand-001782 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001782`
- External reference / 外部参照: `obimd-sub-utzaaksrqa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018003_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pzvzykmf5e/utzaaksrqa/utzaaksrqa.png`
- Checksum / 校验和:
  `4ef1830882e9df57dca07305a5dd1785caf03b20dfbc043af62fc5bfb1a33c34`
...
- Marked-pixel bounds: (80,63)–(169,182); span 90 × 120 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.66%。
- 痕迹范围：(80,63)–(169,182)；跨度90 × 120 px；痕迹矩形高于宽。
