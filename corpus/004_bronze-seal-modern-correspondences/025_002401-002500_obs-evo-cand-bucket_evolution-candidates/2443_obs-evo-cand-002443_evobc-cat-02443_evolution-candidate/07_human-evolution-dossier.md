...
Project ID: `obs-evo-cand-002443`
...
- Project ID: `obs-evo-cand-002443`
- EVOBC category candidate ID: `evobc-evo-cat-02443`
- External category reference: `evobc-cat-02443`
- Source category ID: `02443`
- Source label for human review: `寱`
- Source codepoints: `U+5BF1`
...
- `obs-evo-cand-002443-route-category-staging`
...
- `obs-evo-cand-002443-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002443-route-evolution-graph`
