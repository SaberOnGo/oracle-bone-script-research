...
- Project ID: `obs-evo-cand-008529`
- EVOBC category candidate ID: `evobc-evo-cat-08529`
- External category reference: `evobc-cat-08529`
- Source category ID: `08529`
- Source label for human review: `貙`
- Source codepoints: `U+8C99`
...
- `obs-evo-cand-008529-route-category-staging`
...
- `obs-evo-cand-008529-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008529-route-evolution-graph`
