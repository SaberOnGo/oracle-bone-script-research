# obs-unk-004395 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004395`
- primary external id: `hust-obc-und-L-004395`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/095_obs-unk-004395_h
  ust-obc-und-L-004395_oracle-character-candidate/03_visual-assets/001_asset
  -005988_hust-obc-und-L-004395_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4395/L_？_9784.jpg`
- asset id: `asset-005988`
...
- source class: `HUST-OBC/undeciphered/L/4395/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4395/L_？_9784.jpg`
- asset id: `asset-005988`
...
- English observation: `The opened crop is nearly blank; no stable dark`
  `stroke or outline is distinguishable.`
- 中文观察: `打开的裁剪图近乎空白，暂不能辨认稳定深色笔痕或轮廓。`
...
- Which source records identify obs-unk-004395 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004395？
