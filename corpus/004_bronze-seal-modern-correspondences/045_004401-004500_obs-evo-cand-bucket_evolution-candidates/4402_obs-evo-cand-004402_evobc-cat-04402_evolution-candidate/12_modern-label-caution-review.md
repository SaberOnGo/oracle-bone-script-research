# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004402
...
- EVOBC candidate category: `evobc-evo-cat-04402`.
- Source label for search only: `歾`.
- Source codepoints for search only: `U+6B7E`.
