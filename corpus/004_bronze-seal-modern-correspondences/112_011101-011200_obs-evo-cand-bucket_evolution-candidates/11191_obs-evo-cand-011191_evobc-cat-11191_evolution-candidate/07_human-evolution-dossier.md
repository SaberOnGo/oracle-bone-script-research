...
- Project ID: `obs-evo-cand-011191`
- EVOBC category candidate ID: `evobc-evo-cat-11191`
- External category reference: `evobc-cat-11191`
- Source category ID: `11191`
- Source label for human review: `𢑏`
- Source codepoints: `U+2244F`
- Image reference count in source metadata: `9`
...
- `obs-evo-cand-011191-route-category-staging`
...
- `obs-evo-cand-011191-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011191-route-evolution-graph`
