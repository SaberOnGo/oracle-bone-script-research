...
- External category reference: `evobc-cat-01236`
- Source category ID: `01236`
- Source label for human review: `剪`
...
- `obs-evo-cand-001236-route-category-staging`
...
- `obs-evo-cand-001236-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001236-route-evolution-graph`
