# obs-char-000750 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/750_obs-char-000750_hust-obc-cat-0852_orac
  le-character/03_visual-assets/001_asset-000755_hust-obc-cat-0852_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0852/G_0852_乙960(甲).png`
- asset id: `asset-000755`
...
- source category: `0852`
- validation class: `749`
- source image route: `HUST-OBC/deciphered/0852/G_0852_乙960(甲).png`
- asset id: `asset-000755`
...
- English observation: `Three small tilted loops occupy the upper row and
  attach to spreading diagonal branches that meet at a central fork above
  two narrow descending strokes.`
- 中文观察: `三个小型倾斜环位于上排，连接外展斜枝；斜枝在中央分叉处汇合，下接两条狭长下笔。`
...
- dataset label text: `㝊`
- dataset label codepoints: `U+374A`
...
- matched OBIMD main UIDs: `mqa9ifrvq4`
...
- Which source records identify obs-char-000750 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000750？
