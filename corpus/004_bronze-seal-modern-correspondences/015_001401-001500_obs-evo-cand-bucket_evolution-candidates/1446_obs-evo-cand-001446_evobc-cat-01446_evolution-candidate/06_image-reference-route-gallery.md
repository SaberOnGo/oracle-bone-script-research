...
- `obs-evo-cand-001446-route-category-staging`
...
- `obs-evo-cand-001446-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001446-route-evolution-graph`
