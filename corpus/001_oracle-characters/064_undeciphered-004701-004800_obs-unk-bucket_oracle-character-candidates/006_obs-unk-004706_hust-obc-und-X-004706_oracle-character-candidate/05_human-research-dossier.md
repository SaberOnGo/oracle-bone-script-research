# obs-unk-004706 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004706`
- primary external id: `hust-obc-und-X-004706`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/006_obs-unk-004706_h
  ust-obc-und-X-004706_oracle-character-candidate/03_visual-assets/001_asset
  -006299_hust-obc-und-X-004706_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/262/X_？_7234_1.png`
- asset id: `asset-006299`
...
- source class: `HUST-OBC/undeciphered/X/262/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/262/X_？_7234_1.png`
- asset id: `asset-006299`
...
- English observation: `thin vertical trunk with angled lower band`
- 中文观察: `带下部斜带的细长竖向主体`
...
- Which source records identify obs-unk-004706 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004706？
