...
- External category reference: `evobc-cat-11420`
- Source category ID: `11420`
- Source label for human review: `𣎆`
- Source codepoints: `U+23386`
...
- `obs-evo-cand-011420-route-category-staging`
...
- `obs-evo-cand-011420-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011420-route-evolution-graph`
