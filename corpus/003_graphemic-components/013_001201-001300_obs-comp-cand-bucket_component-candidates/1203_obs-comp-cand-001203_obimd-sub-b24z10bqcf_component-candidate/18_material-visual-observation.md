# Material Visual Observation / obs-comp-cand-001203 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001203`
- External reference / 外部参照: `obimd-sub-b24z10bqcf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015434_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m9q3n9zj10/b24z10bqcf/b24z10bqcf.png`
- Checksum / 校验和:
  `5e093e0408df1667e220598f0ec7f7db25a1e325c38164f0f0734a5ed39593b7`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.39%.
- Marked-pixel bounds: (66,34)–(186,219); span 121 × 186 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.39%。
- 痕迹范围：(66,34)–(186,219)；跨度121 × 186 px；痕迹矩形高于宽。
