...
- Project ID: `obs-evo-cand-006392`
- EVOBC category candidate ID: `evobc-evo-cat-06392`
- External category reference: `evobc-cat-06392`
- Source category ID: `06392`
- Source label for human review: `类`
- Source codepoints: `U+7C7B`
...
- `obs-evo-cand-006392-route-category-staging`
...
- `obs-evo-cand-006392-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006392-route-evolution-graph`
