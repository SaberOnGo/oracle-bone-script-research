# obs-unk-004944 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004944`
- primary external id: `hust-obc-und-X-004944`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/044_obs-unk-004944_h
  ust-obc-und-X-004944_oracle-character-candidate/03_visual-assets/001_asset
  -006537_hust-obc-und-X-004944_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/500/X_？_7483_1.png`
- asset id: `asset-006537`
...
- Two upper openings meet a central upright and lower branch.
...
- source class: `HUST-OBC/undeciphered/X/500/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/500/X_？_7483_1.png`
- asset id: `asset-006537`
...
- Which source records identify obs-unk-004944 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004944？
