# obs-unk-004975 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004975`
- primary external id: `hust-obc-und-X-004975`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/075_obs-unk-004975_h
  ust-obc-und-X-004975_oracle-character-candidate/03_visual-assets/001_asset
  -006568_hust-obc-und-X-004975_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/531/X_？_7511_1.png`
- asset id: `asset-006568`
...
- source class: `HUST-OBC/undeciphered/X/531/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/531/X_？_7511_1.png`
- asset id: `asset-006568`
...
- Which source records identify obs-unk-004975 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004975？
