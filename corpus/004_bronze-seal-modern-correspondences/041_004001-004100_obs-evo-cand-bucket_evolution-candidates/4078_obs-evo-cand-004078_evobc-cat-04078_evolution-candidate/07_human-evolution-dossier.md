...
- External category reference: `evobc-cat-04078`
- Source category ID: `04078`
- Source label for human review: `械`
- Source codepoints: `U+68B0`
...
- `obs-evo-cand-004078-route-category-staging`
...
- `obs-evo-cand-004078-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004078-route-evolution-graph`
