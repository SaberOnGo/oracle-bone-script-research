...
- Project ID: `obs-evo-cand-003897`
- EVOBC category candidate ID: `evobc-evo-cat-03897`
- External category reference: `evobc-cat-03897`
- Source category ID: `03897`
- Source label for human review: `東`
- Source codepoints: `U+6771`
- Image reference count in source metadata: `225`
...
- `obs-evo-cand-003897-route-category-staging`
...
- `obs-evo-cand-003897-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003897-route-evolution-graph`
