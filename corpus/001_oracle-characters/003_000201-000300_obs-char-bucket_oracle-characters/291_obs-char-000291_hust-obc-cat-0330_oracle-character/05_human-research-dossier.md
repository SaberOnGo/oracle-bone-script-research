# obs-char-000291 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000291`
- primary external id: `hust-obc-cat-0330`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/291_obs-char-000291_hust-obc-cat-0330_orac
  le-character/03_visual-assets/001_asset-000296_hust-obc-cat-0330_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0330/G_0330_乙3380反合17301反.png`
- asset id: `asset-000296`
...
- source category: `0330`
- validation class: `290`
- source image route: `HUST-OBC/deciphered/0330/G_0330_乙3380反合17301反.png`
- asset id: `asset-000296`
...
- English observation: `The image has a rounded lower enclosure, an interior
  upright mark rising to a pointed top, and a curved outer stroke around the
  upper area.`
- 中文观察: `图像下部有圆弧闭合轮廓，内部竖向痕迹向上延伸至尖端，上部外围有弧形笔画。`
...
- dataset label text: `㕀`
- dataset label codepoints: `U+3540`
...
- Which source records identify obs-char-000291 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000291？
