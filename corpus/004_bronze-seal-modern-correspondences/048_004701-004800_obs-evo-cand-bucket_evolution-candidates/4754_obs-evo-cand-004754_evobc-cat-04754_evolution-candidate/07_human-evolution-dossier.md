...
- External category reference: `evobc-cat-04754`
- Source category ID: `04754`
- Source label for human review: `渚`
- Source codepoints: `U+6E1A`
...
- `obs-evo-cand-004754-route-category-staging`
...
- `obs-evo-cand-004754-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004754-route-evolution-graph`
