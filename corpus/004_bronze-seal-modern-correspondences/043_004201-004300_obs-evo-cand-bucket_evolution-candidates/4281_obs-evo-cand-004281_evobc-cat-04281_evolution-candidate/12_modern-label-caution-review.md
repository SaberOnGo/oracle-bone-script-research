# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004281
...
- EVOBC candidate category: `evobc-evo-cat-04281`.
- Source label for search only: `檃`.
- Source codepoints for search only: `U+6A83`.
