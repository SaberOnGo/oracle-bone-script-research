# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001361
...
- candidate_component_id: `obs-comp-cand-001361`
- primary_external_ref_id: `obimd-sub-hynap6jf6z`
- source_subcharacter_uid: `hynap6jf6z`
...
- glyph_codepoint_uplus_sample: `U+F7BCD, U+F7BCE`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-015780` | `001_asset-015780_img.png` | `c1e47a55429bcafec9c9594ffba3d0f7ed99879915926975d4a151604755cf15` |
