...
- External category reference: `evobc-cat-09716`
- Source category ID: `09716`
- Source label for human review: `阿`
...
- `obs-evo-cand-009716-route-category-staging`
...
- `obs-evo-cand-009716-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009716-route-evolution-graph`
