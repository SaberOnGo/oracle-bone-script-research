...
Project ID: `obs-evo-cand-008640`
...
- Project ID: `obs-evo-cand-008640`
- EVOBC category candidate ID: `evobc-evo-cat-08640`
- External category reference: `evobc-cat-08640`
- Source category ID: `08640`
- Source label for human review: `赋`
- Source codepoints: `U+8D4B`
...
- `obs-evo-cand-008640-route-category-staging`
...
- `obs-evo-cand-008640-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008640-route-evolution-graph`
