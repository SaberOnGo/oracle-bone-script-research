# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002728
...
| --- | --- | --- | --- |
| `obimd-glyph-link-041449` | 󿫤 | `U+FFAE4` | `reviewed_metadata_only` |
| `obimd-glyph-link-041450` | 󿘻 | `U+FF63B` | `reviewed_metadata_only` |
| `obimd-glyph-link-041451` | 󿘼 | `U+FF63C` | `reviewed_metadata_only` |
