...
Project ID: `obs-evo-cand-006103`
...
- Project ID: `obs-evo-cand-006103`
- EVOBC category candidate ID: `evobc-evo-cat-06103`
- External category reference: `evobc-cat-06103`
- Source category ID: `06103`
- Source label for human review: `稞`
- Source codepoints: `U+7A1E`
...
- `obs-evo-cand-006103-route-category-staging`
...
- `obs-evo-cand-006103-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006103-route-evolution-graph`
