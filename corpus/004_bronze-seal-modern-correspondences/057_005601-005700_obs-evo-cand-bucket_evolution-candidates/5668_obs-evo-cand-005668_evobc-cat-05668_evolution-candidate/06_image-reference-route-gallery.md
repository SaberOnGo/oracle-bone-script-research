...
- `obs-evo-cand-005668-route-category-staging`
...
- `obs-evo-cand-005668-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005668-route-evolution-graph`
