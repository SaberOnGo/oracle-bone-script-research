...
- External category reference: `evobc-cat-05582`
- Source category ID: `05582`
- Source label for human review: `異`
- Source codepoints: `U+7570`
...
- `obs-evo-cand-005582-route-category-staging`
...
- `obs-evo-cand-005582-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005582-route-evolution-graph`
