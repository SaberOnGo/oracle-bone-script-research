...
- External category reference: `evobc-cat-04980`
- Source category ID: `04980`
- Source label for human review: `瀁`
...
- `obs-evo-cand-004980-route-category-staging`
...
- `obs-evo-cand-004980-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004980-route-evolution-graph`
