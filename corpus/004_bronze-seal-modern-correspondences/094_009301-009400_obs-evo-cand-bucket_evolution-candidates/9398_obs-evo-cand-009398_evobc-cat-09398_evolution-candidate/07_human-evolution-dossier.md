...
- Project ID: `obs-evo-cand-009398`
- EVOBC category candidate ID: `evobc-evo-cat-09398`
- External category reference: `evobc-cat-09398`
- Source category ID: `09398`
- Source label for human review: `銸`
- Source codepoints: `U+92B8`
...
- `obs-evo-cand-009398-route-category-staging`
...
- `obs-evo-cand-009398-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009398-route-evolution-graph`
