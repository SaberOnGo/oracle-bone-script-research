...
- External category reference: `evobc-cat-07549`
- Source category ID: `07549`
- Source label for human review: `蔎`
- Source codepoints: `U+850E`
...
- `obs-evo-cand-007549-route-category-staging`
...
- `obs-evo-cand-007549-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007549-route-evolution-graph`
