# obs-char-000920 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000920`
- primary external id: `hust-obc-cat-1037`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/920_obs-char-000920_hust-obc-cat-1037_orac
  le-character/03_visual-assets/001_asset-000925_hust-obc-cat-1037_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1037/G_1037_乙3787合6473賓組.png`
- asset id: `asset-000925`
...
- source category: `1037`
- validation class: `919`
- source image route: `HUST-OBC/deciphered/1037/G_1037_乙3787合6473賓組.png`
- asset id: `asset-000925`
...
- English observation: `A long angled upper stroke crosses a central branch
  and continues into a lower forked diagonal.`
- 中文观察: `长上斜笔交叉中央分枝，并延续为下部叉形斜笔。`
...
- dataset label text: `㠃`
- dataset label codepoints: `U+3803`
...
- filename catalog route clues: `Heji-like filename clue: 合6473
  (G_1037_乙3787合6473賓組.png)`
...
- Which source records identify obs-char-000920 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000920？
