...
- Project ID: `obs-evo-cand-008959`
- EVOBC category candidate ID: `evobc-evo-cat-08959`
- External category reference: `evobc-cat-08959`
- Source category ID: `08959`
- Source label for human review: `迥`
- Source codepoints: `U+8FE5`
...
- `obs-evo-cand-008959-route-category-staging`
...
- `obs-evo-cand-008959-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008959-route-evolution-graph`
