# obs-char-000862 Visual Gallery / obs-char-000862 图像资料页
...
- Primary external reference / 首选外部参考: `hust-obc-cat-0972`
...
## obs-char-000862-visual-source-001 / 图像条目

![obs-char-000862 glyph candidate](03_visual-assets/001_asset-000867_hust-obc-cat-0972_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000867_hust-obc-cat-0972_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000867_hust-obc-cat-0972_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0972/G_0972_前4.13.5(甲).png`
