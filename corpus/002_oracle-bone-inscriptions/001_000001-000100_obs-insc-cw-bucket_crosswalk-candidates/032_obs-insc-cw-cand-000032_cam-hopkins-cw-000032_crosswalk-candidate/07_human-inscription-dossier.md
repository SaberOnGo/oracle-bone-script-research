...
- Yingguo / 英国所藏: `y188` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `112` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `597` in source row; primary catalog entry pending
- Heji / 合集: `39701` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000032`
