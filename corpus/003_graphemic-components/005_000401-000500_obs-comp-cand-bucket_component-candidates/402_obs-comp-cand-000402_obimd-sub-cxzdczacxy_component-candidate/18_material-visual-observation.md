# Material Visual Observation / obs-comp-cand-000402 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000402`
- External reference / 外部参照: `obimd-sub-cxzdczacxy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012325_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/cxzdczacxy/cxzdczacxy/cxzdczacxy.png`
- Checksum / 校验和:
  `faf1c53f0a2df4f80442f2ff83a943baff6dd842c5026eca1660771d47ff6c68`
...
- Marked-pixel bounds: (83,28)–(166,221); span 84 × 194 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.44%。
- 痕迹范围：(83,28)–(166,221)；跨度84 × 194 px；痕迹矩形高于宽。
