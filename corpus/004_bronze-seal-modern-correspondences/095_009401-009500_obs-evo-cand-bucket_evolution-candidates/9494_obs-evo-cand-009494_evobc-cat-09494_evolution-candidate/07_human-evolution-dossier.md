...
Project ID: `obs-evo-cand-009494`
...
- Project ID: `obs-evo-cand-009494`
- EVOBC category candidate ID: `evobc-evo-cat-09494`
- External category reference: `evobc-cat-09494`
- Source category ID: `09494`
- Source label for human review: `鏈`
- Source codepoints: `U+93C8`
...
- `obs-evo-cand-009494-route-category-staging`
...
- `obs-evo-cand-009494-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009494-route-evolution-graph`
