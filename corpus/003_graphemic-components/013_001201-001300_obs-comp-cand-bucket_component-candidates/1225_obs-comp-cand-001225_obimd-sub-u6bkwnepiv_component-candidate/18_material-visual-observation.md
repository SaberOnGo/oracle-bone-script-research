# Material Visual Observation / obs-comp-cand-001225 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001225`
- External reference / 外部参照: `obimd-sub-u6bkwnepiv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015463_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u6bkwnepiv/u6bkwnepiv/u6bkwnepiv.png`
- Checksum / 校验和:
  `9e2fad5754173ed4837f58c0f27dae74f568b8ddfe39519e39fed34390a5915e`
...
- Marked-pixel bounds: (71,27)–(178,224); span 108 × 198 px; the marked
...
- 痕迹范围：(71,27)–(178,224)；跨度108 × 198 px；痕迹矩形高于宽。
