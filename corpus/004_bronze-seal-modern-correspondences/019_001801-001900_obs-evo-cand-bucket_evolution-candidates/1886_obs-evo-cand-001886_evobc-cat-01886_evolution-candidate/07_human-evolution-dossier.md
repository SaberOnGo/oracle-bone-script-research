...
- External category reference: `evobc-cat-01886`
- Source category ID: `01886`
- Source label for human review: `執`
- Source codepoints: `U+57F7`
- Image reference count in source metadata: `336`
...
- `obs-evo-cand-001886-route-category-staging`
...
- `obs-evo-cand-001886-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001886-route-evolution-graph`
