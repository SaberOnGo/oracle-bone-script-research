# Material Visual Observation / obs-comp-cand-002729 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002729`
- External reference / 外部参照: `obimd-sub-ef1nwshoqj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021345_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ef1nwshoqj/ef1nwshoqj/ef1nwshoqj.png`
- Checksum / 校验和:
  `5a6622bd301daae9797e0d04f61a138c16c9684251b08b9ec1836d2ad0a77c55`
...
- Marked-pixel bounds: (82,12)–(170,238); span 89 × 227 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.86%。
- 痕迹范围：(82,12)–(170,238)；跨度89 × 227 px；痕迹矩形高于宽。
