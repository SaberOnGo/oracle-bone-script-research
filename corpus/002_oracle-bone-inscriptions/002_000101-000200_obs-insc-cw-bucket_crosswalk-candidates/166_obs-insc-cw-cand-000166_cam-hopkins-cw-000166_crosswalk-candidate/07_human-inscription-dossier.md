...
- Source page section: `Period I Group 13` /
  `第 I 期第 13 组`
- Source section key: `period-i-group-13`
...
- Yingguo / 英国所藏: `y1002` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `7` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `350` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000166`
