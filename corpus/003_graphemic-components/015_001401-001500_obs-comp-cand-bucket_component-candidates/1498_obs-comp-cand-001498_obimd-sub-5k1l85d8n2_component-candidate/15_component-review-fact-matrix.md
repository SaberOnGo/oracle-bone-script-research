# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001498
...
| Glyph or codepoint route / 字形或码位路线 | 50 OBIMD route rows; examples U+3C7F;U+6BBB;U+F8999; U+F899A; 另有 48 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 50 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
