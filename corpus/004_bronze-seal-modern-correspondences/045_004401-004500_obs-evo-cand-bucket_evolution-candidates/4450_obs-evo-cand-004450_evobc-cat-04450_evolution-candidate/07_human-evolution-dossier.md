...
- External category reference: `evobc-cat-04450`
- Source category ID: `04450`
- Source label for human review: `毕`
- Source codepoints: `U+6BD5`
...
- `obs-evo-cand-004450-route-category-staging`
...
- `obs-evo-cand-004450-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004450-route-evolution-graph`
