...
- Project ID: `obs-evo-cand-007581`
- EVOBC category candidate ID: `evobc-evo-cat-07581`
- External category reference: `evobc-cat-07581`
- Source category ID: `07581`
- Source label for human review: `蕘`
- Source codepoints: `U+8558`
...
- `obs-evo-cand-007581-route-category-staging`
...
- `obs-evo-cand-007581-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007581-route-evolution-graph`
