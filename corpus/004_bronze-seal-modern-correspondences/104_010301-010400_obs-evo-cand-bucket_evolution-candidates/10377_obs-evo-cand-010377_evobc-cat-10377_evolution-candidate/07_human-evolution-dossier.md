...
Project ID: `obs-evo-cand-010377`
...
- Project ID: `obs-evo-cand-010377`
- EVOBC category candidate ID: `evobc-evo-cat-10377`
- External category reference: `evobc-cat-10377`
- Source category ID: `10377`
- Source label for human review: `魴`
- Source codepoints: `U+9B74`
...
- `obs-evo-cand-010377-route-category-staging`
...
- `obs-evo-cand-010377-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010377-route-evolution-graph`
