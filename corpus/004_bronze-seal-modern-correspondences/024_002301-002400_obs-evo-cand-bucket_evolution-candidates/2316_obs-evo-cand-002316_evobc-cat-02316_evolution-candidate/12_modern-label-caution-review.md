# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002316
...
- EVOBC candidate category: `evobc-evo-cat-02316`.
- Source label for search only: `嬿`.
- Source codepoints for search only: `U+5B3F`.
