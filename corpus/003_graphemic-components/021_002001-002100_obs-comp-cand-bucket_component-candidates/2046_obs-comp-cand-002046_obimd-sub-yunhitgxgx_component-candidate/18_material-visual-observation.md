# Material Visual Observation / obs-comp-cand-002046 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002046`
- External reference / 外部参照: `obimd-sub-yunhitgxgx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019415_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yunhitgxgx/yunhitgxgx/yunhitgxgx.png`
- Checksum / 校验和:
  `27601ec2e14015a287b00a394513382b81cc394a5115d3e2011234a316341968`
...
- Marked-pixel bounds: (54,25)–(196,224); span 143 × 200 px; the marked
...
- 痕迹范围：(54,25)–(196,224)；跨度143 × 200 px；痕迹矩形高于宽。
