...
- External category reference: `evobc-cat-10190`
- Source category ID: `10190`
- Source label for human review: `駜`
- Source codepoints: `U+99DC`
...
- `obs-evo-cand-010190-route-category-staging`
...
- `obs-evo-cand-010190-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010190-route-evolution-graph`
