...
- External category reference: `evobc-cat-04735`
- Source category ID: `04735`
- Source label for human review: `淯`
- Source codepoints: `U+6DEF`
...
- `obs-evo-cand-004735-route-category-staging`
...
- `obs-evo-cand-004735-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004735-route-evolution-graph`
