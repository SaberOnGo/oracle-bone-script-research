# Material Visual Observation / obs-comp-cand-002001 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002001`
- External reference / 外部参照: `obimd-sub-relqgnqija`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019221_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/relqgnqija/relqgnqija/relqgnqija.png`
- Checksum / 校验和:
  `48a78ec66a4a942056e648132a4b16f431ae59c866b6cff76f404e934c8178f9`
...
- Marked-pixel bounds: (62,39)–(200,205); span 139 × 167 px; the marked
...
- 痕迹范围：(62,39)–(200,205)；跨度139 × 167 px；痕迹矩形高于宽。
