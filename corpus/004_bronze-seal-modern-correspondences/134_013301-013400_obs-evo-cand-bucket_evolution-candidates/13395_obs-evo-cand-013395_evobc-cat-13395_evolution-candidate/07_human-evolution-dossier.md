...
Project ID: `obs-evo-cand-013395`
...
- Project ID: `obs-evo-cand-013395`
- EVOBC category candidate ID: `evobc-evo-cat-13395`
- External category reference: `evobc-cat-13395`
- Source category ID: `13395`
- Source label for human review: `𬫍`
- Source codepoints: `U+2CACD`
...
- `obs-evo-cand-013395-route-category-staging`
...
- `obs-evo-cand-013395-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013395-route-evolution-graph`
