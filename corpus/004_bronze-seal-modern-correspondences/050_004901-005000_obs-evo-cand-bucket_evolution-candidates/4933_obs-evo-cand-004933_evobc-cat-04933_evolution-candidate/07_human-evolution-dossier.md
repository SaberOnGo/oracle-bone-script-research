...
- External category reference: `evobc-cat-04933`
- Source category ID: `04933`
- Source label for human review: `澒`
- Source codepoints: `U+6F92`
...
- `obs-evo-cand-004933-route-category-staging`
...
- `obs-evo-cand-004933-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004933-route-evolution-graph`
