# obs-unk-003957 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/056_undeciphered-003
  901-004000_obs-unk-bucket_oracle-character-candidates/057_obs-unk-003957_h
  ust-obc-und-L-003957_oracle-character-candidate/03_visual-assets/001_asset
  -005550_hust-obc-und-L-003957_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3957/L_？_8350.jpg`
- asset id: `asset-005550`
...
- source class: `HUST-OBC/undeciphered/L/3957/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3957/L_？_8350.jpg`
- asset id: `asset-005550`
...
- English observation: Short upper forked traces descend into a broader lower
  enclosure with two small downward extensions.
- 中文观察：上部短分叉痕迹向下进入较宽围合轮廓，轮廓下方有两处短延伸。
...
- Which source records identify obs-unk-003957 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003957？
