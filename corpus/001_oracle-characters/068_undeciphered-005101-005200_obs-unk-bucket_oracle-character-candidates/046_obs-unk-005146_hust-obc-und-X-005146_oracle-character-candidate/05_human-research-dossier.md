# obs-unk-005146 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/068_undeciphered-005
  101-005200_obs-unk-bucket_oracle-character-candidates/046_obs-unk-005146_h
  ust-obc-und-X-005146_oracle-character-candidate/03_visual-assets/001_asset
  -006739_hust-obc-und-X-005146_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/702/X_？_7671_1.png`
- asset id: `asset-006739`
...
- source class: `HUST-OBC/undeciphered/X/702/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/702/X_？_7671_1.png`
- asset id: `asset-006739`
...
- Which source records identify obs-unk-005146 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005146？
