# Material Visual Observation / obs-comp-cand-001034 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001034`
- External reference / 外部参照: `obimd-sub-k33cabnmrn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014527_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fbmole6hwm/k33cabnmrn/k33cabnmrn.png`
- Checksum / 校验和:
  `09de46fbb685e95a993ba526ef67c406a339a5d50498682205755531fff1d271`
...
- Marked-pixel bounds: (61,77)–(188,177); span 128 × 101 px; the marked
...
- 痕迹范围：(61,77)–(188,177)；跨度128 × 101 px；痕迹矩形宽于高。
