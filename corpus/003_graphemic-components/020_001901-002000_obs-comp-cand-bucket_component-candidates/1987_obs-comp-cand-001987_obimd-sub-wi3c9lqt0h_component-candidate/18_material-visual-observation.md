# Material Visual Observation / obs-comp-cand-001987 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001987`
- External reference / 外部参照: `obimd-sub-wi3c9lqt0h`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018979_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qe26dg343r/wi3c9lqt0h/wi3c9lqt0h.png`
- Checksum / 校验和:
  `34113653971b7de70981bb280b8b885632670c632aebfb4065acd315a450a52b`
...
- Marked-pixel bounds: (82,38)–(167,207); span 86 × 170 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.74%。
- 痕迹范围：(82,38)–(167,207)；跨度86 × 170 px；痕迹矩形高于宽。
