...
Project ID: `obs-evo-cand-013332`
...
- Project ID: `obs-evo-cand-013332`
- EVOBC category candidate ID: `evobc-evo-cat-13332`
- External category reference: `evobc-cat-13332`
- Source category ID: `13332`
- Source label for human review: `𬢙`
- Source codepoints: `U+2C899`
...
- `obs-evo-cand-013332-route-category-staging`
...
- `obs-evo-cand-013332-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013332-route-evolution-graph`
