# obs-char-000756 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/756_obs-char-000756_hust-obc-cat-0858_orac
  le-character/03_visual-assets/001_asset-000761_hust-obc-cat-0858_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0858/G_0858_甲骨文.png`
- asset id: `asset-000761`
...
- source category: `0858`
- validation class: `755`
- source image route: `HUST-OBC/deciphered/0858/G_0858_甲骨文.png`
- asset id: `asset-000761`
...
- English observation: `A central upper junction radiates into four long
  branches and a short upright; below it, two detached narrow
  teardrop-shaped loops stand side by side.`
- 中文观察: `中央上部接点放射出四条长枝和一条短竖；其下两个分离狭长水滴形环并列。`
...
- dataset label text: `㝐`
- dataset label codepoints: `U+3750`
...
- Which source records identify obs-char-000756 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000756？
