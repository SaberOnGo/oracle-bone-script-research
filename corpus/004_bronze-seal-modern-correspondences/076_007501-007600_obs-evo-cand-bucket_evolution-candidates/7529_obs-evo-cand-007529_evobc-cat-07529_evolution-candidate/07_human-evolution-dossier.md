...
Project ID: `obs-evo-cand-007529`
...
- Project ID: `obs-evo-cand-007529`
- EVOBC category candidate ID: `evobc-evo-cat-07529`
- External category reference: `evobc-cat-07529`
- Source category ID: `07529`
- Source label for human review: `蓛`
- Source codepoints: `U+84DB`
...
- `obs-evo-cand-007529-route-category-staging`
...
- `obs-evo-cand-007529-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007529-route-evolution-graph`
