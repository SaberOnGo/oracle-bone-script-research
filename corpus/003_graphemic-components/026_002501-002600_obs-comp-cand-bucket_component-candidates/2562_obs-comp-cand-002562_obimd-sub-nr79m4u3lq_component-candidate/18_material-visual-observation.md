# Material Visual Observation / obs-comp-cand-002562 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002562`
- External reference / 外部参照: `obimd-sub-nr79m4u3lq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021094_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nr79m4u3lq/nr79m4u3lq/nr79m4u3lq.png`
- Checksum / 校验和:
  `8b6414a058ff28b61750ba9eff4255f3bf6edafd0333f2da091649e3996b6e26`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.37%.
- Marked-pixel bounds: (55,29)–(200,210); span 146 × 182 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.37%。
- 痕迹范围：(55,29)–(200,210)；跨度146 × 182 px；痕迹矩形高于宽。
