...
- External category reference: `evobc-cat-13246`
- Source category ID: `13246`
- Source label for human review: `𬍢`
...
- `obs-evo-cand-013246-route-category-staging`
...
- `obs-evo-cand-013246-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013246-route-evolution-graph`
