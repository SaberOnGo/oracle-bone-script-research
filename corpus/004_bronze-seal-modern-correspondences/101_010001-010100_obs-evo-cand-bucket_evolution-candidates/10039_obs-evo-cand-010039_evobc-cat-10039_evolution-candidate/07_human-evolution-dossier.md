...
- External category reference: `evobc-cat-10039`
- Source category ID: `10039`
- Source label: `顱`
...
- `obs-evo-cand-010039-route-category-staging`
...
- `obs-evo-cand-010039-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010039-route-evolution-graph`
