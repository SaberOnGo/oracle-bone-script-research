...
- Project ID: `obs-evo-cand-004562`
- EVOBC category candidate ID: `evobc-evo-cat-04562`
- External category reference: `evobc-cat-04562`
- Source category ID: `04562`
- Source label for human review: `治`
- Source codepoints: `U+6CBB`
...
- `obs-evo-cand-004562-route-category-staging`
...
- `obs-evo-cand-004562-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004562-route-evolution-graph`
