# obs-unk-004249 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/049_obs-unk-004249_h
  ust-obc-und-L-004249_oracle-character-candidate/03_visual-assets/001_asset
  -005842_hust-obc-und-L-004249_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4249/L_？_9359.jpg`
- asset id: `asset-005842`
...
- source class: `HUST-OBC/undeciphered/L/4249/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4249/L_？_9359.jpg`
- asset id: `asset-005842`
...
- English observation: `Left trace, branches, rounded right cluster visible.`
- 中文观察: `左侧痕迹、短小分支和右侧弯曲痕迹簇可见。`
...
- Which source records identify obs-unk-004249 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004249？
