# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008115
...
- EVOBC candidate category: `evobc-evo-cat-08115`.
- Source label for search only: `觶`.
- Source codepoints for search only: `U+89F6`.
