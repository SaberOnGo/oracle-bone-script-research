...
- External category reference: `evobc-cat-08898`
- Source category ID: `08898`
- Source label: `辇`
...
- `obs-evo-cand-008898-route-category-staging`
...
- `obs-evo-cand-008898-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-008898-route-evolution-graph`
