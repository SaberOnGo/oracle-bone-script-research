# obs-char-000029 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000029`
- primary external id: `hust-obc-cat-0034`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/029_obs-char-000029_hust-obc-cat-0034_orac
  le-character/03_visual-assets/001_asset-000034_hust-obc-cat-0034_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0034/G_0034_乙2260合96賓組.png`
- asset id: `asset-000034`
...
- source category: `0034`
- validation class: `28`
- source image route: `HUST-OBC/deciphered/0034/G_0034_乙2260合96賓組.png`
- asset id: `asset-000034`
...
- English observation: `The thin gray image has two tall wavy strokes
  crossed by short horizontal marks and a straight lower tail.`
- 中文观察: `纤细灰度图像有两条高而弯曲的笔画，被短横痕穿过，并向下延出直尾。`
...
- dataset label text: `㐘`
- dataset label codepoints: `U+3418`
...
- filename catalog route clues: `Heji-like filename clue: 合96
...
- Which source records identify obs-char-000029 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000029？
