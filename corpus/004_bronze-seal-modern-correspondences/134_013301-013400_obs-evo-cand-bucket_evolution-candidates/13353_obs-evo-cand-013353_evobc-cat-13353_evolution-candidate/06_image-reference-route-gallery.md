...
- `obs-evo-cand-013353-route-category-staging`
...
- `obs-evo-cand-013353-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013353-route-evolution-graph`
