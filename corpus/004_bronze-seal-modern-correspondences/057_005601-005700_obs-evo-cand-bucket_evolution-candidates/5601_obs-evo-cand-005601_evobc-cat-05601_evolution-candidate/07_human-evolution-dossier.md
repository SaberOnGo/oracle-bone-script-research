...
Project ID: `obs-evo-cand-005601`
...
- Project ID: `obs-evo-cand-005601`
- EVOBC category candidate ID: `evobc-evo-cat-05601`
- External category reference: `evobc-cat-05601`
- Source category ID: `05601`
- Source label for human review: `疌`
- Source codepoints: `U+758C`
...
- `obs-evo-cand-005601-route-category-staging`
...
- `obs-evo-cand-005601-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005601-route-evolution-graph`
