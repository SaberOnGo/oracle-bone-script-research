# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001175
...
| --- | --- | --- | --- |
| `obimd-glyph-link-017607` | 󶱌 | `U+F6C4C` | `reviewed_metadata_only` |
| `obimd-glyph-link-017608` | 󶱍 | `U+F6C4D` | `reviewed_metadata_only` |
