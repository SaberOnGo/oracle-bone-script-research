...
- `obs-evo-cand-001510-route-category-staging`
...
- `obs-evo-cand-001510-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001510-route-evolution-graph`
