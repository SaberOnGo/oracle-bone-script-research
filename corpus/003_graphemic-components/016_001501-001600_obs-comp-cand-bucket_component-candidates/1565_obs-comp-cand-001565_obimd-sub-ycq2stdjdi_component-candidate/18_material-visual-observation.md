# Material Visual Observation / obs-comp-cand-001565 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001565`
- External reference / 外部参照: `obimd-sub-ycq2stdjdi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017112_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yg0sm41ear/ycq2stdjdi/ycq2stdjdi.png`
- Checksum / 校验和:
  `f13cc3e118ba17384a31271b6572c8462b941c03dd24c23a249d4c96cdf713f1`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.01%.
- Marked-pixel bounds: (73,54)–(176,200); span 104 × 147 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.01%。
- 痕迹范围：(73,54)–(176,200)；跨度104 × 147 px；痕迹矩形高于宽。
