# Material Visual Observation / obs-comp-cand-001695 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001695`
- External reference / 外部参照: `obimd-sub-8f8jpuogyx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017611_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3eorzalgl4/8f8jpuogyx/8f8jpuogyx.png`
- Checksum / 校验和:
  `dcdd2e32036e2df200c9b21a221dd74af79f9e7a5325411d1ded7ac3c1f9a0af`
...
- Marked-pixel bounds: (67,15)–(188,230); span 122 × 216 px; the marked
...
- 痕迹范围：(67,15)–(188,230)；跨度122 × 216 px；痕迹矩形高于宽。
