# Material Visual Observation / obs-comp-cand-001249 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001249`
- External reference / 外部参照: `obimd-sub-otbtv0ewaj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015487_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/otbtv0ewaj/otbtv0ewaj/otbtv0ewaj.png`
- Checksum / 校验和:
  `cada64b7732faa541df7694c95d8ceb2a9a761ef668907f45e0f677658f17f3e`
...
- Marked-pixel bounds: (60,28)–(189,221); span 130 × 194 px; the marked
...
- 痕迹范围：(60,28)–(189,221)；跨度130 × 194 px；痕迹矩形高于宽。
