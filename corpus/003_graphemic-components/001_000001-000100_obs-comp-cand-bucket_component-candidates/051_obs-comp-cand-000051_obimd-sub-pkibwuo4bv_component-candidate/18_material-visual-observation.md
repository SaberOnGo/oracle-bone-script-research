# Material Visual Observation / obs-comp-cand-000051 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000051`
- External reference / 外部参照: `obimd-sub-pkibwuo4bv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011447_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pkibwuo4bv/pkibwuo4bv/pkibwuo4bv.png`
- Checksum / 校验和:
  `10a6aedd381e92f999d3fd7dd0dc42ec077c88ef00d6592bbd2c02e1b81209f5`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.02%.
- Marked-pixel bounds: (78,63)–(171,192); span 94 × 130 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.02%。
- 痕迹范围：(78,63)–(171,192)；跨度94 × 130 px；痕迹矩形高于宽。
