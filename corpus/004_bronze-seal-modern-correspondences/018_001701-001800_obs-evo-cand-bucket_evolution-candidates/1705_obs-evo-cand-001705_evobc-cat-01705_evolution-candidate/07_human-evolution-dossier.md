...
Project ID: `obs-evo-cand-001705`
...
- Project ID: `obs-evo-cand-001705`
- EVOBC category candidate ID: `evobc-evo-cat-01705`
- External category reference: `evobc-cat-01705`
- Source category ID: `01705`
- Source label for human review: `嘲`
- Source codepoints: `U+5632`
...
- `obs-evo-cand-001705-route-category-staging`
...
- `obs-evo-cand-001705-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001705-route-evolution-graph`
