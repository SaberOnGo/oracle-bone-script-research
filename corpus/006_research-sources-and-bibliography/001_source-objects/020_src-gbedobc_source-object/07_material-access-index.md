# src-gbedobc Material Access Index
...
- Target records / 目标记录: graphic_evolution
- Metadata profile count / 元数据概况数: 3
- Profile metrics / 概况指标: downloaded_article_pdf_size_bytes;
  graph_based_character_count; graph_based_group_count
