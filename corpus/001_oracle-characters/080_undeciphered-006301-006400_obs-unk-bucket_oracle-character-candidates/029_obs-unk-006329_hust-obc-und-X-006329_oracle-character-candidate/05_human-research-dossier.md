# obs-unk-006329 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/080_undeciphered-006
  301-006400_obs-unk-bucket_oracle-character-candidates/029_obs-unk-006329_h
  ust-obc-und-X-006329_oracle-character-candidate/03_visual-assets/001_asset
  -007920_hust-obc-und-X-006329_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1885/X_？_5121_1.png`
- asset id: `asset-007920`
...
- source class: `HUST-OBC/undeciphered/X/1885/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1885/X_？_5121_1.png`
- asset id: `asset-007920`
...
- Which source records identify obs-unk-006329 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006329？
