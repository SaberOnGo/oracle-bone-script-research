...
- External category reference: `evobc-cat-05003`
- Source category ID: `05003`
- Source label for human review: `瀶`
...
- `obs-evo-cand-005003-route-category-staging`
...
- `obs-evo-cand-005003-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005003-route-evolution-graph`
