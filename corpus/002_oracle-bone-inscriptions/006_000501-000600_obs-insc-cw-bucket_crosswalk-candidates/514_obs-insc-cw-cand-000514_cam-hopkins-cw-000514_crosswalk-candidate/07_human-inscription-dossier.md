...
- Source page section: `Period IV Group 20` /
  `第 IV 期第 20 组`
- Source section key: `period-iv-group-20`
...
- Yingguo / 英国所藏: `y2501` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `311` in source row; primary catalog entry pending
