# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006543
...
- EVOBC candidate category: `evobc-evo-cat-06543`.
- Source label for search only: `經`.
- Source codepoints for search only: `U+7D93`.
