...
Project ID: `obs-evo-cand-010264`
...
- Project ID: `obs-evo-cand-010264`
- EVOBC category candidate ID: `evobc-evo-cat-10264`
- External category reference: `evobc-cat-10264`
- Source category ID: `10264`
- Source label for human review: `驥`
- Source codepoints: `U+9A65`
...
- `obs-evo-cand-010264-route-category-staging`
...
- `obs-evo-cand-010264-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010264-route-evolution-graph`
