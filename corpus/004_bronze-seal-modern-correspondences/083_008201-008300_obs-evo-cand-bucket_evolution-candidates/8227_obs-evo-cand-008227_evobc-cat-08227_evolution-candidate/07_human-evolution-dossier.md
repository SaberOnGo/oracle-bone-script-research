...
Project ID: `obs-evo-cand-008227`
...
- Project ID: `obs-evo-cand-008227`
- EVOBC category candidate ID: `evobc-evo-cat-08227`
- External category reference: `evobc-cat-08227`
- Source category ID: `08227`
- Source label for human review: `誓`
- Source codepoints: `U+8A93`
...
- `obs-evo-cand-008227-route-category-staging`
...
- `obs-evo-cand-008227-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008227-route-evolution-graph`
