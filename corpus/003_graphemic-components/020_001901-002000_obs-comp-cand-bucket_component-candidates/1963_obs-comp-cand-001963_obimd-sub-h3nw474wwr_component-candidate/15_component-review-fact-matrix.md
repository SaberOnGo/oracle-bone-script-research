# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001963
...
| Glyph or codepoint route / 字形或码位路线 | 94 OBIMD route rows; examples U+53F2;U+FB32F; U+FB330; 另有 92 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 94 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
