# obs-unk-004457 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004457`
- primary external id: `hust-obc-und-X-004457`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/057_obs-unk-004457_h
  ust-obc-und-X-004457_oracle-character-candidate/03_visual-assets/001_asset
  -006050_hust-obc-und-X-004457_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/13/X_？_8193_1.png`
- asset id: `asset-006050`
...
- source class: `HUST-OBC/undeciphered/X/13/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/13/X_？_8193_1.png`
- asset id: `asset-006050`
...
- English observation: A triangular upper outline sits above a long
  segmented lower trace.
- 中文观察: `三角上部轮廓位于长分段下部痕迹之上。`
...
- Which source records identify obs-unk-004457 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004457？
