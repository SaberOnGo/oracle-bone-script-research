...
- External category reference: `evobc-cat-02549`
- Source category ID: `02549`
- Source label for human review: `岸`
- Source codepoints: `U+5CB8`
...
- `obs-evo-cand-002549-route-category-staging`
...
- `obs-evo-cand-002549-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002549-route-evolution-graph`
