...
- External category reference: `evobc-cat-03397`
- Source category ID: `03397`
- Source label for human review: `掊`
...
- `obs-evo-cand-003397-route-category-staging`
...
- `obs-evo-cand-003397-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003397-route-evolution-graph`
