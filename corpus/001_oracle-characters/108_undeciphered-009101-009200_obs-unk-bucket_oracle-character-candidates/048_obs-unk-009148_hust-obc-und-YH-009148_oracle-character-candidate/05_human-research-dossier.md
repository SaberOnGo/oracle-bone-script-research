# obs-unk-009148 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/108_undeciphered-009
  101-009200_obs-unk-bucket_oracle-character-candidates/048_obs-unk-009148_h
  ust-obc-und-YH-009148_oracle-character-candidate/03_visual-assets/001_asse
  t-010739_hust-obc-und-YH-009148_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/612AB/H_？_612AB_0.png`
- asset id: `asset-010739`
...
- source class: `HUST-OBC/undeciphered/Y+H/612AB/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/612AB/H_？_612AB_0.png`
- asset id: `asset-010739`
...
- Which source records identify obs-unk-009148 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009148？
