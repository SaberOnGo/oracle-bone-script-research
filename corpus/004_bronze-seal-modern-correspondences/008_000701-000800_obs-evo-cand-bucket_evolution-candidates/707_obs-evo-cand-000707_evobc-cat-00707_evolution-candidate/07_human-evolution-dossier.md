...
Project ID: `obs-evo-cand-000707`
...
- Project ID: `obs-evo-cand-000707`
- EVOBC category candidate ID: `evobc-evo-cat-00707`
- External category reference: `evobc-cat-00707`
- Source category ID: `00707`
- Source label for human review: `京`
- Source codepoints: `U+4EAC`
- Image reference count in source metadata: `194`
...
- `obs-evo-cand-000707-route-category-staging`
...
- `obs-evo-cand-000707-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000707-route-evolution-graph`
