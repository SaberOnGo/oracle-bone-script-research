...
- External category reference: `evobc-cat-05519`
- Source category ID: `05519`
- Source label for human review: `甂`
...
- `obs-evo-cand-005519-route-category-staging`
...
- `obs-evo-cand-005519-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005519-route-evolution-graph`
