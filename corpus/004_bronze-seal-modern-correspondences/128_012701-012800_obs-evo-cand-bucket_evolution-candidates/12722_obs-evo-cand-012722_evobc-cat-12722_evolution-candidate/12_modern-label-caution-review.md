# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012722
...
- EVOBC candidate category: `evobc-evo-cat-12722`.
- Source label for search only: `𪀝`.
- Source codepoints for search only: `U+2A01D`.
