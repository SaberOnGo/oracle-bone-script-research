# obs-char-000627 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000627`
- primary external id: `hust-obc-cat-0712`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/627_obs-char-000627_hust-obc-cat-0712_orac
  le-character/03_visual-assets/001_asset-000632_hust-obc-cat-0712_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0712/G_0712_甲骨文0.png`
- asset id: `asset-000632`
...
- source category: `0712`
- validation class: `626`
- source image route: `HUST-OBC/deciphered/0712/G_0712_甲骨文0.png`
- asset id: `asset-000632`
...
- dataset label text: `㚾`
- dataset label codepoints: `U+36BE`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/050_obs-evo-can
  d-000050_evobc-cat-00050_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/050_obs-evo-cand-000050_evobc-cat-00050_evolu
...
- Which source records identify obs-char-000627 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000627？
