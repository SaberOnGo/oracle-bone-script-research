# Material Visual Observation / obs-comp-cand-001024 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001024`
- External reference / 外部参照: `obimd-sub-altlfztjg5`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014506_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/altlfztjg5/altlfztjg5/2wsosek0on.png`
- Checksum / 校验和:
  `a78902abfdf53316b1e07c09021041b32d391029692a65f922a1a6f7817ea838`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.07%.
- Marked-pixel bounds: (83,33)–(166,225); span 84 × 193 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.07%。
- 痕迹范围：(83,33)–(166,225)；跨度84 × 193 px；痕迹矩形高于宽。
