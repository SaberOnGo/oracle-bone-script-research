...
- External category reference: `evobc-cat-05008`
- Source category ID: `05008`
- Source label for human review: `瀾`
- Source codepoints: `U+703E`
...
- `obs-evo-cand-005008-route-category-staging`
...
- `obs-evo-cand-005008-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005008-route-evolution-graph`
