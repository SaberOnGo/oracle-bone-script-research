# obs-char-000151 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000151`
- primary external id: `hust-obc-cat-0167`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/151_obs-char-000151_hust-obc-cat-0167_orac
  le-character/03_visual-assets/001_asset-000156_hust-obc-cat-0167_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0167/G_0167_乙1654合18271賓組.png`
- asset id: `asset-000156`
...
- source category: `0167`
- validation class: `150`
- source image route: `HUST-OBC/deciphered/0167/G_0167_乙1654合18271賓組.png`
- asset id: `asset-000156`
...
- English observation: `The image has a pointed upper descending stroke, a
  compact angular loop on the left, and a short lower projection.`
- 中文观察: `图像上方有尖状下行笔，左侧有紧凑折角环状形，下方有短伸出笔。`
...
- dataset label text: `㒝`
- dataset label codepoints: `U+349D`
...
- Which source records identify obs-char-000151 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000151？
