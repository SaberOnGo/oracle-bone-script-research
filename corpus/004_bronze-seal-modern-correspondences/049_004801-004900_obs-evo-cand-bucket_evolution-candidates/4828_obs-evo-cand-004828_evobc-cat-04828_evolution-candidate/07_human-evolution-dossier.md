...
Project ID: `obs-evo-cand-004828`
...
- Project ID: `obs-evo-cand-004828`
- EVOBC category candidate ID: `evobc-evo-cat-04828`
- External category reference: `evobc-cat-04828`
- Source category ID: `04828`
- Source label for human review: `溽`
- Source codepoints: `U+6EBD`
...
- `obs-evo-cand-004828-route-category-staging`
...
- `obs-evo-cand-004828-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004828-route-evolution-graph`
