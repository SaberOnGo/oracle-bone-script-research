...
- External category reference: `evobc-cat-03134`
- Source category ID: `03134`
- Source label for human review: `慷`
- Source codepoints: `U+6177`
...
- `obs-evo-cand-003134-route-category-staging`
...
- `obs-evo-cand-003134-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003134-route-evolution-graph`
