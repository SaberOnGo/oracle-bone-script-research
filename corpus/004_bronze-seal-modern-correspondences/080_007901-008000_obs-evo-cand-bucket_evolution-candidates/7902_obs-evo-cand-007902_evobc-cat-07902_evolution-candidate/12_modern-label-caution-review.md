# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007902
...
- EVOBC candidate category: `evobc-evo-cat-07902`.
- Source label for search only: `行`.
- Source codepoints for search only: `U+884C`.
