# obs-unk-004305 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004305`
- primary external id: `hust-obc-und-L-004305`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/005_obs-unk-004305_h
  ust-obc-und-L-004305_oracle-character-candidate/03_visual-assets/001_asset
  -005898_hust-obc-und-L-004305_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4305/L_？_950.jpg`
- asset id: `asset-005898`
...
- source class: `HUST-OBC/undeciphered/L/4305/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4305/L_？_950.jpg`
- asset id: `asset-005898`
...
- English observation: `Central traces, upper branches, uneven ends visible.`
- 中文观察: `中央竖痕、上部枝状痕迹和不均匀末端可见。`
...
- Which source records identify obs-unk-004305 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004305？
