...
- External category reference: `evobc-cat-03723`
- Source category ID: `03723`
- Source label for human review: `昫`
- Source codepoints: `U+662B`
...
- `obs-evo-cand-003723-route-category-staging`
...
- `obs-evo-cand-003723-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003723-route-evolution-graph`
