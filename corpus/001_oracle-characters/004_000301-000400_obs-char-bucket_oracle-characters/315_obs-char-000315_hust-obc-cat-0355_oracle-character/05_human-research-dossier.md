# obs-char-000315 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000315`
- primary external id: `hust-obc-cat-0355`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/315_obs-char-000315_hust-obc-cat-0355_orac
  le-character/03_visual-assets/001_asset-000320_hust-obc-cat-0355_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0355/G_0355_甲1556(甲).png`
- asset id: `asset-000320`
...
- source category: `0355`
- validation class: `314`
- source image route: `HUST-OBC/deciphered/0355/G_0355_甲1556(甲).png`
- asset id: `asset-000320`
...
- English observation: `The rounded outer form contains horizontal and
  vertical interior marks, with a branching top and a small lower
  enclosure.`
- 中文观察: `图像外部呈圆弧形，内部有横竖痕迹，上方分叉，下方有小型闭合轮廓。`
...
- dataset label text: `㕙`
- dataset label codepoints: `U+3559`
...
- Which source records identify obs-char-000315 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000315？
