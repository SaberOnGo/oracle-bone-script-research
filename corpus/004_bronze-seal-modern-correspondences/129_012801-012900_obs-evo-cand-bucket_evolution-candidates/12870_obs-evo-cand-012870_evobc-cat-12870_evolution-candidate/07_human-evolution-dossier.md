...
- External category reference: `evobc-cat-12870`
- Source category ID: `12870`
- Source label: `𪴇`
...
- `obs-evo-cand-012870-route-category-staging`
...
- `obs-evo-cand-012870-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012870-route-evolution-graph`
