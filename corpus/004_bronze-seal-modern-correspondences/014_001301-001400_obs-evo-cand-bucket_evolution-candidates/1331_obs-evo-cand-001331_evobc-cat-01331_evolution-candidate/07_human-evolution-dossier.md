...
Project ID: `obs-evo-cand-001331`
...
- Project ID: `obs-evo-cand-001331`
- EVOBC category candidate ID: `evobc-evo-cat-01331`
- External category reference: `evobc-cat-01331`
- Source category ID: `01331`
- Source label for human review: `匌`
- Source codepoints: `U+530C`
...
- `obs-evo-cand-001331-route-category-staging`
...
- `obs-evo-cand-001331-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001331-route-evolution-graph`
