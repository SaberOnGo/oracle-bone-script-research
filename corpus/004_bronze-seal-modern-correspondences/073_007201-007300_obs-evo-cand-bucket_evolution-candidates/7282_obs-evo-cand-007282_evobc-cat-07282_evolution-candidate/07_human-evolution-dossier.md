...
- External category reference: `evobc-cat-07282`
- Source category ID: `07282`
- Source label for human review: `苟`
- Source codepoints: `U+82DF`
...
- `obs-evo-cand-007282-route-category-staging`
...
- `obs-evo-cand-007282-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007282-route-evolution-graph`
