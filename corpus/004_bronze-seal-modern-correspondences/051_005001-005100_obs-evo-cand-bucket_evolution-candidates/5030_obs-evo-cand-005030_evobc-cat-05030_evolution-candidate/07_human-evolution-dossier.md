...
- External category reference: `evobc-cat-05030`
- Source category ID: `05030`
- Source label for human review: `灸`
...
- `obs-evo-cand-005030-route-category-staging`
...
- `obs-evo-cand-005030-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005030-route-evolution-graph`
