...
- External category reference: `evobc-cat-13181`
- Source category ID: `13181`
- Source label for human review: `𬀆`
- Source codepoints: `U+2C006`
...
- `obs-evo-cand-013181-route-category-staging`
...
- `obs-evo-cand-013181-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013181-route-evolution-graph`
