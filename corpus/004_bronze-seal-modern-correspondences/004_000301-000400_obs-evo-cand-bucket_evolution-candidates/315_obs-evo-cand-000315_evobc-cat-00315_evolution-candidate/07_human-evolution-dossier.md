...
Project ID: `obs-evo-cand-000315`
...
- Project ID: `obs-evo-cand-000315`
- EVOBC category candidate ID: `evobc-evo-cat-00315`
- External category reference: `evobc-cat-00315`
- Source category ID: `00315`
- Source label for human review: `䊻`
- Source codepoints: `U+42BB`
...
- `obs-evo-cand-000315-route-category-staging`
...
- `obs-evo-cand-000315-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000315-route-evolution-graph`
