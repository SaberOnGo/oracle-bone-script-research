# Material Visual Observation / obs-comp-cand-002243 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002243`
- External reference / 外部参照: `obimd-sub-1fjsmv778r`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020056_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1fjsmv778r/1fjsmv778r/1fjsmv778r.png`
- Checksum / 校验和:
  `7760980fd2baf5556554a5870240976f51920eb005f755f0f1347dd0fcb3d006`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.30%.
- Marked-pixel bounds: (60,20)–(170,230); span 111 × 211 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.30%。
- 痕迹范围：(60,20)–(170,230)；跨度111 × 211 px；痕迹矩形高于宽。
