# obs-unk-004345 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004345`
- primary external id: `hust-obc-und-L-004345`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/045_obs-unk-004345_h
  ust-obc-und-L-004345_oracle-character-candidate/03_visual-assets/001_asset
  -005938_hust-obc-und-L-004345_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4345/L_？_9624.jpg`
- asset id: `asset-005938`
...
- source class: `HUST-OBC/undeciphered/L/4345/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4345/L_？_9624.jpg`
- asset id: `asset-005938`
...
- English observation: `Central trace, middle bar, and uneven lower terminals`
  `recorded.`
- 中文观察: `已记录中央痕迹、中部宽痕和下部不齐末端。`
...
- Which source records identify obs-unk-004345 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004345？
