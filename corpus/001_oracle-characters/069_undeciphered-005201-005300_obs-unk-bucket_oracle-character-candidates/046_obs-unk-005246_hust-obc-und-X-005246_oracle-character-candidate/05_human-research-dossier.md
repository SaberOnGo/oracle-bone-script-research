# obs-unk-005246 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005246`
- primary external id: `hust-obc-und-X-005246`
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/046_obs-unk-005246_h
  ust-obc-und-X-005246_oracle-character-candidate/03_visual-assets/001_asset
  -006839_hust-obc-und-X-005246_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/802/X_？_7766_1.png`
- asset id: `asset-006839`
...
- source class: `HUST-OBC/undeciphered/X/802/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/802/X_？_7766_1.png`
- asset id: `asset-006839`
...
- Which source records identify obs-unk-005246 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005246？
