...
- External category reference: `evobc-cat-08726`
- Source category ID: `08726`
- Source label for human review: `跾`
- Source codepoints: `U+8DFE`
...
- `obs-evo-cand-008726-route-category-staging`
...
- `obs-evo-cand-008726-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008726-route-evolution-graph`
