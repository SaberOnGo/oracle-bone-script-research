# obs-char-001403 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001403`
- primary external id: `hust-obc-cat-1571_1572`
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1403_obs-char-001403_hust-obc-cat-1571_157
  2_oracle-character/03_visual-assets/001_asset-001408_hust-obc-cat-1571_157
  2_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1571_1572/1571/G_1571_乙7746合109
  89賓組.png`
- asset id: `asset-001408`
...
- source category: `1571_1572`
- validation class: `1402`
- source image route: `HUST-OBC/deciphered/1571_1572/1571/G_1571_乙7746合10989賓組
  .png`
- asset id: `asset-001408`
...
- English observation: `A small upper frame leads into a narrow lower
  cluster with a long curve.`
- 中文观察: `小型上部框形连接狭长下部笔画群，旁有长弧线。`
...
- dataset label text: `㨙㨚`
- dataset label codepoints: `U+3A19;U+3A1A`
...
- graph edge count: `2`
- codepoint routes: `U+3A19;U+3A1A`
...
- filename catalog route clues: `Heji-like filename clue: 合10989
  (G_1571_乙7746合10989賓組.png)`
...
- Which source records identify obs-char-001403 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001403？
