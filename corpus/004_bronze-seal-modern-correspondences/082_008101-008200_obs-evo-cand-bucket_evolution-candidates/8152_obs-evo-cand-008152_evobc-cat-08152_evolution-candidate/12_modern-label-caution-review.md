# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008152
...
- EVOBC candidate category: `evobc-evo-cat-08152`.
- Source label for search only: `訫`.
- Source codepoints for search only: `U+8A2B`.
