# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010258
...
- EVOBC candidate category: `evobc-evo-cat-10258`.
- Source label for search only: `驚`.
- Source codepoints for search only: `U+9A5A`.
