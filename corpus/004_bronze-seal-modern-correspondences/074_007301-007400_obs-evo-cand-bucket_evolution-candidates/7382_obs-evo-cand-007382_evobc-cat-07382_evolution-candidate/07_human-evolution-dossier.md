...
Project ID: `obs-evo-cand-007382`
...
- Project ID: `obs-evo-cand-007382`
- EVOBC category candidate ID: `evobc-evo-cat-07382`
- External category reference: `evobc-cat-07382`
- Source category ID: `07382`
- Source label for human review: `莝`
- Source codepoints: `U+839D`
...
- `obs-evo-cand-007382-route-category-staging`
...
- `obs-evo-cand-007382-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007382-route-evolution-graph`
