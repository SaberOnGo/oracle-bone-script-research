# obs-unk-004803 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004803`
- primary external id: `hust-obc-und-X-004803`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/003_obs-unk-004803_h
  ust-obc-und-X-004803_oracle-character-candidate/03_visual-assets/001_asset
  -006396_hust-obc-und-X-004803_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/359/X_？_7343_1.png`
- asset id: `asset-006396`
...
- source class: `HUST-OBC/undeciphered/X/359/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/359/X_？_7343_1.png`
- asset id: `asset-006396`
...
- English observation: `tall branching left group and right openings`
- 中文观察: `高长左侧分支结构和右侧开口`
...
- Which source records identify obs-unk-004803 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004803？
