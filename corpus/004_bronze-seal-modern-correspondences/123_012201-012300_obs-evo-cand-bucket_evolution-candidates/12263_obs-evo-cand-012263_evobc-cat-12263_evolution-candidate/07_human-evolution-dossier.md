...
- External category reference: `evobc-cat-12263`
- Source category ID: `12263`
- Source label for human review: `𧯡`
- Source codepoints: `U+27BE1`
...
- `obs-evo-cand-012263-route-category-staging`
...
- `obs-evo-cand-012263-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012263-route-evolution-graph`
