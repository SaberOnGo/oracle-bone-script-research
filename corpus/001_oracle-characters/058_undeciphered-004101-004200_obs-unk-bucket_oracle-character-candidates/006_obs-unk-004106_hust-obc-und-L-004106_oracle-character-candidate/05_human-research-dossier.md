# obs-unk-004106 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/006_obs-unk-004106_h
  ust-obc-und-L-004106_oracle-character-candidate/03_visual-assets/001_asset
  -005699_hust-obc-und-L-004106_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4106/L_？_8842.jpg`
- asset id: `asset-005699`
...
- source class: `HUST-OBC/undeciphered/L/4106/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4106/L_？_8842.jpg`
- asset id: `asset-005699`
...
- English observation: A narrow vertical composition has central crossing
  strokes, a short left stroke, and a thin right tail.
- 中文观察：图像为窄长竖向组合，中央笔画相交，左侧较短，右侧有细尾。
...
- Which source records identify obs-unk-004106 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004106？
