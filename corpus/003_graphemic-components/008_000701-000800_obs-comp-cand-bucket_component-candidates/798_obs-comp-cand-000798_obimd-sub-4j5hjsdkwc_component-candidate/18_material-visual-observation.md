# Material Visual Observation / obs-comp-cand-000798 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000798`
- External reference / 外部参照: `obimd-sub-4j5hjsdkwc`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013596_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4j5hjsdkwc/4j5hjsdkwc/4j5hjsdkwc.png`
- Checksum / 校验和:
  `4628de30bc679b717e90bd039a119eb6a281e48ecd8418700b6de8ec5bd40dd3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.38%.
- Marked-pixel bounds: (57,39)–(192,215); span 136 × 177 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.38%。
- 痕迹范围：(57,39)–(192,215)；跨度136 × 177 px；痕迹矩形高于宽。
