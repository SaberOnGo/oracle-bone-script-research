...
- External category reference: `evobc-cat-02216`
- Source category ID: `02216`
- Source label for human review: `婺`
...
- `obs-evo-cand-002216-route-category-staging`
...
- `obs-evo-cand-002216-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002216-route-evolution-graph`
