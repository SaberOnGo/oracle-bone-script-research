# obs-char-001095 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1095_obs-char-001095_hust-obc-cat-1224_ora
  cle-character/03_visual-assets/001_asset-001100_hust-obc-cat-1224_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1224/H_1224_612DD_0.png`
- asset id: `asset-001100`
...
- source category: `1224`
- validation class: `1094`
- source image route: `HUST-OBC/deciphered/1224/H_1224_612DD_0.png`
- asset id: `asset-001100`
...
- English observation: `A tall curved form has a rounded upper contour, a
  long central descending stroke, and a short lower side branch.`
- 中文观察: `高而弯曲的形体有圆弧上部轮廓、长中央下行笔和短下部侧分枝。`
...
- dataset label text: `㢾`
- dataset label codepoints: `U+38BE`
...
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/104_obs-evo-can
  d-000104_evobc-cat-00104_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/104_obs-evo-cand-000104_evobc-cat-00104_evolu
...
- filename catalog route clues: `catalog-like filename clue: H_1224
  (H_1224_612DD_0.png)`
...
- Which source records identify obs-char-001095 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001095？
