# obs-unk-004657 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/063_undeciphered-004
  601-004700_obs-unk-bucket_oracle-character-candidates/057_obs-unk-004657_h
  ust-obc-und-X-004657_oracle-character-candidate/03_visual-assets/001_asset
  -006250_hust-obc-und-X-004657_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/213/X_？_7221_1.png`
- asset id: `asset-006250`
...
- source class: `HUST-OBC/undeciphered/X/213/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/213/X_？_7221_1.png`
- asset id: `asset-006250`
...
- English observation: `noisy dark-background derivative with unstable contours`
- 中文观察: `深色背景噪声派生图，轮廓暂不稳定`
...
- Which source records identify obs-unk-004657 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004657？
