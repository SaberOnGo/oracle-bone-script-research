# obs-char-001176 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1176_obs-char-001176_hust-obc-cat-1316_ora
  cle-character/03_visual-assets/001_asset-001181_hust-obc-cat-1316_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1316/G_1316_續2.16.4(甲).png`
- asset id: `asset-001181`
...
- source category: `1316`
- validation class: `1175`
- source image route: `HUST-OBC/deciphered/1316/G_1316_續2.16.4(甲).png`
- asset id: `asset-001181`
...
- English observation: `A small open rounded curve rises to a short upright
  stroke and a pointed upper tip.`
- 中文观察: `小型开放圆弧向上连接短直立笔和尖状上端。`
...
- dataset label text: `㤚`
- dataset label codepoints: `U+391A`
...
- Which source records identify obs-char-001176 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001176？
