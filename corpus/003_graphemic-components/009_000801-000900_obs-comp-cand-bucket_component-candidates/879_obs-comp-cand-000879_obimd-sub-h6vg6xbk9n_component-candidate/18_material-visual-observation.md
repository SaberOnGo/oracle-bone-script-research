# Material Visual Observation / obs-comp-cand-000879 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000879`
- External reference / 外部参照: `obimd-sub-h6vg6xbk9n`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013951_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/o6m37o3l7o/h6vg6xbk9n/h6vg6xbk9n.png`
- Checksum / 校验和:
  `5804e1c78208c9db279bca25777eb483a9e247e48d215209e8de2ffffd8bf0ae`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.31%.
- Marked-pixel bounds: (61,34)–(188,218); span 128 × 185 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.31%。
- 痕迹范围：(61,34)–(188,218)；跨度128 × 185 px；痕迹矩形高于宽。
