# obs-char-001079 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1079_obs-char-001079_hust-obc-cat-1207_120
  8_oracle-character/03_visual-assets/001_asset-001084_hust-obc-cat-1207_120
  8_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1207_1208/1207/G_1207_摭續85(甲).p
  ng`
- asset id: `asset-001084`
...
- source category: `1207_1208`
- validation class: `1078`
- source image route: `HUST-OBC/deciphered/1207_1208/1207/G_1207_摭續85(甲).png`
- asset id: `asset-001084`
...
- English observation: `Two separated similar upright forms each have
  pointed upper branches and short lower side strokes.`
...
- dataset label text: `㢭㢮`
- dataset label codepoints: `U+38AD;U+38AE`
...
- Which source records identify obs-char-001079 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001079？
