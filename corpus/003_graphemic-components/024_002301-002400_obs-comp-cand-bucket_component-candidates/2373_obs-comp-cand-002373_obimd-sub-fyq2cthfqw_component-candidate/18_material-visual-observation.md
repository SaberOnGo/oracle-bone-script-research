# Material Visual Observation / obs-comp-cand-002373 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002373`
- External reference / 外部参照: `obimd-sub-fyq2cthfqw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020444_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bluyc51w9k/fyq2cthfqw/fyq2cthfqw.png`
- Checksum / 校验和:
  `faf414ae5c802d11c45de2445d05e065ba5ff5dd8f215470052c97108e11e138`
...
- Marked-pixel bounds: (94,30)–(159,216); span 66 × 187 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.53%。
- 痕迹范围：(94,30)–(159,216)；跨度66 × 187 px；痕迹矩形高于宽。
