# obs-unk-004531 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004531`
- primary external id: `hust-obc-und-X-004531`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/031_obs-unk-004531_h
  ust-obc-und-X-004531_oracle-character-candidate/03_visual-assets/001_asset
  -006124_hust-obc-und-X-004531_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/87/X_？_8271_1.png`
- asset id: `asset-006124`
...
- source class: `HUST-OBC/undeciphered/X/87/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/87/X_？_8271_1.png`
- asset id: `asset-006124`
...
- English observation: `U-like outline, stem, and detached marks recorded.`
- 中文观察: `已记录 U 形轮廓、中央长痕迹和分离痕迹。`
...
- Which source records identify obs-unk-004531 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004531？
