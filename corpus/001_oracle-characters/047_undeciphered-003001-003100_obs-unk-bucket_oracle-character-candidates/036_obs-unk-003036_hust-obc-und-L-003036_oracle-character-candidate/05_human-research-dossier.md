# obs-unk-003036 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-003036`
- primary external id: `hust-obc-und-L-003036`
...
- local review image route: `corpus/001_oracle-characters/047_undeciphered-003
  001-003100_obs-unk-bucket_oracle-character-candidates/036_obs-unk-003036_h
  ust-obc-und-L-003036_oracle-character-candidate/03_visual-assets/001_asset
  -004629_hust-obc-und-L-003036_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3036/L_？_5428.jpg`
- asset id: `asset-004629`
...
- source class: `HUST-OBC/undeciphered/L/3036/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3036/L_？_5428.jpg`
- asset id: `asset-004629`
...
- Which source records identify obs-unk-003036 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003036？
