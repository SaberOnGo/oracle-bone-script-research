...
- External category reference: `evobc-cat-06743`
- Source category ID: `06743`
- Source label for human review: `绊`
...
- `obs-evo-cand-006743-route-category-staging`
...
- `obs-evo-cand-006743-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006743-route-evolution-graph`
