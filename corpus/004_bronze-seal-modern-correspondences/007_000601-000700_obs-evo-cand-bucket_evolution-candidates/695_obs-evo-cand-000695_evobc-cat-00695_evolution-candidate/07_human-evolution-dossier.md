...
- External category reference: `evobc-cat-00695`
- Source category ID: `00695`
- Source label for human review: `些`
...
- `obs-evo-cand-000695-route-category-staging`
...
- `obs-evo-cand-000695-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000695-route-evolution-graph`
