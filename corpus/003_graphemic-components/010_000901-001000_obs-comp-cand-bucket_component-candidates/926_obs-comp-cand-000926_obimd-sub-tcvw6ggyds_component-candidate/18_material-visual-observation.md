# Material Visual Observation / obs-comp-cand-000926 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000926`
- External reference / 外部参照: `obimd-sub-tcvw6ggyds`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014009_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/tcvw6ggyds/tcvw6ggyds/tcvw6ggyds.png`
- Checksum / 校验和:
  `bec71ef6f298e1bca425062cb47d30e4e449e0c987481b4f51fddc22aad74c0b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.28%.
- Marked-pixel bounds: (60,35)–(189,217); span 130 × 183 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.28%。
- 痕迹范围：(60,35)–(189,217)；跨度130 × 183 px；痕迹矩形高于宽。
