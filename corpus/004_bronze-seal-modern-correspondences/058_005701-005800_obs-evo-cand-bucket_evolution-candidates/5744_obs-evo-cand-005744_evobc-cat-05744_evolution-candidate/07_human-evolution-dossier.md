...
Project ID: `obs-evo-cand-005744`
...
- Project ID: `obs-evo-cand-005744`
- EVOBC category candidate ID: `evobc-evo-cat-05744`
- External category reference: `evobc-cat-05744`
- Source category ID: `05744`
- Source label for human review: `盉`
- Source codepoints: `U+76C9`
...
- `obs-evo-cand-005744-route-category-staging`
...
- `obs-evo-cand-005744-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005744-route-evolution-graph`
