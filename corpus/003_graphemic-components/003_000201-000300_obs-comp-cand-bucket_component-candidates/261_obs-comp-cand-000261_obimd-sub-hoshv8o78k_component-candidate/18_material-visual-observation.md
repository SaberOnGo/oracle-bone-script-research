# Material Visual Observation / obs-comp-cand-000261 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000261`
- External reference / 外部参照: `obimd-sub-hoshv8o78k`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011907_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hoshv8o78k/hoshv8o78k/hoshv8o78k.png`
- Checksum / 校验和:
  `fcf0dbf129497219e35462dbc7e495216fd6c782cc3f1caece0c2551f60633d1`
...
- Marked-pixel bounds: (69,47)–(180,204); span 112 × 158 px; the marked
...
- 痕迹范围：(69,47)–(180,204)；跨度112 × 158 px；痕迹矩形高于宽。
