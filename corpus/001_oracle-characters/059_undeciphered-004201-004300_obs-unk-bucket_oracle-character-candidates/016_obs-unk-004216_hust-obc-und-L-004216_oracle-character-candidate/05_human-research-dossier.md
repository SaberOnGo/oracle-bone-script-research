# obs-unk-004216 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/016_obs-unk-004216_h
  ust-obc-und-L-004216_oracle-character-candidate/03_visual-assets/001_asset
  -005809_hust-obc-und-L-004216_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4216/L_？_9222.jpg`
- asset id: `asset-005809`
...
- source class: `HUST-OBC/undeciphered/L/4216/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4216/L_？_9222.jpg`
- asset id: `asset-005809`
...
- English observation: `Long diagonal, left wedge, right angular trace visible.`
- 中文观察: `长斜笔画、左侧楔状痕迹和右侧棱角痕迹可见。`
...
- Which source records identify obs-unk-004216 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004216？
