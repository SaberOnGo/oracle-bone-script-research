...
Project ID: `obs-evo-cand-000559`
...
- Project ID: `obs-evo-cand-000559`
- EVOBC category candidate ID: `evobc-evo-cat-00559`
- External category reference: `evobc-cat-00559`
- Source category ID: `00559`
- Source label for human review: `䮑`
- Source codepoints: `U+4B91`
...
- `obs-evo-cand-000559-route-category-staging`
...
- `obs-evo-cand-000559-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000559-route-evolution-graph`
