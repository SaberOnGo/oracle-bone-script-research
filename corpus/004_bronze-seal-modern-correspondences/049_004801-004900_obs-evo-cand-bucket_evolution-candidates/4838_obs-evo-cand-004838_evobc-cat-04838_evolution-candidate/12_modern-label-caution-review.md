# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004838
...
- EVOBC candidate category: `evobc-evo-cat-04838`.
- Source label for search only: `滍`.
- Source codepoints for search only: `U+6ECD`.
