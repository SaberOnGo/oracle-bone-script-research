# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004288
...
- EVOBC candidate category: `evobc-evo-cat-04288`.
- Source label for search only: `檐`.
- Source codepoints for search only: `U+6A90`.
