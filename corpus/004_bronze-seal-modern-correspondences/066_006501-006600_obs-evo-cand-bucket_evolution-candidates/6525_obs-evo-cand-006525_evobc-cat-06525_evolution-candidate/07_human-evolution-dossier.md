...
- External category reference: `evobc-cat-06525`
- Source category ID: `06525`
- Source label for human review: `絳`
...
- `obs-evo-cand-006525-route-category-staging`
...
- `obs-evo-cand-006525-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006525-route-evolution-graph`
