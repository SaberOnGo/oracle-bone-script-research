# obs-char-000152 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000152`
- primary external id: `hust-obc-cat-0168`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/152_obs-char-000152_hust-obc-cat-0168_orac
  le-character/03_visual-assets/001_asset-000157_hust-obc-cat-0168_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0168/G_0168_菁3.1(甲).png`
- asset id: `asset-000157`
...
- source category: `0168`
- validation class: `151`
- source image route: `HUST-OBC/deciphered/0168/G_0168_菁3.1(甲).png`
- asset id: `asset-000157`
...
- English observation: `The image combines a narrow banded form on the left
  with a broad pointed arch on the right and a small enclosed loop inside
  it.`
- 中文观察: `图像左侧有窄而带横痕的形体，右侧有宽大的尖顶拱形，内部另有小型围合环。`
...
- dataset label text: `㒞`
- dataset label codepoints: `U+349E`
...
- Which source records identify obs-char-000152 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000152？
