...
- External category reference: `evobc-cat-11754`
- Source category ID: `11754`
- Source label for human review: `𥁕`
- Source codepoints: `U+25055`
- Image reference count in source metadata: `95`
...
- `obs-evo-cand-011754-route-category-staging`
...
- `obs-evo-cand-011754-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011754-route-evolution-graph`
