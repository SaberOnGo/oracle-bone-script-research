# Material Visual Observation / obs-comp-cand-001958 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001958`
- External reference / 外部参照: `obimd-sub-5d0rxu2cn6`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018768_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/knps4jrxz3/5d0rxu2cn6/5d0rxu2cn6.png`
- Checksum / 校验和:
  `853a860bab75ed36c575f4717a7204d683f0635a9f6cc74ddbd9f9cc69523585`
...
- Marked-pixel bounds: (69,25)–(175,228); span 107 × 204 px; the marked
...
- 痕迹范围：(69,25)–(175,228)；跨度107 × 204 px；痕迹矩形高于宽。
