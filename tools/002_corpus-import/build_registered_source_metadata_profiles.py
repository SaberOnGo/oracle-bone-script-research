...
REGISTERED_PROFILE_ROWS = [
    {
        ...
        "evidence_download_id": "dl-british-museum-oa-165",
        "metadata_file": "014_browser-verified-metadata-capture.csv",
        "profile_metric": "browser_verified_museum_number",
        "profile_value": "OA+.165",
        "profile_unit": "museum_number_label",
        "import_relevance": "Preserves the official museum number as a human lookup and later object cross-reference route",
        "caution": "Controlled-browser metadata only; no page payload, image, source checksum, or object identity crosswalk was captured",
    },
    {
        "source_id": "src-british-museum-oracle-bone",
        "evidence_download_id": "dl-british-museum-oa-165",
        "metadata_file": "014_browser-verified-metadata-capture.csv",
        "profile_metric": "browser_verified_object_type",
        "profile_value": "oracle-bone",
        "profile_unit": "official_object_type_label",
        "import_relevance": "Records the official object-type label for source discovery and museum-record comparison",
        "caution": "The museum label is source metadata; it does not establish an inscription identity, reading, or corpus-scale coverage",
    },
    {
        "source_id": "src-british-museum-oracle-bone",
        "evidence_download_id": "dl-british-museum-oa-165",
        "metadata_file": "014_browser-verified-metadata-capture.csv",
        "profile_metric": "browser_verified_period_and_date",
        "profile_value": "Shang dynasty;13thC BC-11thC BC",
        "profile_unit": "official_period_and_date_labels",
        "import_relevance": "Keeps the official period and production-date labels visible for later provenance review",
        "caution": "Source-page labels only; archaeological dating and group assignment require independent object-level review",
    },
    {
        "source_id": "src-british-museum-oracle-bone",
        "evidence_download_id": "dl-british-museum-oa-165",
        "metadata_file": "014_browser-verified-metadata-capture.csv",
        "profile_metric": "browser_verified_findspot",
        "profile_value": "Found/Acquired: China",
        "profile_unit": "official_findspot_label",
        "import_relevance": "Preserves the official findspot wording so its broad provenance scope remains reviewable",
        "caution": "The broad country-level wording is not an excavation site, pit, batch, or secure archaeological context",
    },
    {
        "source_id": "src-british-museum-oracle-bone",
        "evidence_download_id": "dl-british-museum-oa-165",
        "metadata_file": "014_browser-verified-metadata-capture.csv",
        "profile_metric": "browser_verified_material_acquisition_department",
        "profile_value": "bone;1972;Asia",
        "profile_unit": "official_material_acquisition_department_labels",
        "import_relevance": "Keeps material, acquisition year, and department labels available for museum provenance checking",
        "caution": "Metadata-only routing aid; it is not rights clearance, image availability, or evidence of original excavation context",
    },
    {
    ...
    },
    {
        ...
        "evidence_download_id": "dl-xxt-jgw-home",
        "metadata_file": "011_core-institutional-access-profile.csv",
        "profile_metric": "registered_official_character_head_count",
        "profile_value": "2548",
        "profile_unit": "character_heads",
        "import_relevance": "Preserves the reviewed official scale target for human planning of character-head lookup and later source cross-reference",
        "caution": "Registered scale metadata only; it is not a count of locally imported or human-verified character records",
    },
    {
        "source_id": "src-xiaoxuetang-jiaguwen",
        "evidence_download_id": "dl-xxt-jgw-home",
        "metadata_file": "011_core-institutional-access-profile.csv",
        "profile_metric": "registered_official_glyph_form_count",
        "profile_value": "24701",
        "profile_unit": "glyph_forms",
        "import_relevance": "Preserves the reviewed official scale target for later glyph-form lookup and variant comparison planning",
        "caution": "Registered scale metadata only; it does not establish local image availability, reuse rights, or reviewed variant relations",
    },
    {
        "source_id": "src-xiaoxuetang-jiaguwen",
        "evidence_download_id": "dl-xxt-jgw-home",
        "metadata_file": "011_core-institutional-access-profile.csv",
        "profile_metric": "registered_simple_search_fields",
        "profile_value": "character_number;glyph_form;jiaguwen_bian_page;heji_number;old_catalog_ref;class_group",
        "profile_unit": "normalized_search_field_labels",
        "import_relevance": "Keeps the reviewed discovery fields visible for human lookup and future source-marked crosswalk work",
        "caution": "Search-field labels are routing metadata and not imported records, identifier equivalences, or decipherment evidence",
    },
    {
        "source_id": "src-xiaoxuetang-jiaguwen",
        "evidence_download_id": "dl-xxt-jgw-about",
        "metadata_file": "011_core-institutional-access-profile.csv",
        "profile_metric": "registered_primary_glyph_source_basis",
        "profile_value": "jiaguwen_bian_primary_basis",
        "profile_unit": "source_basis_label",
        "import_relevance": "Records the reviewed database-level statement that glyph coverage is based mainly on Jiaguwen Bian",
        "caution": "Database-level source basis only; each page, glyph, catalog link, and reading still requires object-level evidence review",
    },
    {
        "source_id": "src-xiaoxuetang-obm",
        "evidence_download_id": "dl-xxt-obm-example",
        "metadata_file": "011_core-institutional-access-profile.csv",
        "profile_metric": "registered_heji_range_upper_bound",
        "profile_value": "41956",
        "profile_unit": "heji_number_upper_bound",
        "import_relevance": "Preserves the reviewed 1 through 41956 source range for human material-source lookup and completeness planning",
        "caution": "Registered range metadata only; it is not a local import count or proof that every number has complete object evidence",
    },
    {
        "source_id": "src-xiaoxuetang-obm",
        "evidence_download_id": "dl-xxt-obm-example",
        "metadata_file": "011_core-institutional-access-profile.csv",
        "profile_metric": "registered_old_catalog_abbreviation_count",
        "profile_value": "90",
        "profile_unit": "old_catalog_book_abbreviations",
        "import_relevance": "Preserves the reviewed abbreviation-table scale for later source-cited expansion of old catalog references",
        "caution": "Abbreviation count is planning metadata; titles and row-level relations remain pending source and rights review",
    },
    {
        "source_id": "src-xiaoxuetang-obm",
        "evidence_download_id": "dl-xxt-obm-example",
        "metadata_file": "011_core-institutional-access-profile.csv",
        "profile_metric": "registered_holding_abbreviation_count",
        "profile_value": "211",
        "profile_unit": "rubbing_or_holding_abbreviations",
        "import_relevance": "Preserves the reviewed holding-abbreviation scale for future collection-provenance crosswalk checks",
        "caution": "Institution labels are metadata-only and require object-level verification before provenance claims",
    },
    {
        "source_id": "src-xiaoxuetang-obm",
        "evidence_download_id": "dl-xxt-obm-example",
        "metadata_file": "011_core-institutional-access-profile.csv",
        "profile_metric": "registered_source_table_fields",
        "profile_value": "heji_number;zhetuo_ref;selected_ref;duplicate_ref;join_ref;holding_ref;note",
        "profile_unit": "normalized_source_table_field_labels",
        "import_relevance": "Keeps the reviewed source-table fields visible for human provenance review and future inscription staging",
        "caution": "Field labels do not establish row completeness, catalog identity, collection provenance, or rights clearance",
    },
    {
