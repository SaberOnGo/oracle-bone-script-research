# Material Visual Observation / obs-comp-cand-002233 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002233`
- External reference / 外部参照: `obimd-sub-yo32drds2u`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020046_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yo32drds2u/yo32drds2u/yo32drds2u.png`
- Checksum / 校验和:
  `101ebec778da0b63ec3a0c8ba19631c068f4bcac100cd80c638d36b8c01f35aa`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.75%.
- Marked-pixel bounds: (64,16)–(189,233); span 126 × 218 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.75%。
- 痕迹范围：(64,16)–(189,233)；跨度126 × 218 px；痕迹矩形高于宽。
