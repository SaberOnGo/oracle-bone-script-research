...
- Project ID: `obs-evo-cand-013557`
- EVOBC category candidate ID: `evobc-evo-cat-13557`
- External category reference: `evobc-cat-13557`
- Source category ID: `13557`
- Source label for human review: `𭬰`
- Source codepoints: `U+2DB30`
...
- `obs-evo-cand-013557-route-category-staging`
...
- `obs-evo-cand-013557-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013557-route-evolution-graph`
