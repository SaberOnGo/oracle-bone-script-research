...
- External category reference: `evobc-cat-11261`
- Source category ID: `11261`
- Source label for human review: `𢟚`
...
- `obs-evo-cand-011261-route-category-staging`
...
- `obs-evo-cand-011261-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011261-route-evolution-graph`
