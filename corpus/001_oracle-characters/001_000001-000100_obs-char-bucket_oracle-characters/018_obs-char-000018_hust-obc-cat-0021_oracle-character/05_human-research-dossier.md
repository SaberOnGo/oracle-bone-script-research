# obs-char-000018 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/018_obs-char-000018_hust-obc-cat-0021_orac
  le-character/03_visual-assets/001_asset-000023_hust-obc-cat-0021_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0021/G_0021_佚624合5991賓組.png`
- asset id: `asset-000023`
...
- source category: `0021`
- validation class: `17`
- source image route: `HUST-OBC/deciphered/0021/G_0021_佚624合5991賓組.png`
- asset id: `asset-000023`
...
- English observation: `A second tall arched form is visible, with crossing
  interior strokes and long lines descending from the lower edge.`
- 中文观察: `图像呈另一种高拱形体，内部笔画交叉，底部向下延伸出较长线条。`
...
- dataset label text: `㐋`
- dataset label codepoints: `U+340B`
...
- filename catalog route clues: `Heji-like filename clue: 合5991
  (G_0021_佚624合5991賓組.png)`
...
- Which source records identify obs-char-000018 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000018？
