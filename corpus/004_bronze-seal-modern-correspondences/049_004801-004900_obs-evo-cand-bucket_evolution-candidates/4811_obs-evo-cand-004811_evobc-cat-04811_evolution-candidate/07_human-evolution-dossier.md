...
- External category reference: `evobc-cat-04811`
- Source category ID: `04811`
- Source label for human review: `溝`
...
- `obs-evo-cand-004811-route-category-staging`
...
- `obs-evo-cand-004811-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004811-route-evolution-graph`
