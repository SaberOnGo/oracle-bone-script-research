...
- Project ID: `obs-evo-cand-011365`
- EVOBC category candidate ID: `evobc-evo-cat-11365`
- External category reference: `evobc-cat-11365`
- Source category ID: `11365`
- Source label for human review: `𣀉`
- Source codepoints: `U+23009`
...
- `obs-evo-cand-011365-route-category-staging`
...
- `obs-evo-cand-011365-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011365-route-evolution-graph`
