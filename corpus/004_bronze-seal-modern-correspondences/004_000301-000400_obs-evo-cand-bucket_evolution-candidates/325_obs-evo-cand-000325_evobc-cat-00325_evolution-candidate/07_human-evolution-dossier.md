...
Project ID: `obs-evo-cand-000325`
...
- Project ID: `obs-evo-cand-000325`
- EVOBC category candidate ID: `evobc-evo-cat-00325`
- External category reference: `evobc-cat-00325`
- Source category ID: `00325`
- Source label for human review: `䋣`
- Source codepoints: `U+42E3`
...
- `obs-evo-cand-000325-route-category-staging`
...
- `obs-evo-cand-000325-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000325-route-evolution-graph`
