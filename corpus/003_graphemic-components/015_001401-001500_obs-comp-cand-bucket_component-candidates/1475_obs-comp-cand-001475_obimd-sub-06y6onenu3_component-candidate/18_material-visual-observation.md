# Material Visual Observation / obs-comp-cand-001475 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001475`
- External reference / 外部参照: `obimd-sub-06y6onenu3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016052_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gqezg03aqo/06y6onenu3/06y6onenu3.png`
- Checksum / 校验和:
  `09b8d2ba517206882b2ecad9f2077ecd9abe19c64034973b12f2a62092973019`
...
- Marked-pixel bounds: (84,25)–(181,213); span 98 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.71%。
- 痕迹范围：(84,25)–(181,213)；跨度98 × 189 px；痕迹矩形高于宽。
