# obs-unk-005147 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005147`
- primary external id: `hust-obc-und-X-005147`
...
- local review image route: `corpus/001_oracle-characters/068_undeciphered-005
  101-005200_obs-unk-bucket_oracle-character-candidates/047_obs-unk-005147_h
  ust-obc-und-X-005147_oracle-character-candidate/03_visual-assets/001_asset
  -006740_hust-obc-und-X-005147_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/703/X_？_7672_1.png`
- asset id: `asset-006740`
...
- source class: `HUST-OBC/undeciphered/X/703/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/703/X_？_7672_1.png`
- asset id: `asset-006740`
...
- Which source records identify obs-unk-005147 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005147？
