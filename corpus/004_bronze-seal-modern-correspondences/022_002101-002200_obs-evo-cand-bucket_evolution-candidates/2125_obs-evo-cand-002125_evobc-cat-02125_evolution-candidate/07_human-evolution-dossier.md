...
Project ID: `obs-evo-cand-002125`
...
- Project ID: `obs-evo-cand-002125`
- EVOBC category candidate ID: `evobc-evo-cat-02125`
- External category reference: `evobc-cat-02125`
- Source category ID: `02125`
- Source label for human review: `姗`
- Source codepoints: `U+59D7`
...
- `obs-evo-cand-002125-route-category-staging`
...
- `obs-evo-cand-002125-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002125-route-evolution-graph`
