...
- External category reference: `evobc-cat-03432`
- Source category ID: `03432`
- Source label for human review: `揟`
- Source codepoints: `U+63DF`
...
- `obs-evo-cand-003432-route-category-staging`
...
- `obs-evo-cand-003432-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003432-route-evolution-graph`
