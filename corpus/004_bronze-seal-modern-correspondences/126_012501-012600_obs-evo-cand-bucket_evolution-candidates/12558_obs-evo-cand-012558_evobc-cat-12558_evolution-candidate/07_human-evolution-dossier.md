...
- Project ID: `obs-evo-cand-012558`
- EVOBC category candidate ID: `evobc-evo-cat-12558`
- External category reference: `evobc-cat-12558`
- Source category ID: `12558`
- Source label for human review: `𩃶`
- Source codepoints: `U+290F6`
...
- `obs-evo-cand-012558-route-category-staging`
...
- `obs-evo-cand-012558-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012558-route-evolution-graph`
