...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0884`
...
- Source image / 来源图: `G_0884_甲骨文0.png`
- Image / 图像: `001_asset-000785_hust-obc-cat-0884_glyph.png`
...
- target node: `obimd-main-cand-003071`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00074`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/074_obs-evo-cand-000074_evobc-cat-00074_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `x9f7dp1d6n`
...
- Source label text / 来源标签文字: `㝪`
- Source label codepoint / 来源标签 codepoint: `U+376A`
