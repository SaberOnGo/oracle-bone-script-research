...
- Project ID: `obs-evo-cand-001703`
- EVOBC category candidate ID: `evobc-evo-cat-01703`
- External category reference: `evobc-cat-01703`
- Source category ID: `01703`
- Source label for human review: `嘯`
- Source codepoints: `U+562F`
...
- `obs-evo-cand-001703-route-category-staging`
...
- `obs-evo-cand-001703-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001703-route-evolution-graph`
