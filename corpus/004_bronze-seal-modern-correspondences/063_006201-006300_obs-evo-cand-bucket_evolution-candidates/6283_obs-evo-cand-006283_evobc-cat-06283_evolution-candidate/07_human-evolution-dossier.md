...
- Project ID: `obs-evo-cand-006283`
- EVOBC category candidate ID: `evobc-evo-cat-06283`
- External category reference: `evobc-cat-06283`
- Source category ID: `06283`
- Source label for human review: `箁`
- Source codepoints: `U+7B81`
...
- `obs-evo-cand-006283-route-category-staging`
...
- `obs-evo-cand-006283-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006283-route-evolution-graph`
