# obs-unk-008000 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008000`
- primary external id: `hust-obc-und-YH-008000`
...
- local review image route: `corpus/001_oracle-characters/096_undeciphered-007
  901-008000_obs-unk-bucket_oracle-character-candidates/100_obs-unk-008000_h
  ust-obc-und-YH-008000_oracle-character-candidate/03_visual-assets/001_asse
  t-009591_hust-obc-und-YH-008000_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/605EE/H_？_605EE_0.png`
- asset id: `asset-009591`
...
- source class: `HUST-OBC/undeciphered/Y+H/605EE/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/605EE/H_？_605EE_0.png`
- asset id: `asset-009591`
...
- Which source records identify obs-unk-008000 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008000？
