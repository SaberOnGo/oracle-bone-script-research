# Material Visual Observation / obs-comp-cand-001734 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001734`
- External reference / 外部参照: `obimd-sub-3girn45lu1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017929_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l7cyvm7kbt/3girn45lu1/3girn45lu1.png`
- Checksum / 校验和:
  `930f10fbfc8284f1ea7a9be8a26e7569f845b3a716b444295064db0e923e2091`
...
- Marked-pixel bounds: (59,74)–(192,183); span 134 × 110 px; the marked
...
- 痕迹范围：(59,74)–(192,183)；跨度134 × 110 px；痕迹矩形宽于高。
