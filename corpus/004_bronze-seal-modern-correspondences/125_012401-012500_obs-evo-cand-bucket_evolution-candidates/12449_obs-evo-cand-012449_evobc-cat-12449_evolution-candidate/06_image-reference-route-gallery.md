...
- `obs-evo-cand-012449-route-category-staging`
...
- `obs-evo-cand-012449-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-012449-route-evolution-graph`
