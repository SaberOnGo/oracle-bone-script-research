# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000294
...
| Glyph or codepoint route / 字形或码位路线 | 59 OBIMD route rows; examples U+79B1;U+209AA;U+F1A76; U+F1A77; 另有 57 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
| Local visual evidence / 本地视觉证据 | 59 local image rows; source_image_extracted | 06_component-visual-index.csv; 07_component-visual-gallery.md |
