...
- `obs-evo-cand-001336-route-category-staging`
...
- `obs-evo-cand-001336-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001336-route-evolution-graph`
