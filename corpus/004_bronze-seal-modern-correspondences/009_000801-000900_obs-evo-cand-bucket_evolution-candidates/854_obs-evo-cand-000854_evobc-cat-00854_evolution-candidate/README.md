# obs-evo-cand-000854 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000854`
- EVOBC category candidate ID: `evobc-evo-cat-00854`
- External category ref: `evobc-cat-00854`
- Source label for human review: `侜`
- Source codepoints: `U+4F9C`
- Image reference count: `27`
- Era token counts: `BI:3;OBC:22;SS:1;WSC:1`
- Source token counts: `Book:2;Web:25`
