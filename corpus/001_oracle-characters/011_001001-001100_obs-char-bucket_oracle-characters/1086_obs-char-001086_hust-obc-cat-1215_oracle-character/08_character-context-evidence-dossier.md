...
- Primary external ID / 首选外部 ID: `hust-obc-cat-1215`
...
- Source image / 来源图: `H_1215_60486_0.png`
- Image / 图像: `001_asset-001091_hust-obc-cat-1215_glyph.png`
...
- target node: `evobc-evo-cat-00101`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/101_obs-evo-cand-000101_evobc-cat-00101_evoluti
...
- Source label text / 来源标签文字: `㢵`
- Source label codepoint / 来源标签 codepoint: `U+38B5`
