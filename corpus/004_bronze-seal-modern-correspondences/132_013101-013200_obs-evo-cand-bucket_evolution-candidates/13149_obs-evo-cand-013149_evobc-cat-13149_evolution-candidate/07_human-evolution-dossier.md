...
Project ID: `obs-evo-cand-013149`
...
- Project ID: `obs-evo-cand-013149`
- EVOBC category candidate ID: `evobc-evo-cat-13149`
- External category reference: `evobc-cat-13149`
- Source category ID: `13149`
- Source label for human review: `𫺟`
- Source codepoints: `U+2BE9F`
...
- `obs-evo-cand-013149-route-category-staging`
...
- `obs-evo-cand-013149-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013149-route-evolution-graph`
