# obs-unk-004845 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004845`
- primary external id: `hust-obc-und-X-004845`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/045_obs-unk-004845_h
  ust-obc-und-X-004845_oracle-character-candidate/03_visual-assets/001_asset
  -006438_hust-obc-und-X-004845_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/401/X_？_7387_1.png`
- asset id: `asset-006438`
...
- source class: `HUST-OBC/undeciphered/X/401/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/401/X_？_7387_1.png`
- asset id: `asset-006438`
...
- English observation: `left outline with pale opening and right stroke`
- 中文观察: `左侧带开口的围合和右侧下伸笔画`
...
- Which source records identify obs-unk-004845 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004845？
