...
- External category reference: `evobc-cat-03815`
- Source category ID: `03815`
- Source label for human review: `曷`
- Source codepoints: `U+66F7`
...
- `obs-evo-cand-003815-route-category-staging`
...
- `obs-evo-cand-003815-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003815-route-evolution-graph`
