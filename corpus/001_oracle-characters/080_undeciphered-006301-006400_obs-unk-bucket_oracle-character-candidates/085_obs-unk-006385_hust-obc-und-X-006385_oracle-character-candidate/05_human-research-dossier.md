# obs-unk-006385 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/080_undeciphered-006
  301-006400_obs-unk-bucket_oracle-character-candidates/085_obs-unk-006385_h
  ust-obc-und-X-006385_oracle-character-candidate/03_visual-assets/001_asset
  -007976_hust-obc-und-X-006385_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1941/X_？_536_1.png`
- asset id: `asset-007976`
...
- source class: `HUST-OBC/undeciphered/X/1941/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1941/X_？_536_1.png`
- asset id: `asset-007976`
...
- Which source records identify obs-unk-006385 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006385？
