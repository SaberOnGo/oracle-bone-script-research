# obs-evo-cand-002966 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02966`
- Source label: `恆`
- Source codepoints: `U+6046`
- Image reference count: `131`
- Era token counts: `BI:14;CS:2;OBC:9;SS:2;WSC:104`
- Source token counts: `Book:39;Web:92`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 9 image references
- era 1 / BI: 14 image references
- era 2 / SS: 2 image references
- era 4 / WSC: 104 image references
