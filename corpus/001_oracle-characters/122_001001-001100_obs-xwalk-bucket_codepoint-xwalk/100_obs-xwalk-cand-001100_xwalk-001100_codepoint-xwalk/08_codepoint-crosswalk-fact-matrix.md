# obs-xwalk-cand-001100 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+38C3` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1229` | not reading |
