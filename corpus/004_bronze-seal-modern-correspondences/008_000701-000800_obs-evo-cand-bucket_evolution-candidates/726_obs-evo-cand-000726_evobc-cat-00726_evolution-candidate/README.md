# obs-evo-cand-000726 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000726`
- EVOBC category candidate ID: `evobc-evo-cat-00726`
- External category ref: `evobc-cat-00726`
- Source label: `今`
- Source codepoints: `U+4ECA`
- Image reference count: `180`
- Era token counts: `BI:53;CS:2;OBC:92;SAC:3;SS:2;WSC:28`
- Source token counts: `Book:83;Web:97`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 92 image references
- era 1 / BI: 53 image references
- era 2 / SS: 2 image references
- era 3 / SAC: 3 image references
- era 4 / WSC: 28 image references
