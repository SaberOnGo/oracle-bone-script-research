...
- Project ID: `obs-evo-cand-007328`
- EVOBC category candidate ID: `evobc-evo-cat-07328`
- External category reference: `evobc-cat-07328`
- Source category ID: `07328`
- Source label for human review: `茵`
- Source codepoints: `U+8335`
...
- `obs-evo-cand-007328-route-category-staging`
...
- `obs-evo-cand-007328-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007328-route-evolution-graph`
