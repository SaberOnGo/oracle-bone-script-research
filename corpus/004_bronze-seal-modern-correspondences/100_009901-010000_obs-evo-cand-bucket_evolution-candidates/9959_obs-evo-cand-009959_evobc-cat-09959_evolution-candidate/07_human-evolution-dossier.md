...
- External category reference: `evobc-cat-09959`
- Source category ID: `09959`
- Source label for human review: `韭`
...
- `obs-evo-cand-009959-route-category-staging`
...
- `obs-evo-cand-009959-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009959-route-evolution-graph`
