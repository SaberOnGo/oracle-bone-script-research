...
- Project ID: `obs-evo-cand-004320`
- EVOBC category candidate ID: `evobc-evo-cat-04320`
- External category reference: `evobc-cat-04320`
- Source category ID: `04320`
- Source label for human review: `櫪`
- Source codepoints: `U+6AEA`
...
- `obs-evo-cand-004320-route-category-staging`
...
- `obs-evo-cand-004320-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004320-route-evolution-graph`
