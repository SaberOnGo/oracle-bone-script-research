...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000454` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2327` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `286` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `378` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41422` [route_present_image_or_text_not_collected]
