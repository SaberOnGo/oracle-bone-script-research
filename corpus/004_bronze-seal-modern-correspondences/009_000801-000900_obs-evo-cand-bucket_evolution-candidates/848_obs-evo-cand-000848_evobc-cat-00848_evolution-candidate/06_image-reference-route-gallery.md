...
- `obs-evo-cand-000848-route-category-staging`
...
- `obs-evo-cand-000848-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000848-route-evolution-graph`
