...
- Review draft ID / 复核草稿 ID: `source-engineering-second-wave-review-draft-0003`
- Continuation task ID / 后续任务 ID: `source-engineering-second-wave-source-checklist-0003`
- Source status ID / 来源状态 ID: `source-engineering-first-wave-source-status-0003`
...
- First-wave status / 第一波状态: `metadata_profile_available_field_map_semantics_pending`
- Source action lane / 来源动作泳道: `field_map_semantics_review`

## Objective / 目标

`review_field_map_semantics_and_rights_boundary_before_import;review_field_map_semantics_against_metadata_profile_before_import;keep_metadata_only_boundary;record_human_review_before_any_source_promotion_or_import`

## Blockers / 阻断项

- `field_map_semantics_not_reviewed`
- `rights_boundary_per_field_pending`
...
- `doc/public/user_research/009_source-engineering-gap-review-queues/0017_src-ihp-museum-oracle-bones_source_field_map_needed_next-action-result.md`
