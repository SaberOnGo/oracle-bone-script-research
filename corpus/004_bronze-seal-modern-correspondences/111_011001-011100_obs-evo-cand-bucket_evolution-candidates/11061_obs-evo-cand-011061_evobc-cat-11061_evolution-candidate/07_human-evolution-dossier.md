...
- External category reference: `evobc-cat-11061`
- Source category ID: `11061`
- Source label for human review: `𡧄`
- Source codepoints: `U+219C4`
...
- `obs-evo-cand-011061-route-category-staging`
...
- `obs-evo-cand-011061-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011061-route-evolution-graph`
