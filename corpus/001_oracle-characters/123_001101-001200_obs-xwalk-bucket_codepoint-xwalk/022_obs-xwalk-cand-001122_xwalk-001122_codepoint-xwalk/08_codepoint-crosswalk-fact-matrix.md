# obs-xwalk-cand-001122 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+38DB` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-1253` | not reading |
| OBIMD route / OBIMD 路线 | `obimd-main-cand-002593` | not component |
...
| Missing evidence route / 缺失证据路线 | `matched_obimd_by_codepoint` | not decipherment |
