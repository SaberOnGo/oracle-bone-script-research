# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000343
...
| --- | --- | --- | --- |
| `obimd-glyph-link-005107` | 󱾇 | `U+F1F87` | `reviewed_metadata_only` |
| `obimd-glyph-link-005108` | 󱾈 | `U+F1F88` | `reviewed_metadata_only` |
| `obimd-glyph-link-005109` | 󱾉 | `U+F1F89` | `reviewed_metadata_only` |
| `obimd-glyph-link-005110` | 󱾊 | `U+F1F8A` | `reviewed_metadata_only` |
