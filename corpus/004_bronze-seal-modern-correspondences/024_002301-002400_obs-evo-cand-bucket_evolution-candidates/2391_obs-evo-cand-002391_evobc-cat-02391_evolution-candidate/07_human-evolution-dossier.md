...
- External category reference: `evobc-cat-02391`
- Source category ID: `02391`
- Source label for human review: `宬`
- Source codepoints: `U+5BAC`
...
- `obs-evo-cand-002391-route-category-staging`
...
- `obs-evo-cand-002391-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002391-route-evolution-graph`
