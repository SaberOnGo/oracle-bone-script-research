...
- External category reference: `evobc-cat-13243`
- Source category ID: `13243`
- Source label for human review: `𬌺`
...
- `obs-evo-cand-013243-route-category-staging`
...
- `obs-evo-cand-013243-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013243-route-evolution-graph`
