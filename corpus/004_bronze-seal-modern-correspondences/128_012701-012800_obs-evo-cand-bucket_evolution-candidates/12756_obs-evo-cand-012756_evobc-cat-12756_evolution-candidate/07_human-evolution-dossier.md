...
- Project ID: `obs-evo-cand-012756`
- EVOBC category candidate ID: `evobc-evo-cat-12756`
- External category reference: `evobc-cat-12756`
- Source category ID: `12756`
- Source label for human review: `𪑧`
- Source codepoints: `U+2A467`
...
- `obs-evo-cand-012756-route-category-staging`
...
- `obs-evo-cand-012756-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012756-route-evolution-graph`
