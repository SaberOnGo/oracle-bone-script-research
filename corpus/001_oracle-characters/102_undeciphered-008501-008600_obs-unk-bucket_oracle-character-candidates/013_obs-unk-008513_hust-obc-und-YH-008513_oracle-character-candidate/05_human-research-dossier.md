# obs-unk-008513 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008513`
- primary external id: `hust-obc-und-YH-008513`
...
- local review image route: `corpus/001_oracle-characters/102_undeciphered-008
  501-008600_obs-unk-bucket_oracle-character-candidates/013_obs-unk-008513_h
  ust-obc-und-YH-008513_oracle-character-candidate/03_visual-assets/001_asse
  t-010104_hust-obc-und-YH-008513_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60B97/Y_？_60B97.jpg`
- asset id: `asset-010104`
...
- source class: `HUST-OBC/undeciphered/Y+H/60B97/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60B97/Y_？_60B97.jpg`
- asset id: `asset-010104`
...
- Which source records identify obs-unk-008513 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008513？
