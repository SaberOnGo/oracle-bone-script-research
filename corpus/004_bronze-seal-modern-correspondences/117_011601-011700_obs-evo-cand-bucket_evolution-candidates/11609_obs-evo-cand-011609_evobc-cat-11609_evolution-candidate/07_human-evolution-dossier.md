...
Project ID: `obs-evo-cand-011609`
...
- Project ID: `obs-evo-cand-011609`
- EVOBC category candidate ID: `evobc-evo-cat-11609`
- External category reference: `evobc-cat-11609`
- Source category ID: `11609`
- Source label for human review: `𤜻`
- Source codepoints: `U+2473B`
...
- `obs-evo-cand-011609-route-category-staging`
...
- `obs-evo-cand-011609-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011609-route-evolution-graph`
