...
- Project ID / 项目 ID: `obs-char-001227`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1372`
...
- Source image / 来源图: `G_1372_乙8718(甲).png`
- Image / 图像: `001_asset-001232_hust-obc-cat-1372_glyph.png`
...
- target node: `evobc-evo-cat-00127`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/127_obs-evo-cand-000127_evobc-cat-00127_evoluti
...
- Source label text / 来源标签文字: `㥒`
- Source label codepoint / 来源标签 codepoint: `U+3952`
