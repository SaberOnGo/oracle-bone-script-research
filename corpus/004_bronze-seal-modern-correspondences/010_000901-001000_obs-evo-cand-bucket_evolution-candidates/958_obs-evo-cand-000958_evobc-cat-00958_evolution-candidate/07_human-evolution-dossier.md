...
Project ID: `obs-evo-cand-000958`
...
- Project ID: `obs-evo-cand-000958`
- EVOBC category candidate ID: `evobc-evo-cat-00958`
- External category reference: `evobc-cat-00958`
- Source category ID: `00958`
- Source label for human review: `偘`
- Source codepoints: `U+5058`
...
- `obs-evo-cand-000958-route-category-staging`
...
- `obs-evo-cand-000958-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000958-route-evolution-graph`
