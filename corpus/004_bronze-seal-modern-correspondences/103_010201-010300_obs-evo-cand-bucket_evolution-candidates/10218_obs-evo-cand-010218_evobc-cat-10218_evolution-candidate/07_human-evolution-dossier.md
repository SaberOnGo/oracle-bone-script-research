...
- External category reference: `evobc-cat-10218`
- Source category ID: `10218`
- Source label for human review: `騑`
...
- `obs-evo-cand-010218-route-category-staging`
...
- `obs-evo-cand-010218-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010218-route-evolution-graph`
