# obs-unk-003148 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/048_undeciphered-003
  101-003200_obs-unk-bucket_oracle-character-candidates/048_obs-unk-003148_h
  ust-obc-und-L-003148_oracle-character-candidate/03_visual-assets/001_asset
  -004741_hust-obc-und-L-003148_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/3148/L_？_5795.jpg`
- asset id: `asset-004741`
...
- source class: `HUST-OBC/undeciphered/L/3148/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/3148/L_？_5795.jpg`
- asset id: `asset-004741`
...
- Which source records identify obs-unk-003148 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-003148？
