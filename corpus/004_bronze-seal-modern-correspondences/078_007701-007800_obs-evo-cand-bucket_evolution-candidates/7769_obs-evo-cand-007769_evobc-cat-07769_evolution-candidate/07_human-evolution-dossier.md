...
- External category reference: `evobc-cat-07769`
- Source category ID: `07769`
- Source label for human review: `蜂`
...
- `obs-evo-cand-007769-route-category-staging`
...
- `obs-evo-cand-007769-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007769-route-evolution-graph`
