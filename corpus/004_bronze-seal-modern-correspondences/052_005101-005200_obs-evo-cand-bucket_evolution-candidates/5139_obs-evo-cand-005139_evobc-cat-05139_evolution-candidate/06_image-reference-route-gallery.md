...
- `obs-evo-cand-005139-route-category-staging`
...
- `obs-evo-cand-005139-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-005139-route-evolution-graph`
