...
- External category reference: `evobc-cat-00236`
- Source category ID: `00236`
- Source label for human review: `㺞`
...
- `obs-evo-cand-000236-route-category-staging`
...
- `obs-evo-cand-000236-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000236-route-evolution-graph`
