...
- External category reference: `evobc-cat-03184`
- Source category ID: `03184`
- Source label for human review: `懣`
...
- `obs-evo-cand-003184-route-category-staging`
...
- `obs-evo-cand-003184-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003184-route-evolution-graph`
