...
- External category reference: `evobc-cat-07761`
- Source category ID: `07761`
- Source label for human review: `蛶`
- Source codepoints: `U+86F6`
...
- `obs-evo-cand-007761-route-category-staging`
...
- `obs-evo-cand-007761-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007761-route-evolution-graph`
