...
Project ID: `obs-evo-cand-009147`
...
- Project ID: `obs-evo-cand-009147`
- EVOBC category candidate ID: `evobc-evo-cat-09147`
- External category reference: `evobc-cat-09147`
- Source category ID: `09147`
- Source label for human review: `郝`
- Source codepoints: `U+90DD`
...
- `obs-evo-cand-009147-route-category-staging`
...
- `obs-evo-cand-009147-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009147-route-evolution-graph`
