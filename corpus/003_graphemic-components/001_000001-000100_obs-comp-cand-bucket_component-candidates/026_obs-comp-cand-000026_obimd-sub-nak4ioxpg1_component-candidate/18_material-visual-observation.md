# Material Visual Observation / obs-comp-cand-000026 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000026`
- External reference / 外部参照: `obimd-sub-nak4ioxpg1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011178_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/nak4ioxpg1/nak4ioxpg1/nak4ioxpg1.png`
- Checksum / 校验和:
  `cb4e2dbcacf6de09a1cb4b3ed5f11ab5bf1cfe3f4617437adfab5fe3efc3023e`
...
- Marked-pixel bounds: (85,17)–(164,231); span 80 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.77%。
- 痕迹范围：(85,17)–(164,231)；跨度80 × 215 px；痕迹矩形高于宽。
