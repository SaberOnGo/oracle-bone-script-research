...
Project ID: `obs-evo-cand-008395`
...
- Project ID: `obs-evo-cand-008395`
- EVOBC category candidate ID: `evobc-evo-cat-08395`
- External category reference: `evobc-cat-08395`
- Source category ID: `08395`
- Source label for human review: `讘`
- Source codepoints: `U+8B98`
...
- `obs-evo-cand-008395-route-category-staging`
...
- `obs-evo-cand-008395-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008395-route-evolution-graph`
