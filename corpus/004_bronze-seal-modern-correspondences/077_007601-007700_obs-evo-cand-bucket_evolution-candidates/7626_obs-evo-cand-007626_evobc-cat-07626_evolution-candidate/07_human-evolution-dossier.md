...
- External category reference: `evobc-cat-07626`
- Source category ID: `07626`
- Source label for human review: `薶`
- Source codepoints: `U+85B6`
...
- `obs-evo-cand-007626-route-category-staging`
...
- `obs-evo-cand-007626-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007626-route-evolution-graph`
