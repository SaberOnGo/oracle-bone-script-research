# Collection Provenance Evidence Dossier / 馆藏来源证据档案: coll-obj-cand-00024
...
| source_row_id | `24` |
| object_page_url | `https://museum.sinica.edu.tw/en/collection/32/item/781/` |
...
The item page and large image were re-opened on 2026-08-14. Source text,
image checksum, and the visual boundary are recorded in
`18_live-source-evidence-review.md`; rights remain unresolved.

2026-08-14 重新打开对象页和大图。来源文字、图像校验和与视觉边界已记录在
...
| asset_id | `` |
| asset_path | `` |
| thumbnail_url | `https://museum.sinica.edu.tw/_upload/image/collection_item/thumbnail/8945f68987791716.jpg` |
| source_image_url | `` |
...
| `source_collection_item_id` | `781` |
| `object_title_en` | `Inscribed Carapace I 4683` |
| `catalog_reference_text` | `I 4683` |
| `accession_number` | `` |
| `historical_period` | `` |
| `object_date` | `` |
| `provenience` | `` |
