...
- External category reference: `evobc-cat-07709`
- Source category ID: `07709`
- Source label for human review: `虣`
- Source codepoints: `U+8663`
...
- `obs-evo-cand-007709-route-category-staging`
...
- `obs-evo-cand-007709-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007709-route-evolution-graph`
