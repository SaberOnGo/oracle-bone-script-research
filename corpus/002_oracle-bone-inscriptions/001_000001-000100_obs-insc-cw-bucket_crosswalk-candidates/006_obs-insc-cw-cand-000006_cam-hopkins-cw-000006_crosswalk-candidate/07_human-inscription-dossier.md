...
- Yingguo / 英国所藏: `y30` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `69` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `722` in source row; primary catalog entry pending
- Heji / 合集: `39572` in source row; primary catalog entry pending
