...
- External category reference: `evobc-cat-11082`
- Source category ID: `11082`
...
- `obs-evo-cand-011082-route-category-staging`
...
- `obs-evo-cand-011082-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011082-route-evolution-graph`
