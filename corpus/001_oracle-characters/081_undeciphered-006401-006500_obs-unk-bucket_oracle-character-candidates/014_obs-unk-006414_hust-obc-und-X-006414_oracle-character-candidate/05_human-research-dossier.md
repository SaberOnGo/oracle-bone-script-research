# obs-unk-006414 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/081_undeciphered-006
  401-006500_obs-unk-bucket_oracle-character-candidates/014_obs-unk-006414_h
  ust-obc-und-X-006414_oracle-character-candidate/03_visual-assets/001_asset
  -008005_hust-obc-und-X-006414_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1970/X_？_554_1.png`
- asset id: `asset-008005`
...
- source class: `HUST-OBC/undeciphered/X/1970/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1970/X_？_554_1.png`
- asset id: `asset-008005`
...
- Which source records identify obs-unk-006414 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006414？
