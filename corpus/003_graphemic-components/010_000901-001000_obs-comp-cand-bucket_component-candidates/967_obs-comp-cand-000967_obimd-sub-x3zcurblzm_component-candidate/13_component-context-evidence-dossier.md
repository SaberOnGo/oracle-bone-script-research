# obs-comp-cand-000967 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000967`
- 首选外部 ID: `obimd-sub-x3zcurblzm`
- OBIMD subcharacter UID: `x3zcurblzm`
- OBIMD main character UID: `x3zcurblzm`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+A90AA;U+F56FA; U+F56FB; 另有 1 项
