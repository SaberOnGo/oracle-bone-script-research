# obs-unk-004384 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004384`
- primary external id: `hust-obc-und-L-004384`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/084_obs-unk-004384_h
  ust-obc-und-L-004384_oracle-character-candidate/03_visual-assets/001_asset
  -005977_hust-obc-und-L-004384_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4384/L_？_9747.jpg`
- asset id: `asset-005977`
...
- source class: `HUST-OBC/undeciphered/L/4384/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4384/L_？_9747.jpg`
- asset id: `asset-005977`
...
- English observation: `A dense central cluster and a long`
  `descending right trace are visible.`
- 中文观察: `中央痕迹群较密，右侧有一条向下延伸的长痕。`
...
- Which source records identify obs-unk-004384 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004384？
