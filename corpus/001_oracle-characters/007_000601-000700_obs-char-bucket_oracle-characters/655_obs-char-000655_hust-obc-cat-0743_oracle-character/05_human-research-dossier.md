# obs-char-000655 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000655`
- primary external id: `hust-obc-cat-0743`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/655_obs-char-000655_hust-obc-cat-0743_orac
  le-character/03_visual-assets/001_asset-000660_hust-obc-cat-0743_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0743/G_0743_甲骨文0.png`
- asset id: `asset-000660`
...
- source category: `0743`
- validation class: `654`
- source image route: `HUST-OBC/deciphered/0743/G_0743_甲骨文0.png`
- asset id: `asset-000660`
...
- English observation: `A left angular outline with a small upper opening
  descends through sharp bends, beside a tall right vertical with a forked
  top and crossing lower diagonal.`
- 中文观察: `带小上部空隙的左折角轮廓经数次尖折下行，旁有叉顶高右竖和交叉下斜笔。`
...
- dataset label text: `㛝`
- dataset label codepoints: `U+36DD`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00056`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00056`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00056`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/056_obs-evo-can
  d-000056_evobc-cat-00056_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/056_obs-evo-cand-000056_evobc-cat-00056_evolu
...
- Which source records identify obs-char-000655 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000655？
