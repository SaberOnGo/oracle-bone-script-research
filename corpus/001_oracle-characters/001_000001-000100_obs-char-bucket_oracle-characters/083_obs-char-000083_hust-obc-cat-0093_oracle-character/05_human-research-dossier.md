# obs-char-000083 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000083`
- primary external id: `hust-obc-cat-0093`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/083_obs-char-000083_hust-obc-cat-0093_orac
  le-character/03_visual-assets/001_asset-000088_hust-obc-cat-0093_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0093/G_0093_前1.36.6合23395賓組.png
  `
- asset id: `asset-000088`
...
- source category: `0093`
- validation class: `82`
- source image route: `HUST-OBC/deciphered/0093/G_0093_前1.36.6合23395賓組.png`
- asset id: `asset-000088`
...
- English observation: `The compact image has a rounded outer enclosure, a
  peaked upper interior junction, and a smaller rectangular enclosure
  inside.`
- 中文观察: `小型图像有弧曲外框，上部内部笔画在中央形成尖角，内部另有较小的方框。`
...
- dataset label text: `㑓`
- dataset label codepoints: `U+3453`
...
- filename catalog route clues: `Heji-like filename clue: 合23395
  (G_0093_前1.36.6合23395賓組.png)`
...
- Which source records identify obs-char-000083 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000083？
