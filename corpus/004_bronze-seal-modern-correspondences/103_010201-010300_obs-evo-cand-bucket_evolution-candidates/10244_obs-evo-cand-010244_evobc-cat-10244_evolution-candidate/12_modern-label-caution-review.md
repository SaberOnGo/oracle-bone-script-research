# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010244
...
- EVOBC candidate category: `evobc-evo-cat-10244`.
- Source label for search only: `驂`.
- Source codepoints for search only: `U+9A42`.
