# Material Visual Observation / obs-comp-cand-000939 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000939`
- External reference / 外部参照: `obimd-sub-s42qydp267`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014022_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dccq423sp2/s42qydp267/s42qydp267.png`
- Checksum / 校验和:
  `6a140060de8b8a3ad4c9e36ac3c647a828188750feb6b5d159301cf061ffc5d4`
...
- Marked-pixel bounds: (85,26)–(164,226); span 80 × 201 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.40%。
- 痕迹范围：(85,26)–(164,226)；跨度80 × 201 px；痕迹矩形高于宽。
