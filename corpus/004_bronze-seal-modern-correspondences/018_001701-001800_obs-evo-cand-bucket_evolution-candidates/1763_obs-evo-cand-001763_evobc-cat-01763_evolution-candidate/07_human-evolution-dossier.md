...
- External category reference: `evobc-cat-01763`
- Source category ID: `01763`
- Source label for human review: `囪`
...
- `obs-evo-cand-001763-route-category-staging`
...
- `obs-evo-cand-001763-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001763-route-evolution-graph`
