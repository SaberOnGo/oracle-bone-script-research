...
- External category reference: `evobc-cat-04195`
- Source category ID: `04195`
- Source label for human review: `榻`
- Source codepoints: `U+69BB`
...
- `obs-evo-cand-004195-route-category-staging`
...
- `obs-evo-cand-004195-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004195-route-evolution-graph`
