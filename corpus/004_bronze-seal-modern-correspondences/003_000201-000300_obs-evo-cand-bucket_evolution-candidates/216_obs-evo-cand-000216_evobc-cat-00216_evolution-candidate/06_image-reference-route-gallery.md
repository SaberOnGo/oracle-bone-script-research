...
- `obs-evo-cand-000216-route-category-staging`
...
- `obs-evo-cand-000216-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000216-route-evolution-graph`
