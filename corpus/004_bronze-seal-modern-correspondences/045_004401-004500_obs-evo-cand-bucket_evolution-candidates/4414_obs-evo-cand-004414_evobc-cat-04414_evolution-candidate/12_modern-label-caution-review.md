# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004414
...
- EVOBC candidate category: `evobc-evo-cat-04414`.
- Source label for search only: `殛`.
- Source codepoints for search only: `U+6B9B`.
