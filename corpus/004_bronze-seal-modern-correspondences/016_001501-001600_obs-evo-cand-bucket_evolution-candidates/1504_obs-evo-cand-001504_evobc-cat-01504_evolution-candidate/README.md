# obs-evo-cand-001504 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-001504`
- EVOBC category candidate ID: `evobc-evo-cat-01504`
- External category ref: `evobc-cat-01504`
- Source label for human review: `吕`
- Source codepoints: `U+5415`
- Image reference count: `79`
- Era token counts: `BI:13;CS:2;OBC:26;SAC:14;SS:3;WSC:21`
- Source token counts: `Book:50;Web:29`
