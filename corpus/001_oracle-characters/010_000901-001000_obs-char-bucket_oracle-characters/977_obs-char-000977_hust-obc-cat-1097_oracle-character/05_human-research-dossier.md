# obs-char-000977 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/977_obs-char-000977_hust-obc-cat-1097_orac
  le-character/03_visual-assets/001_asset-000982_hust-obc-cat-1097_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1097/G_1097_寧滬1.521合29415何組.png
  `
- asset id: `asset-000982`
...
- source category: `1097`
- validation class: `976`
- source image route: `HUST-OBC/deciphered/1097/G_1097_寧滬1.521合29415何組.png`
- asset id: `asset-000982`
...
- dataset label text: `㠿`
- dataset label codepoints: `U+383F`
...
- filename catalog route clues: `Heji-like filename clue: 合29415
...
- Which source records identify obs-char-000977 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000977？
