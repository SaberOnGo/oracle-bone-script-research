# obs-char-000957 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000957`
- primary external id: `hust-obc-cat-1076`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/957_obs-char-000957_hust-obc-cat-1076_orac
  le-character/03_visual-assets/001_asset-000962_hust-obc-cat-1076_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1076/G_1076_花037(甲).png`
- asset id: `asset-000962`
...
- source category: `1076`
- validation class: `956`
- source image route: `HUST-OBC/deciphered/1076/G_1076_花037(甲).png`
- asset id: `asset-000962`
...
- English observation: `A small oval mark at left accompanies an upper
  hooked stroke and a long descending central branch.`
- 中文观察: `左侧小型椭圆痕迹旁有上部钩状笔和长中央下行分枝。`
...
- dataset label text: `㠪`
- dataset label codepoints: `U+382A`
...
- Which source records identify obs-char-000957 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000957？
