# obs-char-000159 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000159`
- primary external id: `hust-obc-cat-0175`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/159_obs-char-000159_hust-obc-cat-0175_orac
  le-character/03_visual-assets/001_asset-000164_hust-obc-cat-0175_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0175/G_0175_合565(甲).png`
- asset id: `asset-000164`
...
- source category: `0175`
- validation class: `158`
- source image route: `HUST-OBC/deciphered/0175/G_0175_合565(甲).png`
- asset id: `asset-000164`
...
- English observation: `The image has a rough square enclosure containing
  crossing strokes, with a separate long vertical stroke along the right
  side.`
- 中文观察: `图像有粗略方形围合，内部含交叉笔，右侧另有一条分离的长竖笔。`
...
- dataset label text: `㒥`
- dataset label codepoints: `U+34A5`
...
- filename catalog route clues: `Heji-like filename clue: 合565
  (G_0175_合565(甲).png)`
...
- Which source records identify obs-char-000159 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000159？
