...
- External category reference: `evobc-cat-05976`
- Source category ID: `05976`
- Source label for human review: `祉`
...
- `obs-evo-cand-005976-route-category-staging`
...
- `obs-evo-cand-005976-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005976-route-evolution-graph`
