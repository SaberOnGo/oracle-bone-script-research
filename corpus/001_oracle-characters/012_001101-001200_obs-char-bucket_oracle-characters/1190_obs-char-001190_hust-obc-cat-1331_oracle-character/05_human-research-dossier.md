# obs-char-001190 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1190_obs-char-001190_hust-obc-cat-1331_ora
  cle-character/03_visual-assets/001_asset-001195_hust-obc-cat-1331_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1331/G_1331_乙6404合685賓組.png`
- asset id: `asset-001195`
...
- source category: `1331`
- validation class: `1189`
- source image route: `HUST-OBC/deciphered/1331/G_1331_乙6404合685賓組.png`
- asset id: `asset-001195`
...
- English observation: `A broad rounded central enclosure has two forked
  upper branches, short side strokes, and a lower base.`
...
- dataset label text: `㤩`
- dataset label codepoints: `U+3929`
...
- filename catalog route clues: `Heji-like filename clue: 合685
  (G_1331_乙6404合685賓組.png)`
...
- Which source records identify obs-char-001190 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001190？
