# obs-char-001562 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001562`
- primary external id: `hust-obc-cat-1753`
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1562_obs-char-001562_hust-obc-cat-1753_ora
  cle-character/03_visual-assets/001_asset-001567_hust-obc-cat-1753_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1753/G_1753_掇2.403(甲).png`
- asset id: `asset-001567`
...
- source category: `1753`
- validation class: `1561`
- source image route: `HUST-OBC/deciphered/1753/G_1753_掇2.403(甲).png`
- asset id: `asset-001567`
...
- English observation: `A sparse form has a long right vertical, two small
  left loops, and a lower bowl-like mark.`
...
- dataset label text: `㫏`
- dataset label codepoints: `U+3ACF`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00157`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00157`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00157`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/157_obs-evo-can
  d-000157_evobc-cat-00157_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/157_obs-evo-cand-000157_evobc-cat-00157_evolu
...
- Which source records identify obs-char-001562 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001562？
