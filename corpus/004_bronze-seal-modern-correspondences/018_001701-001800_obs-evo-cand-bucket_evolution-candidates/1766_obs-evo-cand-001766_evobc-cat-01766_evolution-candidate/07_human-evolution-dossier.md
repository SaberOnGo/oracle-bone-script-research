...
- External category reference: `evobc-cat-01766`
- Source category ID: `01766`
- Source label for human review: `围`
- Source codepoints: `U+56F4`
...
- `obs-evo-cand-001766-route-category-staging`
...
- `obs-evo-cand-001766-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001766-route-evolution-graph`
