# obs-char-001360 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001360`
- primary external id: `hust-obc-cat-1517`
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1360_obs-char-001360_hust-obc-cat-1517_ora
  cle-character/03_visual-assets/001_asset-001365_hust-obc-cat-1517_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1517/G_1517_甲1647(甲).png`
- asset id: `asset-001365`
...
- source category: `1517`
- validation class: `1359`
- source image route: `HUST-OBC/deciphered/1517/G_1517_甲1647(甲).png`
- asset id: `asset-001365`
...
- English observation: `A small dense cluster has a pointed upper crossing,
  several side loops, and a compact lower body.`
- 中文观察: `小型密集笔画群有尖状上部交叉笔、数个侧部环形和紧凑下部主体。`
...
- dataset label text: `㧣`
- dataset label codepoints: `U+39E3`
...
- Which source records identify obs-char-001360 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001360？
