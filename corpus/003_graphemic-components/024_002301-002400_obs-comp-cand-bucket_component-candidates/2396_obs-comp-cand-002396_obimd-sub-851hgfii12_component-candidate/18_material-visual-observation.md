# Material Visual Observation / obs-comp-cand-002396 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002396`
- External reference / 外部参照: `obimd-sub-851hgfii12`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020467_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ebp3zxjwi7/851hgfii12/851hgfii12.png`
- Checksum / 校验和:
  `70630c4a3441ab82f60bf2a3c8b6d412711fe892f5e0f6a4a1a3e0e1d81c9df2`
...
- Marked-pixel bounds: (92,35)–(153,212); span 62 × 178 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.27%。
- 痕迹范围：(92,35)–(153,212)；跨度62 × 178 px；痕迹矩形高于宽。
