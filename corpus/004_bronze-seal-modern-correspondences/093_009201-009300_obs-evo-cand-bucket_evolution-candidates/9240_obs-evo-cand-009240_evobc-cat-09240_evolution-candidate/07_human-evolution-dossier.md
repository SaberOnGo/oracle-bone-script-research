...
Project ID: `obs-evo-cand-009240`
...
- Project ID: `obs-evo-cand-009240`
- EVOBC category candidate ID: `evobc-evo-cat-09240`
- External category reference: `evobc-cat-09240`
- Source category ID: `09240`
- Source label for human review: `酎`
- Source codepoints: `U+914E`
...
- `obs-evo-cand-009240-route-category-staging`
...
- `obs-evo-cand-009240-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009240-route-evolution-graph`
