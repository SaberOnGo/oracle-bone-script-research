...
- External category reference: `evobc-cat-04046`
- Source category ID: `04046`
- Source label for human review: `梀`
- Source codepoints: `U+6880`
...
- `obs-evo-cand-004046-route-category-staging`
...
- `obs-evo-cand-004046-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004046-route-evolution-graph`
