# Preformal Research Start Check / 正式研究开始前开包核查: coll-obj-cand-00053
...
| --- | --- | --- |
| 1 | `02_collection-source-index.csv` | `FSC-O-26` |
| 2 | `04_visual-gallery.md` | `committed_public_domain_asset` |
