...
Project ID: `obs-evo-cand-004973`
...
- Project ID: `obs-evo-cand-004973`
- EVOBC category candidate ID: `evobc-evo-cat-04973`
- External category reference: `evobc-cat-04973`
- Source category ID: `04973`
- Source label for human review: `濬`
- Source codepoints: `U+6FEC`
...
- `obs-evo-cand-004973-route-category-staging`
...
- `obs-evo-cand-004973-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004973-route-evolution-graph`
