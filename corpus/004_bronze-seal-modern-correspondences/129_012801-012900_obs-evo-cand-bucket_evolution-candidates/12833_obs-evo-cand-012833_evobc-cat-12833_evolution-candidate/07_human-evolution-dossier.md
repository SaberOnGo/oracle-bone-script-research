...
Project ID: `obs-evo-cand-012833`
...
- Project ID: `obs-evo-cand-012833`
- EVOBC category candidate ID: `evobc-evo-cat-12833`
- External category reference: `evobc-cat-12833`
- Source category ID: `12833`
- Source label for human review: `𪨘`
- Source codepoints: `U+2AA18`
...
- `obs-evo-cand-012833-route-category-staging`
...
- `obs-evo-cand-012833-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012833-route-evolution-graph`
