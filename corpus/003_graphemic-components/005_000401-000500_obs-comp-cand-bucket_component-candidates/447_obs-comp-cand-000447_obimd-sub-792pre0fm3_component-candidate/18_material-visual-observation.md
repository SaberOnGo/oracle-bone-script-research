# Material Visual Observation / obs-comp-cand-000447 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000447`
- External reference / 外部参照: `obimd-sub-792pre0fm3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012370_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/792pre0fm3/792pre0fm3/792pre0fm3.png`
- Checksum / 校验和:
  `f8a1963e6752b5784780aea6278242b75a0c33337ba0dd6e77a8d6529a7b2a59`
...
- Marked-pixel bounds: (77,24)–(172,229); span 96 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.18%。
- 痕迹范围：(77,24)–(172,229)；跨度96 × 206 px；痕迹矩形高于宽。
