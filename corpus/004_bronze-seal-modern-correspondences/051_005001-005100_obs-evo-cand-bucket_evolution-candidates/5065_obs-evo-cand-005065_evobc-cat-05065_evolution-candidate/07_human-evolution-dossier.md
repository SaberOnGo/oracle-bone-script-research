...
Project ID: `obs-evo-cand-005065`
...
- Project ID: `obs-evo-cand-005065`
- EVOBC category candidate ID: `evobc-evo-cat-05065`
- External category reference: `evobc-cat-05065`
- Source category ID: `05065`
- Source label for human review: `烓`
- Source codepoints: `U+70D3`
...
- `obs-evo-cand-005065-route-category-staging`
...
- `obs-evo-cand-005065-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005065-route-evolution-graph`
