# obs-comp-cand-001545 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001545`
- 首选外部 ID: `obimd-sub-9vm0d7txqd`
- OBIMD subcharacter UID: `9vm0d7txqd`
- OBIMD main character UID: `9vm0d7txqd`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+6597;U+F9066; U+F9067; 另有 2 项
