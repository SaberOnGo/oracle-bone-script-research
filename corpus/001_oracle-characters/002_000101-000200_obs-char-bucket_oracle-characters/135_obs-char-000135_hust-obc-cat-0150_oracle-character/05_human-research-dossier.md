# obs-char-000135 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/135_obs-char-000135_hust-obc-cat-0150_orac
  le-character/03_visual-assets/001_asset-000140_hust-obc-cat-0150_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0150/Y_0150_60087.jpg`
- asset id: `asset-000140`
...
- source category: `0150`
- validation class: `134`
- source image route: `HUST-OBC/deciphered/0150/Y_0150_60087.jpg`
- asset id: `asset-000140`
...
- English observation: `The large image has a long upper stem that opens
  into a rounded right loop, while multiple curved strokes descend on the
  left and below.`
...
- dataset label text: `㒌`
- dataset label codepoints: `U+348C`
...
- Which source records identify obs-char-000135 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000135？
