# obs-char-000217 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000217`
- primary external id: `hust-obc-cat-0241`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/217_obs-char-000217_hust-obc-cat-0241_orac
  le-character/03_visual-assets/001_asset-000222_hust-obc-cat-0241_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0241/G_0241_坊間1.71.png`
- asset id: `asset-000222`
...
- source category: `0241`
- validation class: `216`
- source image route: `HUST-OBC/deciphered/0241/G_0241_坊間1.71.png`
- asset id: `asset-000222`
...
- English observation: `The image combines a small upper fork with a compact
  lower grid-like form and a separate long curve along the right side.`
- 中文观察: `图像上方有小分叉，下方为紧凑网格状形，右侧另有分离长弯曲笔。`
...
- dataset label text: `㓧`
- dataset label codepoints: `U+34E7`
...
- Which source records identify obs-char-000217 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000217？
