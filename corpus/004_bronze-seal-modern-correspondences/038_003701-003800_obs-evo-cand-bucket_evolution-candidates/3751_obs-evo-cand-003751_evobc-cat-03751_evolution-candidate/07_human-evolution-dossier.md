...
- External category reference: `evobc-cat-03751`
- Source category ID: `03751`
- Source label for human review: `晤`
- Source codepoints: `U+6664`
...
- `obs-evo-cand-003751-route-category-staging`
...
- `obs-evo-cand-003751-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003751-route-evolution-graph`
