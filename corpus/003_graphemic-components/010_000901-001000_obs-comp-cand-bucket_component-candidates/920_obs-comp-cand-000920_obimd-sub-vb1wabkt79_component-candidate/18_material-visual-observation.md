# Material Visual Observation / obs-comp-cand-000920 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000920`
- External reference / 外部参照: `obimd-sub-vb1wabkt79`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014003_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/x4mvyzj0ob/vb1wabkt79/vb1wabkt79.png`
- Checksum / 校验和:
  `2687aaf7546255c0c755716dedcb65bdff8b53276b9faaf43d8c4847c2f0c644`
...
- Marked-pixel bounds: (76,29)–(173,223); span 98 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.70%。
- 痕迹范围：(76,29)–(173,223)；跨度98 × 195 px；痕迹矩形高于宽。
