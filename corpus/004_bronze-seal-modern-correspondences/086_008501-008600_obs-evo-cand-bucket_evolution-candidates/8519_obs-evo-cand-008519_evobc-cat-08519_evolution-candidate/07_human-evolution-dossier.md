...
- External category reference: `evobc-cat-08519`
- Source category ID: `08519`
- Source label for human review: `貉`
...
- `obs-evo-cand-008519-route-category-staging`
...
- `obs-evo-cand-008519-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008519-route-evolution-graph`
