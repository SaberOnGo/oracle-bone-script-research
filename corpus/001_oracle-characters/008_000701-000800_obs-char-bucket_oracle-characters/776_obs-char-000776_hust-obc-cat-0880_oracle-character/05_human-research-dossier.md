# obs-char-000776 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000776`
- primary external id: `hust-obc-cat-0880`
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/776_obs-char-000776_hust-obc-cat-0880_orac
  le-character/03_visual-assets/001_asset-000781_hust-obc-cat-0880_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0880/L_0880_10544.jpg`
- asset id: `asset-000781`
...
- source category: `0880`
- validation class: `775`
- source image route: `HUST-OBC/deciphered/0880/L_0880_10544.jpg`
- asset id: `asset-000781`
...
- English observation: `The tiny faint image shows a compact upper group of
  narrow angular outlines and short strokes, separated from a small
  horizontal rectangular loop below; fine joins are unclear.`
- 中文观察: `微小淡弱图像显示上部紧凑的狭长折角轮廓和短笔，与下方小型横向矩形环分离；细接点难辨。`
...
- dataset label text: `㝦`
- dataset label codepoints: `U+3766`
...
- Which source records identify obs-char-000776 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000776？
