...
- External category reference: `evobc-cat-11560`
- Source category ID: `11560`
- Source label for human review: `𤉨`
- Source codepoints: `U+24268`
...
- `obs-evo-cand-011560-route-category-staging`
...
- `obs-evo-cand-011560-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011560-route-evolution-graph`
