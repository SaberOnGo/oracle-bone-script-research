# obs-unk-004038 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004038`
- primary external id: `hust-obc-und-L-004038`
- source id: `src-hust-obc`
- packet: `01_undeciphered-candidate-packet.json`
- record type: `oracle_character_undeciphered_candidate_packet`
- review status: `reviewed_metadata_only`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/038_obs-unk-004038_h
  ust-obc-und-L-004038_oracle-character-candidate/03_visual-assets/001_asset
  -005631_hust-obc-und-L-004038_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4038/L_？_863.jpg`
- asset id: `asset-005631`
...
- source class: `HUST-OBC/undeciphered/L/4038/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4038/L_？_863.jpg`
- asset id: `asset-005631`
...
- English observation: A thin branching trace rises on the left, with several
  short marks near the upper right. A longer central trace descends toward the
  lower edge. The image appears similar to a nearby candidate, but no checksum
  or deduplication decision has been made.
- 中文观察：左侧有细长分叉痕迹，右上附近有数枚短痕；较长中央痕迹向下延伸至下缘。
    图像与邻近候选外观相似，但尚未完成 checksum 或去重判断。
...
- registered crosswalk rows: `0`
- matched source ids / 匹配来源 ID: `none`
...
- Which source records identify obs-unk-004038 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004038？
