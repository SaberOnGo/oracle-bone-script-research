# Material Visual Observation / obs-comp-cand-002709 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002709`
- External reference / 外部参照: `obimd-sub-b8fbfuqs4s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021285_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b8fbfuqs4s/b8fbfuqs4s/b8fbfuqs4s.png`
- Checksum / 校验和:
  `00839f85d502421ccbcfffd7498bdd3bd6604b6baee39c40bae092c15be4b397`
...
- Marked-pixel bounds: (97,20)–(149,226); span 53 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.60%。
- 痕迹范围：(97,20)–(149,226)；跨度53 × 207 px；痕迹矩形高于宽。
