# Material Visual Observation / obs-comp-cand-001631 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001631`
- External reference / 外部参照: `obimd-sub-bg0evhjvox`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017307_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bg0evhjvox/bg0evhjvox/bg0evhjvox.png`
- Checksum / 校验和:
  `7baa3c3c9dbc6b64763b7dee425f5e09a5a88b6cdb94af2499a8f39c12143faa`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.24%.
- Marked-pixel bounds: (82,22)–(181,226); span 100 × 205 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.24%。
- 痕迹范围：(82,22)–(181,226)；跨度100 × 205 px；痕迹矩形高于宽。
