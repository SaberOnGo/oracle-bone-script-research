...
Project ID: `obs-evo-cand-012487`
...
- Project ID: `obs-evo-cand-012487`
- EVOBC category candidate ID: `evobc-evo-cat-12487`
- External category reference: `evobc-cat-12487`
- Source category ID: `12487`
- Source label for human review: `𨩦`
- Source codepoints: `U+28A66`
...
- `obs-evo-cand-012487-route-category-staging`
...
- `obs-evo-cand-012487-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012487-route-evolution-graph`
