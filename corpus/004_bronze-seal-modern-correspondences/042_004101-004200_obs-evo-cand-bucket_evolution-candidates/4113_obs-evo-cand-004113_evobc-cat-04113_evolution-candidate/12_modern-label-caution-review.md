# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004113
...
- EVOBC candidate category: `evobc-evo-cat-04113`.
- Source label for search only: `棼`.
- Source codepoints for search only: `U+68FC`.
