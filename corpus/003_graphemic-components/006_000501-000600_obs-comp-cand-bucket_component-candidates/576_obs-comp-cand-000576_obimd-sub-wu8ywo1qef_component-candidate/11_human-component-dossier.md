# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000576
...
- glyph_codepoint_count: `96`
- glyph_codepoint_uplus_sample: `U+B1551;U+F36B3, U+F36B4, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-013104` | `001_asset-013104_img.png` | `112c3c20d1e0d5ecac69326562be6987e97c3f1cbbe86ec8a942461d2823442e` |
