# Material Visual Observation / obs-comp-cand-002441 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002441`
- External reference / 外部参照: `obimd-sub-x78fx9gvsv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020613_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/goxg9wwonn/x78fx9gvsv/x78fx9gvsv.png`
- Checksum / 校验和:
  `00285969cf7092902fbdaddb7bf08e1c7a3b1d9dddb1c76a57390b4975a92d70`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.54%.
- Marked-pixel bounds: (57,53)–(192,190); span 136 × 138 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.54%。
- 痕迹范围：(57,53)–(192,190)；跨度136 × 138 px；痕迹矩形近方形。
