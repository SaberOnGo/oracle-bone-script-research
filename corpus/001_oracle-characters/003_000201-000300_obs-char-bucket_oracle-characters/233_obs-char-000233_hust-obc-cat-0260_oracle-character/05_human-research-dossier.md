# obs-char-000233 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000233`
- primary external id: `hust-obc-cat-0260`
...
- local review image route: `corpus/001_oracle-characters/003_000201-000300_ob
  s-char-bucket_oracle-characters/233_obs-char-000233_hust-obc-cat-0260_orac
  le-character/03_visual-assets/001_asset-000238_hust-obc-cat-0260_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0260/G_0260_乙2503合6650賓組.png`
- asset id: `asset-000238`
...
- source category: `0260`
- validation class: `232`
- source image route: `HUST-OBC/deciphered/0260/G_0260_乙2503合6650賓組.png`
- asset id: `asset-000238`
...
- English observation: `The thin upright image has a long central stroke, a
  pointed upper branch, and two separated diagonal marks toward the lower
  left.`
- 中文观察: `纤细直立图像有长中央笔，上方有尖状分支，下方偏左有两道分离斜痕。`
...
- dataset label text: `㓺`
- dataset label codepoints: `U+34FA`
...
- filename catalog route clues: `Heji-like filename clue: 合6650
  (G_0260_乙2503合6650賓組.png)`
...
- Which source records identify obs-char-000233 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000233？
