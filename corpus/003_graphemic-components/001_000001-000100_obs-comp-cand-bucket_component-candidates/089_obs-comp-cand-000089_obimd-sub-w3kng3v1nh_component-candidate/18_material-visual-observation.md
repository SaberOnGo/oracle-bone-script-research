# Material Visual Observation / obs-comp-cand-000089 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000089`
- External reference / 外部参照: `obimd-sub-w3kng3v1nh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011501_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/w3kng3v1nh/w3kng3v1nh/w3kng3v1nh.png`
- Checksum / 校验和:
  `711f1839baffc62e0ecea1ac3cfd3d8f2af10af22600a51c1306b9e7b9773b0a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.82%.
- Marked-pixel bounds: (69,22)–(189,222); span 121 × 201 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.82%。
- 痕迹范围：(69,22)–(189,222)；跨度121 × 201 px；痕迹矩形高于宽。
