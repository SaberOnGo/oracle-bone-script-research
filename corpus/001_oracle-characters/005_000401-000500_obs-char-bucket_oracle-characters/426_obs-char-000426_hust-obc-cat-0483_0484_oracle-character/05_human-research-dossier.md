# obs-char-000426 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/426_obs-char-000426_hust-obc-cat-0483_0484
  _oracle-character/03_visual-assets/001_asset-000431_hust-obc-cat-0483_0484
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0483_0484/0483/H_0483_602A9_0.p
  ng`
- asset id: `asset-000431`
...
- source category: `0483_0484`
- validation class: `425`
- source image route: `HUST-OBC/deciphered/0483_0484/0483/H_0483_602A9_0.png`
- asset id: `asset-000431`
...
- English observation: `Two bold forms are separated: the left is a
  four-armed crossed figure with outlined ends, and the right has crossed
  upper strokes and an angular lower loop.`
- 中文观察: `两个粗重形体彼此分离：左侧为四向交叉且末端带轮廓，右侧上部交叉、下部呈折角环曲。`
...
- dataset label text: `㗙㗚`
- dataset label codepoints: `U+35D9;U+35DA`
...
- filename catalog route clues: `catalog-like filename clue: H_0483
  (H_0483_602A9_0.png)`
...
- Which source records identify obs-char-000426 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000426？
