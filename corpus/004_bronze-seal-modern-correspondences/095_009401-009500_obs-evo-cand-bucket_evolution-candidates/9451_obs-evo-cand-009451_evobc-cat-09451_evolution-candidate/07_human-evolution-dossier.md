...
- External category reference: `evobc-cat-09451`
- Source category ID: `09451`
- Source label for human review: `鍊`
...
- `obs-evo-cand-009451-route-category-staging`
...
- `obs-evo-cand-009451-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009451-route-evolution-graph`
