# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-001695
...
- glyph_codepoint_uplus_sample: `U+F9D1D, U+F9D1E, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-017611` | `001_asset-017611_img.png` | `dcdd2e32036e2df200c9b21a221dd74af79f9e7a5325411d1ded7ac3c1f9a0af` |
