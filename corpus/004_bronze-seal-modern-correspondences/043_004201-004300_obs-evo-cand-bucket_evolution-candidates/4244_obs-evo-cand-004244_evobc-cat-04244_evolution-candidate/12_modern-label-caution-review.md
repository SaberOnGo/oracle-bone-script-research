# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004244
...
- EVOBC candidate category: `evobc-evo-cat-04244`.
- Source label for search only: `樞`.
- Source codepoints for search only: `U+6A1E`.
