# Material Visual Observation / obs-comp-cand-000615 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000615`
- External reference / 外部参照: `obimd-sub-zapprwvtx9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013178_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zapprwvtx9/zapprwvtx9/zapprwvtx9.png`
- Checksum / 校验和:
  `b493d250c87149109185f200919863160e0a68ec5d2e1c79904fd8c2cb89fa48`
...
- Marked-pixel bounds: (82,20)–(177,226); span 96 × 207 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.37%。
- 痕迹范围：(82,20)–(177,226)；跨度96 × 207 px；痕迹矩形高于宽。
