...
- `obs-evo-cand-001183-route-category-staging`
...
- `obs-evo-cand-001183-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001183-route-evolution-graph`
