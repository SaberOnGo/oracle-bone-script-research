...
- Project ID: `obs-evo-cand-004055`
- EVOBC category candidate ID: `evobc-evo-cat-04055`
- External category reference: `evobc-cat-04055`
- Source category ID: `04055`
- Source label for human review: `梏`
- Source codepoints: `U+688F`
...
- `obs-evo-cand-004055-route-category-staging`
...
- `obs-evo-cand-004055-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004055-route-evolution-graph`
