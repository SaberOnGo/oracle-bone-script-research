# obs-unk-004949 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/049_obs-unk-004949_h
  ust-obc-und-X-004949_oracle-character-candidate/03_visual-assets/001_asset
  -006542_hust-obc-und-X-004949_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/505/X_？_7487_1.png`
- asset id: `asset-006542`
...
- A curved left group meets a pointed right outline with lower strokes.
- The single source view is present locally.
- 直接记录：`14_material-visual-observation.md`
- 左侧弧形结构连接尖顶右侧外轮廓和下部笔画。
- 单一来源视图已在本地保存。
...
- source class: `HUST-OBC/undeciphered/X/505/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/505/X_？_7487_1.png`
- asset id: `asset-006542`
...
- Which source records identify obs-unk-004949 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004949？
