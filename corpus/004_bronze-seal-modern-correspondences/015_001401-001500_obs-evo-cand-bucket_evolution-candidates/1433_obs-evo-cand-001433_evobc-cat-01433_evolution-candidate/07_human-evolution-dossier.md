...
Project ID: `obs-evo-cand-001433`
...
- Project ID: `obs-evo-cand-001433`
- EVOBC category candidate ID: `evobc-evo-cat-01433`
- External category reference: `evobc-cat-01433`
- Source category ID: `01433`
- Source label for human review: `厦`
- Source codepoints: `U+53A6`
...
- `obs-evo-cand-001433-route-category-staging`
...
- `obs-evo-cand-001433-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001433-route-evolution-graph`
