# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001156
...
| --- | --- | --- | --- |
| `obimd-glyph-link-017353` | 󶪎 | `U+F6A8E` | `reviewed_metadata_only` |
| `obimd-glyph-link-017354` | 󶪏 | `U+F6A8F` | `reviewed_metadata_only` |
| `obimd-glyph-link-017355` | 󶪐 | `U+F6A90` | `reviewed_metadata_only` |
| `obimd-glyph-link-017356` | 󶪑 | `U+F6A91` | `reviewed_metadata_only` |
| `obimd-glyph-link-017357` | 󶪒 | `U+F6A92` | `reviewed_metadata_only` |
