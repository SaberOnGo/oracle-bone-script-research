...
Project ID: `obs-evo-cand-007921`
...
- Project ID: `obs-evo-cand-007921`
- EVOBC category candidate ID: `evobc-evo-cat-07921`
- External category reference: `evobc-cat-07921`
- Source category ID: `07921`
- Source label for human review: `衧`
- Source codepoints: `U+8867`
...
- `obs-evo-cand-007921-route-category-staging`
...
- `obs-evo-cand-007921-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007921-route-evolution-graph`
