...
- `obs-evo-cand-003380-route-category-staging`
...
- `obs-evo-cand-003380-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-003380-route-evolution-graph`
