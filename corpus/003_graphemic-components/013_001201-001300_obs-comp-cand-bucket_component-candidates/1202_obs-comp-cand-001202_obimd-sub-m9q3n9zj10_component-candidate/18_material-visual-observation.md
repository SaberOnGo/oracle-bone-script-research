# Material Visual Observation / obs-comp-cand-001202 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001202`
- External reference / 外部参照: `obimd-sub-m9q3n9zj10`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015433_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/m9q3n9zj10/m9q3n9zj10/m9q3n9zj10.png`
- Checksum / 校验和:
  `5e0ada5a7821dbecd151a0a739d6b0b79cd8f21f517c0cda0ff8a56745890acb`
...
- Marked-pixel bounds: (96,27)–(166,217); span 71 × 191 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.85%。
- 痕迹范围：(96,27)–(166,217)；跨度71 × 191 px；痕迹矩形高于宽。
