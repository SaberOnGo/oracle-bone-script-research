...
- External category reference: `evobc-cat-09506`
- Source category ID: `09506`
- Source label for human review: `鏠`
...
- `obs-evo-cand-009506-route-category-staging`
...
- `obs-evo-cand-009506-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009506-route-evolution-graph`
