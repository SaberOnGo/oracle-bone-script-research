# obs-char-001158 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001158`
- primary external id: `hust-obc-cat-1297`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1158_obs-char-001158_hust-obc-cat-1297_ora
  cle-character/03_visual-assets/001_asset-001163_hust-obc-cat-1297_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1297/X_1297_4676_1.png`
- asset id: `asset-001163`
...
- source category: `1297`
- validation class: `1157`
- source image route: `HUST-OBC/deciphered/1297/X_1297_4676_1.png`
- asset id: `asset-001163`
...
- English observation: `A tall dense form has a long central upright, a
  sweeping left stroke, a curved right enclosure, and several lower
  descending lines.`
- 中文观察: `高而密集的形体有中央长直立笔、向左挥出的笔、右侧弯曲框廓和数条下行线。`
...
- dataset label text: `㤇`
- dataset label codepoints: `U+3907`
...
- Which source records identify obs-char-001158 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001158？
