# obs-unk-004927 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004927`
- primary external id: `hust-obc-und-X-004927`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/027_obs-unk-004927_h
  ust-obc-und-X-004927_oracle-character-candidate/03_visual-assets/001_asset
  -006520_hust-obc-und-X-004927_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/483/X_？_7467_1.png`
- asset id: `asset-006520`
...
- A curved opening and a long right descent are visible.
- The source packet expects three views; one local view is present.
- 直接记录：`14_material-visual-observation.md`
- 可见弧形开口和右侧长下行笔画。
- 来源包记录应有三个视图；当前仅有一个本地图像。
...
- source class: `HUST-OBC/undeciphered/X/483/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/483/X_？_7467_1.png`
- asset id: `asset-006520`
...
- Which source records identify obs-unk-004927 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004927？
