...
- External category reference: `evobc-cat-00305`
- Source category ID: `00305`
- Source label for human review: `䈪`
- Source codepoints: `U+422A`
...
- `obs-evo-cand-000305-route-category-staging`
...
- `obs-evo-cand-000305-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000305-route-evolution-graph`
