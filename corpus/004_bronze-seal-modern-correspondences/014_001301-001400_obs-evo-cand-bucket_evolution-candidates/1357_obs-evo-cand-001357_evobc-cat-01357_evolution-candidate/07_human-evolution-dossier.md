...
- External category reference: `evobc-cat-01357`
- Source category ID: `01357`
- Source label for human review: `区`
- Source codepoints: `U+533A`
...
- `obs-evo-cand-001357-route-category-staging`
...
- `obs-evo-cand-001357-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001357-route-evolution-graph`
