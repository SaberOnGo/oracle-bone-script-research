# Material Visual Observation / obs-comp-cand-001212 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001212`
- External reference / 外部参照: `obimd-sub-ib8smd6c1j`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015443_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lsh0azwee5/ib8smd6c1j/ib8smd6c1j.png`
- Checksum / 校验和:
  `3e5be8752a092c67f875791c13a23d8fb956924dc3230a1d95aa95e9658f4411`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.49%.
- Marked-pixel bounds: (61,49)–(188,200); span 128 × 152 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.49%。
- 痕迹范围：(61,49)–(188,200)；跨度128 × 152 px；痕迹矩形近方形。
