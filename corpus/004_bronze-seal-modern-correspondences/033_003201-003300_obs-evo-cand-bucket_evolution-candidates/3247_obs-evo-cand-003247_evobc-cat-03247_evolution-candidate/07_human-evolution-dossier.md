...
Project ID: `obs-evo-cand-003247`
...
- Project ID: `obs-evo-cand-003247`
- EVOBC category candidate ID: `evobc-evo-cat-03247`
- External category reference: `evobc-cat-03247`
- Source category ID: `03247`
- Source label for human review: `扑`
- Source codepoints: `U+6251`
...
- `obs-evo-cand-003247-route-category-staging`
...
- `obs-evo-cand-003247-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003247-route-evolution-graph`
