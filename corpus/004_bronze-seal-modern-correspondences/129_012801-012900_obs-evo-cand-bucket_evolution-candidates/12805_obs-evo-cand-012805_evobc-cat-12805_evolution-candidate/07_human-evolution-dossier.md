...
- External category reference: `evobc-cat-12805`
- Source category ID: `12805`
- Source label for human review: `𪠑`
...
- `obs-evo-cand-012805-route-category-staging`
...
- `obs-evo-cand-012805-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012805-route-evolution-graph`
