# obs-unk-004350 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004350`
- primary external id: `hust-obc-und-L-004350`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/050_obs-unk-004350_h
  ust-obc-und-L-004350_oracle-character-candidate/03_visual-assets/001_asset
  -005943_hust-obc-und-L-004350_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4350/L_？_9648.jpg`
- asset id: `asset-005943`
...
- source class: `HUST-OBC/undeciphered/L/4350/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4350/L_？_9648.jpg`
- asset id: `asset-005943`
...
- English observation: `Central vertical trace, upper bar, and lower direction`
  `change recorded.`
- 中文观察: `已记录中央纵痕、上部横痕和下部方向变化。`
...
- Which source records identify obs-unk-004350 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004350？
