...
- External category reference: `evobc-cat-07912`
- Source category ID: `07912`
- Source label for human review: `衝`
- Source codepoints: `U+885D`
...
- `obs-evo-cand-007912-route-category-staging`
...
- `obs-evo-cand-007912-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007912-route-evolution-graph`
