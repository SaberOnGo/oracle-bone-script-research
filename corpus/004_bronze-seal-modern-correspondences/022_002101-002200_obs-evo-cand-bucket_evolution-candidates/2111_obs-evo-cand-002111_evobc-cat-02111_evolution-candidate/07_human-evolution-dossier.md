...
- External category reference: `evobc-cat-02111`
- Source category ID: `02111`
- Source label: `姂`
...
- `obs-evo-cand-002111-route-category-staging`
...
- `obs-evo-cand-002111-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002111-route-evolution-graph`
