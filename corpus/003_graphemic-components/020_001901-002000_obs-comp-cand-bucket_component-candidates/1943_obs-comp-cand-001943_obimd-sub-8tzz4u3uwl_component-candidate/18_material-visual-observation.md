# Material Visual Observation / obs-comp-cand-001943 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001943`
- External reference / 外部参照: `obimd-sub-8tzz4u3uwl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018753_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/41cgu5ewmd/8tzz4u3uwl/8tzz4u3uwl.png`
- Checksum / 校验和:
  `c24f3f3b3d2631cf724e4ea1946966b4b457dc27b9e10bc3660e58ca030d24b6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.20%.
- Marked-pixel bounds: (64,19)–(188,230); span 125 × 212 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.20%。
- 痕迹范围：(64,19)–(188,230)；跨度125 × 212 px；痕迹矩形高于宽。
