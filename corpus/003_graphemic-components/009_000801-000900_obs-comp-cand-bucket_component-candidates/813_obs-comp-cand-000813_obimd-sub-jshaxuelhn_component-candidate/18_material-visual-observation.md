# Material Visual Observation / obs-comp-cand-000813 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000813`
- External reference / 外部参照: `obimd-sub-jshaxuelhn`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013684_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jshaxuelhn/jshaxuelhn/jshaxuelhn.png`
- Checksum / 校验和:
  `350b047d6f4e8b45cad94104078ede7f6123ec6c5376109b31dacec279ea80fe`
...
- Marked-pixel bounds: (69,22)–(193,227); span 125 × 206 px; the marked
...
- 痕迹范围：(69,22)–(193,227)；跨度125 × 206 px；痕迹矩形高于宽。
