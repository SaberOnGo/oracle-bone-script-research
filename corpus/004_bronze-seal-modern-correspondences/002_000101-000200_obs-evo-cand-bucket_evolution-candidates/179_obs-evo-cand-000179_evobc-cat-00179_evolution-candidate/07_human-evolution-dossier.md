...
- External category reference: `evobc-cat-00179`
- Source category ID: `00179`
- Source label: `㯢`
...
- `obs-evo-cand-000179-route-category-staging`
...
- `obs-evo-cand-000179-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000179-route-evolution-graph`
