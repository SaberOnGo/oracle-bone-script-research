...
- External category reference: `evobc-cat-00294`
- Source category ID: `00294`
- Source label for human review: `䇂`
- Source codepoints: `U+41C2`
- Image reference count in source metadata: `131`
...
- `obs-evo-cand-000294-route-category-staging`
...
- `obs-evo-cand-000294-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000294-route-evolution-graph`
