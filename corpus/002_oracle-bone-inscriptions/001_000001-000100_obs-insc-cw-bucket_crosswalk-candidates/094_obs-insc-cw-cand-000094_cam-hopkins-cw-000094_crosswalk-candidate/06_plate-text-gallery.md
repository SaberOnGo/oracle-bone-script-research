...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000094` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y560` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `101` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `600` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `39869` [route_present_image_or_text_not_collected]
