...
- `obs-evo-cand-001474-route-category-staging`
...
- `obs-evo-cand-001474-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001474-route-evolution-graph`
