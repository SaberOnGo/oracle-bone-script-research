# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005794
...
- EVOBC candidate category: `evobc-evo-cat-05794`.
- Source label for search only: `眕`.
- Source codepoints for search only: `U+7715`.
