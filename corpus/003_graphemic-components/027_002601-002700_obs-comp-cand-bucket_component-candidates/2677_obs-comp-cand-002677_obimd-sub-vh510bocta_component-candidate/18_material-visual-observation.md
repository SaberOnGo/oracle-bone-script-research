# Material Visual Observation / obs-comp-cand-002677 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002677`
- External reference / 外部参照: `obimd-sub-vh510bocta`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021253_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vh510bocta/vh510bocta/vh510bocta.png`
- Checksum / 校验和:
