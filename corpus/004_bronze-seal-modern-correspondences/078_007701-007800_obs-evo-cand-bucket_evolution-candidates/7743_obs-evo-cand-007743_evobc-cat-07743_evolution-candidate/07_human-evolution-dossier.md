...
- External category reference: `evobc-cat-07743`
- Source category ID: `07743`
- Source label for human review: `蛇`
...
- `obs-evo-cand-007743-route-category-staging`
...
- `obs-evo-cand-007743-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007743-route-evolution-graph`
