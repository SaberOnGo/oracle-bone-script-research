# obs-char-000970 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000970`
- primary external id: `hust-obc-cat-1090`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/970_obs-char-000970_hust-obc-cat-1090_orac
  le-character/03_visual-assets/001_asset-000975_hust-obc-cat-1090_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1090/G_1090_京津2652合18842賓組.png`
- asset id: `asset-000975`
...
- source category: `1090`
- validation class: `969`
- source image route: `HUST-OBC/deciphered/1090/G_1090_京津2652合18842賓組.png`
- asset id: `asset-000975`
...
- English observation: `A small upper grid-like enclosure sits above a
  horizontal stroke and a long descending diagonal.`
- 中文观察: `小型上部格状闭合轮廓位于横笔和长下行斜笔之上。`
...
- dataset label text: `㠸`
- dataset label codepoints: `U+3838`
...
- filename catalog route clues: `Heji-like filename clue: 合18842
  (G_1090_京津2652合18842賓組.png)`
...
- Which source records identify obs-char-000970 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000970？
