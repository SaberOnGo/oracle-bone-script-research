...
- External category reference: `evobc-cat-05369`
- Source category ID: `05369`
- Source label for human review: `珈`
- Source codepoints: `U+73C8`
...
- `obs-evo-cand-005369-route-category-staging`
...
- `obs-evo-cand-005369-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005369-route-evolution-graph`
