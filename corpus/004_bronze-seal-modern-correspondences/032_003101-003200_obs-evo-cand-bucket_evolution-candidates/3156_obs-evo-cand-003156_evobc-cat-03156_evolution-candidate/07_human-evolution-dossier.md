...
Project ID: `obs-evo-cand-003156`
...
- Project ID: `obs-evo-cand-003156`
- EVOBC category candidate ID: `evobc-evo-cat-03156`
- External category reference: `evobc-cat-03156`
- Source category ID: `03156`
- Source label for human review: `憤`
- Source codepoints: `U+61A4`
...
- `obs-evo-cand-003156-route-category-staging`
...
- `obs-evo-cand-003156-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003156-route-evolution-graph`
