# obs-comp-cand-001752 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001752`
- 首选外部 ID: `obimd-sub-ea22soll93`
- OBIMD subcharacter UID: `ea22soll93`
- OBIMD main character UID: `ea22soll93`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `2`
- codepoint 示例: U+A4330;U+FA21A; U+FA21B
