# Material Visual Observation / obs-comp-cand-000265 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000265`
- External reference / 外部参照: `obimd-sub-c3cuhcc3mt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011910_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hoshv8o78k/c3cuhcc3mt/c3cuhcc3mt.png`
- Checksum / 校验和:
  `3443039a225493a41b161dc2712a9ea097e5802a1b2a27879a7d53fc9b3cf12f`
...
- Marked-pixel bounds: (78,25)–(171,223); span 94 × 199 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.12%。
- 痕迹范围：(78,25)–(171,223)；跨度94 × 199 px；痕迹矩形高于宽。
