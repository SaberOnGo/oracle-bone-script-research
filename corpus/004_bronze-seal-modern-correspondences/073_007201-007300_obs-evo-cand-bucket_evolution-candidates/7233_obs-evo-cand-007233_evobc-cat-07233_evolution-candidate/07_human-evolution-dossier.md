...
- Project ID: `obs-evo-cand-007233`
- EVOBC category candidate ID: `evobc-evo-cat-07233`
- External category reference: `evobc-cat-07233`
- Source category ID: `07233`
- Source label for human review: `芋`
- Source codepoints: `U+828B`
...
- `obs-evo-cand-007233-route-category-staging`
...
- `obs-evo-cand-007233-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007233-route-evolution-graph`
