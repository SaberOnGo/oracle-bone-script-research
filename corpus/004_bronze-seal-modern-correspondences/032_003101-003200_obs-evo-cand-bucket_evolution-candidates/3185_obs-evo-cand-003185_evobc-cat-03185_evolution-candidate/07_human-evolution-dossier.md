...
- External category reference: `evobc-cat-03185`
- Source category ID: `03185`
- Source label for human review: `懥`
- Source codepoints: `U+61E5`
...
- `obs-evo-cand-003185-route-category-staging`
...
- `obs-evo-cand-003185-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003185-route-evolution-graph`
