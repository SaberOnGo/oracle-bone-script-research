...
Project ID: `obs-evo-cand-008635`
...
- Project ID: `obs-evo-cand-008635`
- EVOBC category candidate ID: `evobc-evo-cat-08635`
- External category reference: `evobc-cat-08635`
- Source category ID: `08635`
- Source label for human review: `贺`
- Source codepoints: `U+8D3A`
...
- `obs-evo-cand-008635-route-category-staging`
...
- `obs-evo-cand-008635-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008635-route-evolution-graph`
