# obs-unk-004369 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004369`
- primary external id: `hust-obc-und-L-004369`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/069_obs-unk-004369_h
  ust-obc-und-L-004369_oracle-character-candidate/03_visual-assets/001_asset
  -005962_hust-obc-und-L-004369_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4369/L_？_9695.jpg`
- asset id: `asset-005962`
...
- source class: `HUST-OBC/undeciphered/L/4369/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4369/L_？_9695.jpg`
- asset id: `asset-005962`
...
- English observation: `Upper trace, angular cluster, and lower curves`
  `recorded.`
- 中文观察: `已记录上部长痕、斜角痕簇和下部弧痕。`
...
- Which source records identify obs-unk-004369 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004369？
