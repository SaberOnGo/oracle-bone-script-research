# Material Visual Observation / obs-comp-cand-002409 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002409`
- External reference / 外部参照: `obimd-sub-df1fjpfewv`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020480_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/df1fjpfewv/df1fjpfewv/df1fjpfewv.png`
- Checksum / 校验和:
  `bed46a92a63e54274a1333b3006e3b1c513bbe1d41ec44d6e1ea1726e2c91332`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 12.84%.
- Marked-pixel bounds: (58,36)–(208,225); span 151 × 190 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占12.84%。
- 痕迹范围：(58,36)–(208,225)；跨度151 × 190 px；痕迹矩形高于宽。
