# obs-unk-002253 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-002253`
- primary external id: `hust-obc-und-L-002253`
...
- local review image route: `corpus/001_oracle-characters/039_undeciphered-002
  201-002300_obs-unk-bucket_oracle-character-candidates/053_obs-unk-002253_h
  ust-obc-und-L-002253_oracle-character-candidate/03_visual-assets/001_asset
  -003846_hust-obc-und-L-002253_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2253/L_？_2843.jpg`
- asset id: `asset-003846`
...
- source class: `HUST-OBC/undeciphered/L/2253/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2253/L_？_2843.jpg`
- asset id: `asset-003846`
...
- Which source records identify obs-unk-002253 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002253？
