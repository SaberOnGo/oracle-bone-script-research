...
- External category reference: `evobc-cat-05079`
- Source category ID: `05079`
- Source label for human review: `烾`
...
- `obs-evo-cand-005079-route-category-staging`
...
- `obs-evo-cand-005079-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005079-route-evolution-graph`
