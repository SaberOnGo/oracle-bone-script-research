# obs-unk-004171 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/071_obs-unk-004171_h
  ust-obc-und-L-004171_oracle-character-candidate/03_visual-assets/001_asset
  -005764_hust-obc-und-L-004171_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4171/L_？_9037.jpg`
- asset id: `asset-005764`
...
- source class: `HUST-OBC/undeciphered/L/4171/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4171/L_？_9037.jpg`
- asset id: `asset-005764`
...
- English observation: Two tall irregular groups stand side by side with a
  narrow gap.
- 中文观察: 两组高而不规则的纵向形态并列，中间有窄间隙。
...
- Which source records identify obs-unk-004171 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004171？
