# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010542
...
- EVOBC candidate category: `evobc-evo-cat-10542`.
- Source label for search only: `鶿`.
- Source codepoints for search only: `U+9DBF`.
