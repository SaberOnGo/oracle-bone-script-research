# Material Visual Observation / obs-comp-cand-001344 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001344`
- External reference / 外部参照: `obimd-sub-1yxyj1hxvi`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015727_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1yxyj1hxvi/1yxyj1hxvi/1yxyj1hxvi.png`
- Checksum / 校验和:
  `86f931b0f88b129a124e6210edbb763f5aabb1b35577c65ebadce5f7940d4c6a`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 11.03%.
- Marked-pixel bounds: (42,37)–(205,208); span 164 × 172 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.03%。
- 痕迹范围：(42,37)–(205,208)；跨度164 × 172 px；痕迹矩形近方形。
