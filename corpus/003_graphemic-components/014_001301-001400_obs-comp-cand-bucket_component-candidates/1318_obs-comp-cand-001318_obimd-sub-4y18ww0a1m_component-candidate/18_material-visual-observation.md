# Material Visual Observation / obs-comp-cand-001318 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001318`
- External reference / 外部参照: `obimd-sub-4y18ww0a1m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015655_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/4y18ww0a1m/4y18ww0a1m/4y18ww0a1m.png`
- Checksum / 校验和:
  `35974def5e4450f9c7bb61089bb3f28d7134ae0de6626b07e1244795fa9ff4d8`
...
- Marked-pixel bounds: (79,27)–(170,226); span 92 × 200 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.34%。
- 痕迹范围：(79,27)–(170,226)；跨度92 × 200 px；痕迹矩形高于宽。
