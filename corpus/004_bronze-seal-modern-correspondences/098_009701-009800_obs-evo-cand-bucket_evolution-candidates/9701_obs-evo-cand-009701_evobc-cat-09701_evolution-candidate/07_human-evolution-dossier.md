...
- External category reference: `evobc-cat-09701`
- Source category ID: `09701`
- Source label for human review: `阭`
- Source codepoints: `U+962D`
...
- `obs-evo-cand-009701-route-category-staging`
...
- `obs-evo-cand-009701-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009701-route-evolution-graph`
