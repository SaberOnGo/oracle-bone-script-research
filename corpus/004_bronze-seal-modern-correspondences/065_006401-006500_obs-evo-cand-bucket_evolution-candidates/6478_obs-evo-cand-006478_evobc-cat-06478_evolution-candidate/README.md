# obs-evo-cand-006478 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06478`
- Source label for human review: `紳`
- Source codepoints: `U+7D33`
- Image reference count: `109`
- Era token counts: `BI:33;OBC:5;SAC:10;SS:1;WSC:60`
- Source token counts: `Book:51;Web:58`
