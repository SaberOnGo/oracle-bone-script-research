# obs-char-001156 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001156`
- primary external id: `hust-obc-cat-1295`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1156_obs-char-001156_hust-obc-cat-1295_ora
  cle-character/03_visual-assets/001_asset-001161_hust-obc-cat-1295_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1295/G_1295_乙6638(甲).png`
- asset id: `asset-001161`
...
- source category: `1295`
- validation class: `1155`
- source image route: `HUST-OBC/deciphered/1295/G_1295_乙6638(甲).png`
- asset id: `asset-001161`
...
- English observation: `A small upright trapezoidal enclosure has a narrow
  open top and a rounded lower contour.`
...
- dataset label text: `㤅`
- dataset label codepoints: `U+3905`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00113`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00113`
- EvoBC image reference count / EvoBC 图像引用数: `26`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00113`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/113_obs-evo-can
  d-000113_evobc-cat-00113_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/113_obs-evo-cand-000113_evobc-cat-00113_evolu
...
- Which source records identify obs-char-001156 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001156？
