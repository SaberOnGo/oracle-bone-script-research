...
- External category reference: `evobc-cat-11680`
- Source category ID: `11680`
- Source label for human review: `𤵌`
...
- `obs-evo-cand-011680-route-category-staging`
...
- `obs-evo-cand-011680-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011680-route-evolution-graph`
