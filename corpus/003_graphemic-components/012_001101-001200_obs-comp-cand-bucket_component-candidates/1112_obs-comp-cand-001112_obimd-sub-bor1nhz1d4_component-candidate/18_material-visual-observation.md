# Material Visual Observation / obs-comp-cand-001112 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001112`
- External reference / 外部参照: `obimd-sub-bor1nhz1d4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015053_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/bor1nhz1d4/bor1nhz1d4/bor1nhz1d4.png`
- Checksum / 校验和:
  `171706be27281724c2f072f4ff3a590b4a742b7873d7853ec07f066ec55c511a`
...
- Marked-pixel bounds: (85,20)–(172,228); span 88 × 209 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.64%。
- 痕迹范围：(85,20)–(172,228)；跨度88 × 209 px；痕迹矩形高于宽。
