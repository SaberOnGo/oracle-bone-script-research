# Material Visual Observation / obs-comp-cand-001918 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001918`
- External reference / 外部参照: `obimd-sub-duv08l81ng`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018328_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/oxa0ylq9ay/duv08l81ng/duv08l81ng.png`
- Checksum / 校验和:
  `bfde426062e89b76573ddf26862e306301284f3ee906e4f0b34eb6d2ebcb754c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.74%.
- Marked-pixel bounds: (57,29)–(199,215); span 143 × 187 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.74%。
- 痕迹范围：(57,29)–(199,215)；跨度143 × 187 px；痕迹矩形高于宽。
