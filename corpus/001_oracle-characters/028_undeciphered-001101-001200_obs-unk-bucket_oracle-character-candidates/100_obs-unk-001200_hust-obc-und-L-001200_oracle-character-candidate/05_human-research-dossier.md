# obs-unk-001200 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-001200`
- primary external id: `hust-obc-und-L-001200`
...
- local review image route: `corpus/001_oracle-characters/028_undeciphered-001
  101-001200_obs-unk-bucket_oracle-character-candidates/100_obs-unk-001200_h
  ust-obc-und-L-001200_oracle-character-candidate/03_visual-assets/001_asset
  -002793_hust-obc-und-L-001200_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1200/L_？_13419.jpg`
- asset id: `asset-002793`
...
- source class: `HUST-OBC/undeciphered/L/1200/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1200/L_？_13419.jpg`
- asset id: `asset-002793`
...
- Which source records identify obs-unk-001200 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001200？
