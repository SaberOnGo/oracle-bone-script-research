...
- External category reference: `evobc-cat-10506`
- Source category ID: `10506`
- Source label for human review: `鵁`
- Source codepoints: `U+9D41`
...
- `obs-evo-cand-010506-route-category-staging`
...
- `obs-evo-cand-010506-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010506-route-evolution-graph`
