# obs-char-001513 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/016_001501-001600_ob
  s-char-bucket_oracle-characters/1513_obs-char-001513_hust-obc-cat-1698_ora
  cle-character/03_visual-assets/001_asset-001518_hust-obc-cat-1698_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1698/X_1698_1665_1.png`
- asset id: `asset-001518`
...
- source category: `1698`
- validation class: `1512`
- source image route: `HUST-OBC/deciphered/1698/X_1698_1665_1.png`
- asset id: `asset-001518`
...
- English observation: `A large triangular enclosure contains a central
  upright and an inner rounded opening.`
- 中文观察: `大型三角框形包含中央竖笔和内部圆折开口。`
...
- dataset label text: `㪘`
- dataset label codepoints: `U+3A98`
...
- Which source records identify obs-char-001513 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001513？
