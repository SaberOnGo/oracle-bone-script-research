# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002572
...
| --- | --- | --- | --- |
| `obimd-glyph-link-039396` | 󾥸 | `U+FE978` | `reviewed_metadata_only` |
| `obimd-glyph-link-039397` | 󾥹 | `U+FE979` | `reviewed_metadata_only` |
