...
- Project ID: `obs-evo-cand-006368`
- EVOBC category candidate ID: `evobc-evo-cat-06368`
- External category reference: `evobc-cat-06368`
- Source category ID: `06368`
- Source label for human review: `籌`
- Source codepoints: `U+7C4C`
...
- `obs-evo-cand-006368-route-category-staging`
...
- `obs-evo-cand-006368-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006368-route-evolution-graph`
