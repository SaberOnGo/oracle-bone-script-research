...
- External category reference: `evobc-cat-03237`
- Source category ID: `03237`
- Source label for human review: `扁`
- Source codepoints: `U+6241`
...
- `obs-evo-cand-003237-route-category-staging`
...
- `obs-evo-cand-003237-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003237-route-evolution-graph`
