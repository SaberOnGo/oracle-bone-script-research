# obs-char-000661 Visual Gallery / obs-char-000661 图像资料页
...
- Project ID / 项目 ID: `obs-char-000661`
- Primary external reference / 首选外部参考: `hust-obc-cat-0749`
...
## obs-char-000661-visual-source-001 / 图像条目

![obs-char-000661 glyph candidate](03_visual-assets/001_asset-000666_hust-obc-cat-0749_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000666_hust-obc-cat-0749_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000666_hust-obc-cat-0749_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0749/G_0749_京津4454合29403無名組.png`
