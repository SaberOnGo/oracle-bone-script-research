# Material Visual Observation / obs-comp-cand-001545 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001545`
- External reference / 外部参照: `obimd-sub-9vm0d7txqd`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016959_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9vm0d7txqd/9vm0d7txqd/9vm0d7txqd.png`
- Checksum / 校验和:
  `d74303919557346c9850af408fd2f352b580fb6665e44ef776940fac508922dc`
...
- Marked-pixel bounds: (86,34)–(163,208); span 78 × 175 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.26%。
- 痕迹范围：(86,34)–(163,208)；跨度78 × 175 px；痕迹矩形高于宽。
