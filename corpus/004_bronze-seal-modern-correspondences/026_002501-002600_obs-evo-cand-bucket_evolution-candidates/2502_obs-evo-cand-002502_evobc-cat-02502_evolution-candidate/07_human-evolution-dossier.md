...
- External category reference: `evobc-cat-02502`
- Source category ID: `02502`
- Source label for human review: `屍`
- Source codepoints: `U+5C4D`
...
- `obs-evo-cand-002502-route-category-staging`
...
- `obs-evo-cand-002502-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002502-route-evolution-graph`
