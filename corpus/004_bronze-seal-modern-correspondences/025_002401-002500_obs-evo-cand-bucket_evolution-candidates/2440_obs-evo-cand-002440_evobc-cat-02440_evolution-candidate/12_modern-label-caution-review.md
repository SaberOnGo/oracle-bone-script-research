# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002440
...
- EVOBC candidate category: `evobc-evo-cat-02440`.
- Source label for search only: `寬`.
- Source codepoints for search only: `U+5BEC`.
