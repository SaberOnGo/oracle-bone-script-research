...
- External category reference: `evobc-cat-10273`
- Source category ID: `10273`
- Source label for human review: `驳`
- Source codepoints: `U+9A73`
...
- `obs-evo-cand-010273-route-category-staging`
...
- `obs-evo-cand-010273-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010273-route-evolution-graph`
