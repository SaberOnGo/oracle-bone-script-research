# obs-char-001265 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/013_001201-001300_ob
  s-char-bucket_oracle-characters/1265_obs-char-001265_hust-obc-cat-1414_ora
  cle-character/03_visual-assets/001_asset-001270_hust-obc-cat-1414_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1414/L_1414_13039.jpg`
- asset id: `asset-001270`
...
- source category: `1414`
- validation class: `1264`
- source image route: `HUST-OBC/deciphered/1414/L_1414_13039.jpg`
- asset id: `asset-001270`
...
- English observation: `A small faint pointed cluster has two detached upper
  marks, a central angular loop, and a tapered lower end.`
- 中文观察: `小型较淡尖状笔画群有两个分离的上部标记、中央折角环形和渐尖下端。`
...
- dataset label text: `㥼`
- dataset label codepoints: `U+397C`
...
- Which source records identify obs-char-001265 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001265？
