# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000302
...
| Glyph or codepoint route / 字形或码位路线 | 97 OBIMD route rows; examples U+6C42;U+F1B3C; U+F1B3D; 另有 95 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
