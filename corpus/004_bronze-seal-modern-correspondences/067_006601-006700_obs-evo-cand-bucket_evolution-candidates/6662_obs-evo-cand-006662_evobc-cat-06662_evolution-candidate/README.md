# obs-evo-cand-006662 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06662`
- Source label: `繃`
- Source codepoints: `U+7E43`
- Image reference count: `46`
- Era token counts: `SS:2;WSC:44`
- Source token counts: `Book:8;Web:38`
