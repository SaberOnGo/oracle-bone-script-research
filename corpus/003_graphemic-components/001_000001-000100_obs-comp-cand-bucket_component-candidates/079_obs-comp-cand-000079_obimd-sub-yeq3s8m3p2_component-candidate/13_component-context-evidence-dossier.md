# obs-comp-cand-000079 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000079`
- 首选外部 ID: `obimd-sub-yeq3s8m3p2`
- OBIMD subcharacter UID: `yeq3s8m3p2`
- OBIMD main character UID: `t4tioxlhov`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `6`
- codepoint 示例: U+F0893; U+F0894; 另有 4 项
