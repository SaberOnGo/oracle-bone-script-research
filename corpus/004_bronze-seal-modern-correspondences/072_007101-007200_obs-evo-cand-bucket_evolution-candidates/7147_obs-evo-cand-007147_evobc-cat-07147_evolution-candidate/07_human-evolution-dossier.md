...
- External category reference: `evobc-cat-07147`
- Source category ID: `07147`
- Source label for human review: `臅`
...
- `obs-evo-cand-007147-route-category-staging`
...
- `obs-evo-cand-007147-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007147-route-evolution-graph`
