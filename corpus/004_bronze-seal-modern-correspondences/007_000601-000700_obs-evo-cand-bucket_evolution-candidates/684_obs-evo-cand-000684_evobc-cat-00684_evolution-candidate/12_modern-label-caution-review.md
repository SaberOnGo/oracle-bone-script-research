# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000684
...
- EVOBC candidate category: `evobc-evo-cat-00684`.
- Source label for search only: `亍`.
- Source codepoints for search only: `U+4E8D`.
