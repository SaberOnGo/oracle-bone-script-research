# obs-char-000349 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000349`
- primary external id: `hust-obc-cat-0394_0395`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/349_obs-char-000349_hust-obc-cat-0394_0395
  _oracle-character/03_visual-assets/001_asset-000354_hust-obc-cat-0394_0395
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0394_0395/0394/G_0394_乙2525(甲).
  png`
- asset id: `asset-000354`
...
- source category: `0394_0395`
- validation class: `348`
- source image route: `HUST-OBC/deciphered/0394_0395/0394/G_0394_乙2525(甲).png`
- asset id: `asset-000354`
...
- English observation: `A slim curved upper stroke descends into two
  adjoining angular lower forms with a small pointed top.`
- 中文观察: `纤细弧形上部笔画向下连接两个相邻折角形体，顶部有小型尖状部分。`
...
- dataset label text: `㖀㖁`
- dataset label codepoints: `U+3580;U+3581`
...
- graph edge count: `2`
- codepoint routes: `U+3580;U+3581`
...
- Which source records identify obs-char-000349 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000349？
