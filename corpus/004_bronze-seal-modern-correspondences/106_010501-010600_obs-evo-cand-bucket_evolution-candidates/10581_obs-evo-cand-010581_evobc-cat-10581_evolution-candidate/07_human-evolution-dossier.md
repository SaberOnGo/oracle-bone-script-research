...
- External category reference: `evobc-cat-10581`
- Source category ID: `10581`
- Source label for human review: `鸞`
- Source codepoints: `U+9E1E`
...
- `obs-evo-cand-010581-route-category-staging`
...
- `obs-evo-cand-010581-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010581-route-evolution-graph`
