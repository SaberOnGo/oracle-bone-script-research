...
Project ID: `obs-evo-cand-007770`
...
- Project ID: `obs-evo-cand-007770`
- EVOBC category candidate ID: `evobc-evo-cat-07770`
- External category reference: `evobc-cat-07770`
- Source category ID: `07770`
- Source label for human review: `蜃`
- Source codepoints: `U+8703`
...
- `obs-evo-cand-007770-route-category-staging`
...
- `obs-evo-cand-007770-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007770-route-evolution-graph`
