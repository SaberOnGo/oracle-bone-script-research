...
- External category reference: `evobc-cat-12651`
- Source category ID: `12651`
- Source label for human review: `𩢘`
...
- `obs-evo-cand-012651-route-category-staging`
...
- `obs-evo-cand-012651-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012651-route-evolution-graph`
