...
- External category reference: `evobc-cat-03219`
- Source category ID: `03219`
- Source label for human review: `戢`
...
- `obs-evo-cand-003219-route-category-staging`
...
- `obs-evo-cand-003219-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003219-route-evolution-graph`
