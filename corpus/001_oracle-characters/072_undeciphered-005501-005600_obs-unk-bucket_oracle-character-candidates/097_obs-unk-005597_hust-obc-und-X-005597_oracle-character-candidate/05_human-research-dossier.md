# obs-unk-005597 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/097_obs-unk-005597_h
  ust-obc-und-X-005597_oracle-character-candidate/03_visual-assets/001_asset
  -007190_hust-obc-und-X-005597_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1153/X_？_8106_1.png`
- asset id: `asset-007190`
...
- source class: `HUST-OBC/undeciphered/X/1153/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1153/X_？_8106_1.png`
- asset id: `asset-007190`
...
- Which source records identify obs-unk-005597 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005597？
