...
- `obs-evo-cand-004386-route-category-staging`
...
- `obs-evo-cand-004386-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-004386-route-evolution-graph`
