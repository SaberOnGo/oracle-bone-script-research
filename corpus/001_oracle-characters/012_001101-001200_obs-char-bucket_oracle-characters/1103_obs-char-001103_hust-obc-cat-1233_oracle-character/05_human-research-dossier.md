# obs-char-001103 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001103`
- primary external id: `hust-obc-cat-1233`
...
- local review image route: `corpus/001_oracle-characters/012_001101-001200_ob
  s-char-bucket_oracle-characters/1103_obs-char-001103_hust-obc-cat-1233_ora
  cle-character/03_visual-assets/001_asset-001108_hust-obc-cat-1233_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1233/G_1233_後2.8.7合3337賓組.png`
- asset id: `asset-001108`
...
- source category: `1233`
- validation class: `1102`
- source image route: `HUST-OBC/deciphered/1233/G_1233_後2.8.7合3337賓組.png`
- asset id: `asset-001108`
...
- English observation: `Two adjacent narrow upright clusters each have a
  wavy central stem, pointed upper branches, and splayed lower strokes.`
- 中文观察: `两个相邻的狭长直立笔群各有波折中央笔干、尖状上部分枝和向外分开的下部笔。`
...
- dataset label text: `㣇`
- dataset label codepoints: `U+38C7`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00105`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00105`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00105`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  002_000101-000200_obs-evo-cand-bucket_evolution-candidates/105_obs-evo-can
  d-000105_evobc-cat-00105_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/002_000101-000200_obs-evo-cand
  -bucket_evolution-candidates/105_obs-evo-cand-000105_evobc-cat-00105_evolu
...
- filename catalog route clues: `Heji-like filename clue: 合3337
  (G_1233_後2.8.7合3337賓組.png)`
...
- Which source records identify obs-char-001103 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001103？
