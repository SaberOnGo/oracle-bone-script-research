# Material Visual Observation / obs-comp-cand-002590 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002590`
- External reference / 外部参照: `obimd-sub-azzc3gn9dj`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021129_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/sdt0io3tms/azzc3gn9dj/azzc3gn9dj.png`
- Checksum / 校验和:
  `91b4643fa9dbb93903bec10dcc0078ef7a1aedbb25c458428bf9b8aae116b497`
...
- Marked-pixel bounds: (88,31)–(161,225); span 74 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.55%。
- 痕迹范围：(88,31)–(161,225)；跨度74 × 195 px；痕迹矩形高于宽。
