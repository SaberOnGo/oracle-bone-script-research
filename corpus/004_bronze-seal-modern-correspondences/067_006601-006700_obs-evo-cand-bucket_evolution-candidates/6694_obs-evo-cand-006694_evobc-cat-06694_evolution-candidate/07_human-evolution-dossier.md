...
Project ID: `obs-evo-cand-006694`
...
- Project ID: `obs-evo-cand-006694`
- EVOBC category candidate ID: `evobc-evo-cat-06694`
- External category reference: `evobc-cat-06694`
- Source category ID: `06694`
- Source label for human review: `繲`
- Source codepoints: `U+7E72`
...
- `obs-evo-cand-006694-route-category-staging`
...
- `obs-evo-cand-006694-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006694-route-evolution-graph`
