...
- External category reference: `evobc-cat-09483`
- Source category ID: `09483`
- Source label for human review: `鎣`
- Source codepoints: `U+93A3`
...
- `obs-evo-cand-009483-route-category-staging`
...
- `obs-evo-cand-009483-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009483-route-evolution-graph`
