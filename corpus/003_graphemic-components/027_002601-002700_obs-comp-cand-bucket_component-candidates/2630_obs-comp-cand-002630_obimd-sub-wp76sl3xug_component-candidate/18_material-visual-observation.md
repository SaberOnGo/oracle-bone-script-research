# Material Visual Observation / obs-comp-cand-002630 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002630`
- External reference / 外部参照: `obimd-sub-wp76sl3xug`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021169_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/yr4rr5qu3e/wp76sl3xug/wp76sl3xug.png`
- Checksum / 校验和:
  `20f29b593fb1bc5e7b1342b8f56ba7dfcf0ad53bc351d7c844c8fb098fc293ee`
...
- Marked-pixel bounds: (77,20)–(168,225); span 92 × 206 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.83%。
- 痕迹范围：(77,20)–(168,225)；跨度92 × 206 px；痕迹矩形高于宽。
