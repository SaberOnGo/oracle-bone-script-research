...
- External category reference: `evobc-cat-00795`
- Source category ID: `00795`
- Source label for human review: `但`
- Source codepoints: `U+4F46`
...
- `obs-evo-cand-000795-route-category-staging`
...
- `obs-evo-cand-000795-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000795-route-evolution-graph`
