...
- External category reference: `evobc-cat-09319`
- Source category ID: `09319`
- Source label: `釴`
...
- `obs-evo-cand-009319-route-category-staging`
...
- `obs-evo-cand-009319-route-code-index`
  ...
  pending check: 待查：打开路线文件后核对本地图像、拓片、摹本或图版。
- `obs-evo-cand-009319-route-evolution-graph`
