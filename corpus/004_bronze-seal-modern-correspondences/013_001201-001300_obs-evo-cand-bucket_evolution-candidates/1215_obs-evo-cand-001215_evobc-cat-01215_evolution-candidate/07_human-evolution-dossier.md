...
- External category reference: `evobc-cat-01215`
- Source category ID: `01215`
- Source label for human review: `剄`
- Source codepoints: `U+5244`
...
- `obs-evo-cand-001215-route-category-staging`
...
- `obs-evo-cand-001215-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001215-route-evolution-graph`
