# obs-unk-004267 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004267`
- primary external id: `hust-obc-und-L-004267`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/067_obs-unk-004267_h
  ust-obc-und-L-004267_oracle-character-candidate/03_visual-assets/001_asset
  -005860_hust-obc-und-L-004267_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4267/L_？_9416.jpg`
- asset id: `asset-005860`
...
- source class: `HUST-OBC/undeciphered/L/4267/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4267/L_？_9416.jpg`
- asset id: `asset-005860`
...
- English observation: `Left strokes, inner bar, right projection visible.`
- 中文观察: `左侧长痕、内部横痕和右侧伸出痕迹可见。`
...
- Which source records identify obs-unk-004267 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004267？
