...
- Project ID: `obs-evo-cand-012372`
- EVOBC category candidate ID: `evobc-evo-cat-12372`
- External category reference: `evobc-cat-12372`
- Source category ID: `12372`
- Source label for human review: `𨔩`
- Source codepoints: `U+28529`
...
- `obs-evo-cand-012372-route-category-staging`
...
- `obs-evo-cand-012372-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012372-route-evolution-graph`
