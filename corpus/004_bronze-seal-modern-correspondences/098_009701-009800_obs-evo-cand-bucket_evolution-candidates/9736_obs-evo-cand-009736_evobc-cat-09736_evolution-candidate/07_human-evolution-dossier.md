...
- External category reference: `evobc-cat-09736`
- Source category ID: `09736`
- Source label for human review: `陟`
...
- `obs-evo-cand-009736-route-category-staging`
...
- `obs-evo-cand-009736-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009736-route-evolution-graph`
