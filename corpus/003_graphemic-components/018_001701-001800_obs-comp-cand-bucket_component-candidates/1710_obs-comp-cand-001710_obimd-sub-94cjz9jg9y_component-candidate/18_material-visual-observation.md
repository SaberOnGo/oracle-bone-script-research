# Material Visual Observation / obs-comp-cand-001710 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001710`
- External reference / 外部参照: `obimd-sub-94cjz9jg9y`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017848_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/94cjz9jg9y/94cjz9jg9y/94cjz9jg9y.png`
- Checksum / 校验和:
  `34ff85394685546bd1e85a5a4c9a1700c51feefa2b449f94af38128f1ba1dcec`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.16%.
- Marked-pixel bounds: (89,30)–(163,208); span 75 × 179 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.16%。
- 痕迹范围：(89,30)–(163,208)；跨度75 × 179 px；痕迹矩形高于宽。
