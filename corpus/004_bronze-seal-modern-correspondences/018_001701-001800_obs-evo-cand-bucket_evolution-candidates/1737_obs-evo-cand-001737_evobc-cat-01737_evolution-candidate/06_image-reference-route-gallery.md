...
- `obs-evo-cand-001737-route-category-staging`
...
- `obs-evo-cand-001737-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001737-route-evolution-graph`
