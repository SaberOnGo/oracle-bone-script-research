...
Project ID: `obs-evo-cand-013329`
...
- Project ID: `obs-evo-cand-013329`
- EVOBC category candidate ID: `evobc-evo-cat-13329`
- External category reference: `evobc-cat-13329`
- Source category ID: `13329`
- Source label for human review: `𬢉`
- Source codepoints: `U+2C889`
...
- `obs-evo-cand-013329-route-category-staging`
...
- `obs-evo-cand-013329-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013329-route-evolution-graph`
