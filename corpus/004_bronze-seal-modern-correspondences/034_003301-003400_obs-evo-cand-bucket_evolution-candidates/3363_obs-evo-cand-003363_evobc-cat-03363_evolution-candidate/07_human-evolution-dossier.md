...
- External category reference: `evobc-cat-03363`
- Source category ID: `03363`
- Source label for human review: `捇`
...
- `obs-evo-cand-003363-route-category-staging`
...
- `obs-evo-cand-003363-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003363-route-evolution-graph`
