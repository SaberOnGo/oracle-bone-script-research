# Material Visual Observation / obs-comp-cand-002170 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002170`
- External reference / 外部参照: `obimd-sub-q4rk3syf2x`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019871_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/q4rk3syf2x/q4rk3syf2x/q4rk3syf2x.png`
- Checksum / 校验和:
  `11323ae4dd3da22ec78b9da01ddfd4e9432c7506c169dd4e8ed740e0ca3798fc`
...
- Marked-pixel bounds: (84,19)–(166,228); span 83 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.70%。
- 痕迹范围：(84,19)–(166,228)；跨度83 × 210 px；痕迹矩形高于宽。
