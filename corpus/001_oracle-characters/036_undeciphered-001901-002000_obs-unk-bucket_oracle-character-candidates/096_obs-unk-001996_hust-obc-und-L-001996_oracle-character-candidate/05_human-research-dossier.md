# obs-unk-001996 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-001996`
- primary external id: `hust-obc-und-L-001996`
...
- local review image route: `corpus/001_oracle-characters/036_undeciphered-001
  901-002000_obs-unk-bucket_oracle-character-candidates/096_obs-unk-001996_h
  ust-obc-und-L-001996_oracle-character-candidate/03_visual-assets/001_asset
  -003589_hust-obc-und-L-001996_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/1996/L_？_1877.jpg`
- asset id: `asset-003589`
...
- source class: `HUST-OBC/undeciphered/L/1996/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/1996/L_？_1877.jpg`
- asset id: `asset-003589`
...
- Which source records identify obs-unk-001996 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-001996？
