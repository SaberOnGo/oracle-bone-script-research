# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002331
...
- EVOBC candidate category: `evobc-evo-cat-02331`.
- Source label for search only: `存`.
- Source codepoints for search only: `U+5B58`.
