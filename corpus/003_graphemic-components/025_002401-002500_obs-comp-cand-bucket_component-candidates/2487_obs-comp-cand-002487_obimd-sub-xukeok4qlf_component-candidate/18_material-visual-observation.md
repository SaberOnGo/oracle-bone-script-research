# Material Visual Observation / obs-comp-cand-002487 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002487`
- External reference / 外部参照: `obimd-sub-xukeok4qlf`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020707_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xukeok4qlf/xukeok4qlf/xukeok4qlf.png`
- Checksum / 校验和:
  `b9577c02fd78755ba5fe581f47004f54f2bb315c2c53fb475c0e5865a9525a48`
...
- Marked-pixel bounds: (75,49)–(172,195); span 98 × 147 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.73%。
- 痕迹范围：(75,49)–(172,195)；跨度98 × 147 px；痕迹矩形高于宽。
