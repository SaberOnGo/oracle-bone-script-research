...
- External category reference: `evobc-cat-06275`
- Source category ID: `06275`
- Source label for human review: `筮`
- Source codepoints: `U+7B6E`
...
- `obs-evo-cand-006275-route-category-staging`
...
- `obs-evo-cand-006275-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006275-route-evolution-graph`
