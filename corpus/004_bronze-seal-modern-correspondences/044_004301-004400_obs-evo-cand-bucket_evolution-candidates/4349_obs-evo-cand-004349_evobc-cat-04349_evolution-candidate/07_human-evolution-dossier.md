...
- External category reference: `evobc-cat-04349`
- Source category ID: `04349`
- Source label for human review: `欲`
...
- `obs-evo-cand-004349-route-category-staging`
...
- `obs-evo-cand-004349-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004349-route-evolution-graph`
