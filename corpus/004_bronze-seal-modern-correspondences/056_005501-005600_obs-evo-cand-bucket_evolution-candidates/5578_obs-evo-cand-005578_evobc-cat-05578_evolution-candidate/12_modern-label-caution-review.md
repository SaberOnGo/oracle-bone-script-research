# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005578
...
- EVOBC candidate category: `evobc-evo-cat-05578`.
- Source label for search only: `番`.
- Source codepoints for search only: `U+756A`.
