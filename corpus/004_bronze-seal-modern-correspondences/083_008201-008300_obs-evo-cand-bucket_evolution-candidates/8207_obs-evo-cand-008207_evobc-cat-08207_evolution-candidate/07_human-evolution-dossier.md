...
- External category reference: `evobc-cat-08207`
- Source category ID: `08207`
- Source label for human review: `詻`
...
- `obs-evo-cand-008207-route-category-staging`
...
- `obs-evo-cand-008207-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008207-route-evolution-graph`
