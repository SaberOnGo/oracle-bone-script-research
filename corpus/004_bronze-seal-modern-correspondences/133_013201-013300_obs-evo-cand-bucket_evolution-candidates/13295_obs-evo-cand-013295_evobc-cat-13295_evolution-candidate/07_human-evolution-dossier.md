...
- External category reference: `evobc-cat-13295`
- Source category ID: `13295`
- Source label for human review: `𬙡`
...
- `obs-evo-cand-013295-route-category-staging`
...
- `obs-evo-cand-013295-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013295-route-evolution-graph`
