# Material Visual Observation / obs-comp-cand-000639 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000639`
- External reference / 外部参照: `obimd-sub-oh1d6hr82z`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013202_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6vdibqvqd8/oh1d6hr82z/oh1d6hr82z.png`
- Checksum / 校验和:
  `cd189f845efb61b22e83186e2d04d75d943bfeb90062694772e30a3d586c1247`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.00%.
- Marked-pixel bounds: (64,24)–(191,222); span 128 × 199 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.00%。
- 痕迹范围：(64,24)–(191,222)；跨度128 × 199 px；痕迹矩形高于宽。
