# Material Visual Observation / obs-comp-cand-000498 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000498`
- External reference / 外部参照: `obimd-sub-awr5k47vw0`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012734_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dhbxzk9tyc/awr5k47vw0/awr5k47vw0.png`
- Checksum / 校验和:
  `a10db6bf8d9e1f962dbdab111d170e67e9d6834b203dfc40343268963f76e479`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.96%.
- Marked-pixel bounds: (82,27)–(167,222); span 86 × 196 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.96%。
- 痕迹范围：(82,27)–(167,222)；跨度86 × 196 px；痕迹矩形高于宽。
