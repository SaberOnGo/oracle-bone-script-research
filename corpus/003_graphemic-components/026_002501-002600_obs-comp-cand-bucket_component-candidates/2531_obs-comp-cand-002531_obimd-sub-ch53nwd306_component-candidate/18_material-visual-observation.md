# Material Visual Observation / obs-comp-cand-002531 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002531`
- External reference / 外部参照: `obimd-sub-ch53nwd306`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021050_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ch53nwd306/ch53nwd306/ch53nwd306.png`
- Checksum / 校验和:
  `2585300444c6a1b2f361563948e7e209a449fbaa3e7cf4d5f631081f566ab776`
...
- Marked-pixel bounds: (84,29)–(165,218); span 82 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.20%。
- 痕迹范围：(84,29)–(165,218)；跨度82 × 190 px；痕迹矩形高于宽。
