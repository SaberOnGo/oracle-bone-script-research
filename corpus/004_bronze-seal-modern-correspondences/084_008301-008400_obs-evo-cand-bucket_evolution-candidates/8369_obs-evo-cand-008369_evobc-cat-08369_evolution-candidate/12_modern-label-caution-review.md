# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008369
...
- EVOBC candidate category: `evobc-evo-cat-08369`.
- Source label for search only: `譬`.
- Source codepoints for search only: `U+8B6C`.
