...
- External category reference: `evobc-cat-10019`
- Source category ID: `10019`
- Source label for human review: `顓`
...
- `obs-evo-cand-010019-route-category-staging`
...
- `obs-evo-cand-010019-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010019-route-evolution-graph`
