...
Project ID: `obs-evo-cand-003408`
...
- Project ID: `obs-evo-cand-003408`
- EVOBC category candidate ID: `evobc-evo-cat-03408`
- External category reference: `evobc-cat-03408`
- Source category ID: `03408`
- Source label for human review: `掠`
- Source codepoints: `U+63A0`
...
- `obs-evo-cand-003408-route-category-staging`
...
- `obs-evo-cand-003408-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003408-route-evolution-graph`
