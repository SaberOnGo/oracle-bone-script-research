# Material Visual Observation / obs-comp-cand-001877 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001877`
- External reference / 外部参照: `obimd-sub-mhpbr7aqcp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018256_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/pmjqw82db0/mhpbr7aqcp/mhpbr7aqcp.png`
- Checksum / 校验和:
  `0551d231b0138f96b6c36eee3e3b19b81cbd0eac741af965d3a5ba7e62842e1d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.82%.
- Marked-pixel bounds: (46,8)–(214,238); span 169 × 231 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.82%。
- 痕迹范围：(46,8)–(214,238)；跨度169 × 231 px；痕迹矩形高于宽。
