...
Project ID: `obs-evo-cand-012757`
...
- Project ID: `obs-evo-cand-012757`
- EVOBC category candidate ID: `evobc-evo-cat-12757`
- External category reference: `evobc-cat-12757`
- Source category ID: `12757`
- Source label for human review: `𪑪`
- Source codepoints: `U+2A46A`
...
- `obs-evo-cand-012757-route-category-staging`
...
- `obs-evo-cand-012757-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012757-route-evolution-graph`
