...
- Project ID: `obs-evo-cand-008994`
- EVOBC category candidate ID: `evobc-evo-cat-08994`
- External category reference: `evobc-cat-08994`
- Source category ID: `08994`
- Source label for human review: `逖`
- Source codepoints: `U+9016`
...
- `obs-evo-cand-008994-route-category-staging`
...
- `obs-evo-cand-008994-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008994-route-evolution-graph`
