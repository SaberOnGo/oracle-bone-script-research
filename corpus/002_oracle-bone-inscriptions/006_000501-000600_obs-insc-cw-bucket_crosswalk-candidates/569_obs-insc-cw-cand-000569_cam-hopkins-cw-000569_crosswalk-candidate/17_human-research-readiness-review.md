# Human Research Readiness Review / 人类研究准备度复核
...
inscription research. It gathers the exact blockers that must be resolved by
a human reviewer before this candidate can become a formal inscription
record or be imported as corpus evidence.

本文件是正式卜辞研究前的本对象准备度复核表。它集中列出人工复核者必须先解决的具体阻断项，然后才能把这个候选项提升为正式卜辞记录或语料证据。
