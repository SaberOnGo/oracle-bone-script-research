# obs-unk-008887 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/105_undeciphered-008
  801-008900_obs-unk-bucket_oracle-character-candidates/087_obs-unk-008887_h
  ust-obc-und-YH-008887_oracle-character-candidate/03_visual-assets/001_asse
  t-010478_hust-obc-und-YH-008887_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60EFC/H_？_60EFC_0.png`
- asset id: `asset-010478`
...
- source class: `HUST-OBC/undeciphered/Y+H/60EFC/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60EFC/H_？_60EFC_0.png`
- asset id: `asset-010478`
...
- Which source records identify obs-unk-008887 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008887？
