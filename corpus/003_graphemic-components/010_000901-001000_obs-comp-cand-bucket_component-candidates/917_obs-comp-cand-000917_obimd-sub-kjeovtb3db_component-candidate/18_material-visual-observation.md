# Material Visual Observation / obs-comp-cand-000917 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000917`
- External reference / 外部参照: `obimd-sub-kjeovtb3db`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014000_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kjeovtb3db/kjeovtb3db/kjeovtb3db.png`
- Checksum / 校验和:
  `2eec3e42ec7f649d6f490d8ced5277e4e2cd167c4a5d2f79039f1600b462f76a`
...
- Marked-pixel bounds: (69,40)–(180,212); span 112 × 173 px; the marked
...
- 痕迹范围：(69,40)–(180,212)；跨度112 × 173 px；痕迹矩形高于宽。
