# obs-unk-009013 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/107_undeciphered-009
  001-009100_obs-unk-bucket_oracle-character-candidates/013_obs-unk-009013_h
  ust-obc-und-YH-009013_oracle-character-candidate/03_visual-assets/001_asse
  t-010604_hust-obc-und-YH-009013_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/610A2/Y_？_610A2.jpg`
- asset id: `asset-010604`
...
- source class: `HUST-OBC/undeciphered/Y+H/610A2/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/610A2/Y_？_610A2.jpg`
- asset id: `asset-010604`
...
- Which source records identify obs-unk-009013 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-009013？
