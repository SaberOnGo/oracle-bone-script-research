...
- External category reference: `evobc-cat-00932`
- Source category ID: `00932`
- Source label for human review: `倠`
- Source codepoints: `U+5020`
...
- `obs-evo-cand-000932-route-category-staging`
...
- `obs-evo-cand-000932-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000932-route-evolution-graph`
