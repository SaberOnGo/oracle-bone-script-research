...
- Primary external ID / 首选外部 ID: `hust-obc-cat-0829`
...
- Source image / 来源图: `G_0829_乙4309合6477賓組.png`
- Image / 图像: `001_asset-000733_hust-obc-cat-0829_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合6477
...
- target node: `evobc-evo-cat-00063`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/063_obs-evo-cand-000063_evobc-cat-00063_evoluti
...
- Source label text / 来源标签文字: `㜳`
- Source label codepoint / 来源标签 codepoint: `U+3733`
