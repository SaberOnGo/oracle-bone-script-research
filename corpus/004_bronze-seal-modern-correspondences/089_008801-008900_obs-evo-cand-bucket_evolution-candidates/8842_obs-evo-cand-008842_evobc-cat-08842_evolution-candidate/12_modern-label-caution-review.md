# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008842
...
- EVOBC candidate category: `evobc-evo-cat-08842`.
- Source label for search only: `輟`.
- Source codepoints for search only: `U+8F1F`.
