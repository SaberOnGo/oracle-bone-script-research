...
- Project ID: `obs-evo-cand-012982`
- EVOBC category candidate ID: `evobc-evo-cat-12982`
- External category reference: `evobc-cat-12982`
- Source category ID: `12982`
- Source label for human review: `𫜡`
- Source codepoints: `U+2B721`
...
- `obs-evo-cand-012982-route-category-staging`
...
- `obs-evo-cand-012982-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012982-route-evolution-graph`
