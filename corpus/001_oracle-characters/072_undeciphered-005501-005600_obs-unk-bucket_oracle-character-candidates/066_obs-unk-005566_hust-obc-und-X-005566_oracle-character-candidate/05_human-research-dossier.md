# obs-unk-005566 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005566`
- primary external id: `hust-obc-und-X-005566`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/066_obs-unk-005566_h
  ust-obc-und-X-005566_oracle-character-candidate/03_visual-assets/001_asset
  -007159_hust-obc-und-X-005566_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1122/X_？_8078_1.png`
- asset id: `asset-007159`
...
- source class: `HUST-OBC/undeciphered/X/1122/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1122/X_？_8078_1.png`
- asset id: `asset-007159`
...
- Which source records identify obs-unk-005566 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005566？
