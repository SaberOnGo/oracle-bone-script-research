# Material Visual Observation / obs-comp-cand-001394 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001394`
- External reference / 外部参照: `obimd-sub-9izvvjw1bu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015813_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9izvvjw1bu/9izvvjw1bu/9izvvjw1bu.png`
- Checksum / 校验和:
  `fe4df8d13d71c188f1a963e52e4abbcfab3877353a4076463a68825c2ea287ea`
...
- Marked-pixel bounds: (69,45)–(180,207); span 112 × 163 px; the marked
...
- 痕迹范围：(69,45)–(180,207)；跨度112 × 163 px；痕迹矩形高于宽。
