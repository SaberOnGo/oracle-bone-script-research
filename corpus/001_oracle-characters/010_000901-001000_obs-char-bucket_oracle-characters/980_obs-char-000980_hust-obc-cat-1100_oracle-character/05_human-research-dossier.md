# obs-char-000980 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000980`
- primary external id: `hust-obc-cat-1100`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/980_obs-char-000980_hust-obc-cat-1100_orac
  le-character/03_visual-assets/001_asset-000985_hust-obc-cat-1100_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1100/G_1100_乙1493合17992賓組.png`
- asset id: `asset-000985`
...
- source category: `1100`
- validation class: `979`
- source image route: `HUST-OBC/deciphered/1100/G_1100_乙1493合17992賓組.png`
- asset id: `asset-000985`
...
- English observation: `A U-shaped grid-like cluster has an outer curved
  stroke and two long lower branching strokes.`
- 中文观察: `U 形格状笔群有外部弯曲笔和两条长下部分枝笔。`
...
- dataset label text: `㡂`
- dataset label codepoints: `U+3842`
...
- filename catalog route clues: `Heji-like filename clue: 合17992
  (G_1100_乙1493合17992賓組.png)`
...
- Which source records identify obs-char-000980 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000980？
