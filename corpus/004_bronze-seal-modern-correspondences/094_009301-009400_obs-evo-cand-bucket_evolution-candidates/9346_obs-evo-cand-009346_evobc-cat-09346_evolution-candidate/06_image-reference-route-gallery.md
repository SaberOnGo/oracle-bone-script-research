...
- `obs-evo-cand-009346-route-category-staging`
...
- `obs-evo-cand-009346-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009346-route-evolution-graph`
