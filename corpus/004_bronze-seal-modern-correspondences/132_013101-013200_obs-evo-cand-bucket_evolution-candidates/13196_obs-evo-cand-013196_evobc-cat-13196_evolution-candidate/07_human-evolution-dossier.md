...
Project ID: `obs-evo-cand-013196`
...
- Project ID: `obs-evo-cand-013196`
- EVOBC category candidate ID: `evobc-evo-cat-13196`
- External category reference: `evobc-cat-13196`
- Source category ID: `13196`
- Source label for human review: `𬄄`
- Source codepoints: `U+2C104`
...
- `obs-evo-cand-013196-route-category-staging`
...
- `obs-evo-cand-013196-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013196-route-evolution-graph`
