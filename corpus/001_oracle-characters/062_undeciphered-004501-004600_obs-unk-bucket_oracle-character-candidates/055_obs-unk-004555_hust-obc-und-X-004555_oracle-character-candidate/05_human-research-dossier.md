# obs-unk-004555 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004555`
- primary external id: `hust-obc-und-X-004555`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/055_obs-unk-004555_h
  ust-obc-und-X-004555_oracle-character-candidate/03_visual-assets/001_asset
  -006148_hust-obc-und-X-004555_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/111/X_？_8293_1.png`
- asset id: `asset-006148`
...
- source class: `HUST-OBC/undeciphered/X/111/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/111/X_？_8293_1.png`
- asset id: `asset-006148`
...
- English observation: `Upper enclosure, middle outline, and traces recorded.`
- 中文观察: `已记录上部轮廓、中部轮廓和下部痕迹。`
...
- Which source records identify obs-unk-004555 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004555？
