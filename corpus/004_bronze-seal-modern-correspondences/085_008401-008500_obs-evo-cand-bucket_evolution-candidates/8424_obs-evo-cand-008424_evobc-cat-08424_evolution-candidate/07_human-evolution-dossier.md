...
- External category reference: `evobc-cat-08424`
- Source category ID: `08424`
- Source label for human review: `诗`
- Source codepoints: `U+8BD7`
...
- `obs-evo-cand-008424-route-category-staging`
...
- `obs-evo-cand-008424-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008424-route-evolution-graph`
