...
Project ID: `obs-evo-cand-004063`
...
- Project ID: `obs-evo-cand-004063`
- EVOBC category candidate ID: `evobc-evo-cat-04063`
- External category reference: `evobc-cat-04063`
- Source category ID: `04063`
- Source label for human review: `梟`
- Source codepoints: `U+689F`
...
- `obs-evo-cand-004063-route-category-staging`
...
- `obs-evo-cand-004063-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004063-route-evolution-graph`
