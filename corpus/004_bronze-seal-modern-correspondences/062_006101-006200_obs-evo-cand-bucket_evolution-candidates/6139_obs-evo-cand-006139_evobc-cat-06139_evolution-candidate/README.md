# obs-evo-cand-006139 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06139`
- Source label for human review: `穫`
- Source codepoints: `U+7A6B`
- Image reference count: `60`
- Era token counts: `BI:1;OBC:40;SS:1;WSC:18`
- Source token counts: `Book:50;Web:10`
