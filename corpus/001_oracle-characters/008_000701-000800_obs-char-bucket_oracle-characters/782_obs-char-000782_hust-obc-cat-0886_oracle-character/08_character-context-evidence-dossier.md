...
- Project ID / 项目 ID: `obs-char-000782`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0886`
...
- Source image / 来源图: `G_0886_粹1276(甲).png`
- Image / 图像: `001_asset-000787_hust-obc-cat-0886_glyph.png`
...
- target node: `obimd-main-cand-000981`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00075`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- EvoBC image references / EvoBC 图像引用数: `69`
...
- Human review files / 人类复核文件:
  ...
  -bucket_evolution-candidates/075_obs-evo-cand-000075_evobc-cat-00075_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `gxkrzcoj69`
...
- Source label text / 来源标签文字: `㝬`
- Source label codepoint / 来源标签 codepoint: `U+376C`
