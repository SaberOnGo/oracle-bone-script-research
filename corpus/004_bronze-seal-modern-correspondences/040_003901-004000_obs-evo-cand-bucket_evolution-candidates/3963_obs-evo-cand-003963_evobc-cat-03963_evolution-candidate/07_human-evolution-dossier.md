...
- Project ID: `obs-evo-cand-003963`
- EVOBC category candidate ID: `evobc-evo-cat-03963`
- External category reference: `evobc-cat-03963`
- Source category ID: `03963`
- Source label for human review: `柞`
- Source codepoints: `U+67DE`
...
- `obs-evo-cand-003963-route-category-staging`
...
- `obs-evo-cand-003963-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003963-route-evolution-graph`
