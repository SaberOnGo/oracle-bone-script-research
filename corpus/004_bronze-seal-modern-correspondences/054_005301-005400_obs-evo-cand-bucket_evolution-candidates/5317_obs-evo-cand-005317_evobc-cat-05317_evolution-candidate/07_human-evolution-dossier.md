...
- External category reference: `evobc-cat-05317`
- Source category ID: `05317`
- Source label for human review: `獘`
...
- `obs-evo-cand-005317-route-category-staging`
...
- `obs-evo-cand-005317-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005317-route-evolution-graph`
