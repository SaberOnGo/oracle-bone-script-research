# obs-evo-cand-006461 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-06461`
- Source label: `級`
- Source codepoints: `U+7D1A`
- Image reference count: `18`
- Era token counts: `CS:1;SS:2;WSC:15`
- Source token counts: `Book:7;Web:11`
