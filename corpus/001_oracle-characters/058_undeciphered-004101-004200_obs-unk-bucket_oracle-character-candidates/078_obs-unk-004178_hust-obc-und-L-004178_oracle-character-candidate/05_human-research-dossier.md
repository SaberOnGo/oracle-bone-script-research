# obs-unk-004178 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004178`
- primary external id: `hust-obc-und-L-004178`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/078_obs-unk-004178_h
  ust-obc-und-L-004178_oracle-character-candidate/03_visual-assets/001_asset
  -005771_hust-obc-und-L-004178_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4178/L_？_9049.jpg`
- asset id: `asset-005771`
...
- source class: `HUST-OBC/undeciphered/L/4178/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4178/L_？_9049.jpg`
- asset id: `asset-005771`
...
- English observation: A compact upper group descends into two long narrow
  strokes.
- 中文观察: 紧凑的上部形态向下连接两条较长窄笔画。
...
- Which source records identify obs-unk-004178 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004178？
