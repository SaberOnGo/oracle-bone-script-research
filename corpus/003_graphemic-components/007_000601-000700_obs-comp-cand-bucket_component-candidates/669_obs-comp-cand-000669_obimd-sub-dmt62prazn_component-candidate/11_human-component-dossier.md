# Human Component Candidate Dossier / 构件候选研究档案: obs-comp-cand-000669
...
- candidate_component_id: `obs-comp-cand-000669`
- primary_external_ref_id: `obimd-sub-dmt62prazn`
- source_subcharacter_uid: `dmt62prazn`
- source_main_character_uid: `dmt62prazn`
- main_character_external_ref_id: `obimd-main-dmt62prazn`
...
- glyph_codepoint_uplus_sample: `U+B6AFA;U+F3D88, U+F3D89, ...`
- full_glyph_codepoint_list: see `03_glyph-codepoint-index.csv`

| Asset ID | Local image file | SHA-256 |
| --- | --- | --- |
| `asset-013232` | `001_asset-013232_img.png` | `b73d8dffd42398c7839f4698abda01c7216dd6df97ef06a42fe6a781373f08dc` |
