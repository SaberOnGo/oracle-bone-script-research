# Material Visual Observation / obs-comp-cand-002060 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002060`
- External reference / 外部参照: `obimd-sub-eqj67fc64m`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019447_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f31a6zuqwf/eqj67fc64m/eqj67fc64m.png`
- Checksum / 校验和:
  `acc853ce8d58009ffdb302a85569f4960390e99da432952a09a94a429da4872d`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.64%.
- Marked-pixel bounds: (52,22)–(212,217); span 161 × 196 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.64%。
- 痕迹范围：(52,22)–(212,217)；跨度161 × 196 px；痕迹矩形高于宽。
