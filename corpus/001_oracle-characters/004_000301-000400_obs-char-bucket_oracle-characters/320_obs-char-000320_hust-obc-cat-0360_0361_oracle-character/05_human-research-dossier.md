# obs-char-000320 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/320_obs-char-000320_hust-obc-cat-0360_0361
  _oracle-character/03_visual-assets/001_asset-000325_hust-obc-cat-0360_0361
  _glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0360_0361/0360/G_0360_乙368合2072
  6𠂤組.png`
- asset id: `asset-000325`
...
- source category: `0360_0361`
- validation class: `319`
- source image route: `HUST-OBC/deciphered/0360_0361/0360/G_0360_乙368合20726𠂤組.
  png`
- asset id: `asset-000325`
...
- English observation: `The image has a peaked outer contour, a central
  descending stroke, and a rounded lower enclosure; the small image needs
  detail recheck.`
...
- dataset label text: `㕞㕟`
- dataset label codepoints: `U+355E;U+355F`
...
- filename catalog route clues: `Heji-like filename clue: 合20726
  (G_0360_乙368合20726𠂤組.png)`
...
- Which source records identify obs-char-000320 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000320？
