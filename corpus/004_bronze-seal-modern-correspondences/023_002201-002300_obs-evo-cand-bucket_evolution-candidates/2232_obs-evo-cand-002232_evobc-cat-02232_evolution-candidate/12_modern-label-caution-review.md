# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002232
...
- EVOBC candidate category: `evobc-evo-cat-02232`.
- Source label for search only: `媚`.
- Source codepoints for search only: `U+5A9A`.
