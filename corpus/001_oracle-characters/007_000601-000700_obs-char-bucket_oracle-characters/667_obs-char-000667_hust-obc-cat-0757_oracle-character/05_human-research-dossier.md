# obs-char-000667 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/667_obs-char-000667_hust-obc-cat-0757_orac
  le-character/03_visual-assets/001_asset-000672_hust-obc-cat-0757_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0757/G_0757_乙117(甲).png`
- asset id: `asset-000672`
...
- source category: `0757`
- validation class: `666`
- source image route: `HUST-OBC/deciphered/0757/G_0757_乙117(甲).png`
- asset id: `asset-000672`
...
- English observation: `A single tall vertical bends leftward into a broad
  open upper hook and carries two short horizontal bars before narrowing to
  a pointed bottom.`
...
- dataset label text: `㛫`
- dataset label codepoints: `U+36EB`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00057`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00057`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00057`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/057_obs-evo-can
  d-000057_evobc-cat-00057_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/057_obs-evo-cand-000057_evobc-cat-00057_evolu
...
- Which source records identify obs-char-000667 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000667？
