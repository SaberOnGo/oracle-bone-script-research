# Preformal Research Start Check / 正式研究开始前开包核查: coll-obj-cand-00004
...
| --- | --- | --- |
| 1 | `02_collection-source-index.csv` | `1215` |
| 2 | `04_visual-gallery.md` | `external_thumbnail_url_metadata_only` |
| 2a | `18_live-source-evidence-review.md` | three private JPEG routes and hashes |
