# obs-char-001100 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-001100`
- primary external id: `hust-obc-cat-1229`
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1100_obs-char-001100_hust-obc-cat-1229_ora
  cle-character/03_visual-assets/001_asset-001105_hust-obc-cat-1229_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1229/G_1229_乙434(甲).png`
- asset id: `asset-001105`
...
- source category: `1229`
- validation class: `1099`
- source image route: `HUST-OBC/deciphered/1229/G_1229_乙434(甲).png`
- asset id: `asset-001105`
...
- English observation: `A slender upright form has a short upper horizontal
  stroke, a central crossing, and a long lower stem.`
- 中文观察: `纤细直立形体有短上部水平笔、中央交叉和长下部笔干。`
...
- dataset label text: `㣃`
- dataset label codepoints: `U+38C3`
...
- Which source records identify obs-char-001100 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001100？
