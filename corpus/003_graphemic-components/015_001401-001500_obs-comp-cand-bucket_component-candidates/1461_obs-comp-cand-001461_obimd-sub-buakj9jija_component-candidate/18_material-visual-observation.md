# Material Visual Observation / obs-comp-cand-001461 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001461`
- External reference / 外部参照: `obimd-sub-buakj9jija`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016038_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/buakj9jija/buakj9jija/buakj9jija.png`
- Checksum / 校验和:
  `27b6107ffbae09190858b3e6b47cae931fdbd474bc810db7ee27afca00a60a34`
...
- Marked-pixel bounds: (71,20)–(168,229); span 98 × 210 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.50%。
- 痕迹范围：(71,20)–(168,229)；跨度98 × 210 px；痕迹矩形高于宽。
