# obs-char-000496 Visual Gallery / obs-char-000496 图像资料页
...
- Project ID / 项目 ID: `obs-char-000496`
- Primary external reference / 首选外部参考: `hust-obc-cat-0565`
...
## obs-char-000496-visual-source-001 / 图像条目

![obs-char-000496 glyph candidate](03_visual-assets/001_asset-000501_hust-obc-cat-0565_glyph.png)

- Local image / 本地图像: `03_visual-assets/001_asset-000501_hust-obc-cat-0565_glyph.png`
- Local metadata / 本地 metadata: `03_visual-assets/001_asset-000501_hust-obc-cat-0565_glyph.yaml`
- Source image path / 来源图像路径: `HUST-OBC/deciphered/0565/G_0565_前6.31.3合3919.png`
