...
- Project ID: `obs-evo-cand-008956`
- EVOBC category candidate ID: `evobc-evo-cat-08956`
- External category reference: `evobc-cat-08956`
- Source category ID: `08956`
- Source label for human review: `迡`
- Source codepoints: `U+8FE1`
...
- `obs-evo-cand-008956-route-category-staging`
...
- `obs-evo-cand-008956-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008956-route-evolution-graph`
