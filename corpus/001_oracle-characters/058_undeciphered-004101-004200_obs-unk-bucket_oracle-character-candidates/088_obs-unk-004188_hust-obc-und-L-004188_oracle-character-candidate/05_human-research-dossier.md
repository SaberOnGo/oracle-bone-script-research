# obs-unk-004188 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/088_obs-unk-004188_h
  ust-obc-und-L-004188_oracle-character-candidate/03_visual-assets/001_asset
  -005781_hust-obc-und-L-004188_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4188/L_？_9110.jpg`
- asset id: `asset-005781`
...
- source class: `HUST-OBC/undeciphered/L/4188/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4188/L_？_9110.jpg`
- asset id: `asset-005781`
...
- English observation: `Two upper slanting strokes and a central crossing;
stroke descends on the right.`
- 中文观察: `上部可见两条斜笔画和中央交叉处；右侧笔画向下弯曲。`
...
- Which source records identify obs-unk-004188 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004188？
