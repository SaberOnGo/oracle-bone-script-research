# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003065
...
- EVOBC candidate category: `evobc-evo-cat-03065`.
- Source label for search only: `惲`.
- Source codepoints for search only: `U+60F2`.
