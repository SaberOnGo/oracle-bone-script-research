# Material Visual Observation / obs-comp-cand-001971 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001971`
- External reference / 外部参照: `obimd-sub-1vataolxj9`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018963_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/1vataolxj9/1vataolxj9/1vataolxj9.png`
- Checksum / 校验和:
  `d4e8fb4f1d358cf350da86bde3fa890a3a95366c9af0150f3a76b3bb97bc870b`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.85%.
- Marked-pixel bounds: (54,56)–(195,190); span 142 × 135 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.85%。
- 痕迹范围：(54,56)–(195,190)；跨度142 × 135 px；痕迹矩形近方形。
