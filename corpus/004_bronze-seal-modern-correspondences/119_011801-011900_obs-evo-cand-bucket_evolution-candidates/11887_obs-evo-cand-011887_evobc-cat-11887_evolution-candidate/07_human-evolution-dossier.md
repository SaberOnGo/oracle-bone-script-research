...
- Project ID: `obs-evo-cand-011887`
- EVOBC category candidate ID: `evobc-evo-cat-11887`
- External category reference: `evobc-cat-11887`
- Source category ID: `11887`
- Source label for human review: `𥯺`
- Source codepoints: `U+25BFA`
...
- `obs-evo-cand-011887-route-category-staging`
...
- `obs-evo-cand-011887-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011887-route-evolution-graph`
