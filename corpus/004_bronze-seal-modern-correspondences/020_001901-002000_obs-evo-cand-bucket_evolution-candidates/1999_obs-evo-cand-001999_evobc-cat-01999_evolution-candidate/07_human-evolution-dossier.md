...
- Project ID: `obs-evo-cand-001999`
- EVOBC category candidate ID: `evobc-evo-cat-01999`
- External category reference: `evobc-cat-01999`
- Source category ID: `01999`
- Source label for human review: `外`
- Source codepoints: `U+5916`
- Image reference count in source metadata: `93`
...
- `obs-evo-cand-001999-route-category-staging`
...
- `obs-evo-cand-001999-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001999-route-evolution-graph`
