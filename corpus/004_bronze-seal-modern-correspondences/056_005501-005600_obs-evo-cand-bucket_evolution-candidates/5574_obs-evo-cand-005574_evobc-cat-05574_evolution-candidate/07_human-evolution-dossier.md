...
Project ID: `obs-evo-cand-005574`
...
- Project ID: `obs-evo-cand-005574`
- EVOBC category candidate ID: `evobc-evo-cat-05574`
- External category reference: `evobc-cat-05574`
- Source category ID: `05574`
- Source label for human review: `畢`
- Source codepoints: `U+7562`
...
- `obs-evo-cand-005574-route-category-staging`
...
- `obs-evo-cand-005574-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005574-route-evolution-graph`
