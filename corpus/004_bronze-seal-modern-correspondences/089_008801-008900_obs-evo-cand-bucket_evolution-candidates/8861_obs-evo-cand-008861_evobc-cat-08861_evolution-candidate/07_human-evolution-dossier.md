...
- External category reference: `evobc-cat-08861`
- Source category ID: `08861`
- Source label for human review: `轀`
...
- `obs-evo-cand-008861-route-category-staging`
...
- `obs-evo-cand-008861-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008861-route-evolution-graph`
