...
- Project ID: `obs-evo-cand-009532`
- EVOBC category candidate ID: `evobc-evo-cat-09532`
- External category reference: `evobc-cat-09532`
- Source category ID: `09532`
- Source label for human review: `鐧`
- Source codepoints: `U+9427`
...
- `obs-evo-cand-009532-route-category-staging`
...
- `obs-evo-cand-009532-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009532-route-evolution-graph`
