...
- External category reference: `evobc-cat-02988`
- Source category ID: `02988`
- Source label for human review: `恭`
- Source codepoints: `U+606D`
...
- `obs-evo-cand-002988-route-category-staging`
...
- `obs-evo-cand-002988-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002988-route-evolution-graph`
