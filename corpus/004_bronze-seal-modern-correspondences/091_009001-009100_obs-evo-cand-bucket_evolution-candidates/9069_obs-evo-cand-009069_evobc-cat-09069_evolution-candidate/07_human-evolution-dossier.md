...
- External category reference: `evobc-cat-09069`
- Source category ID: `09069`
- Source label for human review: `避`
...
- `obs-evo-cand-009069-route-category-staging`
...
- `obs-evo-cand-009069-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009069-route-evolution-graph`
