# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-000840
...
- EVOBC candidate category: `evobc-evo-cat-00840`.
- Source label for search only: `侊`.
- Source codepoints for search only: `U+4F8A`.
