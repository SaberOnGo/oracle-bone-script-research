# Material Visual Observation / obs-comp-cand-000676 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000676`
- External reference / 外部参照: `obimd-sub-xmfpjivigx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013239_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/xmfpjivigx/xmfpjivigx/4p5u3tkqec.png`
- Checksum / 校验和:
  `0914bafe4cab4f521c25389b6314002528acbf04b2b6416ed27dcaf05e2e6eb6`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.16%.
- Marked-pixel bounds: (66,45)–(183,205); span 118 × 161 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.16%。
- 痕迹范围：(66,45)–(183,205)；跨度118 × 161 px；痕迹矩形高于宽。
