...
- `obs-evo-cand-008437-route-category-staging`
...
- `obs-evo-cand-008437-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008437-route-evolution-graph`
