# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001613
...
| --- | --- | --- | --- |
| `obimd-glyph-link-025132` | 󹚕 | `U+F9695` | `reviewed_metadata_only` |
| `obimd-glyph-link-025133` | 󹚖 | `U+F9696` | `reviewed_metadata_only` |
| `obimd-glyph-link-025134` | 󹚗 | `U+F9697` | `reviewed_metadata_only` |
