...
Project ID: `obs-evo-cand-007903`
...
- Project ID: `obs-evo-cand-007903`
- EVOBC category candidate ID: `evobc-evo-cat-07903`
- External category reference: `evobc-cat-07903`
- Source category ID: `07903`
- Source label for human review: `衍`
- Source codepoints: `U+884D`
...
- `obs-evo-cand-007903-route-category-staging`
...
- `obs-evo-cand-007903-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007903-route-evolution-graph`
