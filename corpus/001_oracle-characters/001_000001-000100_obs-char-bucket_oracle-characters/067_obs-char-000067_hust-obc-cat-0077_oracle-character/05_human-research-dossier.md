# obs-char-000067 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/067_obs-char-000067_hust-obc-cat-0077_orac
  le-character/03_visual-assets/001_asset-000072_hust-obc-cat-0077_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0077/X_0077_4497_1.png`
- asset id: `asset-000072`
...
- source category: `0077`
- validation class: `66`
- source image route: `HUST-OBC/deciphered/0077/X_0077_4497_1.png`
- asset id: `asset-000072`
...
- English observation: `The large image contains a tall branching form on
  the left and a dense angular form on the right, with several detached
  lower strokes.`
...
- dataset label text: `㑃`
- dataset label codepoints: `U+3443`
...
- Which source records identify obs-char-000067 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000067？
