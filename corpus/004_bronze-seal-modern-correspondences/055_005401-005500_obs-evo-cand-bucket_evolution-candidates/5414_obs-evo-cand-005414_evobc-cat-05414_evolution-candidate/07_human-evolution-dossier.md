...
- Project ID: `obs-evo-cand-005414`
- EVOBC category candidate ID: `evobc-evo-cat-05414`
- External category reference: `evobc-cat-05414`
- Source category ID: `05414`
- Source label for human review: `琨`
- Source codepoints: `U+7428`
...
- `obs-evo-cand-005414-route-category-staging`
...
- `obs-evo-cand-005414-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005414-route-evolution-graph`
