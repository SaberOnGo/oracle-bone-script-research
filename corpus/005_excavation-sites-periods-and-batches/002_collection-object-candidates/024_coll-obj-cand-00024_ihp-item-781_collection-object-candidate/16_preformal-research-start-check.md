# Preformal Research Start Check / 正式研究开始前开包核查: coll-obj-cand-00024
...
| --- | --- | --- |
| 1 | `02_collection-source-index.csv` | `781` |
...
| 6 | `18_live-source-evidence-review.md` | source text, image hash, rights |
...
- Which source text, image observation, or YH127 route still needs an
  independent check?
