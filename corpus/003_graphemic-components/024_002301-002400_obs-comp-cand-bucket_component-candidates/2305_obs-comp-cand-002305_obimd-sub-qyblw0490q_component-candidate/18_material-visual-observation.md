# Material Visual Observation / obs-comp-cand-002305 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002305`
- External reference / 外部参照: `obimd-sub-qyblw0490q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020324_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/s65fsavh28/qyblw0490q/qyblw0490q.png`
- Checksum / 校验和:
  `1b609082bc4f1cc93fe6f6ebddec4cf6c617b08a41f18604c0ba94db3d63b866`
...
- Marked-pixel bounds: (91,25)–(180,219); span 90 × 195 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.03%。
- 痕迹范围：(91,25)–(180,219)；跨度90 × 195 px；痕迹矩形高于宽。
