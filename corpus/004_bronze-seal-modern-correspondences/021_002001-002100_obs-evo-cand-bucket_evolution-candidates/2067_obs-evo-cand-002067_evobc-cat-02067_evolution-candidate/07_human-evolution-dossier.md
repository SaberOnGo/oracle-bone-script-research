...
- External category reference: `evobc-cat-02067`
- Source category ID: `02067`
- Source label for human review: `妁`
- Source codepoints: `U+5981`
...
- `obs-evo-cand-002067-route-category-staging`
...
- `obs-evo-cand-002067-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002067-route-evolution-graph`
