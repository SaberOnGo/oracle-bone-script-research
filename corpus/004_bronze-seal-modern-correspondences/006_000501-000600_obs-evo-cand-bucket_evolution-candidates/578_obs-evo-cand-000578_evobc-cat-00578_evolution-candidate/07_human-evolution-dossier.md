...
- External category reference: `evobc-cat-00578`
- Source category ID: `00578`
- Source label for human review: `䱜`
- Source codepoints: `U+4C5C`
...
- `obs-evo-cand-000578-route-category-staging`
...
- `obs-evo-cand-000578-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000578-route-evolution-graph`
