# Material Visual Observation / obs-comp-cand-002328 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002328`
- External reference / 外部参照: `obimd-sub-kggb6goupa`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020347_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/kggb6goupa/kggb6goupa/kggb6goupa.png`
- Checksum / 校验和:
  `ac2f994f516229cd50e2dd37807f86f3abbd7320151949911eda4ba1b260f81d`
...
- Marked-pixel bounds: (72,37)–(184,208); span 113 × 172 px; the marked
...
- 痕迹范围：(72,37)–(184,208)；跨度113 × 172 px；痕迹矩形高于宽。
