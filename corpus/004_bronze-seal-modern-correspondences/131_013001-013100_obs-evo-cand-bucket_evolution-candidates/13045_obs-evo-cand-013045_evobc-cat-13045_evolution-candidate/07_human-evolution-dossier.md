...
- Project ID: `obs-evo-cand-013045`
- EVOBC category candidate ID: `evobc-evo-cat-13045`
- External category reference: `evobc-cat-13045`
- Source category ID: `13045`
- Source label for human review: `𫨸`
- Source codepoints: `U+2BA38`
...
- `obs-evo-cand-013045-route-category-staging`
...
- `obs-evo-cand-013045-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013045-route-evolution-graph`
