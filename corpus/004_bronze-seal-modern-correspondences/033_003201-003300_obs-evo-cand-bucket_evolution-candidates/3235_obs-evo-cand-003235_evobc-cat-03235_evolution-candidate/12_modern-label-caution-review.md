# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003235
...
- EVOBC candidate category: `evobc-evo-cat-03235`.
- Source label for search only: `房`.
- Source codepoints for search only: `U+623F`.
