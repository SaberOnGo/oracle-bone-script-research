...
- External category reference: `evobc-cat-03125`
- Source category ID: `03125`
- Source label for human review: `慪`
- Source codepoints: `U+616A`
...
- `obs-evo-cand-003125-route-category-staging`
...
- `obs-evo-cand-003125-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003125-route-evolution-graph`
