# obs-char-000358 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000358`
- primary external id: `hust-obc-cat-0406`
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/358_obs-char-000358_hust-obc-cat-0406_orac
  le-character/03_visual-assets/001_asset-000363_hust-obc-cat-0406_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0406/G_0406_後2.32.16合9379.png`
- asset id: `asset-000363`
...
- source category: `0406`
- validation class: `357`
- source image route: `HUST-OBC/deciphered/0406/G_0406_後2.32.16合9379.png`
- asset id: `asset-000363`
...
- English observation: `A thin central stem is flanked by two small pointed
  upper forms and a long curved lower extension.`
...
- dataset label text: `㖌`
- dataset label codepoints: `U+358C`
...
- filename catalog route clues: `Heji-like filename clue: 合9379
  (G_0406_後2.32.16合9379.png)`
...
- Which source records identify obs-char-000358 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000358？
