...
- External category reference: `evobc-cat-11950`
- Source category ID: `11950`
- Source label for human review: `𦁢`
...
- `obs-evo-cand-011950-route-category-staging`
...
- `obs-evo-cand-011950-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011950-route-evolution-graph`
