...
- External category reference: `evobc-cat-04727`
- Source category ID: `04727`
- Source label for human review: `淥`
...
- `obs-evo-cand-004727-route-category-staging`
...
- `obs-evo-cand-004727-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004727-route-evolution-graph`
