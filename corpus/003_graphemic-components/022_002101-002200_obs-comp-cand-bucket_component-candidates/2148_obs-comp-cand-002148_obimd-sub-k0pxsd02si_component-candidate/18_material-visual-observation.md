# Material Visual Observation / obs-comp-cand-002148 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002148`
- External reference / 外部参照: `obimd-sub-k0pxsd02si`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019736_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/k0pxsd02si/k0pxsd02si/k0pxsd02si.png`
- Checksum / 校验和:
  `435a5064584a470dbad017d83abd1d27a92930d77758fcb3d8196c0ba4ccde7a`
...
- Marked-pixel bounds: (71,40)–(177,203); span 107 × 164 px; the marked
...
- 痕迹范围：(71,40)–(177,203)；跨度107 × 164 px；痕迹矩形高于宽。
