...
- Project ID: `obs-evo-cand-004708`
- EVOBC category candidate ID: `evobc-evo-cat-04708`
- External category reference: `evobc-cat-04708`
- Source category ID: `04708`
- Source label for human review: `淅`
- Source codepoints: `U+6DC5`
...
- `obs-evo-cand-004708-route-category-staging`
...
- `obs-evo-cand-004708-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004708-route-evolution-graph`
