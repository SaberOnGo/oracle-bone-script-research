# Material Visual Observation / obs-comp-cand-002010 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002010`
- External reference / 外部参照: `obimd-sub-9k2v5ankcl`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019337_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/l4lq5esn5g/9k2v5ankcl/9k2v5ankcl.png`
- Checksum / 校验和:
  `e93d369fad219b37cc3b21903c7fb9d7b4be4680738ae4138c7b85fde9777e2d`
...
- Marked-pixel bounds: (89,22)–(168,225); span 80 × 204 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.01%。
- 痕迹范围：(89,22)–(168,225)；跨度80 × 204 px；痕迹矩形高于宽。
