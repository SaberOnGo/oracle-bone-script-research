# obs-char-000930 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000930`
- primary external id: `hust-obc-cat-1047`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/930_obs-char-000930_hust-obc-cat-1047_orac
  le-character/03_visual-assets/001_asset-000935_hust-obc-cat-1047_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1047/G_1047_乙3219合9214.png`
- asset id: `asset-000935`
...
- source category: `1047`
- validation class: `929`
- source image route: `HUST-OBC/deciphered/1047/G_1047_乙3219合9214.png`
- asset id: `asset-000935`
...
- English observation: `A U-shaped upper curve narrows into a central
  descending branch that ends in a pointed lower stroke.`
- 中文观察: `U 形上部弯笔收拢为中央下行分枝，并以尖形下笔收尾。`
...
- dataset label text: `㠍`
- dataset label codepoints: `U+380D`
...
- filename catalog route clues: `Heji-like filename clue: 合9214
  (G_1047_乙3219合9214.png)`
...
- Which source records identify obs-char-000930 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000930？
