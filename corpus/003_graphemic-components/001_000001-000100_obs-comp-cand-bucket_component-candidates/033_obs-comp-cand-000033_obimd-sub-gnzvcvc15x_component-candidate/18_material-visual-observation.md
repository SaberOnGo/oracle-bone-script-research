# Material Visual Observation / obs-comp-cand-000033 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000033`
- External reference / 外部参照: `obimd-sub-gnzvcvc15x`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-011286_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/ftj0qy2f7b/gnzvcvc15x/2t1n8nsxe5.png`
- Checksum / 校验和:
  `a4574d0784dce8f3f094cf36e5e59438a08e8003c88f726c8f7fed9e85dc0f80`
...
- Marked-pixel bounds: (69,66)–(180,177); span 112 × 112 px; the marked
...
- 痕迹范围：(69,66)–(180,177)；跨度112 × 112 px；痕迹矩形近方形。
