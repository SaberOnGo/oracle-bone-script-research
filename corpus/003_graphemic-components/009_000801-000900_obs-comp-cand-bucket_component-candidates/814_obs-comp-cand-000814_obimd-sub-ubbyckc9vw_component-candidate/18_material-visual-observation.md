# Material Visual Observation / obs-comp-cand-000814 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000814`
- External reference / 外部参照: `obimd-sub-ubbyckc9vw`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013685_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/jshaxuelhn/ubbyckc9vw/ubbyckc9vw.png`
- Checksum / 校验和:
  `94a0310d852ac03eb9b93e896bade37682a34a452dbe4cbd24a1e9fae665cd1d`
...
- Marked-pixel bounds: (71,33)–(185,221); span 115 × 189 px; the marked
...
- 痕迹范围：(71,33)–(185,221)；跨度115 × 189 px；痕迹矩形高于宽。
