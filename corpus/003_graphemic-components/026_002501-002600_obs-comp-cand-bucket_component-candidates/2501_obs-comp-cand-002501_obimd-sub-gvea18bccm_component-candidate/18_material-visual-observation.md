# Material Visual Observation / obs-comp-cand-002501 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002501`
- External reference / 外部参照: `obimd-sub-gvea18bccm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020765_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/gvea18bccm/gvea18bccm/gvea18bccm.png`
- Checksum / 校验和:
  `e68d05a9a0356771a46c2fcb08d8ac989c69dc8b334d6e0cefa0dea7876de2da`
...
- Marked-pixel bounds: (50,89)–(199,156); span 150 × 68 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占3.69%。
- 痕迹范围：(50,89)–(199,156)；跨度150 × 68 px；痕迹矩形宽于高。
