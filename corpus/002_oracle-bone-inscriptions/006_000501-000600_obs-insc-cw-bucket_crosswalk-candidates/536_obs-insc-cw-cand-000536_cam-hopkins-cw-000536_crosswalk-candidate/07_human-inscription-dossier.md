...
Project ID: `obs-insc-cw-cand-000536`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000536`
...
- Yingguo / 英国所藏: `y2533` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `349` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `458b` in source row; primary catalog entry
  pending
- Heji / 合集: `41773` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000536`
