...
Project ID: `obs-evo-cand-007971`
...
- Project ID: `obs-evo-cand-007971`
- EVOBC category candidate ID: `evobc-evo-cat-07971`
- External category reference: `evobc-cat-07971`
- Source category ID: `07971`
- Source label for human review: `裒`
- Source codepoints: `U+88D2`
...
- `obs-evo-cand-007971-route-category-staging`
...
- `obs-evo-cand-007971-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007971-route-evolution-graph`
