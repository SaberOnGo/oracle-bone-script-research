# obs-comp-cand-001954 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001954`
- 首选外部 ID: `obimd-sub-r1qimk9d4z`
- OBIMD subcharacter UID: `r1qimk9d4z`
- OBIMD main character UID: `r1qimk9d4z`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+FB2A5; U+FB2A6; 另有 1 项
