...
Project ID: `obs-evo-cand-011898`
...
- Project ID: `obs-evo-cand-011898`
- EVOBC category candidate ID: `evobc-evo-cat-11898`
- External category reference: `evobc-cat-11898`
- Source category ID: `11898`
- Source label for human review: `𥲆`
- Source codepoints: `U+25C86`
...
- `obs-evo-cand-011898-route-category-staging`
...
- `obs-evo-cand-011898-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011898-route-evolution-graph`
