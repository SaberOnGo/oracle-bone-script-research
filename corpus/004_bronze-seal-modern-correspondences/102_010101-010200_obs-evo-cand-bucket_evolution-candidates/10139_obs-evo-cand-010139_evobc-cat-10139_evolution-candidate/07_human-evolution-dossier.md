...
- External category reference: `evobc-cat-10139`
- Source category ID: `10139`
- Source label for human review: `饗`
- Source codepoints: `U+9957`
...
- `obs-evo-cand-010139-route-category-staging`
...
- `obs-evo-cand-010139-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010139-route-evolution-graph`
