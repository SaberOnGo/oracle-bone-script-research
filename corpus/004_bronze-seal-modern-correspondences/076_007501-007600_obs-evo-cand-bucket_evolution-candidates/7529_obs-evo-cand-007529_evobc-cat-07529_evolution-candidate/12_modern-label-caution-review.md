# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-007529
...
- EVOBC candidate category: `evobc-evo-cat-07529`.
- Source label for search only: `蓛`.
- Source codepoints for search only: `U+84DB`.
