# Material Visual Observation / obs-comp-cand-000300 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000300`
- External reference / 外部参照: `obimd-sub-myb8ogz68b`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012066_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/qzgadtxm9i/myb8ogz68b/myb8ogz68b.png`
- Checksum / 校验和:
  `7eb5c59b0cdeb9afd131e511f9af86e642690f06c38c7f6607e1441844f00743`
...
- Marked-pixel bounds: (83,16)–(166,230); span 84 × 215 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.09%。
- 痕迹范围：(83,16)–(166,230)；跨度84 × 215 px；痕迹矩形高于宽。
