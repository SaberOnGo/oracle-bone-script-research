...
- External category reference: `evobc-cat-00186`
- Source category ID: `00186`
- Source label for human review: `㰯`
- Source codepoints: `U+3C2F`
...
- `obs-evo-cand-000186-route-category-staging`
...
- `obs-evo-cand-000186-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000186-route-evolution-graph`
