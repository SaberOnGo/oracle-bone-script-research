# Material Visual Observation / obs-comp-cand-001176 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001176`
- External reference / 外部参照: `obimd-sub-hcimcis80q`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015366_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hcimcis80q/hcimcis80q/hcimcis80q.png`
- Checksum / 校验和:
  `da334ad99575f4cc3f6dad5bc1119f07a605d0129aad95ef9ba4bd0a0021e63f`
...
- Marked-pixel bounds: (85,31)–(164,214); span 80 × 184 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.31%。
- 痕迹范围：(85,31)–(164,214)；跨度80 × 184 px；痕迹矩形高于宽。
