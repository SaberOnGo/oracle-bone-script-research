...
- External category reference: `evobc-cat-08748`
- Source category ID: `08748`
- Source label for human review: `蹂`
...
- `obs-evo-cand-008748-route-category-staging`
...
- `obs-evo-cand-008748-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008748-route-evolution-graph`
