...
- `obs-evo-cand-002611-route-category-staging`
...
- `obs-evo-cand-002611-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002611-route-evolution-graph`
