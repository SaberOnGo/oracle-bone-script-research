# obs-char-000309 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/309_obs-char-000309_hust-obc-cat-0349_orac
  le-character/03_visual-assets/001_asset-000314_hust-obc-cat-0349_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0349/G_0349_甲225(甲).png`
- asset id: `asset-000314`
...
- source category: `0349`
- validation class: `308`
- source image route: `HUST-OBC/deciphered/0349/G_0349_甲225(甲).png`
- asset id: `asset-000314`
...
- English observation: `The small light image shows a thin descending curved
  stroke, a short upper mark, and a detached curved mark at the right.`
- 中文观察: `浅色小图像有纤细下行弧笔画、上方短痕迹，右侧另有分离的弧形痕迹。`
...
- dataset label text: `㕓`
- dataset label codepoints: `U+3553`
...
- Which source records identify obs-char-000309 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000309？
