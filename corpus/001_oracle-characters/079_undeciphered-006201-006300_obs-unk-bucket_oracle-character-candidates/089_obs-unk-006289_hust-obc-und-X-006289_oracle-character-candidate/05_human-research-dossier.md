# obs-unk-006289 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/079_undeciphered-006
  201-006300_obs-unk-bucket_oracle-character-candidates/089_obs-unk-006289_h
  ust-obc-und-X-006289_oracle-character-candidate/03_visual-assets/001_asset
  -007881_hust-obc-und-X-006289_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1845/X_？_4817_1.png`
- asset id: `asset-007881`
...
- source class: `HUST-OBC/undeciphered/X/1845/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1845/X_？_4817_1.png`
...
- Which source records identify obs-unk-006289 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006289？
