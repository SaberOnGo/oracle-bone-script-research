...
- Local image / 本地图像:
  `03_visual-assets/001_asset-001114_hust-obc-cat-1239_1240_glyph.png`
- Local metadata / 本地 metadata:
  `03_visual-assets/001_asset-001114_hust-obc-cat-1239_1240_glyph.yaml`
- Source image path / 来源图像路径:
  `HUST-OBC/deciphered/1239_1240/1239/G_1239_上(2).從(甲).16(楚).png`
