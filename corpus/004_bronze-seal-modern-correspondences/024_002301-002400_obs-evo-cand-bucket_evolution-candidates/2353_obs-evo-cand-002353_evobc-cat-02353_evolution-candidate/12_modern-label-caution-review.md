# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002353
...
- EVOBC candidate category: `evobc-evo-cat-02353`.
- Source label for search only: `孿`.
- Source codepoints for search only: `U+5B7F`.
