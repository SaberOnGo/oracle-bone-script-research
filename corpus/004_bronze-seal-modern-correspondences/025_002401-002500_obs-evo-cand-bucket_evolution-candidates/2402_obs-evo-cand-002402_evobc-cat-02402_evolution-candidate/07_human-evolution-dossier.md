...
- External category reference: `evobc-cat-02402`
- Source category ID: `02402`
- Source label for human review: `宽`
- Source codepoints: `U+5BBD`
...
- `obs-evo-cand-002402-route-category-staging`
...
- `obs-evo-cand-002402-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002402-route-evolution-graph`
