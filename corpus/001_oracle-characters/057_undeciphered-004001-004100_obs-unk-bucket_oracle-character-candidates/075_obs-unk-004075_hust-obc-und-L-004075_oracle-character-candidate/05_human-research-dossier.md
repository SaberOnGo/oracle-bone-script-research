# obs-unk-004075 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004075`
- primary external id: `hust-obc-und-L-004075`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/075_obs-unk-004075_h
  ust-obc-und-L-004075_oracle-character-candidate/03_visual-assets/001_asset
  -005668_hust-obc-und-L-004075_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4075/L_？_8734.jpg`
- asset id: `asset-005668`
...
- source class: `HUST-OBC/undeciphered/L/4075/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4075/L_？_8734.jpg`
- asset id: `asset-005668`
...
- English observation: A short curved or horizontal trace spans the top. Below
  it are slanting side traces and a compact angular lower outline with a dark
  center; the joins between the upper and lower marks are not fully visible.
...
- Which source records identify obs-unk-004075 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004075？
