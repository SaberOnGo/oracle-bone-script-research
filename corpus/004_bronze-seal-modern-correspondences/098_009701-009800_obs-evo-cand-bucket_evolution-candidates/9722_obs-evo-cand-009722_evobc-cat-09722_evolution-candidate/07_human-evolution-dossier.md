...
- Project ID: `obs-evo-cand-009722`
- EVOBC category candidate ID: `evobc-evo-cat-09722`
- External category reference: `evobc-cat-09722`
- Source category ID: `09722`
- Source label for human review: `陈`
- Source codepoints: `U+9648`
...
- `obs-evo-cand-009722-route-category-staging`
...
- `obs-evo-cand-009722-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009722-route-evolution-graph`
