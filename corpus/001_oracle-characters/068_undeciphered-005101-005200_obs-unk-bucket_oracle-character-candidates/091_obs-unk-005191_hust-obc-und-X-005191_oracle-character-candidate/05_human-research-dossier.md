# obs-unk-005191 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/068_undeciphered-005
  101-005200_obs-unk-bucket_oracle-character-candidates/091_obs-unk-005191_h
  ust-obc-und-X-005191_oracle-character-candidate/03_visual-assets/001_asset
  -006784_hust-obc-und-X-005191_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/747/X_？_7712_1.png`
- asset id: `asset-006784`
...
- source class: `HUST-OBC/undeciphered/X/747/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/747/X_？_7712_1.png`
- asset id: `asset-006784`
...
- Which source records identify obs-unk-005191 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005191？
