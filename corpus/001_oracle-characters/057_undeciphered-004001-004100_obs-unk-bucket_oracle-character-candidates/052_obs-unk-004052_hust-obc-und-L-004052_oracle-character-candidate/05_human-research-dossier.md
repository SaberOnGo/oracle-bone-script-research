# obs-unk-004052 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004052`
- primary external id: `hust-obc-und-L-004052`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/052_obs-unk-004052_h
  ust-obc-und-L-004052_oracle-character-candidate/03_visual-assets/001_asset
  -005645_hust-obc-und-L-004052_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4052/L_？_8662.jpg`
- asset id: `asset-005645`
...
- source class: `HUST-OBC/undeciphered/L/4052/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4052/L_？_8662.jpg`
- asset id: `asset-005645`
...
- English observation: A long dark stroke slopes down into a compact lower
  cluster. The lower cluster includes a wedge-like outline and a small
  enclosed or recessed mark on the right. The outer joins remain uncertain.
- 中文观察：一条较长的深色痕迹斜向下进入紧凑的下部痕迹组。下部包含近似
  楔形的轮廓，右侧有小型封闭或凹入痕迹。外部连接点仍待核查。
...
- Which source records identify obs-unk-004052 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004052？
