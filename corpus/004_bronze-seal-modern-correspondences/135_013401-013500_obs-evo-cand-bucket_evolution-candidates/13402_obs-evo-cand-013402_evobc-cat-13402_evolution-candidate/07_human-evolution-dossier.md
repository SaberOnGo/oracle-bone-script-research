...
- External category reference: `evobc-cat-13402`
- Source category ID: `13402`
- Source label for human review: `𬬖`
- Source codepoints: `U+2CB16`
...
- `obs-evo-cand-013402-route-category-staging`
...
- `obs-evo-cand-013402-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013402-route-evolution-graph`
