...
- 项目 ID: `obs-char-001444`
- 首选外部 ID: `hust-obc-cat-1618_1619`
- 来源 ID: `src-hust-obc`
...
- 来源图像路线数: `1`
- 本地复核图像数: `1`
- 首个来源图像名: `G_1618_寧滬1.500(甲).png`
- 首个本地图像名: `001_asset-001449_hust-obc-cat-1618_1619_glyph.png`
