# obs-char-000913 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000913`
- primary external id: `hust-obc-cat-1028`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/913_obs-char-000913_hust-obc-cat-1028_orac
  le-character/03_visual-assets/001_asset-000918_hust-obc-cat-1028_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1028/G_1028_拾12.10(甲).png`
- asset id: `asset-000918`
...
- source category: `1028`
- validation class: `912`
- source image route: `HUST-OBC/deciphered/1028/G_1028_拾12.10(甲).png`
- asset id: `asset-000918`
...
- English observation: `Two small leaf-like loops at the top lead into a
  long central stem with diagonal lower side strokes.`
- 中文观察: `顶部两个叶片状小环连接长中央笔干，下部两侧有斜向笔。`
...
- dataset label text: `㟺`
- dataset label codepoints: `U+37FA`
...
- Which source records identify obs-char-000913 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000913？
