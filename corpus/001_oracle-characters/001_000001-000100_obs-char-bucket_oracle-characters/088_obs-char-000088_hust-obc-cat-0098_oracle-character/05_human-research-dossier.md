# obs-char-000088 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/088_obs-char-000088_hust-obc-cat-0098_orac
  le-character/03_visual-assets/001_asset-000093_hust-obc-cat-0098_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0098/H_0098_6136A_0.png`
- asset id: `asset-000093`
...
- source category: `0098`
- validation class: `87`
- source image route: `HUST-OBC/deciphered/0098/H_0098_6136A_0.png`
- asset id: `asset-000093`
...
- English observation: `The enlarged image shows a central descending stroke
  crossed by broad diagonal strokes, with a separate curved stroke on the
  right.`
...
- dataset label text: `㑘`
- dataset label codepoints: `U+3458`
...
- filename catalog route clues: `catalog-like filename clue: H_0098
  (H_0098_6136A_0.png)`
...
- Which source records identify obs-char-000088 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000088？
