...
Project ID: `obs-evo-cand-001349`
...
- Project ID: `obs-evo-cand-001349`
- EVOBC category candidate ID: `evobc-evo-cat-01349`
- External category reference: `evobc-cat-01349`
- Source category ID: `01349`
- Source label for human review: `匭`
- Source codepoints: `U+532D`
...
- `obs-evo-cand-001349-route-category-staging`
...
- `obs-evo-cand-001349-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001349-route-evolution-graph`
