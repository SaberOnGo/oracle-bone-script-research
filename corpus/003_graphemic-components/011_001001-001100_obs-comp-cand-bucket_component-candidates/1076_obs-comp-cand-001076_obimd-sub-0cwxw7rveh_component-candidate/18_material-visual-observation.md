# Material Visual Observation / obs-comp-cand-001076 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001076`
- External reference / 外部参照: `obimd-sub-0cwxw7rveh`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014626_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0cwxw7rveh/0cwxw7rveh/02ne7wkfna.png`
- Checksum / 校验和:
  `b920c71e703261a923f8053d937207fe590ef72f4ef1c5064435eb2c58ca5547`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.93%.
- Marked-pixel bounds: (82,46)–(167,203); span 86 × 158 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.93%。
- 痕迹范围：(82,46)–(167,203)；跨度86 × 158 px；痕迹矩形高于宽。
