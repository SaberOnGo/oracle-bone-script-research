# Material Visual Observation / obs-comp-cand-001257 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001257`
- External reference / 外部参照: `obimd-sub-lzbougefv1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015495_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/74alaf1szs/lzbougefv1/lzbougefv1.png`
- Checksum / 校验和:
  `7708022ce8a2e5f4cfff927273a464d9c034bd835c5f16b898f0a36d6900d827`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.42%.
- Marked-pixel bounds: (69,31)–(186,213); span 118 × 183 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.42%。
- 痕迹范围：(69,31)–(186,213)；跨度118 × 183 px；痕迹矩形高于宽。
