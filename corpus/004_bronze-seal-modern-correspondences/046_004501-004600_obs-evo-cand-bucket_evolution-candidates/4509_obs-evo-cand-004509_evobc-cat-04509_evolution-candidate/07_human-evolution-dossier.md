...
- External category reference: `evobc-cat-04509`
- Source category ID: `04509`
- Source label for human review: `汨`
- Source codepoints: `U+6C68`
...
- `obs-evo-cand-004509-route-category-staging`
...
- `obs-evo-cand-004509-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004509-route-evolution-graph`
