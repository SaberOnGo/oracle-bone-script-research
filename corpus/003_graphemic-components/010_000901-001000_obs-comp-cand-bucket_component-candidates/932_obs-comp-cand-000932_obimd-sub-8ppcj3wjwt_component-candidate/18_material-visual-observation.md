# Material Visual Observation / obs-comp-cand-000932 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000932`
- External reference / 外部参照: `obimd-sub-8ppcj3wjwt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014015_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/8ppcj3wjwt/8ppcj3wjwt/8ppcj3wjwt.png`
- Checksum / 校验和:
  `5cbf3fd1da2eb5c2d31742006adbda169c4ee02007a1dfa51fdfd9402a79944a`
...
- Marked-pixel bounds: (60,36)–(189,217); span 130 × 182 px; the marked
...
- 痕迹范围：(60,36)–(189,217)；跨度130 × 182 px；痕迹矩形高于宽。
