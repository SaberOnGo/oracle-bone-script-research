...
- Yingguo / 英国所藏: `y1867` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `553` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `409` in source row; primary catalog entry pending
- Heji / 合集: `40817` in source row; primary catalog entry pending
