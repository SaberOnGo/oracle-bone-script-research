...
- `obs-evo-cand-002687-route-category-staging`
...
- `obs-evo-cand-002687-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002687-route-evolution-graph`
