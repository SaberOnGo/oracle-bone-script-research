...
Project ID: `obs-evo-cand-008347`
...
- Project ID: `obs-evo-cand-008347`
- EVOBC category candidate ID: `evobc-evo-cat-08347`
- External category reference: `evobc-cat-08347`
- Source category ID: `08347`
- Source label for human review: `譇`
- Source codepoints: `U+8B47`
...
- `obs-evo-cand-008347-route-category-staging`
...
- `obs-evo-cand-008347-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008347-route-evolution-graph`
