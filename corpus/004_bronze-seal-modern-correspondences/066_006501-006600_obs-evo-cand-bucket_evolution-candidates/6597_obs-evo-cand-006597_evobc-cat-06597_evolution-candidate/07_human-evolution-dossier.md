...
Project ID: `obs-evo-cand-006597`
...
- Project ID: `obs-evo-cand-006597`
- EVOBC category candidate ID: `evobc-evo-cat-06597`
- External category reference: `evobc-cat-06597`
- Source category ID: `06597`
- Source label for human review: `締`
- Source codepoints: `U+7DE0`
...
- `obs-evo-cand-006597-route-category-staging`
...
- `obs-evo-cand-006597-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006597-route-evolution-graph`
