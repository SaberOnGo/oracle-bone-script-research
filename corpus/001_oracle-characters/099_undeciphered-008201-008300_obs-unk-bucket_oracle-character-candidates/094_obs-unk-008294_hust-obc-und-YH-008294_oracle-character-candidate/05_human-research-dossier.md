# obs-unk-008294 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008294`
- primary external id: `hust-obc-und-YH-008294`
...
- local review image route: `corpus/001_oracle-characters/099_undeciphered-008
  201-008300_obs-unk-bucket_oracle-character-candidates/094_obs-unk-008294_h
  ust-obc-und-YH-008294_oracle-character-candidate/03_visual-assets/001_asse
  t-009885_hust-obc-und-YH-008294_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/609A0/H_？_609A0_0.png`
- asset id: `asset-009885`
...
- source class: `HUST-OBC/undeciphered/Y+H/609A0/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/609A0/H_？_609A0_0.png`
- asset id: `asset-009885`
...
- Which source records identify obs-unk-008294 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008294？
