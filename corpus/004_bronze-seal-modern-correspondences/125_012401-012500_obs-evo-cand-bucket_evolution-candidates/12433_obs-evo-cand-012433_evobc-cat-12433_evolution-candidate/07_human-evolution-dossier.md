...
- External category reference: `evobc-cat-12433`
- Source category ID: `12433`
- Source label for human review: `𨛬`
- Source codepoints: `U+286EC`
...
- `obs-evo-cand-012433-route-category-staging`
...
- `obs-evo-cand-012433-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012433-route-evolution-graph`
