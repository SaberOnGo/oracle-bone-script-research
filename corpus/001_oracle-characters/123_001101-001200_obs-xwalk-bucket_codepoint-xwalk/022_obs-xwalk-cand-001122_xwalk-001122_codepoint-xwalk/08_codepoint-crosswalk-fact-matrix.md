...
|---|---|---|
| Source Codepoint Route | `U+38DB` | not identity |
| HUST candidate route | `hust-obc-cat-1253` | not reading |
| OBIMD route | `obimd-main-cand-002593` | not component |
| EVOBC route | `pending route` | not evolution |
| Source and rights trail | `source_marked_risk_noted` | source-marked risk note required |
| Missing evidence route | `matched_obimd_by_codepoint` | not decipherment |
