...
Project ID: `obs-insc-cw-cand-000466`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000466`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000466` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y2367` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `267` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `3` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `41322` [route_present_image_or_text_not_collected]
