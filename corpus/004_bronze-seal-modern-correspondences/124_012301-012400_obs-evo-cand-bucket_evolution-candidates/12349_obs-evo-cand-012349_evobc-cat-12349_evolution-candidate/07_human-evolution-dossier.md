...
- Project ID: `obs-evo-cand-012349`
- EVOBC category candidate ID: `evobc-evo-cat-12349`
- External category reference: `evobc-cat-12349`
- Source category ID: `12349`
- Source label for human review: `𨒋`
- Source codepoints: `U+2848B`
...
- `obs-evo-cand-012349-route-category-staging`
...
- `obs-evo-cand-012349-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012349-route-evolution-graph`
