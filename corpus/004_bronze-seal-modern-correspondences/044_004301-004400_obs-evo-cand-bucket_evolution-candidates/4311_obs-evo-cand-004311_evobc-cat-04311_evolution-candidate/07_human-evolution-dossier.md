...
- External category reference: `evobc-cat-04311`
- Source category ID: `04311`
- Source label for human review: `櫑`
- Source codepoints: `U+6AD1`
...
- `obs-evo-cand-004311-route-category-staging`
...
- `obs-evo-cand-004311-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004311-route-evolution-graph`
