...
- External category reference: `evobc-cat-07902`
- Source category ID: `07902`
- Source label for human review: `行`
- Source codepoints: `U+884C`
- Image reference count in source metadata: `335`
...
- `obs-evo-cand-007902-route-category-staging`
...
- `obs-evo-cand-007902-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007902-route-evolution-graph`
