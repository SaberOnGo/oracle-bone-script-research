# obs-unk-004397 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/097_obs-unk-004397_h
  ust-obc-und-L-004397_oracle-character-candidate/03_visual-assets/001_asset
  -005990_hust-obc-und-L-004397_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4397/L_？_9788.jpg`
- asset id: `asset-005990`
...
- source class: `HUST-OBC/undeciphered/L/4397/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4397/L_？_9788.jpg`
- asset id: `asset-005990`
...
- English observation: `A small upper-left enclosure leads to long`
  `descending traces with uneven curved terminals.`
- 中文观察: `左上小轮廓下有数条下伸痕迹，末端向两侧分开且弯曲不均。`
...
- Which source records identify obs-unk-004397 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004397？
