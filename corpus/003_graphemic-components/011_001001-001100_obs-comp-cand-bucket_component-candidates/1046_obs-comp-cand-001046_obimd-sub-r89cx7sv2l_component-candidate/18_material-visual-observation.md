# Material Visual Observation / obs-comp-cand-001046 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001046`
- External reference / 外部参照: `obimd-sub-r89cx7sv2l`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014596_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/r89cx7sv2l/r89cx7sv2l/r89cx7sv2l.png`
- Checksum / 校验和:
  `5ac976d3c4863789423f7501cc8ffb427c1a60acfdf21df4b3d4be905138c6e9`
...
- Marked-pixel bounds: (76,15)–(162,232); span 87 × 218 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.37%。
- 痕迹范围：(76,15)–(162,232)；跨度87 × 218 px；痕迹矩形高于宽。
