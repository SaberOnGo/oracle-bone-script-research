...
- Project ID: `obs-evo-cand-008606`
- EVOBC category candidate ID: `evobc-evo-cat-08606`
- External category reference: `evobc-cat-08606`
- Source category ID: `08606`
- Source label for human review: `贏`
- Source codepoints: `U+8D0F`
...
- `obs-evo-cand-008606-route-category-staging`
...
- `obs-evo-cand-008606-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008606-route-evolution-graph`
