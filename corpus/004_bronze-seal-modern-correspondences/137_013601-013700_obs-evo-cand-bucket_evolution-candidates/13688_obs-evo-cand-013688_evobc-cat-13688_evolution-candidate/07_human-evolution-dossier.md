...
Project ID: `obs-evo-cand-013688`
...
- Project ID: `obs-evo-cand-013688`
- EVOBC category candidate ID: `evobc-evo-cat-13688`
- External category reference: `evobc-cat-13688`
- Source category ID: `13688`
- Source label for human review: `𮪪`
- Source codepoints: `U+2EAAA`
...
- `obs-evo-cand-013688-route-category-staging`
...
- `obs-evo-cand-013688-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013688-route-evolution-graph`
