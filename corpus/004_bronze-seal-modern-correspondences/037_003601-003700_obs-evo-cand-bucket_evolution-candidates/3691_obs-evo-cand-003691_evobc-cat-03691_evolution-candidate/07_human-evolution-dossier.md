...
- External category reference: `evobc-cat-03691`
- Source category ID: `03691`
- Source label for human review: `旰`
- Source codepoints: `U+65F0`
...
- `obs-evo-cand-003691-route-category-staging`
...
- `obs-evo-cand-003691-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003691-route-evolution-graph`
