# obs-char-000573 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000573`
- primary external id: `hust-obc-cat-0649`
...
- local review image route: `corpus/001_oracle-characters/006_000501-000600_ob
  s-char-bucket_oracle-characters/573_obs-char-000573_hust-obc-cat-0649_orac
  le-character/03_visual-assets/001_asset-000578_hust-obc-cat-0649_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0649/G_0649_京津190合9350.png`
- asset id: `asset-000578`
...
- source category: `0649`
- validation class: `572`
- source image route: `HUST-OBC/deciphered/0649/G_0649_京津190合9350.png`
- asset id: `asset-000578`
...
- English observation: `Two close parallel wavering strokes descend together
  from a small angular upper turn and remain narrowly separated along most
  of their length.`
- 中文观察: `两条紧邻平行波折笔从小型上部折转处共同下行，绝大部分长度保持狭窄间隔。`
...
- dataset label text: `㙿`
- dataset label codepoints: `U+367F`
...
- filename catalog route clues: `Heji-like filename clue: 合9350
  (G_0649_京津190合9350.png)`
...
- Which source records identify obs-char-000573 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000573？
