# obs-char-000946 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000946`
- primary external id: `hust-obc-cat-1063`
...
- local review image route: `corpus/001_oracle-characters/010_000901-001000_ob
  s-char-bucket_oracle-characters/946_obs-char-000946_hust-obc-cat-1063_orac
  le-character/03_visual-assets/001_asset-000951_hust-obc-cat-1063_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1063/G_1063_京都673合18370.png`
- asset id: `asset-000951`
...
- source category: `1063`
- validation class: `945`
- source image route: `HUST-OBC/deciphered/1063/G_1063_京都673合18370.png`
- asset id: `asset-000951`
...
- English observation: `An angular upper enclosure leads into a small
  rounded lower cluster; a long curved stroke descends at right.`
- 中文观察: `折角上部闭合轮廓连接小型圆弧下部笔群；右侧有长弯曲下行笔。`
...
- dataset label text: `㠝`
- dataset label codepoints: `U+381D`
...
- filename catalog route clues: `Heji-like filename clue: 合18370
  (G_1063_京都673合18370.png)`
...
- Which source records identify obs-char-000946 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000946？
