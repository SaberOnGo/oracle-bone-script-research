# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002335
...
- EVOBC candidate category: `evobc-evo-cat-02335`.
- Source label for search only: `孜`.
- Source codepoints for search only: `U+5B5C`.
