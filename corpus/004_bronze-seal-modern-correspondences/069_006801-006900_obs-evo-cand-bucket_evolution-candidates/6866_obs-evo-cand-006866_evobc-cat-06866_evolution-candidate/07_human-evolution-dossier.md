...
- External category reference: `evobc-cat-06866`
- Source category ID: `06866`
- Source label for human review: `羸`
...
- `obs-evo-cand-006866-route-category-staging`
...
- `obs-evo-cand-006866-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006866-route-evolution-graph`
