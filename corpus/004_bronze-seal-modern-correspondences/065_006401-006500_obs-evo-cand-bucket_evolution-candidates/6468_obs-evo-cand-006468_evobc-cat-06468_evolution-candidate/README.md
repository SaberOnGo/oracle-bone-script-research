# obs-evo-cand-006468 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-006468`
- EVOBC category candidate ID: `evobc-evo-cat-06468`
- External category ref: `evobc-cat-06468`
- Source label: `索`
- Source codepoints: `U+7D22`
- Image reference count: `69`
- Era token counts: `BI:6;CS:2;OBC:16;SS:2;WSC:43`
- Source token counts: `Book:28;Web:41`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 16 image references
