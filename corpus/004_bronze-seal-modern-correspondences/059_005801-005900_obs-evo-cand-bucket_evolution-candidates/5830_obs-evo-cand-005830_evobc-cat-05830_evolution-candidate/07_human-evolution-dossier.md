...
- External category reference: `evobc-cat-05830`
- Source category ID: `05830`
- Source label for human review: `睡`
- Source codepoints: `U+7761`
...
- `obs-evo-cand-005830-route-category-staging`
...
- `obs-evo-cand-005830-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005830-route-evolution-graph`
