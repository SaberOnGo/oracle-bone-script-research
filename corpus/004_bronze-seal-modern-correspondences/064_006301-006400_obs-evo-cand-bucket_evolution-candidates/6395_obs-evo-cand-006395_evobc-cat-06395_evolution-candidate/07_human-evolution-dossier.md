...
- External category reference: `evobc-cat-06395`
- Source category ID: `06395`
- Source label for human review: `粒`
...
- `obs-evo-cand-006395-route-category-staging`
...
- `obs-evo-cand-006395-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006395-route-evolution-graph`
