...
Project ID: `obs-evo-cand-008063`
...
- Project ID: `obs-evo-cand-008063`
- EVOBC category candidate ID: `evobc-evo-cat-08063`
- External category reference: `evobc-cat-08063`
- Source category ID: `08063`
- Source label for human review: `覜`
- Source codepoints: `U+899C`
...
- `obs-evo-cand-008063-route-category-staging`
...
- `obs-evo-cand-008063-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008063-route-evolution-graph`
