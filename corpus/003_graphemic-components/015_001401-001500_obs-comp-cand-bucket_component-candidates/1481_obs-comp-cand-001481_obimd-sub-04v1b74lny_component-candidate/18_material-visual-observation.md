# Material Visual Observation / obs-comp-cand-001481 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001481`
- External reference / 外部参照: `obimd-sub-04v1b74lny`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016058_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3lizt17yhy/04v1b74lny/04v1b74lny.png`
- Checksum / 校验和:
  `52f65ee954cc633aa59a2318a3df9a8e3ae7d665bd575dab1fb093b1ba070715`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.53%.
- Marked-pixel bounds: (78,33)–(174,210); span 97 × 178 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.53%。
- 痕迹范围：(78,33)–(174,210)；跨度97 × 178 px；痕迹矩形高于宽。
