...
Project ID: `obs-evo-cand-004449`
...
- Project ID: `obs-evo-cand-004449`
- EVOBC category candidate ID: `evobc-evo-cat-04449`
- External category reference: `evobc-cat-04449`
- Source category ID: `04449`
- Source label for human review: `比`
- Source codepoints: `U+6BD4`
...
- `obs-evo-cand-004449-route-category-staging`
...
- `obs-evo-cand-004449-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004449-route-evolution-graph`
