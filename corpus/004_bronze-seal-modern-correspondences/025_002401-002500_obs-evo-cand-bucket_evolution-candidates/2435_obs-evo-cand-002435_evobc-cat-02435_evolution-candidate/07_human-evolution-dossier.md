...
- Project ID: `obs-evo-cand-002435`
- EVOBC category candidate ID: `evobc-evo-cat-02435`
- External category reference: `evobc-cat-02435`
- Source category ID: `02435`
- Source label for human review: `實`
- Source codepoints: `U+5BE6`
...
- `obs-evo-cand-002435-route-category-staging`
...
- `obs-evo-cand-002435-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002435-route-evolution-graph`
