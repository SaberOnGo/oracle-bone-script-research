...
Project ID: `obs-evo-cand-006831`
...
- Project ID: `obs-evo-cand-006831`
- EVOBC category candidate ID: `evobc-evo-cat-06831`
- External category reference: `evobc-cat-06831`
- Source category ID: `06831`
- Source label for human review: `罿`
- Source codepoints: `U+7F7F`
...
- `obs-evo-cand-006831-route-category-staging`
...
- `obs-evo-cand-006831-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006831-route-evolution-graph`
