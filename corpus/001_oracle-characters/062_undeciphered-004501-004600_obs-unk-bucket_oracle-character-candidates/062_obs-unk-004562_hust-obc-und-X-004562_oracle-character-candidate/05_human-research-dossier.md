# obs-unk-004562 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/062_obs-unk-004562_h
  ust-obc-und-X-004562_oracle-character-candidate/03_visual-assets/001_asset
  -006155_hust-obc-und-X-004562_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/118/X_？_8298_1.png`
- asset id: `asset-006155`
...
- source class: `HUST-OBC/undeciphered/X/118/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/118/X_？_8298_1.png`
- asset id: `asset-006155`
...
- English observation: `Outer outline, inner lobes, and central point recorded.`
- 中文观察: `已记录外部轮廓、内部区域和中央尖点。`
...
- Which source records identify obs-unk-004562 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004562？
