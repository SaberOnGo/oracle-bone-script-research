...
- External category reference: `evobc-cat-00508`
- Source category ID: `00508`
- Source label for human review: `䤥`
- Source codepoints: `U+4925`
...
- `obs-evo-cand-000508-route-category-staging`
...
- `obs-evo-cand-000508-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000508-route-evolution-graph`
