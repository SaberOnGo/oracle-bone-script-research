# obs-unk-004419 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004419`
- primary external id: `hust-obc-und-L-004419`
...
- local review image route: `corpus/001_oracle-characters/061_undeciphered-004
  401-004500_obs-unk-bucket_oracle-character-candidates/019_obs-unk-004419_h
  ust-obc-und-L-004419_oracle-character-candidate/03_visual-assets/001_asset
  -006012_hust-obc-und-L-004419_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4419/L_？_9893.jpg`
- asset id: `asset-006012`
...
- source class: `HUST-OBC/undeciphered/L/4419/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4419/L_？_9893.jpg`
- asset id: `asset-006012`
...
- English observation: `Long outer traces frame an angular upper outline`
  `with small marks.`
- 中文观察: `长外缘痕迹围住带有小痕迹的上部角状轮廓。`
...
- Which source records identify obs-unk-004419 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004419？
