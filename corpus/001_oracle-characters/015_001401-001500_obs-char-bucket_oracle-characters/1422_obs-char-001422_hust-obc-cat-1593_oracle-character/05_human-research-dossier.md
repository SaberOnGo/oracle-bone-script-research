# obs-char-001422 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1422_obs-char-001422_hust-obc-cat-1593_ora
  cle-character/03_visual-assets/001_asset-001427_hust-obc-cat-1593_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1593/G_1593_合17952.png`
- asset id: `asset-001427`
...
- source category: `1593`
- validation class: `1421`
- source image route: `HUST-OBC/deciphered/1593/G_1593_合17952.png`
- asset id: `asset-001427`
...
- dataset label text: `㨯`
- dataset label codepoints: `U+3A2F`
...
- filename catalog route clues: `Heji-like filename clue: 合17952
  (G_1593_合17952.png)`
...
- Which source records identify obs-char-001422 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001422？
