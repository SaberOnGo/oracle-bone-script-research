...
Project ID: `obs-evo-cand-006830`
...
- Project ID: `obs-evo-cand-006830`
- EVOBC category candidate ID: `evobc-evo-cat-06830`
- External category reference: `evobc-cat-06830`
- Source category ID: `06830`
- Source label for human review: `罾`
- Source codepoints: `U+7F7E`
...
- `obs-evo-cand-006830-route-category-staging`
...
- `obs-evo-cand-006830-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006830-route-evolution-graph`
