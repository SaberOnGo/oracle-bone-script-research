...
- External category reference: `evobc-cat-04604`
- Source category ID: `04604`
- Source label for human review: `泲`
- Source codepoints: `U+6CF2`
...
- `obs-evo-cand-004604-route-category-staging`
...
- `obs-evo-cand-004604-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004604-route-evolution-graph`
