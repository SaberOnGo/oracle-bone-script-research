# obs-char-000675 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000675`
- primary external id: `hust-obc-cat-0766`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/675_obs-char-000675_hust-obc-cat-0766_orac
  le-character/03_visual-assets/001_asset-000680_hust-obc-cat-0766_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0766/G_0766_前2.3.2合36945黃組.png`
- asset id: `asset-000680`
...
- source category: `0766`
- validation class: `674`
- source image route: `HUST-OBC/deciphered/0766/G_0766_前2.3.2合36945黃組.png`
- asset id: `asset-000680`
...
- English observation: `A small upper rectangular open form is separated
  from a lower angular cluster with a short top bar, crossed diagonals, and
  one long central descent.`
- 中文观察: `小型上部矩形开口形与下部折角笔群分离；下群带短顶横、交叉斜笔和一条长中央下笔。`
...
- dataset label text: `㛴`
- dataset label codepoints: `U+36F4`
...
- filename catalog route clues: `Heji-like filename clue: 合36945
  (G_0766_前2.3.2合36945黃組.png)`
...
- Which source records identify obs-char-000675 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000675？
