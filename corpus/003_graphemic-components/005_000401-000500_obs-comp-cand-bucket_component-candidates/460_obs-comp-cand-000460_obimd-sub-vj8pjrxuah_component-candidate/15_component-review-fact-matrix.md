# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-000460
...
| Glyph or codepoint route / 字形或码位路线 | 1 OBIMD route rows; examples U+F2BA8 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
