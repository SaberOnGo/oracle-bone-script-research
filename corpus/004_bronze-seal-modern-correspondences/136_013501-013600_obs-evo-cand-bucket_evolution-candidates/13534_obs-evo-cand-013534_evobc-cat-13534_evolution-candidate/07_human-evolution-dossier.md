...
Project ID: `obs-evo-cand-013534`
...
- Project ID: `obs-evo-cand-013534`
- EVOBC category candidate ID: `evobc-evo-cat-13534`
- External category reference: `evobc-cat-13534`
- Source category ID: `13534`
- Source label for human review: `𭡤`
- Source codepoints: `U+2D864`
...
- `obs-evo-cand-013534-route-category-staging`
...
- `obs-evo-cand-013534-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013534-route-evolution-graph`
