# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001435
...
| --- | --- | --- | --- |
| `obimd-glyph-link-021846` | 󸏕 | `U+F83D5` | `reviewed_metadata_only` |
| `obimd-glyph-link-021847` | 󸏖 | `U+F83D6` | `reviewed_metadata_only` |
