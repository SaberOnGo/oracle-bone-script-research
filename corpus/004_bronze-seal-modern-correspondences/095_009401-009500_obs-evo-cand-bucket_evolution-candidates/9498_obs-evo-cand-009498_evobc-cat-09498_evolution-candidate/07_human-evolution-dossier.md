...
Project ID: `obs-evo-cand-009498`
...
- Project ID: `obs-evo-cand-009498`
- EVOBC category candidate ID: `evobc-evo-cat-09498`
- External category reference: `evobc-cat-09498`
- Source category ID: `09498`
- Source label for human review: `鏐`
- Source codepoints: `U+93D0`
...
- `obs-evo-cand-009498-route-category-staging`
...
- `obs-evo-cand-009498-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009498-route-evolution-graph`
