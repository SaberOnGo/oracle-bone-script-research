...
- External category reference: `evobc-cat-10916`
- Source category ID: `10916`
- Source label for human review: `𠫹`
...
- `obs-evo-cand-010916-route-category-staging`
...
- `obs-evo-cand-010916-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010916-route-evolution-graph`
