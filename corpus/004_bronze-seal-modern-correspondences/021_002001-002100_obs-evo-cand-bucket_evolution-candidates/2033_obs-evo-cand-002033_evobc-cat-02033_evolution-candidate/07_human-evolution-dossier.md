...
- External category reference: `evobc-cat-02033`
- Source category ID: `02033`
- Source label for human review: `奊`
...
- `obs-evo-cand-002033-route-category-staging`
...
- `obs-evo-cand-002033-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002033-route-evolution-graph`
