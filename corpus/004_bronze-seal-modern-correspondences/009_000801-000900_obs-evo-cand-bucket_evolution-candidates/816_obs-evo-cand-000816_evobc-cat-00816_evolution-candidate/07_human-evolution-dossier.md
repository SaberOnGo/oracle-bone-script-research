...
- Project ID: `obs-evo-cand-000816`
- EVOBC category candidate ID: `evobc-evo-cat-00816`
- External category reference: `evobc-cat-00816`
- Source category ID: `00816`
- Source label for human review: `佩`
- Source codepoints: `U+4F69`
...
- `obs-evo-cand-000816-route-category-staging`
...
- `obs-evo-cand-000816-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000816-route-evolution-graph`
