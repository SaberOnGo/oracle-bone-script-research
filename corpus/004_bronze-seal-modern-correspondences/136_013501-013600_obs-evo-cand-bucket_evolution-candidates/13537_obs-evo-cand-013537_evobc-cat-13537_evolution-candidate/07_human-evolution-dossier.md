...
- External category reference: `evobc-cat-13537`
- Source category ID: `13537`
- Source label for human review: `𭤃`
- Source codepoints: `U+2D903`
...
- `obs-evo-cand-013537-route-category-staging`
...
- `obs-evo-cand-013537-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013537-route-evolution-graph`
