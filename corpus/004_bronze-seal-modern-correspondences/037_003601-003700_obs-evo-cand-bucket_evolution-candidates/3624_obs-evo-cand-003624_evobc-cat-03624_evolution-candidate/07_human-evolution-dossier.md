...
- Project ID: `obs-evo-cand-003624`
- EVOBC category candidate ID: `evobc-evo-cat-03624`
- External category reference: `evobc-cat-03624`
- Source category ID: `03624`
- Source label for human review: `斆`
- Source codepoints: `U+6586`
...
- `obs-evo-cand-003624-route-category-staging`
...
- `obs-evo-cand-003624-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003624-route-evolution-graph`
