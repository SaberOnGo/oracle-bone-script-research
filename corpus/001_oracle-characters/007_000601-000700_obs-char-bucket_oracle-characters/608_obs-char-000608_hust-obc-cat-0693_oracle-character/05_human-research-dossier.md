# obs-char-000608 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000608`
- primary external id: `hust-obc-cat-0693`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/608_obs-char-000608_hust-obc-cat-0693_orac
  le-character/03_visual-assets/001_asset-000613_hust-obc-cat-0693_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0693/X_0693_4936_1.png`
- asset id: `asset-000613`
...
- source category: `0693`
- validation class: `607`
- source image route: `HUST-OBC/deciphered/0693/X_0693_4936_1.png`
- asset id: `asset-000613`
...
- English observation: `A pointed hollow triangle sits above two thick
  horizontal bars and small openings; a forked lower form rises from a broad
  dark base.`
...
- dataset label text: `㚫`
- dataset label codepoints: `U+36AB`
...
- Which source records identify obs-char-000608 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000608？
