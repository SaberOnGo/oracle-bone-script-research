# obs-unk-006553 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006553`
- primary external id: `hust-obc-und-X-006553`
...
- local review image route: `corpus/001_oracle-characters/082_undeciphered-006
  501-006600_obs-unk-bucket_oracle-character-candidates/053_obs-unk-006553_h
  ust-obc-und-X-006553_oracle-character-candidate/03_visual-assets/001_asset
  -008144_hust-obc-und-X-006553_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/2109/X_？_5999_1.png`
- asset id: `asset-008144`
...
- source class: `HUST-OBC/undeciphered/X/2109/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/2109/X_？_5999_1.png`
- asset id: `asset-008144`
- source image count: `39`
...
- Which source records identify obs-unk-006553 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006553？
