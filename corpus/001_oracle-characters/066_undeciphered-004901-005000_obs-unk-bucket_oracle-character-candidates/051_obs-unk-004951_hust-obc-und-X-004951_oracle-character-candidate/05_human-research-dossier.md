# obs-unk-004951 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004951`
- primary external id: `hust-obc-und-X-004951`
...
- local review image route: `corpus/001_oracle-characters/066_undeciphered-004
  901-005000_obs-unk-bucket_oracle-character-candidates/051_obs-unk-004951_h
  ust-obc-und-X-004951_oracle-character-candidate/03_visual-assets/001_asset
  -006544_hust-obc-und-X-004951_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/507/X_？_7489_1.png`
- asset id: `asset-006544`
...
- A dense left group meets a right rounded opening and lower branches.
...
- source class: `HUST-OBC/undeciphered/X/507/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/507/X_？_7489_1.png`
- asset id: `asset-006544`
...
- Which source records identify obs-unk-004951 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004951？
