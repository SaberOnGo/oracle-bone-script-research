...
- External category reference: `evobc-cat-03302`
- Source category ID: `03302`
- Source label for human review: `抽`
- Source codepoints: `U+62BD`
...
- `obs-evo-cand-003302-route-category-staging`
...
- `obs-evo-cand-003302-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003302-route-evolution-graph`
