# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001269
...
| --- | --- | --- | --- |
| `obimd-glyph-link-019124` | 󀞁󷃪 | `U+C0781;U+F70EA` | `reviewed_metadata_only` |
| `obimd-glyph-link-019125` | 󷓳 | `U+F74F3` | `reviewed_metadata_only` |
