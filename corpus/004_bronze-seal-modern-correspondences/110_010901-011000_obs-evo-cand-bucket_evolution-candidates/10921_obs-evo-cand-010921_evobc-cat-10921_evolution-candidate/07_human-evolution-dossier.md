...
- Project ID: `obs-evo-cand-010921`
- EVOBC category candidate ID: `evobc-evo-cat-10921`
- External category reference: `evobc-cat-10921`
- Source category ID: `10921`
- Source label for human review: `𠬸`
- Source codepoints: `U+20B38`
...
- `obs-evo-cand-010921-route-category-staging`
...
- `obs-evo-cand-010921-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010921-route-evolution-graph`
