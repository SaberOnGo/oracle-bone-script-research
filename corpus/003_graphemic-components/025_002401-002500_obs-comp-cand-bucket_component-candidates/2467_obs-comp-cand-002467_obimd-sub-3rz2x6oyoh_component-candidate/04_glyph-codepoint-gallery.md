# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-002467
...
| --- | --- | --- | --- |
| `obimd-glyph-link-037937` | 󾃶 | `U+FE0F6` | `reviewed_metadata_only` |
| `obimd-glyph-link-037938` | 󾃷 | `U+FE0F7` | `reviewed_metadata_only` |
| `obimd-glyph-link-037939` | 󾃸 | `U+FE0F8` | `reviewed_metadata_only` |
