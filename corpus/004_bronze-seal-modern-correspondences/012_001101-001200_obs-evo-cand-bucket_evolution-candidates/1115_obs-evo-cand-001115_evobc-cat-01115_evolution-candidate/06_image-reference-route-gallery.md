...
- `obs-evo-cand-001115-route-category-staging`
...
- `obs-evo-cand-001115-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-001115-route-evolution-graph`
