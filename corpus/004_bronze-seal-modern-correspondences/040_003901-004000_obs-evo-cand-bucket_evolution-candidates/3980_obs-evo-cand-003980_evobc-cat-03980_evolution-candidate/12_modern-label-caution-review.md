# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-003980
...
- EVOBC candidate category: `evobc-evo-cat-03980`.
- Source label for search only: `柵`.
- Source codepoints for search only: `U+67F5`.
