# Material Visual Observation / obs-comp-cand-001470 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001470`
- External reference / 外部参照: `obimd-sub-fu6caa5q2a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016047_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fu6caa5q2a/fu6caa5q2a/fu6caa5q2a.png`
- Checksum / 校验和:
  `ce20e02a2cf9023ee339fc2f4c541db87bd4d6e311af2e1de08e0e537d694325`
...
- Marked-pixel bounds: (82,45)–(167,198); span 86 × 154 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.70%。
- 痕迹范围：(82,45)–(167,198)；跨度86 × 154 px；痕迹矩形高于宽。
