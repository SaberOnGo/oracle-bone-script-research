# obs-unk-006298 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-006298`
- primary external id: `hust-obc-und-X-006298`
...
- local review image route: `corpus/001_oracle-characters/079_undeciphered-006
  201-006300_obs-unk-bucket_oracle-character-candidates/098_obs-unk-006298_h
  ust-obc-und-X-006298_oracle-character-candidate/03_visual-assets/001_asset
  -007889_hust-obc-und-X-006298_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1854/X_？_5079_1.png`
- asset id: `asset-007889`
...
- source class: `HUST-OBC/undeciphered/X/1854/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1854/X_？_5079_1.png`
- asset id: `asset-007889`
...
- Which source records identify obs-unk-006298 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-006298？
