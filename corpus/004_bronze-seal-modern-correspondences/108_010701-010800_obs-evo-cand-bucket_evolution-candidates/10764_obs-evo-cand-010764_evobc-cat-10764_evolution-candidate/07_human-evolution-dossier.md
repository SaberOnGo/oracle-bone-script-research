...
- External category reference: `evobc-cat-10764`
- Source category ID: `10764`
- Source label for human review: `𠀞`
...
- `obs-evo-cand-010764-route-category-staging`
...
- `obs-evo-cand-010764-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010764-route-evolution-graph`
