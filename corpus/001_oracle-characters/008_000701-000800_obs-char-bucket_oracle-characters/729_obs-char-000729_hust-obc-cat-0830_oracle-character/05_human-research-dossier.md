# obs-char-000729 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/729_obs-char-000729_hust-obc-cat-0830_orac
  le-character/03_visual-assets/001_asset-000734_hust-obc-cat-0830_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0830/G_0830_佚383背(甲).png`
- asset id: `asset-000734`
...
- source category: `0830`
- validation class: `728`
- source image route: `HUST-OBC/deciphered/0830/G_0830_佚383背(甲).png`
- asset id: `asset-000734`
...
- English observation: `Three close upper uprights descend toward a central
  stem crossed by two horizontal bars; short diagonal branches spread from
  the lower junction.`
- 中文观察: `三条相邻上竖向中央干下收，中央干被两条横笔穿过；下部接点伸出数条短斜枝。`
...
- dataset label text: `㜴`
- dataset label codepoints: `U+3734`
...
- Which source records identify obs-char-000729 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000729？
