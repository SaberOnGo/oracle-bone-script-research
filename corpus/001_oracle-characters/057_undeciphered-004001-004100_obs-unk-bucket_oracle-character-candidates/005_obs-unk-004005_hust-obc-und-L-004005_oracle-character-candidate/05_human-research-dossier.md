# obs-unk-004005 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004005`
- primary external id: `hust-obc-und-L-004005`
...
- local review image route: `corpus/001_oracle-characters/057_undeciphered-004
  001-004100_obs-unk-bucket_oracle-character-candidates/005_obs-unk-004005_h
  ust-obc-und-L-004005_oracle-character-candidate/03_visual-assets/001_asset
  -005598_hust-obc-und-L-004005_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4005/L_？_8495.jpg`
- asset id: `asset-005598`
...
- source class: `HUST-OBC/undeciphered/L/4005/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4005/L_？_8495.jpg`
- asset id: `asset-005598`
...
- English observation: Two upright traces are joined by a lower horizontal or
  curved trace; the upper ends are rounded.
- 中文观察：两条直立痕迹由下部横向或弯曲痕迹连接，上端较圆。
...
- Which source records identify obs-unk-004005 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004005？
