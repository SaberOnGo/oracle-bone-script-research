# obs-unk-004134 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/034_obs-unk-004134_h
  ust-obc-und-L-004134_oracle-character-candidate/03_visual-assets/001_asset
  -005727_hust-obc-und-L-004134_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4134/L_？_8910.jpg`
- asset id: `asset-005727`
...
- source class: `HUST-OBC/undeciphered/L/4134/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4134/L_？_8910.jpg`
- asset id: `asset-005727`
...
- English observation: A narrow central trace has bent upper strokes;
  a rounded mark appears on the lower left.
- 中文观察：中央窄痕迹带上部折转痕迹；左下侧可见圆弧状痕迹。
...
- Which source records identify obs-unk-004134 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004134？
