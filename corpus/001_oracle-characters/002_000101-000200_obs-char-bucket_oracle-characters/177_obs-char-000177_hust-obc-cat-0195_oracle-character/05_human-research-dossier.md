# obs-char-000177 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000177`
- primary external id: `hust-obc-cat-0195`
...
- local review image route: `corpus/001_oracle-characters/002_000101-000200_ob
  s-char-bucket_oracle-characters/177_obs-char-000177_hust-obc-cat-0195_orac
  le-character/03_visual-assets/001_asset-000182_hust-obc-cat-0195_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0195/G_0195_乙6570反合9293反賓組.png`
- asset id: `asset-000182`
...
- source category: `0195`
- validation class: `176`
- source image route: `HUST-OBC/deciphered/0195/G_0195_乙6570反合9293反賓組.png`
- asset id: `asset-000182`
...
- English observation: `The image is a single broad inverted V-shaped form
  with two long tapering strokes meeting at the top.`
- 中文观察: `图像由单一宽大的倒 V 形构成，两道长而渐细的笔在上方相接。`
...
- dataset label text: `㒹`
- dataset label codepoints: `U+34B9`
...
- filename catalog route clues: `Heji-like filename clue: 合9293
...
- Which source records identify obs-char-000177 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000177？
