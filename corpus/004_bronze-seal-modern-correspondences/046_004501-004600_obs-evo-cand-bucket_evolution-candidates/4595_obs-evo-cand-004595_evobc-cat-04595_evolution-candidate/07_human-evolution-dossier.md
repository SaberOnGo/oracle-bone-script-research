...
- External category reference: `evobc-cat-04595`
- Source category ID: `04595`
- Source label for human review: `泩`
...
- `obs-evo-cand-004595-route-category-staging`
...
- `obs-evo-cand-004595-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004595-route-evolution-graph`
