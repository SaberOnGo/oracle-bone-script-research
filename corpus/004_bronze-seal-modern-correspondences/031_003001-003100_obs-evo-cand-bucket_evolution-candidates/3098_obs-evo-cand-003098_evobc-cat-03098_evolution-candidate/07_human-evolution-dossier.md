...
- External category reference: `evobc-cat-03098`
- Source category ID: `03098`
- Source label for human review: `愵`
...
- `obs-evo-cand-003098-route-category-staging`
...
- `obs-evo-cand-003098-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003098-route-evolution-graph`
