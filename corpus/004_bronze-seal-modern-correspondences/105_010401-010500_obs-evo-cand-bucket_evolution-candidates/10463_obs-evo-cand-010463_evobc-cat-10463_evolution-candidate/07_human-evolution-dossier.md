...
- External category reference: `evobc-cat-10463`
- Source category ID: `10463`
- Source label for human review: `鲸`
- Source codepoints: `U+9CB8`
...
- `obs-evo-cand-010463-route-category-staging`
...
- `obs-evo-cand-010463-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010463-route-evolution-graph`
