...
Project ID: `obs-evo-cand-000177`
...
- Project ID: `obs-evo-cand-000177`
- EVOBC category candidate ID: `evobc-evo-cat-00177`
- External category reference: `evobc-cat-00177`
- Source category ID: `00177`
- Source label for human review: `㮴`
- Source codepoints: `U+3BB4`
...
- `obs-evo-cand-000177-route-category-staging`
...
- `obs-evo-cand-000177-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000177-route-evolution-graph`
