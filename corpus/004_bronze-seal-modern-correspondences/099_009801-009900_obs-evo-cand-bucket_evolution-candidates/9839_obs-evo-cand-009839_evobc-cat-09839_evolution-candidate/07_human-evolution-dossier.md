...
Project ID: `obs-evo-cand-009839`
...
- Project ID: `obs-evo-cand-009839`
- EVOBC category candidate ID: `evobc-evo-cat-09839`
- External category reference: `evobc-cat-09839`
- Source category ID: `09839`
- Source label for human review: `雲`
- Source codepoints: `U+96F2`
...
- `obs-evo-cand-009839-route-category-staging`
...
- `obs-evo-cand-009839-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009839-route-evolution-graph`
