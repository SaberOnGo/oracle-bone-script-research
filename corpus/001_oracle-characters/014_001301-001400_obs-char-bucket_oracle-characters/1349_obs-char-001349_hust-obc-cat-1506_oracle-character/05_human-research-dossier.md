# obs-char-001349 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/014_001301-001400_ob
  s-char-bucket_oracle-characters/1349_obs-char-001349_hust-obc-cat-1506_ora
  cle-character/03_visual-assets/001_asset-001354_hust-obc-cat-1506_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1506/G_1506_乙8710合22137子組.png`
- asset id: `asset-001354`
...
- source category: `1506`
- validation class: `1348`
- source image route: `HUST-OBC/deciphered/1506/G_1506_乙8710合22137子組.png`
- asset id: `asset-001354`
...
- English observation: `A peaked upper contour sits above a small
  rectangular middle enclosure and a pointed lower extension.`
- 中文观察: `尖顶上部轮廓位于小型矩形中部框形之上，下方接尖状延伸。`
...
- dataset label text: `㧘`
- dataset label codepoints: `U+39D8`
...
- filename catalog route clues: `Heji-like filename clue: 合22137
...
- Which source records identify obs-char-001349 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001349？
