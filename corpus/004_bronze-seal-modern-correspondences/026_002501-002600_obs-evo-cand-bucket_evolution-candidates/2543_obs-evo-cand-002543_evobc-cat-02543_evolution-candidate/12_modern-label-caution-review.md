# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002543
...
- EVOBC candidate category: `evobc-evo-cat-02543`.
- Source label for search only: `岪`.
- Source codepoints for search only: `U+5CAA`.
