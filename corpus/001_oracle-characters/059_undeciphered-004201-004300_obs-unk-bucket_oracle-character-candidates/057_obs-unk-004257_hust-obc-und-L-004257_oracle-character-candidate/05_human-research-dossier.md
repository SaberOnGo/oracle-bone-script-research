# obs-unk-004257 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004257`
- primary external id: `hust-obc-und-L-004257`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/057_obs-unk-004257_h
  ust-obc-und-L-004257_oracle-character-candidate/03_visual-assets/001_asset
  -005850_hust-obc-und-L-004257_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4257/L_？_9381.jpg`
- asset id: `asset-005850`
...
- source class: `HUST-OBC/undeciphered/L/4257/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4257/L_？_9381.jpg`
- asset id: `asset-005850`
...
- English observation: `Upper bar, central trace, lower outline visible.`
- 中文观察: `上部横痕、中央痕迹和下部围合轮廓可见。`
...
- Which source records identify obs-unk-004257 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004257？
