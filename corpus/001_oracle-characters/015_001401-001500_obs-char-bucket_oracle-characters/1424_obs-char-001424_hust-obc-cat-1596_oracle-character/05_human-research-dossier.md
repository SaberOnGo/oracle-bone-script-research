# obs-char-001424 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/015_001401-001500_ob
  s-char-bucket_oracle-characters/1424_obs-char-001424_hust-obc-cat-1596_ora
  cle-character/03_visual-assets/001_asset-001429_hust-obc-cat-1596_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1596/G_1596_合17954(甲).png`
- asset id: `asset-001429`
...
- source category: `1596`
- validation class: `1423`
- source image route: `HUST-OBC/deciphered/1596/G_1596_合17954(甲).png`
- asset id: `asset-001429`
...
- English observation: `A pointed inner form is framed by upper prongs and a
  long right stem.`
- 中文观察: `尖状内部形体由上部分叉和长右侧竖干围合。`
...
- dataset label text: `㨲`
- dataset label codepoints: `U+3A32`
...
- filename catalog route clues: `Heji-like filename clue: 合17954
  (G_1596_合17954(甲).png)`
...
- Which source records identify obs-char-001424 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001424？
