...
Project ID: `obs-evo-cand-000012`
...
- Project ID: `obs-evo-cand-000012`
- EVOBC category candidate ID: `evobc-evo-cat-00012`
- External category reference: `evobc-cat-00012`
- Source category ID: `00012`
- Source label for human review: `㒀`
- Source codepoints: `U+3480`
...
- `obs-evo-cand-000012-route-category-staging`
...
- `obs-evo-cand-000012-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000012-route-evolution-graph`
