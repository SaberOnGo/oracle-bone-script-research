# Material Visual Observation / obs-comp-cand-000326 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000326`
- External reference / 外部参照: `obimd-sub-51laoswrwb`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012252_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/51laoswrwb/51laoswrwb/51laoswrwb.png`
- Checksum / 校验和:
  `cc5b49e836f704953f950114249e6aaf8f8cb12fc198a5c230e01d8c2073d3be`
...
- Marked-pixel bounds: (56,40)–(193,209); span 138 × 170 px; the marked
...
- 痕迹范围：(56,40)–(193,209)；跨度138 × 170 px；痕迹矩形高于宽。
