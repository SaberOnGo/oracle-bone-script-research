...
- Project ID: `obs-evo-cand-006855`
- EVOBC category candidate ID: `evobc-evo-cat-06855`
- External category reference: `evobc-cat-06855`
- Source category ID: `06855`
- Source label for human review: `群`
- Source codepoints: `U+7FA4`
...
- `obs-evo-cand-006855-route-category-staging`
...
- `obs-evo-cand-006855-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006855-route-evolution-graph`
