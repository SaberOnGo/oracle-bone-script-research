# obs-char-000801 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/009_000801-000900_ob
  s-char-bucket_oracle-characters/801_obs-char-000801_hust-obc-cat-0907_orac
  le-character/03_visual-assets/001_asset-000806_hust-obc-cat-0907_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0907/G_0907_乙105合21306𠂤組.png`
- asset id: `asset-000806`
...
- source category: `0907`
- validation class: `800`
- source image route: `HUST-OBC/deciphered/0907/G_0907_乙105合21306𠂤組.png`
- asset id: `asset-000806`
...
- English observation: `A narrow irregular cluster has two long side
  contours, short crossbars near the upper left, and a pointed lower split.`
...
- dataset label text: `㞁`
- dataset label codepoints: `U+3781`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00079`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00079`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00079`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/079_obs-evo-can
  d-000079_evobc-cat-00079_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/079_obs-evo-cand-000079_evobc-cat-00079_evolu
...
- Which source records identify obs-char-000801 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000801？
