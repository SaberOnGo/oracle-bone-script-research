...
- External category reference: `evobc-cat-08478`
- Source category ID: `08478`
- Source label for human review: `豉`
...
- `obs-evo-cand-008478-route-category-staging`
...
- `obs-evo-cand-008478-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008478-route-evolution-graph`
