...
Project ID: `obs-evo-cand-002648`
...
- Project ID: `obs-evo-cand-002648`
- EVOBC category candidate ID: `evobc-evo-cat-02648`
- External category reference: `evobc-cat-02648`
- Source category ID: `02648`
- Source label for human review: `帗`
- Source codepoints: `U+5E17`
...
- `obs-evo-cand-002648-route-category-staging`
...
- `obs-evo-cand-002648-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002648-route-evolution-graph`
