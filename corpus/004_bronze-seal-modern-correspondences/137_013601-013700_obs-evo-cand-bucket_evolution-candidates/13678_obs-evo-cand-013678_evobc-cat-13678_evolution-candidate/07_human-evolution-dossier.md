...
Project ID: `obs-evo-cand-013678`
...
- Project ID: `obs-evo-cand-013678`
- EVOBC category candidate ID: `evobc-evo-cat-13678`
- External category reference: `evobc-cat-13678`
- Source category ID: `13678`
- Source label for human review: `𮦜`
- Source codepoints: `U+2E99C`
...
- `obs-evo-cand-013678-route-category-staging`
...
- `obs-evo-cand-013678-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013678-route-evolution-graph`
