# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010249
...
- EVOBC candidate category: `evobc-evo-cat-10249`.
- Source label for search only: `驍`.
- Source codepoints for search only: `U+9A4D`.
