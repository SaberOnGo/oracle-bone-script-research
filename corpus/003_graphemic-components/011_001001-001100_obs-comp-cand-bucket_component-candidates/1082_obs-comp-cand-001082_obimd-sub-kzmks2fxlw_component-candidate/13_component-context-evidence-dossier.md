# obs-comp-cand-001082 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001082`
- 首选外部 ID: `obimd-sub-kzmks2fxlw`
- OBIMD subcharacter UID: `kzmks2fxlw`
- OBIMD main character UID: `kzmks2fxlw`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+30BF4;U+F635A; U+F635B; 另有 3 项
