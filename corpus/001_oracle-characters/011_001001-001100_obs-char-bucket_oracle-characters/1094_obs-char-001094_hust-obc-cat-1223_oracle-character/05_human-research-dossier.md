# obs-char-001094 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1094_obs-char-001094_hust-obc-cat-1223_ora
  cle-character/03_visual-assets/001_asset-001099_hust-obc-cat-1223_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1223/G_1223_甲骨文.png`
- asset id: `asset-001099`
...
- source category: `1223`
- validation class: `1093`
- source image route: `HUST-OBC/deciphered/1223/G_1223_甲骨文.png`
- asset id: `asset-001099`
...
- English observation: `A narrow branching form has a rounded upper turn, a
  central vertical stroke, and a pointed lower extension.`
- 中文观察: `狭长分枝形体有圆弧上部转笔、中央竖笔和尖状下部外伸。`
...
- dataset label text: `㢽`
- dataset label codepoints: `U+38BD`
...
- Which source records identify obs-char-001094 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001094？
