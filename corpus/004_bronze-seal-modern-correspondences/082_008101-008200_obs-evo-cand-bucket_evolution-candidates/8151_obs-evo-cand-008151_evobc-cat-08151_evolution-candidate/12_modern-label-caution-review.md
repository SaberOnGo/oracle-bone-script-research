# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008151
...
- EVOBC candidate category: `evobc-evo-cat-08151`.
- Source label for search only: `訪`.
- Source codepoints for search only: `U+8A2A`.
