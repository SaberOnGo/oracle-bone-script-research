# obs-char-001093 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/011_001001-001100_ob
  s-char-bucket_oracle-characters/1093_obs-char-001093_hust-obc-cat-1222_ora
  cle-character/03_visual-assets/001_asset-001098_hust-obc-cat-1222_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/1222/G_1222_乙105合21306𠂤組.png`
- asset id: `asset-001098`
...
- source category: `1222`
- validation class: `1092`
- source image route: `HUST-OBC/deciphered/1222/G_1222_乙105合21306𠂤組.png`
- asset id: `asset-001098`
...
- English observation: `A tall slender form has a pointed upper projection,
  a long central stem, and a small lower branch.`
...
- dataset label text: `㢼`
- dataset label codepoints: `U+38BC`
...
- Which source records identify obs-char-001093 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-001093？
