# Material Visual Observation / obs-comp-cand-000487 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000487`
- External reference / 外部参照: `obimd-sub-vp4cxkje4s`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012723_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/vp4cxkje4s/vp4cxkje4s/vp4cxkje4s.png`
- Checksum / 校验和:
  `6870bd4700976ed1f2919ba02488d77368bd2e77e47c67c13cadab6b7ba856e2`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 10.60%.
- Marked-pixel bounds: (67,29)–(182,216); span 116 × 188 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占10.60%。
- 痕迹范围：(67,29)–(182,216)；跨度116 × 188 px；痕迹矩形高于宽。
