# obs-unk-005593 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005593`
- primary external id: `hust-obc-und-X-005593`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/093_obs-unk-005593_h
  ust-obc-und-X-005593_oracle-character-candidate/03_visual-assets/001_asset
  -007186_hust-obc-und-X-005593_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1149/X_？_8102_1.png`
- asset id: `asset-007186`
...
- source class: `HUST-OBC/undeciphered/X/1149/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1149/X_？_8102_1.png`
- asset id: `asset-007186`
...
- Which source records identify obs-unk-005593 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005593？
