...
Project ID: `obs-evo-cand-007187`
...
- Project ID: `obs-evo-cand-007187`
- EVOBC category candidate ID: `evobc-evo-cat-07187`
- External category reference: `evobc-cat-07187`
- Source category ID: `07187`
- Source label for human review: `與`
- Source codepoints: `U+8207`
- Image reference count in source metadata: `237`
...
- `obs-evo-cand-007187-route-category-staging`
...
- `obs-evo-cand-007187-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007187-route-evolution-graph`
