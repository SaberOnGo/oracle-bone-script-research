...
- External category reference: `evobc-cat-13499`
- Source category ID: `13499`
- Source label: `𭎦`
...
- `obs-evo-cand-013499-route-category-staging`
...
- `obs-evo-cand-013499-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013499-route-evolution-graph`
