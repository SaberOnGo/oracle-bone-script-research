...
- External category reference: `evobc-cat-10050`
- Source category ID: `10050`
- Source label: `颂`
...
- `obs-evo-cand-010050-route-category-staging`
...
- `obs-evo-cand-010050-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010050-route-evolution-graph`
