...
- Project ID: `obs-evo-cand-006950`
- EVOBC category candidate ID: `evobc-evo-cat-06950`
- External category reference: `evobc-cat-06950`
- Source category ID: `06950`
- Source label for human review: `聚`
- Source codepoints: `U+805A`
...
- `obs-evo-cand-006950-route-category-staging`
...
- `obs-evo-cand-006950-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006950-route-evolution-graph`
