...
- Project ID: `obs-evo-cand-003762`
- EVOBC category candidate ID: `evobc-evo-cat-03762`
- External category reference: `evobc-cat-03762`
- Source category ID: `03762`
- Source label for human review: `晷`
- Source codepoints: `U+6677`
...
- `obs-evo-cand-003762-route-category-staging`
...
- `obs-evo-cand-003762-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003762-route-evolution-graph`
