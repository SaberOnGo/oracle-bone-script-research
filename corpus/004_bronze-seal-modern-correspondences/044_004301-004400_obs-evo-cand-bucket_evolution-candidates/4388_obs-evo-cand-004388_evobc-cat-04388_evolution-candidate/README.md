# obs-evo-cand-004388 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-004388`
- EVOBC category candidate ID: `evobc-evo-cat-04388`
- External category ref: `evobc-cat-04388`
- Source label: `步`
- Source codepoints: `U+6B65`
- Image reference count: `166`
- Era token counts: `BI:17;CS:3;OBC:115;SS:2;WSC:29`
- Source token counts: `Book:54;Web:112`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 115 image references
...
- source 1 / Web:105952;說文Web:58: 89 image references
