# obs-evo-cand-000999 / EVOBC evolution-category candidate
...
- Project ID: `obs-evo-cand-000999`
- EVOBC category candidate ID: `evobc-evo-cat-00999`
- External category ref: `evobc-cat-00999`
- Source label: `傷`
- Source codepoints: `U+50B7`
- Image reference count: `44`
- Era token counts: `CS:1;SS:2;WSC:41`
- Source token counts: `Book:19;Web:25`

## Observed Code Rows / 观察到的代码行

- era 2 / SS: 2 image references
- era 4 / WSC: 41 image references
