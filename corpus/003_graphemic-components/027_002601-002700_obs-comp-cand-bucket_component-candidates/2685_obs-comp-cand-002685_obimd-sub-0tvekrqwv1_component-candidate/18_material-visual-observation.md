# Material Visual Observation / obs-comp-cand-002685 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002685`
- External reference / 外部参照: `obimd-sub-0tvekrqwv1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021261_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0tvekrqwv1/0tvekrqwv1/0tvekrqwv1.png`
- Checksum / 校验和:
  `4fd2a090f55ef64aafdc827389549d907d6c311ed8fa66c17b57b73cb46ffe8a`
...
- Marked-pixel bounds: (103,17)–(157,230); span 55 × 214 px; the marked
...
- 痕迹范围：(103,17)–(157,230)；跨度55 × 214 px；痕迹矩形高于宽。
