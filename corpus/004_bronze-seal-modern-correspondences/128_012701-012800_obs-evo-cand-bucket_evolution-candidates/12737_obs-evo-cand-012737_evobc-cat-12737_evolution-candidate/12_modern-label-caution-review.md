# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012737
...
- EVOBC candidate category: `evobc-evo-cat-12737`.
- Source label for search only: `𪈶`.
- Source codepoints for search only: `U+2A236`.
