# src-tsinghua-oracle-bones Material Access Index / src-tsinghua-oracle-bones 资料访问索引
...
| --- | --- | --- | --- |
| Source summary / 来源摘要 | `README.md` | present | source ID `src-tsinghua-oracle-bones` |
...
| Field maps / 字段映射 | `04_field-map-route-index.csv` | field_rows_present | 2 row(s); target records: excavation_or_collection_context;source_record |
| Downloaded metadata profiles / 已下载 metadata profile | `05_metadata-profile-route-index.csv` | profile_rows_present | 3 row(s); metrics: collection_inscribed_piece_count;collection_oracle_bone_count_over;registered_collection_provenance_names |
...
- Risk note / 风险提示: Official library page; not a full searchable corpus endpoint by itself.
