...
- External category reference: `evobc-cat-09989`
- Source category ID: `09989`
- Source label for human review: `頠`
...
- `obs-evo-cand-009989-route-category-staging`
...
- `obs-evo-cand-009989-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009989-route-evolution-graph`
