...
Project ID: `obs-evo-cand-000083`
...
- Project ID: `obs-evo-cand-000083`
- EVOBC category candidate ID: `evobc-evo-cat-00083`
- External category reference: `evobc-cat-00083`
- Source category ID: `00083`
- Source label for human review: `㞢`
- Source codepoints: `U+37A2`
...
- `obs-evo-cand-000083-route-category-staging`
...
- `obs-evo-cand-000083-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000083-route-evolution-graph`
