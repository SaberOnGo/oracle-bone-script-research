# Material Visual Observation / obs-comp-cand-002123 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002123`
- External reference / 外部参照: `obimd-sub-dlza5ir0k7`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019680_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dlza5ir0k7/dlza5ir0k7/dlza5ir0k7.png`
- Checksum / 校验和:
  `e4f1096a58e13497f4db4f3fce111db6bdc5a6c36307caec128a1beab8590441`
...
- Marked-pixel bounds: (58,28)–(201,221); span 144 × 194 px; the marked
...
- 痕迹范围：(58,28)–(201,221)；跨度144 × 194 px；痕迹矩形高于宽。
