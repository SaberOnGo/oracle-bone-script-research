# obs-char-000065 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/065_obs-char-000065_hust-obc-cat-0075_orac
  le-character/03_visual-assets/001_asset-000070_hust-obc-cat-0075_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0075/L_0075_3583.jpg`
- asset id: `asset-000070`
...
- source category: `0075`
- validation class: `64`
- source image route: `HUST-OBC/deciphered/0075/L_0075_3583.jpg`
- asset id: `asset-000070`
...
- English observation: `The small gray image shows a thin upright cluster
  with an enclosed angular center and curved lower marks.`
- 中文观察: `小型灰度图像呈纤细直立形体，中部有闭合折角痕迹，下方有弯曲笔画。`
...
- dataset label text: `㑁`
- dataset label codepoints: `U+3441`
...
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00008`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00008`
...
- matched candidate folders / 匹配候选目录: `evobc-evo-cat-00008`
- human review files / 人类复核文件: `corpus/004_bronze-seal-modern-correspondences/
  001_000001-000100_obs-evo-cand-bucket_evolution-candidates/008_obs-evo-can
  d-000008_evobc-cat-00008_evolution-candidate/README.md;
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/008_obs-evo-cand-000008_evobc-cat-00008_evolu
...
- Which source records identify obs-char-000065 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000065？
