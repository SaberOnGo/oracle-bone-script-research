# obs-unk-004753 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004753`
- primary external id: `hust-obc-und-X-004753`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/053_obs-unk-004753_h
  ust-obc-und-X-004753_oracle-character-candidate/03_visual-assets/001_asset
  -006346_hust-obc-und-X-004753_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/309/X_？_7294_1.png`
- asset id: `asset-006346`
...
- source class: `HUST-OBC/undeciphered/X/309/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/309/X_？_7294_1.png`
- asset id: `asset-006346`
...
- English observation: `branching upper group with a long lower stroke`
- 中文观察: `带长下部笔画的上部分支结构`
...
- Which source records identify obs-unk-004753 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004753？
