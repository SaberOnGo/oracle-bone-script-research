# Material Visual Observation / obs-comp-cand-001411 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001411`
- External reference / 外部参照: `obimd-sub-wvs056n2ez`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015830_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/fkhhsjy5jk/wvs056n2ez/wvs056n2ez.png`
- Checksum / 校验和:
  `2dc6b1669756fde120f90d7995856a3b278c16c83eac9eb328884feb4d16ca94`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 13.81%.
- Marked-pixel bounds: (30,33)–(217,220); span 188 × 188 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占13.81%。
- 痕迹范围：(30,33)–(217,220)；跨度188 × 188 px；痕迹矩形近方形。
