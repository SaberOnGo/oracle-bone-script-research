# obs-comp-cand-000334 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-000334`
- 首选外部 ID: `obimd-sub-fzv0acj6pa`
- OBIMD subcharacter UID: `fzv0acj6pa`
- OBIMD main character UID: `fzv0acj6pa`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `3`
- codepoint 示例: U+7965;U+BDC23;U+F1ED8; U+F1ED9; 另有 1 项
