# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001689
...
| Glyph or codepoint route / 字形或码位路线 | 3 OBIMD route rows; examples U+A986B;U+A9A6A;U+F9CCC; U+F9CCD; 另有 1 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
