# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-005874
...
- EVOBC candidate category: `evobc-evo-cat-05874`.
- Source label for search only: `矛`.
- Source codepoints for search only: `U+77DB`.
