# obs-unk-004282 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/082_obs-unk-004282_h
  ust-obc-und-L-004282_oracle-character-candidate/03_visual-assets/001_asset
  -005875_hust-obc-und-L-004282_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4282/L_？_9458.jpg`
- asset id: `asset-005875`
...
- source class: `HUST-OBC/undeciphered/L/4282/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4282/L_？_9458.jpg`
- asset id: `asset-005875`
...
- English observation: `Upper forks, point, right trace visible.`
- 中文观察: `上部分叉、尖状下端和右侧痕迹可见。`
...
- Which source records identify obs-unk-004282 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004282？
