...
Project ID: `obs-evo-cand-000413`
...
- Project ID: `obs-evo-cand-000413`
- EVOBC category candidate ID: `evobc-evo-cat-00413`
- External category reference: `evobc-cat-00413`
- Source category ID: `00413`
- Source label for human review: `䙝`
- Source codepoints: `U+465D`
...
- `obs-evo-cand-000413-route-category-staging`
...
- `obs-evo-cand-000413-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000413-route-evolution-graph`
