...
- Project ID: `obs-evo-cand-005865`
- EVOBC category candidate ID: `evobc-evo-cat-05865`
- External category reference: `evobc-cat-05865`
- Source category ID: `05865`
- Source label for human review: `瞽`
- Source codepoints: `U+77BD`
- Image reference count in source metadata: `103`
...
- `obs-evo-cand-005865-route-category-staging`
...
- `obs-evo-cand-005865-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005865-route-evolution-graph`
