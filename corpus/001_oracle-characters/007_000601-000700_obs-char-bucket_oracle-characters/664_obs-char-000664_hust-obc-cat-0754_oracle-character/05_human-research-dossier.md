# obs-char-000664 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000664`
- primary external id: `hust-obc-cat-0754`
...
- local review image route: `corpus/001_oracle-characters/007_000601-000700_ob
  s-char-bucket_oracle-characters/664_obs-char-000664_hust-obc-cat-0754_orac
  le-character/03_visual-assets/001_asset-000669_hust-obc-cat-0754_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0754/G_0754_前4.34.7(甲).png`
- asset id: `asset-000669`
...
- source category: `0754`
- validation class: `663`
- source image route: `HUST-OBC/deciphered/0754/G_0754_前4.34.7(甲).png`
- asset id: `asset-000669`
...
- English observation: `Three separated forms are stacked vertically: a
  hollow triangle, a shallow rectangular outline, and a lower crossed stem
  that splits into pointed branches.`
- 中文观察: `三个分离形体竖向层叠：中空三角、浅矩形轮廓，以及分成尖枝的下部交叉干。`
...
- dataset label text: `㛨`
- dataset label codepoints: `U+36E8`
...
- Which source records identify obs-char-000664 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000664？
