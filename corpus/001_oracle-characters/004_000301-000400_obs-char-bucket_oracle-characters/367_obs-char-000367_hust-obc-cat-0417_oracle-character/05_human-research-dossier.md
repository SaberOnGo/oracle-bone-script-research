# obs-char-000367 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/367_obs-char-000367_hust-obc-cat-0417_orac
  le-character/03_visual-assets/001_asset-000372_hust-obc-cat-0417_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0417/G_0417_京津1331合18684賓組.png`
- asset id: `asset-000372`
...
- source category: `0417`
- validation class: `366`
- source image route: `HUST-OBC/deciphered/0417/G_0417_京津1331合18684賓組.png`
- asset id: `asset-000372`
...
- English observation: `A thin central stem has several short diagonal
  branches and a forked upper end.`
- 中文观察: `纤细中央主干带有数个短斜向分支，上端呈分叉形。`
...
- dataset label text: `㖗`
- dataset label codepoints: `U+3597`
...
- filename catalog route clues: `Heji-like filename clue: 合18684
...
- Which source records identify obs-char-000367 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000367？
