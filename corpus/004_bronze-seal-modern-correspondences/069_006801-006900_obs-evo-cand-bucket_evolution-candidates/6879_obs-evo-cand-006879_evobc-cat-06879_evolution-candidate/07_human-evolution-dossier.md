...
- External category reference: `evobc-cat-06879`
- Source category ID: `06879`
- Source label for human review: `翏`
...
- `obs-evo-cand-006879-route-category-staging`
...
- `obs-evo-cand-006879-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006879-route-evolution-graph`
