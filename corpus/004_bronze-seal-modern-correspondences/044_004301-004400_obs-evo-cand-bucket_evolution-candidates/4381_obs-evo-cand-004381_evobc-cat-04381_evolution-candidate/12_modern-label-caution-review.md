# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004381
...
- EVOBC candidate category: `evobc-evo-cat-04381`.
- Source label for search only: `歜`.
- Source codepoints for search only: `U+6B5C`.
