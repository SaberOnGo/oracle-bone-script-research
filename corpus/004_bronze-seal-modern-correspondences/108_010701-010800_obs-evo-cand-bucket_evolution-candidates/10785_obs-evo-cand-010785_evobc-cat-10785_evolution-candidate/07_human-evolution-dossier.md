...
Project ID: `obs-evo-cand-010785`
...
- Project ID: `obs-evo-cand-010785`
- EVOBC category candidate ID: `evobc-evo-cat-10785`
- External category reference: `evobc-cat-10785`
- Source category ID: `10785`
- Source label for human review: `𠅷`
- Source codepoints: `U+20177`
...
- `obs-evo-cand-010785-route-category-staging`
...
- `obs-evo-cand-010785-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-010785-route-evolution-graph`
