...
Project ID: `obs-evo-cand-008886`
...
- Project ID: `obs-evo-cand-008886`
- EVOBC category candidate ID: `evobc-evo-cat-08886`
- External category reference: `evobc-cat-08886`
- Source category ID: `08886`
- Source label for human review: `车`
- Source codepoints: `U+8F66`
...
- `obs-evo-cand-008886-route-category-staging`
...
- `obs-evo-cand-008886-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008886-route-evolution-graph`
