...
Project ID: `obs-evo-cand-003712`
...
- Project ID: `obs-evo-cand-003712`
- EVOBC category candidate ID: `evobc-evo-cat-03712`
- External category reference: `evobc-cat-03712`
- Source category ID: `03712`
- Source label for human review: `易`
- Source codepoints: `U+6613`
- Image reference count in source metadata: `423`
...
- `obs-evo-cand-003712-route-category-staging`
...
- `obs-evo-cand-003712-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003712-route-evolution-graph`
