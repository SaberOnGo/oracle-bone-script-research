...
- `obs-evo-cand-002412-route-category-staging`
...
- `obs-evo-cand-002412-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-002412-route-evolution-graph`
