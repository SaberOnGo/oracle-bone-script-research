...
Project ID: `obs-evo-cand-003009`
...
- Project ID: `obs-evo-cand-003009`
- EVOBC category candidate ID: `evobc-evo-cat-03009`
- External category reference: `evobc-cat-03009`
- Source category ID: `03009`
- Source label for human review: `悒`
- Source codepoints: `U+6092`
...
- `obs-evo-cand-003009-route-category-staging`
...
- `obs-evo-cand-003009-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003009-route-evolution-graph`
