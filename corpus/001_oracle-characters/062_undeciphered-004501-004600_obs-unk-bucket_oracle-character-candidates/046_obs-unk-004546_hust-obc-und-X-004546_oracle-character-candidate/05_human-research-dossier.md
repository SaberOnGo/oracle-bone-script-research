# obs-unk-004546 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004546`
- primary external id: `hust-obc-und-X-004546`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/046_obs-unk-004546_h
  ust-obc-und-X-004546_oracle-character-candidate/03_visual-assets/001_asset
  -006139_hust-obc-und-X-004546_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/102/X_？_7211_1.png`
- asset id: `asset-006139`
...
- source class: `HUST-OBC/undeciphered/X/102/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/102/X_？_7211_1.png`
- asset id: `asset-006139`
...
- English observation: `Central stem, middle band, and lower outlines recorded.`
- 中文观察: `已记录中央长痕、中部横带和下部轮廓。`
...
- Which source records identify obs-unk-004546 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004546？
