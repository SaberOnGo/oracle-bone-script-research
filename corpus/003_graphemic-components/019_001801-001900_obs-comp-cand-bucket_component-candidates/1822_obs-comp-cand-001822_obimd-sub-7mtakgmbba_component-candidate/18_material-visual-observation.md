# Material Visual Observation / obs-comp-cand-001822 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001822`
- External reference / 外部参照: `obimd-sub-7mtakgmbba`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018148_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/7mtakgmbba/7mtakgmbba/7mtakgmbba.png`
- Checksum / 校验和:
  `6c9981432864bf902327ba8bc59ef4f51f442132129d6ef4115b8aae3c92967d`
...
- Marked-pixel bounds: (58,26)–(188,214); span 131 × 189 px; the marked
...
- 痕迹范围：(58,26)–(188,214)；跨度131 × 189 px；痕迹矩形高于宽。
