# Material Visual Observation / obs-comp-cand-000730 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000730`
- External reference / 外部参照: `obimd-sub-0fjs8401bp`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013457_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/0fjs8401bp/0fjs8401bp/0fjs8401bp.png`
- Checksum / 校验和:
  `fc1735c31340f680abcec459bf8a81161c3de9d356f15cff6f2ae32860e36463`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.38%.
- Marked-pixel bounds: (89,26)–(161,227); span 73 × 202 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.38%。
- 痕迹范围：(89,26)–(161,227)；跨度73 × 202 px；痕迹矩形高于宽。
