...
- External category reference: `evobc-cat-01723`
- Source category ID: `01723`
- Source label for human review: `噪`
...
- `obs-evo-cand-001723-route-category-staging`
...
- `obs-evo-cand-001723-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001723-route-evolution-graph`
