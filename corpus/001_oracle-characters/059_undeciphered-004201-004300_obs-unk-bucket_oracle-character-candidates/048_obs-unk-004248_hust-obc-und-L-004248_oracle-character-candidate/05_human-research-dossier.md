# obs-unk-004248 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/048_obs-unk-004248_h
  ust-obc-und-L-004248_oracle-character-candidate/03_visual-assets/001_asset
  -005841_hust-obc-und-L-004248_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4248/L_？_9358.jpg`
- asset id: `asset-005841`
...
- source class: `HUST-OBC/undeciphered/L/4248/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4248/L_？_9358.jpg`
- asset id: `asset-005841`
...
- English observation: `Left hook, central cluster, right curve visible.`
- 中文观察: `左侧钩状痕迹、中部痕迹簇和右侧弯曲痕迹可见。`
...
- Which source records identify obs-unk-004248 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004248？
