# Material Visual Observation / obs-comp-cand-001303 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001303`
- External reference / 外部参照: `obimd-sub-hunv1ff3gy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015640_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hunv1ff3gy/hunv1ff3gy/hunv1ff3gy.png`
- Checksum / 校验和:
  `80f824ec10ba4a026630ac7938526c77b2d0630c05da17b36b09ef0e10a91825`
...
- Marked-pixel bounds: (73,31)–(161,220); span 89 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.04%。
- 痕迹范围：(73,31)–(161,220)；跨度89 × 190 px；痕迹矩形高于宽。
