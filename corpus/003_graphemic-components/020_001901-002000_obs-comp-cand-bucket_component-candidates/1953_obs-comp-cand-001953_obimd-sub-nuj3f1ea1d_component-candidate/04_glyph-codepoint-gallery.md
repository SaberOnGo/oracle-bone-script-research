# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001953
...
| --- | --- | --- | --- |
| `obimd-glyph-link-029615` | 򺊑󻊟 | `U+BA291;U+FB29F` | `reviewed_metadata_only` |
| `obimd-glyph-link-029616` | 󻊠 | `U+FB2A0` | `reviewed_metadata_only` |
| `obimd-glyph-link-029617` | 󻊡 | `U+FB2A1` | `reviewed_metadata_only` |
