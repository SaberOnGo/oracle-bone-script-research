# obs-unk-008417 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/101_undeciphered-008
  401-008500_obs-unk-bucket_oracle-character-candidates/017_obs-unk-008417_h
  ust-obc-und-YH-008417_oracle-character-candidate/03_visual-assets/001_asse
  t-010008_hust-obc-und-YH-008417_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60ABE/H_？_60ABE_0.png`
- asset id: `asset-010008`
...
- source class: `HUST-OBC/undeciphered/Y+H/60ABE/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60ABE/H_？_60ABE_0.png`
- asset id: `asset-010008`
...
- Which source records identify obs-unk-008417 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008417？
