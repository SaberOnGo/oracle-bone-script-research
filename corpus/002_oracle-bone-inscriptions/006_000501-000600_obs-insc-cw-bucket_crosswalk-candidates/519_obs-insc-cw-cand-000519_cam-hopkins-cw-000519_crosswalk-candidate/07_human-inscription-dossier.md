...
- Yingguo / 英国所藏: `y2507` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `379` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `691` in source row; primary catalog entry pending
