...
Project ID: `obs-evo-cand-013254`
...
- Project ID: `obs-evo-cand-013254`
- EVOBC category candidate ID: `evobc-evo-cat-13254`
- External category reference: `evobc-cat-13254`
- Source category ID: `13254`
- Source label for human review: `𬐘`
- Source codepoints: `U+2C418`
...
- `obs-evo-cand-013254-route-category-staging`
...
- `obs-evo-cand-013254-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013254-route-evolution-graph`
