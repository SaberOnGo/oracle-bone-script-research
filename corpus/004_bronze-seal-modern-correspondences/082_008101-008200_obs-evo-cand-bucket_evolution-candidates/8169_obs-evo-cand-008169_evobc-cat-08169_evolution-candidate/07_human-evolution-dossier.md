...
- External category reference: `evobc-cat-08169`
- Source category ID: `08169`
- Source label for human review: `詇`
...
- `obs-evo-cand-008169-route-category-staging`
...
- `obs-evo-cand-008169-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008169-route-evolution-graph`
