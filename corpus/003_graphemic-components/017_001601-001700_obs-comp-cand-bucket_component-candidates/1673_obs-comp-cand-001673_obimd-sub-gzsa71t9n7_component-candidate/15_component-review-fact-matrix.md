# Component Review Fact Matrix / 构件复核事实矩阵: obs-comp-cand-001673
...
| Glyph or codepoint route / 字形或码位路线 | 12 OBIMD route rows; examples U+F9B9D; U+F9B9E; 另有 10 项 | 03_glyph-codepoint-index.csv; 04_glyph-codepoint-gallery.md |
