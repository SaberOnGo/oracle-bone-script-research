...
- `obs-evo-cand-000268-route-category-staging`
...
- `obs-evo-cand-000268-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-000268-route-evolution-graph`
