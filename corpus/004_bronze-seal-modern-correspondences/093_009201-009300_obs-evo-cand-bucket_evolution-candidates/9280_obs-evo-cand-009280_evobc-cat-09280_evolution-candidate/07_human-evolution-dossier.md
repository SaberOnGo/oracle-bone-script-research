...
- External category reference: `evobc-cat-09280`
- Source category ID: `09280`
- Source label: `醫`
...
- `obs-evo-cand-009280-route-category-staging`
...
- `obs-evo-cand-009280-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009280-route-evolution-graph`
