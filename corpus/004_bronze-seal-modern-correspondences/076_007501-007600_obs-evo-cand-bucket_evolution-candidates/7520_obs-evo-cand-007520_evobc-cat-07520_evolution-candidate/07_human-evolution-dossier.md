...
- External category reference: `evobc-cat-07520`
- Source category ID: `07520`
- Source label for human review: `蓆`
- Source codepoints: `U+84C6`
...
- `obs-evo-cand-007520-route-category-staging`
...
- `obs-evo-cand-007520-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007520-route-evolution-graph`
