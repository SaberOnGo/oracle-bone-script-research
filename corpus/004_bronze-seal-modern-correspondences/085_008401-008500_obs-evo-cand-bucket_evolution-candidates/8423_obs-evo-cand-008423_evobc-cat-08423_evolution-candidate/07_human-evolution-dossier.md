...
Project ID: `obs-evo-cand-008423`
...
- Project ID: `obs-evo-cand-008423`
- EVOBC category candidate ID: `evobc-evo-cat-08423`
- External category reference: `evobc-cat-08423`
- Source category ID: `08423`
- Source label for human review: `试`
- Source codepoints: `U+8BD5`
...
- `obs-evo-cand-008423-route-category-staging`
...
- `obs-evo-cand-008423-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008423-route-evolution-graph`
