...
- External category reference: `evobc-cat-08918`
- Source category ID: `08918`
- Source label for human review: `辩`
- Source codepoints: `U+8FA9`
...
- `obs-evo-cand-008918-route-category-staging`
...
- `obs-evo-cand-008918-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008918-route-evolution-graph`
