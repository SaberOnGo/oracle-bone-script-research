# obs-char-000467 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/467_obs-char-000467_hust-obc-cat-0529_orac
  le-character/03_visual-assets/001_asset-000472_hust-obc-cat-0529_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0529/G_0529_甲骨文.png`
- asset id: `asset-000472`
...
- source category: `0529`
- validation class: `466`
- source image route: `HUST-OBC/deciphered/0529/G_0529_甲骨文.png`
- asset id: `asset-000472`
...
- English observation: `A broad angular arch with long vertical sides
  encloses a short bent stroke near the upper center and a detached short
  base below it.`
...
- dataset label text: `㘇`
- dataset label codepoints: `U+3607`
...
- Which source records identify obs-char-000467 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000467？
