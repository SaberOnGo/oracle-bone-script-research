# Material Visual Observation / obs-comp-cand-001152 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001152`
- External reference / 外部参照: `obimd-sub-6k7x6eaq4d`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015342_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/6k7x6eaq4d/6k7x6eaq4d/6k7x6eaq4d.png`
- Checksum / 校验和:
  `c5ddc01f35e5469a607ef6c1d2553c5db4b15636c1300aec201464244bd19377`
...
- Marked-pixel bounds: (82,31)–(164,220); span 83 × 190 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.40%。
- 痕迹范围：(82,31)–(164,220)；跨度83 × 190 px；痕迹矩形高于宽。
