...
- Project ID: `obs-evo-cand-001312`
- EVOBC category candidate ID: `evobc-evo-cat-01312`
- External category reference: `evobc-cat-01312`
- Source category ID: `01312`
- Source label for human review: `勱`
- Source codepoints: `U+52F1`
...
- `obs-evo-cand-001312-route-category-staging`
...
- `obs-evo-cand-001312-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001312-route-evolution-graph`
