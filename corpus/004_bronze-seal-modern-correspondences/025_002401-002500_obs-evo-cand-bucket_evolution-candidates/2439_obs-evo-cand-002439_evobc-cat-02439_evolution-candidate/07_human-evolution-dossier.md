...
- External category reference: `evobc-cat-02439`
- Source category ID: `02439`
- Source label for human review: `寫`
...
- `obs-evo-cand-002439-route-category-staging`
...
- `obs-evo-cand-002439-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002439-route-evolution-graph`
