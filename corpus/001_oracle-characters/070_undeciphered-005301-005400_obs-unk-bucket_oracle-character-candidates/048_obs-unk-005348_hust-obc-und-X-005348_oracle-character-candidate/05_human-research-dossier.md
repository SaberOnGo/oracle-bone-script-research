# obs-unk-005348 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/070_undeciphered-005
  301-005400_obs-unk-bucket_oracle-character-candidates/048_obs-unk-005348_h
  ust-obc-und-X-005348_oracle-character-candidate/03_visual-assets/001_asset
  -006941_hust-obc-und-X-005348_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/904/X_？_7166_1.png`
- asset id: `asset-006941`
...
- source class: `HUST-OBC/undeciphered/X/904/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/904/X_？_7166_1.png`
- asset id: `asset-006941`
...
- Which source records identify obs-unk-005348 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005348？
