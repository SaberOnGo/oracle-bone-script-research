...
- External category reference: `evobc-cat-06207`
- Source category ID: `06207`
- Source label for human review: `竦`
- Source codepoints: `U+7AE6`
...
- `obs-evo-cand-006207-route-category-staging`
...
- `obs-evo-cand-006207-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006207-route-evolution-graph`
