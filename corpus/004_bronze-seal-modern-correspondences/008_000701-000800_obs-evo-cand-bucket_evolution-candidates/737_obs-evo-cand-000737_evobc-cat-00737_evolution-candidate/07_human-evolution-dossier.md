...
- External category reference: `evobc-cat-00737`
- Source category ID: `00737`
- Source label for human review: `付`
...
- `obs-evo-cand-000737-route-category-staging`
...
- `obs-evo-cand-000737-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000737-route-evolution-graph`
