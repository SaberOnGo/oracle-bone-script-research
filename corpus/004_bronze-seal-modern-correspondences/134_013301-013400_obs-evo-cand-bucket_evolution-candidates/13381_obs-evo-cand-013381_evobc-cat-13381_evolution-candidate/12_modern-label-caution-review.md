# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013381
...
- EVOBC candidate category: `evobc-evo-cat-13381`.
- Source label for search only: `𬪊`.
- Source codepoints for search only: `U+2CA8A`.
