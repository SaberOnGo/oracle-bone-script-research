...
Project ID: `obs-evo-cand-003268`
...
- Project ID: `obs-evo-cand-003268`
- EVOBC category candidate ID: `evobc-evo-cat-03268`
- External category reference: `evobc-cat-03268`
- Source category ID: `03268`
- Source label for human review: `扼`
- Source codepoints: `U+627C`
...
- `obs-evo-cand-003268-route-category-staging`
...
- `obs-evo-cand-003268-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003268-route-evolution-graph`
