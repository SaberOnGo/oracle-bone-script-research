# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008599
...
- EVOBC candidate category: `evobc-evo-cat-08599`.
- Source label for search only: `購`.
- Source codepoints for search only: `U+8CFC`.
