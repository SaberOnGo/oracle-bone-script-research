# obs-unk-005534 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/034_obs-unk-005534_h
  ust-obc-und-X-005534_oracle-character-candidate/03_visual-assets/001_asset
  -007127_hust-obc-und-X-005534_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1090/X_？_8050_1.png`
- asset id: `asset-007127`
...
- source class: `HUST-OBC/undeciphered/X/1090/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1090/X_？_8050_1.png`
- asset id: `asset-007127`
...
- Which source records identify obs-unk-005534 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005534？
