# obs-unk-007581 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/092_undeciphered-007
  501-007600_obs-unk-bucket_oracle-character-candidates/081_obs-unk-007581_h
  ust-obc-und-YH-007581_oracle-character-candidate/03_visual-assets/001_asse
  t-009172_hust-obc-und-YH-007581_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/600DF/H_？_600DF_0.png`
- asset id: `asset-009172`
...
- source class: `HUST-OBC/undeciphered/Y+H/600DF/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/600DF/H_？_600DF_0.png`
- asset id: `asset-009172`
...
- Which source records identify obs-unk-007581 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-007581？
