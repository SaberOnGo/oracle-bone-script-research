...
- External category reference: `evobc-cat-11196`
- Source category ID: `11196`
- Source label for human review: `𢒡`
- Source codepoints: `U+224A1`
...
- `obs-evo-cand-011196-route-category-staging`
...
- `obs-evo-cand-011196-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011196-route-evolution-graph`
