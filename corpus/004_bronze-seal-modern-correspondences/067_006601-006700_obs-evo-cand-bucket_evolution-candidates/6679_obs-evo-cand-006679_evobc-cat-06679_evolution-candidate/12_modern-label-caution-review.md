# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006679
...
- EVOBC candidate category: `evobc-evo-cat-06679`.
- Source label for search only: `繛`.
- Source codepoints for search only: `U+7E5B`.
