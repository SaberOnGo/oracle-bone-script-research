...
- External category reference: `evobc-cat-02084`
- Source category ID: `02084`
- Source label for human review: `妙`
...
- `obs-evo-cand-002084-route-category-staging`
...
- `obs-evo-cand-002084-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002084-route-evolution-graph`
