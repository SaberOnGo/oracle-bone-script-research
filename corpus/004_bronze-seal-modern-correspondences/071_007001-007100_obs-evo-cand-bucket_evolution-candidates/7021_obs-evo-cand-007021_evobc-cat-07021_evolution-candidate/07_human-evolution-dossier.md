...
- External category reference: `evobc-cat-07021`
- Source category ID: `07021`
- Source label for human review: `胊`
...
- `obs-evo-cand-007021-route-category-staging`
...
- `obs-evo-cand-007021-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007021-route-evolution-graph`
