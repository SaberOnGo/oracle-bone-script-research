...
Project ID: `obs-evo-cand-005664`
...
- Project ID: `obs-evo-cand-005664`
- EVOBC category candidate ID: `evobc-evo-cat-05664`
- External category reference: `evobc-cat-05664`
- Source category ID: `05664`
- Source label for human review: `瘍`
- Source codepoints: `U+760D`
...
- `obs-evo-cand-005664-route-category-staging`
...
- `obs-evo-cand-005664-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005664-route-evolution-graph`
