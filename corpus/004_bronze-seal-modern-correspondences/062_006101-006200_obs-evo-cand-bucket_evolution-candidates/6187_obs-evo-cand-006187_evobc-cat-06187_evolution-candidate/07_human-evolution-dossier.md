...
- Project ID: `obs-evo-cand-006187`
- EVOBC category candidate ID: `evobc-evo-cat-06187`
- External category reference: `evobc-cat-06187`
- Source category ID: `06187`
- Source label for human review: `竀`
- Source codepoints: `U+7AC0`
...
- `obs-evo-cand-006187-route-category-staging`
...
- `obs-evo-cand-006187-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006187-route-evolution-graph`
