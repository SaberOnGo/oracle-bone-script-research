...
- Yingguo / 英国所藏: `y1800` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `340` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `702` in source row; primary catalog entry pending
