# obs-char-000710 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/008_000701-000800_ob
  s-char-bucket_oracle-characters/710_obs-char-000710_hust-obc-cat-0805_orac
  le-character/03_visual-assets/001_asset-000715_hust-obc-cat-0805_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0805/G_0805_乙7680合10951𠂤賓間.png`
- asset id: `asset-000715`
...
- source category: `0805`
- validation class: `709`
- source image route: `HUST-OBC/deciphered/0805/G_0805_乙7680合10951𠂤賓間.png`
- asset id: `asset-000715`
...
- English observation: `A tall thin rectangular outer frame contains an
  upper pointed diagonal opening and a long central slanting stroke with
  short branches and a narrow lower tail.`
- 中文观察: `高长纤细矩形外框内含上部尖斜空隙，以及带短枝和狭下尾的长中央斜笔。`
...
- dataset label text: `㜛`
- dataset label codepoints: `U+371B`
...
- filename catalog route clues: `Heji-like filename clue: 合10951
...
- Which source records identify obs-char-000710 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000710？
