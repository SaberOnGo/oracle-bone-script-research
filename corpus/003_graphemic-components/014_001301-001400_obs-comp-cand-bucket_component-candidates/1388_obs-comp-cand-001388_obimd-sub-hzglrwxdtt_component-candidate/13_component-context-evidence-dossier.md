# obs-comp-cand-001388 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-001388`
- 首选外部 ID: `obimd-sub-hzglrwxdtt`
- OBIMD subcharacter UID: `hzglrwxdtt`
- OBIMD main character UID: `hzglrwxdtt`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+98F6;U+B99D7;U+F7E7C; U+F7E7D; 另有 2 项
