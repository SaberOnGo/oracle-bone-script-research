# Material Visual Observation / obs-comp-cand-001778 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001778`
- External reference / 外部参照: `obimd-sub-zxrxdzrytu`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017979_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zxrxdzrytu/zxrxdzrytu/2rosze4pmd.png`
- Checksum / 校验和:
  `ea66006758554cdaf03b177bbd5308485b2c06df93c875fa803f4801ffb0748c`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 4.85%.
- Marked-pixel bounds: (69,50)–(181,195); span 113 × 146 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.85%。
- 痕迹范围：(69,50)–(181,195)；跨度113 × 146 px；痕迹矩形高于宽。
