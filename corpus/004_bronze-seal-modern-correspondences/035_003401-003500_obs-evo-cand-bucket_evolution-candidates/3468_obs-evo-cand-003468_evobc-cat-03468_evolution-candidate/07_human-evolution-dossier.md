...
- Project ID: `obs-evo-cand-003468`
- EVOBC category candidate ID: `evobc-evo-cat-03468`
- External category reference: `evobc-cat-03468`
- Source category ID: `03468`
- Source label for human review: `摇`
- Source codepoints: `U+6447`
...
- `obs-evo-cand-003468-route-category-staging`
...
- `obs-evo-cand-003468-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003468-route-evolution-graph`
