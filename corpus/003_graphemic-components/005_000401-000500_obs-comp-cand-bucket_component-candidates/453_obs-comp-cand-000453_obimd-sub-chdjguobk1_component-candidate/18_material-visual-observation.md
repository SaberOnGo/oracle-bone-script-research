# Material Visual Observation / obs-comp-cand-000453 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000453`
- External reference / 外部参照: `obimd-sub-chdjguobk1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012601_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/chdjguobk1/chdjguobk1/chdjguobk1.png`
- Checksum / 校验和:
  `b61dd18da1ac55e19a8bd0fa41a9e151f4998d75fa0251eef7230ec9bcda75b9`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.23%.
- Marked-pixel bounds: (58,48)–(190,204); span 133 × 157 px; the marked
  rectangle is roughly square.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.23%。
- 痕迹范围：(58,48)–(190,204)；跨度133 × 157 px；痕迹矩形近方形。
