# Material Visual Observation / obs-comp-cand-000510 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000510`
- External reference / 外部参照: `obimd-sub-958xbytpz1`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012746_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dupksehej2/958xbytpz1/958xbytpz1.png`
- Checksum / 校验和:
  `a3640572afc42bcaf3941a0095e2e20f4af342a70917ee68b95863dfef8e56c3`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 8.17%.
- Marked-pixel bounds: (80,42)–(169,203); span 90 × 162 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.17%。
- 痕迹范围：(80,42)–(169,203)；跨度90 × 162 px；痕迹矩形高于宽。
