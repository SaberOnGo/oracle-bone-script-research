# obs-unk-004787 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004787`
- primary external id: `hust-obc-und-X-004787`
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/087_obs-unk-004787_h
  ust-obc-und-X-004787_oracle-character-candidate/03_visual-assets/001_asset
  -006380_hust-obc-und-X-004787_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/343/X_？_7325_1.png`
- asset id: `asset-006380`
...
- source class: `HUST-OBC/undeciphered/X/343/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/343/X_？_7325_1.png`
- asset id: `asset-006380`
...
- English observation: `upper enclosure joined to lower pale openings`
- 中文观察: `连接下部浅色开口的上部围合结构`
...
- Which source records identify obs-unk-004787 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004787？
