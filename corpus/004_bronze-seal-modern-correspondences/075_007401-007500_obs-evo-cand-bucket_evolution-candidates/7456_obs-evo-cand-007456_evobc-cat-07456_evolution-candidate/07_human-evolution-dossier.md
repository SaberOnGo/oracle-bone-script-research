...
- External category reference: `evobc-cat-07456`
- Source category ID: `07456`
- Source label for human review: `萷`
- Source codepoints: `U+8437`
...
- `obs-evo-cand-007456-route-category-staging`
...
- `obs-evo-cand-007456-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007456-route-evolution-graph`
