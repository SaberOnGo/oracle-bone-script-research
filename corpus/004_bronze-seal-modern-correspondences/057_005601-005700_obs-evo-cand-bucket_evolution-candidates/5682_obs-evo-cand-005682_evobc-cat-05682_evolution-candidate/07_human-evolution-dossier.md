...
- External category reference: `evobc-cat-05682`
- Source category ID: `05682`
- Source label for human review: `瘵`
- Source codepoints: `U+7635`
...
- `obs-evo-cand-005682-route-category-staging`
...
- `obs-evo-cand-005682-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005682-route-evolution-graph`
