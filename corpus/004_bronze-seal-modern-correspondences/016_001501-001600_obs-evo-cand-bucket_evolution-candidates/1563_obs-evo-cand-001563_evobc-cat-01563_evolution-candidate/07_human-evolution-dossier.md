...
Project ID: `obs-evo-cand-001563`
...
- Project ID: `obs-evo-cand-001563`
- EVOBC category candidate ID: `evobc-evo-cat-01563`
- External category reference: `evobc-cat-01563`
- Source category ID: `01563`
- Source label for human review: `咢`
- Source codepoints: `U+54A2`
...
- `obs-evo-cand-001563-route-category-staging`
...
- `obs-evo-cand-001563-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001563-route-evolution-graph`
