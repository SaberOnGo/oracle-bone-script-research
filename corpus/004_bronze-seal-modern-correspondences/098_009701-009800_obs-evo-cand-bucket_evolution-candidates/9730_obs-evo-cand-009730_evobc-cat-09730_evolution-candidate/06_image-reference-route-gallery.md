...
- `obs-evo-cand-009730-route-category-staging`
...
- `obs-evo-cand-009730-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-009730-route-evolution-graph`
