# Material Visual Observation / obs-comp-cand-000860 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000860`
- External reference / 外部参照: `obimd-sub-svrqsl8ydm`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-013858_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/svrqsl8ydm/svrqsl8ydm/svrqsl8ydm.png`
- Checksum / 校验和:
  `d8a9cb6c3a51ef0bbac2610a782e4bb35cf7875ec0e452d1e7925f6057f74218`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 7.37%.
- Marked-pixel bounds: (96,31)–(175,219); span 80 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占7.37%。
- 痕迹范围：(96,31)–(175,219)；跨度80 × 189 px；痕迹矩形高于宽。
