...
- External category reference: `evobc-cat-01007`
- Source category ID: `01007`
- Source label for human review: `僊`
...
- `obs-evo-cand-001007-route-category-staging`
...
- `obs-evo-cand-001007-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001007-route-evolution-graph`
