# Material Visual Observation / obs-comp-cand-002164 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002164`
- External reference / 外部参照: `obimd-sub-i46xe6wczx`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019865_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/u3lh7tekno/i46xe6wczx/i46xe6wczx.png`
- Checksum / 校验和:
  `7bb00a8868e37a392de68a7a4ae35381292444daf2d15763c7b151b952d06b16`
...
- Marked-pixel bounds: (89,28)–(160,216); span 72 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.46%。
- 痕迹范围：(89,28)–(160,216)；跨度72 × 189 px；痕迹矩形高于宽。
