...
- External category reference: `evobc-cat-05481`
- Source category ID: `05481`
- Source label for human review: `璫`
- Source codepoints: `U+74AB`
...
- `obs-evo-cand-005481-route-category-staging`
...
- `obs-evo-cand-005481-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005481-route-evolution-graph`
