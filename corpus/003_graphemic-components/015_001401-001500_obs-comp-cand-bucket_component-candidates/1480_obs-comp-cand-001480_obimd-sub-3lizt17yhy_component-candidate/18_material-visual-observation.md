# Material Visual Observation / obs-comp-cand-001480 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001480`
- External reference / 外部参照: `obimd-sub-3lizt17yhy`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016057_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/3lizt17yhy/3lizt17yhy/3lizt17yhy.png`
- Checksum / 校验和:
  `80d21ca3ef4d4f8fbd7f04575bb59c2fc413be86da47e480998eeb1973670ace`
...
- Marked-pixel bounds: (81,32)–(170,212); span 90 × 181 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占8.56%。
- 痕迹范围：(81,32)–(170,212)；跨度90 × 181 px；痕迹矩形高于宽。
