...
- External category reference: `evobc-cat-00509`
- Source category ID: `00509`
- Source label for human review: `䤴`
- Source codepoints: `U+4934`
...
- `obs-evo-cand-000509-route-category-staging`
...
- `obs-evo-cand-000509-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000509-route-evolution-graph`
