# obs-evo-cand-002460 / EVOBC evolution-category candidate
...
- External category ref: `evobc-cat-02460`
- Source label: `專`
- Source codepoints: `U+5C08`
- Image reference count: `101`
- Era token counts: `BI:4;CS:1;OBC:94;SS:2`
- Source token counts: `Book:37;Web:64`

## Observed Code Rows / 观察到的代码行

- era 0 / OBC: 94 image references
