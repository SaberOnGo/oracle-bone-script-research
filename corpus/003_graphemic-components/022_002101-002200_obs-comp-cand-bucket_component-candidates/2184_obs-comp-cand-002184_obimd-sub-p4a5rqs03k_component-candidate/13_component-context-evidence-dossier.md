# obs-comp-cand-002184 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002184`
- 首选外部 ID: `obimd-sub-p4a5rqs03k`
- OBIMD subcharacter UID: `p4a5rqs03k`
- OBIMD main character UID: `p4a5rqs03k`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `4`
- codepoint 示例: U+B99CB;U+FC92C; U+FC92D; 另有 2 项
