...
Project ID: `obs-evo-cand-009536`
...
- Project ID: `obs-evo-cand-009536`
- EVOBC category candidate ID: `evobc-evo-cat-09536`
- External category reference: `evobc-cat-09536`
- Source category ID: `09536`
- Source label for human review: `鐵`
- Source codepoints: `U+9435`
...
- `obs-evo-cand-009536-route-category-staging`
...
- `obs-evo-cand-009536-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009536-route-evolution-graph`
