...
- External category reference: `evobc-cat-01450`
- Source category ID: `01450`
...
- `obs-evo-cand-001450-route-category-staging`
...
- `obs-evo-cand-001450-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001450-route-evolution-graph`
