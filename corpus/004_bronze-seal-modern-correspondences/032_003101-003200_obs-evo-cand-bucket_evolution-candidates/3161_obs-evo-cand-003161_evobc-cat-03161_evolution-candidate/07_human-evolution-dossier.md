...
- External category reference: `evobc-cat-03161`
- Source category ID: `03161`
- Source label for human review: `憭`
...
- `obs-evo-cand-003161-route-category-staging`
...
- `obs-evo-cand-003161-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003161-route-evolution-graph`
