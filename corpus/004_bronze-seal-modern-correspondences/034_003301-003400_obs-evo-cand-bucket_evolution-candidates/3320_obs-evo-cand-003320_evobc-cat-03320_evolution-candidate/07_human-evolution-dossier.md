...
Project ID: `obs-evo-cand-003320`
...
- Project ID: `obs-evo-cand-003320`
- EVOBC category candidate ID: `evobc-evo-cat-03320`
- External category reference: `evobc-cat-03320`
- Source category ID: `03320`
- Source label for human review: `拚`
- Source codepoints: `U+62DA`
...
- `obs-evo-cand-003320-route-category-staging`
...
- `obs-evo-cand-003320-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003320-route-evolution-graph`
