# obs-unk-004539 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/039_obs-unk-004539_h
  ust-obc-und-X-004539_oracle-character-candidate/03_visual-assets/001_asset
  -006132_hust-obc-und-X-004539_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/95/X_？_8278_1.png`
- asset id: `asset-006132`
...
- source class: `HUST-OBC/undeciphered/X/95/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/95/X_？_8278_1.png`
- asset id: `asset-006132`
...
- English observation: `Junction and four surrounding outlines recorded.`
- 中文观察: `已记录中央连接处和周围四个轮廓。`
...
- Which source records identify obs-unk-004539 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004539？
