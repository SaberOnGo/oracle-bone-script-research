# obs-unk-004120 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004120`
- primary external id: `hust-obc-und-L-004120`
...
- material visual observation: `14_material-visual-observation.md`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/020_obs-unk-004120_h
  ust-obc-und-L-004120_oracle-character-candidate/03_visual-assets/001_asset
  -005713_hust-obc-und-L-004120_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4120/L_？_8872.jpg`
- asset id: `asset-005713`
...
- source class: `HUST-OBC/undeciphered/L/4120/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4120/L_？_8872.jpg`
- asset id: `asset-005713`
...
- English observation: The opened image shows a broad left stroke, a narrow
  stem, a dense right cluster, and lower descending traces.
- 中文观察：已打开图像可见宽左笔画、窄主干、右侧密集痕迹簇和下伸痕迹。
...
- Which source records identify obs-unk-004120 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004120？
