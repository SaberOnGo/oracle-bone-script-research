# obs-comp-cand-002594 构件候选上下文复核档案
...
- 构件候选 ID: `obs-comp-cand-002594`
- 首选外部 ID: `obimd-sub-h1r681fij5`
- OBIMD subcharacter UID: `h1r681fij5`
- OBIMD main character UID: `h1r681fij5`
- 来源 ID: `src-obimd`
...
- glyph-codepoint 数: `5`
- codepoint 示例: U+FEB09; U+FEB0A; 另有 3 项
