# obs-unk-005245 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005245`
- primary external id: `hust-obc-und-X-005245`
...
- local review image route: `corpus/001_oracle-characters/069_undeciphered-005
  201-005300_obs-unk-bucket_oracle-character-candidates/045_obs-unk-005245_h
  ust-obc-und-X-005245_oracle-character-candidate/03_visual-assets/001_asset
  -006838_hust-obc-und-X-005245_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/801/X_？_7765_1.png`
- asset id: `asset-006838`
...
- source class: `HUST-OBC/undeciphered/X/801/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/801/X_？_7765_1.png`
- asset id: `asset-006838`
...
- Which source records identify obs-unk-005245 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005245？
