# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010503
...
- EVOBC candidate category: `evobc-evo-cat-10503`.
- Source label for search only: `鴺`.
- Source codepoints for search only: `U+9D3A`.
