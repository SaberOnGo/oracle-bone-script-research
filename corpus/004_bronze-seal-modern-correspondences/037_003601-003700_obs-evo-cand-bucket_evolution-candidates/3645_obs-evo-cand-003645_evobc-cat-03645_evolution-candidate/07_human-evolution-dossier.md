...
Project ID: `obs-evo-cand-003645`
...
- Project ID: `obs-evo-cand-003645`
- EVOBC category candidate ID: `evobc-evo-cat-03645`
- External category reference: `evobc-cat-03645`
- Source category ID: `03645`
- Source label for human review: `斩`
- Source codepoints: `U+65A9`
...
- `obs-evo-cand-003645-route-category-staging`
...
- `obs-evo-cand-003645-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003645-route-evolution-graph`
