...
Project ID: `obs-evo-cand-004404`
...
- Project ID: `obs-evo-cand-004404`
- EVOBC category candidate ID: `evobc-evo-cat-04404`
- External category reference: `evobc-cat-04404`
- Source category ID: `04404`
- Source label for human review: `殁`
- Source codepoints: `U+6B81`
...
- `obs-evo-cand-004404-route-category-staging`
...
- `obs-evo-cand-004404-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004404-route-evolution-graph`
