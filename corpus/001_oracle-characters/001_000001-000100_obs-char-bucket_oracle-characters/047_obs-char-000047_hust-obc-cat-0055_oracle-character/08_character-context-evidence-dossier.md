...
- Project ID / 项目 ID: `obs-char-000047`
- Primary external ID / 首选外部 ID: `hust-obc-cat-0055`
- Source ID / 来源 ID: `src-hust-obc`
- Packet file / packet 文件: `01_candidate-character-packet.json`
- Record type / 记录类型: `oracle_character_candidate_packet`
- Decipherment status / 释读状态: `unknown_until_cross_source_review`
...
- Source image / 来源图: `H_0055_60CB6_0.png`
- Image / 图像: `001_asset-000052_hust-obc-cat-0055_glyph.png`
...
- 当前图边数: `4`
- 图边类型: CHARACTER_HAS_EVOBC_CODEPOINT_LOOKUP_ROUTE;
...
- Filename catalog route clues / 文件名著录线索: `catalog-like filename clue:
  H_0055 (H_0055_60CB6_0.png)`
...
- Graph files / 图边文件: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
#### Graph Evidence Route 3

- edge type: `CHARACTER_HAS_OBIMD_CODEPOINT_LOOKUP_ROUTE`
- target node: `obimd-main-cand-002255`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
#### Graph Evidence Route 4

- edge type: `CHARACTER_HAS_EVOBC_CODEPOINT_LOOKUP_ROUTE`
- target node: `evobc-evo-cat-00005`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-002255`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-dxvqlu3dcd`
- OBIMD transcription field / OBIMD 转写字段: `㐭`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00005`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00005`
- EvoBC image references / EvoBC 图像引用数: `71`
- EvoBC oracle-bone refs / EvoBC 甲骨来源标记: `true`
- Route review status / 路线复核状态: `needs_cross_source_review`
### EvoBC Object-Local Human Routes / EvoBC 对象内人类档案路线

- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00005`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/005_obs-evo-cand-000005_evobc-cat-00005_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `dxvqlu3dcd`
- Component human files / 构件人类档案:
  corpus/003_graphemic-components/017_001601-001700_obs-comp-cand-bucket_compo
  nent-candidates/1626_obs-comp-cand-001626_obimd-sub-dxvqlu3dcd_component-can
  didate/README.md
  corpus/003_graphemic-components/017_001601-001700_obs-comp-cand-bucket_compo
  nent-candidates/1626_obs-comp-cand-001626_obimd-sub-dxvqlu3dcd_component-can
  ...
  corpus/003_graphemic-components/017_001601-001700_obs-comp-cand-bucket_compo
  nent-candidates/1627_obs-comp-cand-001627_obimd-sub-3991b428r6_component-can
  didate/README.md
  corpus/003_graphemic-components/017_001601-001700_obs-comp-cand-bucket_compo
  nent-candidates/1627_obs-comp-cand-001627_obimd-sub-3991b428r6_component-can
  didate/11_human-component-dossier.md
  ...
  didate/16_component-research-readiness-review.md
  corpus/003_graphemic-components/017_001601-001700_obs-comp-cand-bucket_compo
  nent-candidates/1628_obs-comp-cand-001628_obimd-sub-zcrzkabaoc_component-can
  didate/README.md
  corpus/003_graphemic-components/017_001601-001700_obs-comp-cand-bucket_compo
  nent-candidates/1628_obs-comp-cand-001628_obimd-sub-zcrzkabaoc_component-can
  didate/11_human-component-dossier.md
...
- Source trail / 来源追溯: 009_hust-obc-obs-char-promotion-review-queue.csv;
  000_hust-obc-promotion-bucket-manifest.csv;
  005_hust-obc-validation-class-staging.csv;
  007_hust-obc-validation-label-crosswalk-staging.csv; plus 4 more
...
- Source label status / 来源标签状态: `dataset_label_candidate_not_accepted_reading`
- Source label text / 来源标签文字: `㐭`
- Source label codepoint / 来源标签 codepoint: `U+342D`
