...
- External category reference: `evobc-cat-07439`
- Source category ID: `07439`
- Source label for human review: `萉`
- Source codepoints: `U+8409`
...
- `obs-evo-cand-007439-route-category-staging`
...
- `obs-evo-cand-007439-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007439-route-evolution-graph`
