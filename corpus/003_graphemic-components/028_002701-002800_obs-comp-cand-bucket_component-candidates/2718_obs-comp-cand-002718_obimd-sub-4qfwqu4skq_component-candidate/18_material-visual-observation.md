# Material Visual Observation / obs-comp-cand-002718 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002718`
- External reference / 外部参照: `obimd-sub-4qfwqu4skq`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021294_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/hdyubeknoa/4qfwqu4skq/4qfwqu4skq.png`
- Checksum / 校验和:
  `5e5e31a8da90b50f821f95648eb8915efdd481a0940fe9cb5e42390561f8b6b6`
...
- Marked-pixel bounds: (65,53)–(184,204); span 120 × 152 px; the marked
...
- 痕迹范围：(65,53)–(184,204)；跨度120 × 152 px；痕迹矩形高于宽。
