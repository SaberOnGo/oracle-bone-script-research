# Material Visual Observation / obs-comp-cand-000374 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000374`
- External reference / 外部参照: `obimd-sub-lsjuogr2ev`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012297_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/lsjuogr2ev/lsjuogr2ev/lsjuogr2ev.png`
- Checksum / 校验和:
  `cc441f35e39835bd47339472da94372e8b3afc0296c0a7cde6c3adf83c439eab`
...
- Marked-pixel bounds: (66,20)–(183,228); span 118 × 209 px; the marked
...
- 痕迹范围：(66,20)–(183,228)；跨度118 × 209 px；痕迹矩形高于宽。
