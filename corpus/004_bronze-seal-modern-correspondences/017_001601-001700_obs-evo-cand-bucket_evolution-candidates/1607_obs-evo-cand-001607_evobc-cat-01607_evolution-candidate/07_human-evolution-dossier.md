...
- External category reference: `evobc-cat-01607`
- Source category ID: `01607`
- Source label for human review: `唫`
...
- `obs-evo-cand-001607-route-category-staging`
...
- `obs-evo-cand-001607-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001607-route-evolution-graph`
