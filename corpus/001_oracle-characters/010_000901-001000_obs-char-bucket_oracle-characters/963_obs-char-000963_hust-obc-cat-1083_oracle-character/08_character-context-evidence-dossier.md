...
- Project ID / 项目 ID: `obs-char-000963`
- Primary external ID / 首选外部 ID: `hust-obc-cat-1083`
...
- Source image / 来源图: `G_1083_京都620合20217.png`
- Image / 图像: `001_asset-000968_hust-obc-cat-1083_glyph.png`
...
- Filename catalog route clues / 文件名著录线索: `Heji-like filename clue: 合20217
...
- target node: `obimd-main-cand-002775`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- target node: `evobc-evo-cat-00090`
- graph file: `010_cross-source-id-graph-edges.jsonl`
- review status: `needs_cross_source_review`
- source ids: src-hust-obc; src-obimd; src-evobc
- route files: 009_hust-obc-obs-char-promotion-review-queue.csv;
...
- OBIMD candidate ids / OBIMD 候选 ID: `obimd-main-cand-002775`
- OBIMD external refs / OBIMD 外部引用: `obimd-main-rny4p2gchp`
- OBIMD transcription field / OBIMD 转写字段: `㠱`
- EvoBC evolution category ids / EvoBC 演化类别 ID: `evobc-evo-cat-00090`
- EvoBC external refs / EvoBC 外部引用: `evobc-cat-00090`
- EvoBC image references / EvoBC 图像引用数: `99`
...
- Matched candidate folders / 匹配候选目录: `evobc-evo-cat-00090`
- Human review files / 人类复核文件:
  corpus/004_bronze-seal-modern-correspondences/001_000001-000100_obs-evo-cand
  -bucket_evolution-candidates/090_obs-evo-cand-000090_evobc-cat-00090_evoluti
...
- Matched OBIMD main UIDs / OBIMD 主字 UID: `rny4p2gchp`
...
- Source label text / 来源标签文字: `㠱`
- Source label codepoint / 来源标签 codepoint: `U+3831`
