# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001096
...
| --- | --- | --- | --- |
| `obimd-glyph-link-016314` | 󶓈 | `U+F64C8` | `reviewed_metadata_only` |
| `obimd-glyph-link-016315` | 󶓉 | `U+F64C9` | `reviewed_metadata_only` |
