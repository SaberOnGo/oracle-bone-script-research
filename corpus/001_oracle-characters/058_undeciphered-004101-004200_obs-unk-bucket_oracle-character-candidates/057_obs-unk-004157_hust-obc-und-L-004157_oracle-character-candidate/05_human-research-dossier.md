# obs-unk-004157 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004157`
- primary external id: `hust-obc-und-L-004157`
...
- local review image route: `corpus/001_oracle-characters/058_undeciphered-004
  101-004200_obs-unk-bucket_oracle-character-candidates/057_obs-unk-004157_h
  ust-obc-und-L-004157_oracle-character-candidate/03_visual-assets/001_asset
  -005750_hust-obc-und-L-004157_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4157/L_？_9006.jpg`
- asset id: `asset-005750`
...
- source class: `HUST-OBC/undeciphered/L/4157/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4157/L_？_9006.jpg`
- asset id: `asset-005750`
...
- English observation: Two curved upper traces rise above a rounded lower
  trace and a short descending mark.
- 中文观察：两条上部弯曲痕迹位于下部圆弧痕迹和短下行痕迹上方。
...
- Which source records identify obs-unk-004157 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004157？
