...
- External category reference: `evobc-cat-01983`
- Source category ID: `01983`
- Source label for human review: `夂`
- Source codepoints: `U+5902`
...
- `obs-evo-cand-001983-route-category-staging`
...
- `obs-evo-cand-001983-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001983-route-evolution-graph`
