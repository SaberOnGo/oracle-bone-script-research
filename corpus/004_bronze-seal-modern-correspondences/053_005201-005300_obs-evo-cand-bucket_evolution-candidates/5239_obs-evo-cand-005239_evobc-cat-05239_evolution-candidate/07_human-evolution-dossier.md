...
- External category reference: `evobc-cat-05239`
- Source category ID: `05239`
- Source label for human review: `犛`
...
- `obs-evo-cand-005239-route-category-staging`
...
- `obs-evo-cand-005239-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005239-route-evolution-graph`
