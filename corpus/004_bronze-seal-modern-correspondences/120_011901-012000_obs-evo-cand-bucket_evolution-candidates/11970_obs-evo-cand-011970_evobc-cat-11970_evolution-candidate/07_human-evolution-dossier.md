...
- External category reference: `evobc-cat-11970`
- Source category ID: `11970`
- Source label for human review: `𦄙`
...
- `obs-evo-cand-011970-route-category-staging`
...
- `obs-evo-cand-011970-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011970-route-evolution-graph`
