...
- `obs-evo-cand-010040-route-category-staging`
...
- `obs-evo-cand-010040-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010040-route-evolution-graph`
