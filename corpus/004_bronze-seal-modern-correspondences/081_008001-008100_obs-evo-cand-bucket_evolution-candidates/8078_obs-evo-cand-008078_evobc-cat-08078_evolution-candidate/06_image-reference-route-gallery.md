...
- `obs-evo-cand-008078-route-category-staging`
...
- `obs-evo-cand-008078-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-008078-route-evolution-graph`
