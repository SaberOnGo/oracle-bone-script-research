...
- External category reference: `evobc-cat-08384`
- Source category ID: `08384`
- Source label for human review: `讅`
- Source codepoints: `U+8B85`
...
- `obs-evo-cand-008384-route-category-staging`
...
- `obs-evo-cand-008384-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008384-route-evolution-graph`
