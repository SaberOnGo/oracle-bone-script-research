# Material Visual Observation / obs-comp-cand-001122 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001122`
- External reference / 外部参照: `obimd-sub-b6y3pr9x2a`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-015063_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/b6y3pr9x2a/b6y3pr9x2a/b6y3pr9x2a.png`
- Checksum / 校验和:
  `365f5a03f22735cd9bb2637140f7a40e0a7dedbdf3b6ba6963fb7f138a70b932`
...
- Marked-pixel bounds: (70,40)–(185,214); span 116 × 175 px; the marked
...
- 痕迹范围：(70,40)–(185,214)；跨度116 × 175 px；痕迹矩形高于宽。
