...
Project ID: `obs-evo-cand-004707`
...
- Project ID: `obs-evo-cand-004707`
- EVOBC category candidate ID: `evobc-evo-cat-04707`
- External category reference: `evobc-cat-04707`
- Source category ID: `04707`
- Source label for human review: `淄`
- Source codepoints: `U+6DC4`
...
- `obs-evo-cand-004707-route-category-staging`
...
- `obs-evo-cand-004707-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004707-route-evolution-graph`
