# Material Visual Observation / obs-comp-cand-000293 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000293`
- External reference / 外部参照: `obimd-sub-tq1msitntt`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-012001_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/zxuw992m8p/tq1msitntt/tq1msitntt.png`
- Checksum / 校验和:
  `026d80f546f9fecf82de90a2fd92a278e2dfe879663a8a0fa1c758db16d8a920`
...
- Marked-pixel bounds: (74,30)–(175,218); span 102 × 189 px; the marked
...
- 痕迹范围：(74,30)–(175,218)；跨度102 × 189 px；痕迹矩形高于宽。
