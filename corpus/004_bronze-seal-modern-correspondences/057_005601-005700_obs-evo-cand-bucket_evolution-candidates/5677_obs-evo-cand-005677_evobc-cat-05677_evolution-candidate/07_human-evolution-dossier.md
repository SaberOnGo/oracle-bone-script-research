...
Project ID: `obs-evo-cand-005677`
...
- Project ID: `obs-evo-cand-005677`
- EVOBC category candidate ID: `evobc-evo-cat-05677`
- External category reference: `evobc-cat-05677`
- Source category ID: `05677`
- Source label for human review: `瘧`
- Source codepoints: `U+7627`
...
- `obs-evo-cand-005677-route-category-staging`
...
- `obs-evo-cand-005677-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005677-route-evolution-graph`
