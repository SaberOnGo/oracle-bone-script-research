# Material Visual Observation / obs-comp-cand-002632 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002632`
- External reference / 外部参照: `obimd-sub-9j574ajtba`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-021171_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/9j574ajtba/9j574ajtba/9j574ajtba.png`
- Checksum / 校验和:
  `48bb6b476c62e2f5c73821153c0d3d2c927c6ec8d536f1da4de6400e2f7212fe`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 9.52%.
- Marked-pixel bounds: (62,32)–(208,223); span 147 × 192 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占9.52%。
- 痕迹范围：(62,32)–(208,223)；跨度147 × 192 px；痕迹矩形高于宽。
