# obs-unk-004387 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004387`
- primary external id: `hust-obc-und-L-004387`
...
- local review image route: `corpus/001_oracle-characters/060_undeciphered-004
  301-004400_obs-unk-bucket_oracle-character-candidates/087_obs-unk-004387_h
  ust-obc-und-L-004387_oracle-character-candidate/03_visual-assets/001_asset
  -005980_hust-obc-und-L-004387_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4387/L_？_9754.jpg`
- asset id: `asset-005980`
...
- source class: `HUST-OBC/undeciphered/L/4387/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4387/L_？_9754.jpg`
- asset id: `asset-005980`
...
- English observation: `A branching upper-left group and a separate`
  `long right trace are visible.`
- 中文观察: `左上有分叉痕迹群，右侧另有一条较长纵向痕迹。`
...
- Which source records identify obs-unk-004387 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004387？
