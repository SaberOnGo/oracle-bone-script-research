# obs-char-000044 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000044`
- primary external id: `hust-obc-cat-0051`
...
- local review image route: `corpus/001_oracle-characters/001_000001-000100_ob
  s-char-bucket_oracle-characters/044_obs-char-000044_hust-obc-cat-0051_orac
  le-character/03_visual-assets/001_asset-000049_hust-obc-cat-0051_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0051/G_0051_合36541黃組.png`
- asset id: `asset-000049`
...
- source category: `0051`
- validation class: `43`
- source image route: `HUST-OBC/deciphered/0051/G_0051_合36541黃組.png`
- asset id: `asset-000049`
...
- English observation: `The image shows a branching central stroke with
  short side marks and a curved lower extension.`
- 中文观察: `图像呈分叉中央笔画，两侧有短痕，下方有弯曲延伸。`
...
- dataset label text: `㐩`
- dataset label codepoints: `U+3429`
...
- filename catalog route clues: `Heji-like filename clue: 合36541
  (G_0051_合36541黃組.png)`
...
- Which source records identify obs-char-000044 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000044？
