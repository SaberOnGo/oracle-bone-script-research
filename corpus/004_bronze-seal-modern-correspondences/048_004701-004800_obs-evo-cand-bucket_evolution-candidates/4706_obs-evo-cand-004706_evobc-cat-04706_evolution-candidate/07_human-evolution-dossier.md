...
- External category reference: `evobc-cat-04706`
- Source category ID: `04706`
- Source label for human review: `淁`
...
- `obs-evo-cand-004706-route-category-staging`
...
- `obs-evo-cand-004706-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004706-route-evolution-graph`
