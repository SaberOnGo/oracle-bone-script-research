...
- Yingguo / 英国所藏: `y1204` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `62` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `560` in source row; primary catalog entry pending
