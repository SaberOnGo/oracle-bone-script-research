...
- External category reference: `evobc-cat-02491`
- Source category ID: `02491`
- Source label for human review: `尼`
- Source codepoints: `U+5C3C`
...
- `obs-evo-cand-002491-route-category-staging`
...
- `obs-evo-cand-002491-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002491-route-evolution-graph`
