...
- Project ID: `obs-evo-cand-006816`
- EVOBC category candidate ID: `evobc-evo-cat-06816`
- External category reference: `evobc-cat-06816`
- Source category ID: `06816`
- Source label for human review: `罬`
- Source codepoints: `U+7F6C`
...
- `obs-evo-cand-006816-route-category-staging`
...
- `obs-evo-cand-006816-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006816-route-evolution-graph`
