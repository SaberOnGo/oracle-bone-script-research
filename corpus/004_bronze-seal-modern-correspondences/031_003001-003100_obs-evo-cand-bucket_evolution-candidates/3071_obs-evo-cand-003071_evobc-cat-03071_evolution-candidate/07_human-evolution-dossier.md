...
- External category reference: `evobc-cat-03071`
- Source category ID: `03071`
...
- `obs-evo-cand-003071-route-category-staging`
...
- `obs-evo-cand-003071-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003071-route-evolution-graph`
