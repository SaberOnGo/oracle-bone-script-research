# obs-char-000390 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/004_000301-000400_ob
  s-char-bucket_oracle-characters/390_obs-char-000390_hust-obc-cat-0442_orac
  le-character/03_visual-assets/001_asset-000395_hust-obc-cat-0442_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0442/G_0442_乙1216反合6477反賓組.png`
- asset id: `asset-000395`
...
- source category: `0442`
- validation class: `389`
- source image route: `HUST-OBC/deciphered/0442/G_0442_乙1216反合6477反賓組.png`
- asset id: `asset-000395`
...
- English observation: `A thin looping central trace has a small hooked top
  and two long diverging lower strokes.`
- 中文观察: `纤细环曲中央痕迹上端有小钩，下方有两条长分行笔画。`
...
- dataset label text: `㖰`
- dataset label codepoints: `U+35B0`
...
- Which source records identify obs-char-000390 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000390？
