...
Project ID: `obs-insc-cw-cand-000310`

Candidate crosswalk ID: `cam-hopkins-crosswalk-000310`
...
- `cambridge_hopkins_finding_list`: Cambridge/Hopkins finding-list row `cam-hopkins-crosswalk-000310` [route_present_image_or_text_not_collected]
- `yingguo_catalog_reference`: Yingguo suo cang jiagu ji reference `y1964` [route_present_image_or_text_not_collected]
- `cambridge_university_library_reference`: Cambridge University Library object/reference number `424` [route_present_image_or_text_not_collected]
- `chalfant_reference`: Chalfant reference `82` [route_present_image_or_text_not_collected]
- `heji_reference`: Heji reference `40990` [route_present_image_or_text_not_collected]
