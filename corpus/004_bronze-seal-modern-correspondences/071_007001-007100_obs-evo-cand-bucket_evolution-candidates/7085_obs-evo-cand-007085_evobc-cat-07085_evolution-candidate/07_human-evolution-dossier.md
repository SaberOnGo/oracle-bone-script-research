...
- External category reference: `evobc-cat-07085`
- Source category ID: `07085`
- Source label for human review: `腄`
- Source codepoints: `U+8144`
...
- `obs-evo-cand-007085-route-category-staging`
...
- `obs-evo-cand-007085-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007085-route-evolution-graph`
