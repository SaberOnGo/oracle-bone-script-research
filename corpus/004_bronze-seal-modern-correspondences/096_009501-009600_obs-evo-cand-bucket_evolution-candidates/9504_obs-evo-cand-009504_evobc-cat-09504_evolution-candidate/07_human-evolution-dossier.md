...
- External category reference: `evobc-cat-09504`
- Source category ID: `09504`
- Source label for human review: `鏞`
- Source codepoints: `U+93DE`
...
- `obs-evo-cand-009504-route-category-staging`
...
- `obs-evo-cand-009504-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009504-route-evolution-graph`
