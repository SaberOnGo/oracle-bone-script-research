# Material Visual Observation / obs-comp-cand-002173 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002173`
- External reference / 外部参照: `obimd-sub-7echcotpha`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-019874_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/q4rk3syf2x/7echcotpha/7echcotpha.png`
- Checksum / 校验和:
  `1197b0c5242ded0ad4eede8fb80f36accd5b9717382803d3f9ef9b0bac19eb16`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 6.02%.
- Marked-pixel bounds: (94,28)–(155,216); span 62 × 189 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占6.02%。
- 痕迹范围：(94,28)–(155,216)；跨度62 × 189 px；痕迹矩形高于宽。
