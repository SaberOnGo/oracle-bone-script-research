# Material Visual Observation / obs-comp-cand-002513 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-002513`
- External reference / 外部参照: `obimd-sub-dp8imn8ze4`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-020819_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/dp8imn8ze4/dp8imn8ze4/6nrzw821d6.png`
- Checksum / 校验和:
  `a7e4d2e43b9d2567dbc1981254b18ff9ae59f470c36a90266745c38db52be203`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 1.45%.
- Marked-pixel bounds: (49,86)–(200,158); span 152 × 73 px; the marked rectangle
  is wider than tall.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占1.45%。
- 痕迹范围：(49,86)–(200,158)；跨度152 × 73 px；痕迹矩形宽于高。
