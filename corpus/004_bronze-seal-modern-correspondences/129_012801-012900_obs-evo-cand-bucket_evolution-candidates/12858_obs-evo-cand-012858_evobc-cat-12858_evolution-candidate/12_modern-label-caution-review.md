# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-012858
...
- EVOBC candidate category: `evobc-evo-cat-12858`.
- Source label for search only: `𪮻`.
- Source codepoints for search only: `U+2ABBB`.
