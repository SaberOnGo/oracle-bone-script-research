...
- External category reference: `evobc-cat-10602`
- Source category ID: `10602`
- Source label: `麇`
...
- `obs-evo-cand-010602-route-category-staging`
...
- `obs-evo-cand-010602-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-010602-route-evolution-graph`
