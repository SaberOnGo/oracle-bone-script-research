# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-006168
...
- EVOBC candidate category: `evobc-evo-cat-06168`.
- Source label for search only: `窘`.
- Source codepoints for search only: `U+7A98`.
