...
- External category reference: `evobc-cat-09212`
- Source category ID: `09212`
- Source label for human review: `鄬`
- Source codepoints: `U+912C`
...
- `obs-evo-cand-009212-route-category-staging`
...
- `obs-evo-cand-009212-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009212-route-evolution-graph`
