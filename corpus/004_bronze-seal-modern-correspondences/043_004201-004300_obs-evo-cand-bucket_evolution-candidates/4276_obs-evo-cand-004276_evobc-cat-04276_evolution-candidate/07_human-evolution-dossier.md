...
- Project ID: `obs-evo-cand-004276`
- EVOBC category candidate ID: `evobc-evo-cat-04276`
- External category reference: `evobc-cat-04276`
- Source category ID: `04276`
- Source label for human review: `橫`
- Source codepoints: `U+6A6B`
...
- `obs-evo-cand-004276-route-category-staging`
...
- `obs-evo-cand-004276-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004276-route-evolution-graph`
