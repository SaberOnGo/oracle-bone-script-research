...
- External category reference: `evobc-cat-00998`
- Source category ID: `00998`
- Source label for human review: `債`
...
- `obs-evo-cand-000998-route-category-staging`
...
- `obs-evo-cand-000998-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-000998-route-evolution-graph`
