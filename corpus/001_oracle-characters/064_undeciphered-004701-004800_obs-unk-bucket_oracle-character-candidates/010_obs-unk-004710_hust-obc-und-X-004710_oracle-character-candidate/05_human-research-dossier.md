# obs-unk-004710 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/010_obs-unk-004710_h
  ust-obc-und-X-004710_oracle-character-candidate/03_visual-assets/001_asset
  -006303_hust-obc-und-X-004710_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/266/X_？_7240_1.png`
- asset id: `asset-006303`
...
- source class: `HUST-OBC/undeciphered/X/266/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/266/X_？_7240_1.png`
- asset id: `asset-006303`
...
- English observation: `oval outer contour with inner upright stroke`
- 中文观察: `带内部竖向笔画的椭圆外轮廓`
...
- Which source records identify obs-unk-004710 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004710？
