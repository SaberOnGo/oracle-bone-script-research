# obs-unk-004214 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004214`
- primary external id: `hust-obc-und-L-004214`
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/014_obs-unk-004214_h
  ust-obc-und-L-004214_oracle-character-candidate/03_visual-assets/001_asset
  -005807_hust-obc-und-L-004214_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4214/L_？_9193.jpg`
- asset id: `asset-005807`
...
- source class: `HUST-OBC/undeciphered/L/4214/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4214/L_？_9193.jpg`
- asset id: `asset-005807`
...
- English observation: `Upper cluster, bar, and lower frame visible.`
- 中文观察: `上部痕迹、横笔画和下部框状轮廓可见。`
...
- Which source records identify obs-unk-004214 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004214？
