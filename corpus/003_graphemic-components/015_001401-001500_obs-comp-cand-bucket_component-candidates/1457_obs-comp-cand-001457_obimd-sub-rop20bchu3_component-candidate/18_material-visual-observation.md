# Material Visual Observation / obs-comp-cand-001457 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001457`
- External reference / 外部参照: `obimd-sub-rop20bchu3`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-016034_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/acx6uyop18/rop20bchu3/rop20bchu3.png`
- Checksum / 校验和:
  `c59c0d2deb8cc7fce8132fdce2e0e4baac01eda716dda6923b9aa99fdce8a0da`
...
- Image profile: 250 × 250 px, mode L; corner background is light; thresholded
  marked pixels occupy 5.79%.
- Marked-pixel bounds: (75,39)–(177,209); span 103 × 171 px; the marked
  rectangle is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占5.79%。
- 痕迹范围：(75,39)–(177,209)；跨度103 × 171 px；痕迹矩形高于宽。
