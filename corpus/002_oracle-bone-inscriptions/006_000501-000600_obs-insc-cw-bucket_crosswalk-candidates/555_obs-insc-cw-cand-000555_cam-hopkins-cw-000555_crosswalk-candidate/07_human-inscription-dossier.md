...
- Yingguo / 英国所藏: `y2564` in source row; primary catalog entry pending
- CUL / 剑桥大学图书馆: `350` in source row; primary catalog entry pending
- Chalfant / Chalfant 著录: `574` in source row; primary catalog entry pending
- Heji / 合集: `41762` in source row; primary catalog entry pending
...
- Route: `cambridge_hopkins_finding_list`
  ...
  Reference: `cam-hopkins-crosswalk-000555`
