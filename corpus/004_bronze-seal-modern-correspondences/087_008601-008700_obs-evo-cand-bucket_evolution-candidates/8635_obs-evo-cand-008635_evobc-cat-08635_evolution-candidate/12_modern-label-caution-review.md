# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008635
...
- EVOBC candidate category: `evobc-evo-cat-08635`.
- Source label for search only: `贺`.
- Source codepoints for search only: `U+8D3A`.
