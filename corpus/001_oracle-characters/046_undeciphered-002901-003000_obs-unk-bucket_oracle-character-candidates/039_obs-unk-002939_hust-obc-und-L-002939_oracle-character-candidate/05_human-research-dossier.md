# obs-unk-002939 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/046_undeciphered-002
  901-003000_obs-unk-bucket_oracle-character-candidates/039_obs-unk-002939_h
  ust-obc-und-L-002939_oracle-character-candidate/03_visual-assets/001_asset
  -004532_hust-obc-und-L-002939_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/2939/L_？_5084.jpg`
- asset id: `asset-004532`
...
- source class: `HUST-OBC/undeciphered/L/2939/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/2939/L_？_5084.jpg`
- asset id: `asset-004532`
...
- Which source records identify obs-unk-002939 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-002939？
