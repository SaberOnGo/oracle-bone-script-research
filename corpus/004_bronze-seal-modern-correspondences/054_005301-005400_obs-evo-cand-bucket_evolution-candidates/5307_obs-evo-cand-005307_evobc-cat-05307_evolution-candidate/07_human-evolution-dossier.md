...
- External category reference: `evobc-cat-05307`
- Source category ID: `05307`
- Source label for human review: `猵`
...
- `obs-evo-cand-005307-route-category-staging`
...
- `obs-evo-cand-005307-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-005307-route-evolution-graph`
