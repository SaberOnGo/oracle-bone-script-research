# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000979
...
| --- | --- | --- | --- |
| `obimd-glyph-link-014136` | 󴑹 | `U+F4479` | `reviewed_metadata_only` |
| `obimd-glyph-link-014137` | 󵢶 | `U+F58B6` | `reviewed_metadata_only` |
