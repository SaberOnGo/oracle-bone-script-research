...
- External category reference: `evobc-cat-04129`
- Source category ID: `04129`
- Source label for human review: `椱`
...
- `obs-evo-cand-004129-route-category-staging`
...
- `obs-evo-cand-004129-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-004129-route-evolution-graph`
