...
- Project ID: `obs-evo-cand-001939`
- EVOBC category candidate ID: `evobc-evo-cat-01939`
- External category reference: `evobc-cat-01939`
- Source category ID: `01939`
- Source label for human review: `墓`
- Source codepoints: `U+5893`
...
- `obs-evo-cand-001939-route-category-staging`
...
- `obs-evo-cand-001939-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001939-route-evolution-graph`
