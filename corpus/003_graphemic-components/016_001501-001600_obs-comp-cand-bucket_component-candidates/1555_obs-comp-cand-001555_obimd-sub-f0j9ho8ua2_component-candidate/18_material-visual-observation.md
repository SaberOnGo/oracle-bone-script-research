# Material Visual Observation / obs-comp-cand-001555 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001555`
- External reference / 外部参照: `obimd-sub-f0j9ho8ua2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-017075_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/f0j9ho8ua2/f0j9ho8ua2/f0j9ho8ua2.png`
- Checksum / 校验和:
  `51061ad4835a3813aab64be3db26c4d4fb39fbd50d579e9463a5816ea12cf469`
...
- Marked-pixel bounds: (80,18)–(178,229); span 99 × 212 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占11.80%。
- 痕迹范围：(80,18)–(178,229)；跨度99 × 212 px；痕迹矩形高于宽。
