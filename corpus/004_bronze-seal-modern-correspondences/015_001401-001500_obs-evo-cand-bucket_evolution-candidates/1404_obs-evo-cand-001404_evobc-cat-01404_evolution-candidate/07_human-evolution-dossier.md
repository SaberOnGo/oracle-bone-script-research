...
Project ID: `obs-evo-cand-001404`
...
- Project ID: `obs-evo-cand-001404`
- EVOBC category candidate ID: `evobc-evo-cat-01404`
- External category reference: `evobc-cat-01404`
- Source category ID: `01404`
- Source label for human review: `卷`
- Source codepoints: `U+5377`
...
- `obs-evo-cand-001404-route-category-staging`
...
- `obs-evo-cand-001404-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-001404-route-evolution-graph`
