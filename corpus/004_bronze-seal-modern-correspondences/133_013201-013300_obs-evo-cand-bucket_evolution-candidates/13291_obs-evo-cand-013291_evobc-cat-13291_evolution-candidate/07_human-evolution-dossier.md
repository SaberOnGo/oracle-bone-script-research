...
Project ID: `obs-evo-cand-013291`
...
- Project ID: `obs-evo-cand-013291`
- EVOBC category candidate ID: `evobc-evo-cat-13291`
- External category reference: `evobc-cat-13291`
- Source category ID: `13291`
- Source label for human review: `𬗈`
- Source codepoints: `U+2C5C8`
...
- `obs-evo-cand-013291-route-category-staging`
...
- `obs-evo-cand-013291-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013291-route-evolution-graph`
