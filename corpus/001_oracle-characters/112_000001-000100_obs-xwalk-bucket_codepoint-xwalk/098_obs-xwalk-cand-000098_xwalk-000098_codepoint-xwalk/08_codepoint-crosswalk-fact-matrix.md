# obs-xwalk-cand-000098 Codepoint Crosswalk Fact Matrix
...
|---|---|---|
| Source Codepoint Route / 来源码位路线 | `U+3463` | not identity |
| HUST candidate route / HUST 候选路线 | `hust-obc-cat-0109` | not reading |
