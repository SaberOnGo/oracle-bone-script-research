...
- External category reference: `evobc-cat-03568`
- Source category ID: `03568`
- Source label for human review: `敀`
- Source codepoints: `U+6540`
...
- `obs-evo-cand-003568-route-category-staging`
...
- `obs-evo-cand-003568-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003568-route-evolution-graph`
