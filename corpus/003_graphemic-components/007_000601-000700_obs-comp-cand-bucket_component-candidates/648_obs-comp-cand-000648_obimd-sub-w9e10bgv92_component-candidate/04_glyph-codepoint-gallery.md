# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-000648
...
| --- | --- | --- | --- |
| `obimd-glyph-link-009525` | 󳯷 | `U+F3BF7` | `reviewed_metadata_only` |
| `obimd-glyph-link-009526` | 󳯸 | `U+F3BF8` | `reviewed_metadata_only` |
| `obimd-glyph-link-009527` | 󳯹 | `U+F3BF9` | `reviewed_metadata_only` |
| `obimd-glyph-link-009528` | 󳯺 | `U+F3BFA` | `reviewed_metadata_only` |
| `obimd-glyph-link-009529` | 󳯻 | `U+F3BFB` | `reviewed_metadata_only` |
