...
- `obs-evo-cand-013365-route-category-staging`
...
- `obs-evo-cand-013365-route-code-index`
  ...
  status: `not_collected_route_indexed`
- `obs-evo-cand-013365-route-evolution-graph`
