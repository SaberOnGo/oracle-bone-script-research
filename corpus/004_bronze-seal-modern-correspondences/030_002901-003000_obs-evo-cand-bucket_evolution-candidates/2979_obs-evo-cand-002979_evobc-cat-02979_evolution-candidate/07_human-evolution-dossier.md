...
- External category reference: `evobc-cat-02979`
- Source category ID: `02979`
- Source label for human review: `恣`
- Source codepoints: `U+6063`
...
- `obs-evo-cand-002979-route-category-staging`
...
- `obs-evo-cand-002979-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002979-route-evolution-graph`
