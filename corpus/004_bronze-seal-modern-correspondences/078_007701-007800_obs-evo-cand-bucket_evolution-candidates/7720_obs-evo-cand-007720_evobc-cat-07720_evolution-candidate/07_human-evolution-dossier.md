...
- Project ID: `obs-evo-cand-007720`
- EVOBC category candidate ID: `evobc-evo-cat-07720`
- External category reference: `evobc-cat-07720`
- Source category ID: `07720`
- Source label for human review: `虹`
- Source codepoints: `U+8679`
- Image reference count in source metadata: `44`
...
- `obs-evo-cand-007720-route-category-staging`
...
- `obs-evo-cand-007720-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-007720-route-evolution-graph`
