# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-013146
...
- EVOBC candidate category: `evobc-evo-cat-13146`.
- Source label for search only: `𫺍`.
- Source codepoints for search only: `U+2BE8D`.
