# Glyph Codepoint Gallery / 字形码位查看: obs-comp-cand-001097
...
| --- | --- | --- | --- |
| `obimd-glyph-link-016316` | 󄉟󶓤 | `U+C425F;U+F64E4` | `reviewed_metadata_only` |
| `obimd-glyph-link-016317` | 󶓥 | `U+F64E5` | `reviewed_metadata_only` |
| `obimd-glyph-link-016318` | 󶓦 | `U+F64E6` | `reviewed_metadata_only` |
