# Material Visual Observation / obs-comp-cand-000973 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-000973`
- External reference / 外部参照: `obimd-sub-r79attbhro`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-014230_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/r79attbhro/r79attbhro/062x9wdoce.png`
- Checksum / 校验和:
  `9504ac7f0d01313828e0a5396a9968f64bded52a91c81432f0a1c829d0b7d6e2`
...
- Marked-pixel bounds: (85,54)–(164,200); span 80 × 147 px; the marked rectangle
  is taller than wide.
- 简体中文观察：已打开栅格图像中存在对比度明显的痕迹区域。以下 profile 只记录像素，不分割单独笔画。
- 图像 profile：250 × 250 像素，模式 L；角点背景为浅色；阈值痕迹像素占4.55%。
- 痕迹范围：(85,54)–(164,200)；跨度80 × 147 px；痕迹矩形高于宽。
