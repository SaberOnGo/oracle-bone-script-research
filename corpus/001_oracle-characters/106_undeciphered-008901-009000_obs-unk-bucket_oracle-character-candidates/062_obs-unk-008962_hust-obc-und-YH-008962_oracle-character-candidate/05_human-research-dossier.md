# obs-unk-008962 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-008962`
- primary external id: `hust-obc-und-YH-008962`
...
- local review image route: `corpus/001_oracle-characters/106_undeciphered-008
  901-009000_obs-unk-bucket_oracle-character-candidates/062_obs-unk-008962_h
  ust-obc-und-YH-008962_oracle-character-candidate/03_visual-assets/001_asse
  t-010553_hust-obc-und-YH-008962_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/Y+H/60FCB/Y_？_60FCB.jpg`
- asset id: `asset-010553`
...
- source class: `HUST-OBC/undeciphered/Y+H/60FCB/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/Y+H/60FCB/Y_？_60FCB.jpg`
- asset id: `asset-010553`
...
- Which source records identify obs-unk-008962 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-008962？
