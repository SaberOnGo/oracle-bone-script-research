...
Project ID: `obs-evo-cand-011523`
...
- Project ID: `obs-evo-cand-011523`
- EVOBC category candidate ID: `evobc-evo-cat-11523`
- External category reference: `evobc-cat-11523`
- Source category ID: `11523`
- Source label for human review: `𣶏`
- Source codepoints: `U+23D8F`
...
- `obs-evo-cand-011523-route-category-staging`
...
- `obs-evo-cand-011523-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-011523-route-evolution-graph`
