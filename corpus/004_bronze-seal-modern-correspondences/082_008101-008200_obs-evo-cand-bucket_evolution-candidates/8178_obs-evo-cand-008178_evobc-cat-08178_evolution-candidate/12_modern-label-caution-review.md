# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-008178
...
- EVOBC candidate category: `evobc-evo-cat-08178`.
- Source label for search only: `詔`.
- Source codepoints for search only: `U+8A54`.
