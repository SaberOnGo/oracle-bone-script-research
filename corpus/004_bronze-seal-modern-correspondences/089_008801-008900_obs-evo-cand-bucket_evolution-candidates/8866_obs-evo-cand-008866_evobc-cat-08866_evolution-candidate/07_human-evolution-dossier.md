...
- External category reference: `evobc-cat-08866`
- Source category ID: `08866`
- Source label for human review: `轇`
...
- `obs-evo-cand-008866-route-category-staging`
...
- `obs-evo-cand-008866-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008866-route-evolution-graph`
