# obs-unk-005527 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-005527`
- primary external id: `hust-obc-und-X-005527`
...
- local review image route: `corpus/001_oracle-characters/072_undeciphered-005
  501-005600_obs-unk-bucket_oracle-character-candidates/027_obs-unk-005527_h
  ust-obc-und-X-005527_oracle-character-candidate/03_visual-assets/001_asset
  -007120_hust-obc-und-X-005527_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/1083/X_？_8043_1.png`
- asset id: `asset-007120`
...
- source class: `HUST-OBC/undeciphered/X/1083/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/1083/X_？_8043_1.png`
- asset id: `asset-007120`
...
- Which source records identify obs-unk-005527 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-005527？
