...
- Project ID: `obs-evo-cand-003547`
- EVOBC category candidate ID: `evobc-evo-cat-03547`
- External category reference: `evobc-cat-03547`
- Source category ID: `03547`
- Source label for human review: `攜`
- Source codepoints: `U+651C`
...
- `obs-evo-cand-003547-route-category-staging`
...
- `obs-evo-cand-003547-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-003547-route-evolution-graph`
