# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-002885
...
- EVOBC candidate category: `evobc-evo-cat-02885`.
- Source label for search only: `微`.
- Source codepoints for search only: `U+5FAE`.
