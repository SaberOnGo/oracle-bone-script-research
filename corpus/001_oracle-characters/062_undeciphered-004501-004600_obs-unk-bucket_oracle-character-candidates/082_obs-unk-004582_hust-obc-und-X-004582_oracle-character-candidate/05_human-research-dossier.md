# obs-unk-004582 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004582`
- primary external id: `hust-obc-und-X-004582`
...
- local review image route: `corpus/001_oracle-characters/062_undeciphered-004
  501-004600_obs-unk-bucket_oracle-character-candidates/082_obs-unk-004582_h
  ust-obc-und-X-004582_oracle-character-candidate/03_visual-assets/001_asset
  -006175_hust-obc-und-X-004582_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/138/X_？_8316_1.png`
- asset id: `asset-006175`
...
- source class: `HUST-OBC/undeciphered/X/138/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/138/X_？_8316_1.png`
- asset id: `asset-006175`
...
- English observation: `Stepped right side, central gap, and lower enclosure`
  `recorded.`
- 中文观察: `已记录右侧收折、中央开口和下部轮廓。`
...
- Which source records identify obs-unk-004582 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004582？
