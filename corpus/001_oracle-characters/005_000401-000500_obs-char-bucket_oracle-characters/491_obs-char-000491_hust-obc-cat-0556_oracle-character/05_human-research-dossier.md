# obs-char-000491 Human Research Dossier / 人类研究档案
...
- project id: `obs-char-000491`
- primary external id: `hust-obc-cat-0556`
...
- local review image route: `corpus/001_oracle-characters/005_000401-000500_ob
  s-char-bucket_oracle-characters/491_obs-char-000491_hust-obc-cat-0556_orac
  le-character/03_visual-assets/001_asset-000496_hust-obc-cat-0556_glyph.png`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/deciphered/0556/H_0556_60B4C_0.png`
- asset id: `asset-000496`
...
- source category: `0556`
- validation class: `490`
- source image route: `HUST-OBC/deciphered/0556/H_0556_60B4C_0.png`
- asset id: `asset-000496`
...
- English observation: `A bold pointed outer outline surrounds a central
  branching vertical stroke and several detached short marks, above a broad
  curved lower base.`
- 中文观察: `粗重尖顶外轮廓围绕中央分支竖笔和数条分离短痕，下方为宽弯曲底部笔画。`
...
- dataset label text: `㘢`
- dataset label codepoints: `U+3622`
...
- filename catalog route clues: `catalog-like filename clue: H_0556
  (H_0556_60B4C_0.png)`
...
- Which source records identify obs-char-000491 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-char-000491？
