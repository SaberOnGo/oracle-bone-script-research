...
Project ID: `obs-evo-cand-012737`
...
- Project ID: `obs-evo-cand-012737`
- EVOBC category candidate ID: `evobc-evo-cat-12737`
- External category reference: `evobc-cat-12737`
- Source category ID: `12737`
- Source label for human review: `𪈶`
- Source codepoints: `U+2A236`
...
- `obs-evo-cand-012737-route-category-staging`
...
- `obs-evo-cand-012737-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-012737-route-evolution-graph`
