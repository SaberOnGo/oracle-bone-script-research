...
- External category reference: `evobc-cat-06033`
- Source category ID: `06033`
- Source label for human review: `禩`
...
- `obs-evo-cand-006033-route-category-staging`
...
- `obs-evo-cand-006033-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-006033-route-evolution-graph`
