# Material Visual Observation / obs-comp-cand-001994 实物图像观察
...
- Candidate ID / 候选 ID: `obs-comp-cand-001994`
- External reference / 外部参照: `obimd-sub-des9ohoyn2`
- Source / 来源: `src-obimd`
- Download route / 下载路线: `dl-obimd-subchar-main-mapping`
- Local image / 本地图像: `05_component-visual-assets/001_asset-018986_img.png`
- Source zip member / 来源压缩包成员: `Sub-character
  Images/w49pivmpx3/des9ohoyn2/des9ohoyn2.png`
- Checksum / 校验和:
  `c9a5751c1cf67a9467cb4ef446745c9be5d3525f7bd0bc860ebcf437f5875323`
...
- Marked-pixel bounds: (58,36)–(202,202); span 145 × 167 px; the marked
...
- 痕迹范围：(58,36)–(202,202)；跨度145 × 167 px；痕迹矩形近方形。
