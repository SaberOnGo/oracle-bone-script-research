...
- External category reference: `evobc-cat-13460`
- Source category ID: `13460`
- Source label for human review: `𬼂`
...
- `obs-evo-cand-013460-route-category-staging`
...
- `obs-evo-cand-013460-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-013460-route-evolution-graph`
