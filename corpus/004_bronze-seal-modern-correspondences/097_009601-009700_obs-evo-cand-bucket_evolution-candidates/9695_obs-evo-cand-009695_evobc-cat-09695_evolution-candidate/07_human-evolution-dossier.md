...
- External category reference: `evobc-cat-09695`
- Source category ID: `09695`
- Source label for human review: `阤`
- Source codepoints: `U+9624`
...
- `obs-evo-cand-009695-route-category-staging`
...
- `obs-evo-cand-009695-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-009695-route-evolution-graph`
