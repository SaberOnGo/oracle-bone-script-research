...
Project ID: `obs-evo-cand-008594`
...
- Project ID: `obs-evo-cand-008594`
- EVOBC category candidate ID: `evobc-evo-cat-08594`
- External category reference: `evobc-cat-08594`
- Source category ID: `08594`
- Source label for human review: `賶`
- Source codepoints: `U+8CF6`
...
- `obs-evo-cand-008594-route-category-staging`
...
- `obs-evo-cand-008594-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-008594-route-evolution-graph`
