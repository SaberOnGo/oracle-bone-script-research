# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-004860
...
- EVOBC candidate category: `evobc-evo-cat-04860`.
- Source label for search only: `滿`.
- Source codepoints for search only: `U+6EFF`.
