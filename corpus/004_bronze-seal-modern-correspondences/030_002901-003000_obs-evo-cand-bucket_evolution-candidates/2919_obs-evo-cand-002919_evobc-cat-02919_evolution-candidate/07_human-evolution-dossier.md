...
Project ID: `obs-evo-cand-002919`
...
- Project ID: `obs-evo-cand-002919`
- EVOBC category candidate ID: `evobc-evo-cat-02919`
- External category reference: `evobc-cat-02919`
- Source category ID: `02919`
- Source label for human review: `忯`
- Source codepoints: `U+5FEF`
...
- `obs-evo-cand-002919-route-category-staging`
...
- `obs-evo-cand-002919-route-code-index`
  ...
  pending check: 待查：先开 `05_image-reference-route-index.csv` 核对图像路线。
- `obs-evo-cand-002919-route-evolution-graph`
