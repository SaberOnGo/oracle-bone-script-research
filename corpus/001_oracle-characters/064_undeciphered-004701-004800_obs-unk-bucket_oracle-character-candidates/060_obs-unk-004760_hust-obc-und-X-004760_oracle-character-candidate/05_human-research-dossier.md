# obs-unk-004760 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/064_undeciphered-004
  701-004800_obs-unk-bucket_oracle-character-candidates/060_obs-unk-004760_h
  ust-obc-und-X-004760_oracle-character-candidate/03_visual-assets/001_asset
  -006353_hust-obc-und-X-004760_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/316/X_？_7300_1.png`
- asset id: `asset-006353`
...
- source class: `HUST-OBC/undeciphered/X/316/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/316/X_？_7300_1.png`
- asset id: `asset-006353`
...
- English observation: `high-contrast image requires polarity review`
- 中文观察: `高对比图像需要核对黑白极性`
...
- Which source records identify obs-unk-004760 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004760？
