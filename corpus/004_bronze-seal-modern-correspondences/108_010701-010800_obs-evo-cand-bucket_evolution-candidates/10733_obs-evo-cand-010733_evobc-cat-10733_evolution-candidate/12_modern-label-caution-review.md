# Modern Label Caution Review / 今字标签风险复核: obs-evo-cand-010733
...
- EVOBC candidate category: `evobc-evo-cat-10733`.
- Source label for search only: `齯`.
- Source codepoints for search only: `U+9F6F`.
