# obs-unk-004242 Human Research Dossier / 人类研究档案
...
- local review image route: `corpus/001_oracle-characters/059_undeciphered-004
  201-004300_obs-unk-bucket_oracle-character-candidates/042_obs-unk-004242_h
  ust-obc-und-L-004242_oracle-character-candidate/03_visual-assets/001_asset
  -005835_hust-obc-und-L-004242_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/L/4242/L_？_9352.jpg`
- asset id: `asset-005835`
...
- source class: `HUST-OBC/undeciphered/L/4242/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/L/4242/L_？_9352.jpg`
- asset id: `asset-005835`
...
- English observation: `Upper cluster, side curves, central gap visible.`
- 中文观察: `上部痕迹簇、两侧弯曲痕迹和中央间隙可见。`
...
- Which source records identify obs-unk-004242 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004242？
