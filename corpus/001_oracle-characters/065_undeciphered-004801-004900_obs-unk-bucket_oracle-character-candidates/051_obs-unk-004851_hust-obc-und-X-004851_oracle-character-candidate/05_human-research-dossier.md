# obs-unk-004851 Human Research Dossier / 人类研究档案
...
- project id: `obs-unk-004851`
- primary external id: `hust-obc-und-X-004851`
...
- local review image route: `corpus/001_oracle-characters/065_undeciphered-004
  801-004900_obs-unk-bucket_oracle-character-candidates/051_obs-unk-004851_h
  ust-obc-und-X-004851_oracle-character-candidate/03_visual-assets/001_asset
  -006444_hust-obc-und-X-004851_glyph.jpg`
- local image status: `local_file_present`
- source image reference: `HUST-OBC/undeciphered/X/407/X_？_7392_1.png`
- asset id: `asset-006444`
...
- source class: `HUST-OBC/undeciphered/X/407/`
- source category: `待查：需要核对来源记录`
- validation class: `待查：需要核对来源记录`
- source image route: `HUST-OBC/undeciphered/X/407/X_？_7392_1.png`
- asset id: `asset-006444`
...
- English observation: `left curves, upper loop, and lower opening`
- 中文观察: `左侧曲线、上部环状结构和下部开口`
...
- Which source records identify obs-unk-004851 beyond the current packet?
- 除当前 packet 外，哪些来源记录可以继续定位 obs-unk-004851？
